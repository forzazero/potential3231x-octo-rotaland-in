...
`,xR='"Reckk Heading", Georgia, "Times New Roman", serif',SR='"Reckk Title", "Reckk Heading", Fraunces, ui-serif, Georgia, serif';async function MR(){if(!(typeof document>"u"||!document.fonts))try{const r=[{weight:"400",style:"normal"},{weight:"400",style:"italic"},{weight:"600",style:"normal"},{weight:"600",style:"italic"}],e=[{weight:"400",style:"normal"},{weight:"400",style:"italic"},{weight:"500",style:"normal"},{weight:"500",style:"italic"}];await Promise.all([...r.map(async i=>{const s=new FontFace("Reckk Heading",`url(${jA})`,i);document.fonts.add(await s.load())}),...e.map(async i=>{const s=new FontFace("Reckk Title",`url(${JA})`,i);document.fonts.add(await s.load())})]),await document.fonts.ready,await document.fonts.load('italic 400 64px "Reckk Heading"'),await document.fonts.load('italic 500 124px "Reckk Title"')}catch{}}const Gs="flow-intro-hide-chrome";function yR(r){return r<=72}const ER=280;function bR(r){const e=document.documentElement,i=e.style.scrollBehavior;e.style.scrollBehavior="auto",window.scrollTo(0,Math.max(0,r)),e.style.scrollBehavior=i}function ih(){const r=document.getElementById("hero");if(!r)return;const e=r.getBoundingClientRect().top+window.scrollY;bR(e)}function ol(r){const e=Un.clamp(r,0,1);return e*e*e*(e*(e*6-15)+10)}function TR(r,e,i){const s=e.split(/\s+/),l=[];let c="";for(const f of s){const h=c?`${c} ${f}`:f;r.measureText(h).width<=i?c=h:(c&&l.push(c),c=f)}return c&&l.push(c),l}function AR(r,e){const s=e<520?300:400,l=Math.round(s*r),c=Math.round(l*hp/dp);return{W:l,H:c}}function ah(r){const e=Math.max(1,r),i=Math.max(1,Yn*e*$A),s=Math.max(1,i/Math.max(1,Yn-1));return{cardPx:i,titlePx:s,totalPx:i+s}}function tx(r,e){const i=r/Math.max(1,e),s=fp*Math.PI/180,l=2*rl*Math.tan(s/2),c=l*i,f=Qh*dp/hp,h=.992,m=h*l/Qh,p=h*c/f;return Un.clamp(Math.min(m,p),.52,2.35)}function hv(r,e,i){const s=ex(r),l=tx(r,e),c=r/Math.max(1,e),f=fp*Math.PI/180,m=2*rl*Math.tan(f/2)*c,p=s.frustumFill*m/Math.max(1e-6,l),v=Math.min(s.planeBaseW,p);return{w:v,h:v*i}}function RR(r,e){const i=r/Math.max(1,Yn-1),s=Math.min(Math.max(1,e*.38),Math.max(1,i*.34));return i<=s+.001?0:1-s/i}function CR(r,e){const i=Math.min(Math.max(1,e*.38),Math.max(1,r*.34));return r<=i+.001?0:1-i/r}function wR(r,e){const i=Un.clamp(e,0,.999);if(r<i)return{titleOp:1,lastCardOp:0};const s=Math.max(1e-6,1-i),l=ol(Un.clamp((r-i)/s,0,1));return{titleOp:1-l,lastCardOp:l}}function DR(r,e,i){const s=Yn-1;if(r<=0)return{opacity:e===0?1:0};if(r>=s-1e-5)return{opacity:e===s?1:0};const l=Math.floor(r);if(l>=s)return{opacity:e===s?1:0};if(e!==l&&e!==l+1)return{opacity:0};const c=r-l,f=Un.clamp(i,0,.999);if(c<f)return{opacity:e===l?1:0};const h=ol(Un.clamp((c-f)/Math.max(1e-6,1-f),0,1));return{opacity:e===l?1-h:h}}function UR(r,e){return r>1.5&&r<e-.5}function NR(r){return Un.clamp(540/Math.max(r,340),.2,.55)}function LR(r,e,i){const s=[],l=rR;for(let c=0;c<l;c++){const f=Un.clamp(r-c/Math.max(1,l-1)*oR,-.08,1.08),h=Math.sin(f*Math.PI*2*nR)*aR*i,m=Math.sin(f*Math.PI*2*iR)*sR,p=dv+c/Math.max(1,l-1)*(dR-dv),v=e-p;s.push(new $(h,m,v))}return s}function OR(r,e,i,s){const l=r.length;if(l<2)return new wi;const c=[],f=[],h=[],m=[],p=new $,v=new $,x=new $,g=new $(0,1,0),M=e+1;for(let w=0;w<l;w++){w===0?p.subVectors(r[1],r[0]).normalize():w===l-1?p.subVectors(r[l-1],r[l-2]).normalize():p.subVectors(r[w+1],r[w-1]).normalize(),v.copy(g).cross(p),v.lengthSq()<1e-8&&v.set(1,0,0).cross(p),v.normalize(),x.crossVectors(p,v).normalize();const E=l===1?0:w/(l-1),S=i+(s-i)*Math.pow(E,1.5);for(let F=0;F<=e;F++){const z=F/e*Math.PI*2,C=Math.cos(z),I=Math.sin(z),L=r[w];c.push(L.x+(C*v.x+I*x.x)*S,L.y+(C*v.y+I*x.y)*S,L.z+(C*v.z+I*x.z)*S),f.push(C*v.x+I*x.x,C*v.y+I*x.y,C*v.z+I*x.z),h.push(l===1?0:w/(l-1),F/e)}}for(let w=0;w<l-1;w++)for(let E=0;E<e;E++){const S=w*M+E,F=S+1,z=S+M,C=z+1;m.push(S,z,F,F,z,C)}const T=new wi;return T.setAttribute("position",new Ri(c,3)),T.setAttribute("normal",new Ri(f,3)),T.setAttribute("uv",new Ri(h,2)),T.setIndex(m),T.computeBoundingSphere(),T}function pv(r,e,i,s){const{W:l,H:c}=AR(i,s),f=document.createElement("canvas");f.width=l,f.height=c;const h=f.getContext("2d"),m=r.mood,p=h.createLinearGradient(0,0,l,c);p.addColorStop(0,m.mid),p.addColorStop(.55,m.bot),p.addColorStop(1,"#050508"),h.fillStyle=p,h.fillRect(0,0,l,c);const v=h.createRadialGradient(l*.78,c*.18,0,l*.78,c*.18,l*.5);v.addColorStop(0,`${m.top}33`),v.addColorStop(1,"transparent"),h.fillStyle=v,h.fillRect(0,0,l,c);const x=Math.round(28*i);let g=x;h.fillStyle="rgba(200,245,168,0.55)",h.font=`400 ${12*i}px "DM Mono", "JetBrains Mono", ui-monospace, monospace`,h.fillText(`0${e+1}  ·  THE LOOP`,x,g+12*i),g+=48*i,h.fillStyle="rgba(255,255,255,0.92)",h.font=`italic 400 ${Math.min(52*i,l*.15)}px ${xR}`,h.fillText(r.verb,x,g+32*i),g+=60*i,h.fillStyle="rgba(255,255,255,0.55)",h.font=`400 ${15*i}px "Spline Sans", "DM Sans", ui-sans-serif, sans-serif`;for(const T of TR(h,r.caption,l-x*2))h.fillText(T,x,g+14*i),g+=24*i;h.strokeStyle="rgba(200,245,168,0.22)",h.lineWidth=Math.max(2,2*i),h.strokeRect(Math.round(10*i),Math.round(10*i),l-Math.round(20*i),c-Math.round(20*i));const M=new Gv(f);return M.colorSpace=Zn,M.minFilter=gs,M.generateMipmaps=!0,M}function mv(r,e){const i=ex(e),s=Math.min(r*2.35,3.25),l=Math.round(i.canvasW*s),c=Math.round(i.canvasH*s),f=document.createElement("canvas");f.width=l,f.height=c;const h=f.getContext("2d");h.clearRect(0,0,l,c);const m="Morpheum",p=l/2,v=c/2,x=l*(i.mode==="mobile"?.9:.86);let g=i.fontPx;const M=()=>{h.font=`italic 500 ${g*s}px ${SR}`};for(M();h.measureText(m).width>x&&g>64;)g-=2,M();h.textAlign="center",h.textBaseline="middle";const T=h.createLinearGradient(p-l*.35,v-c*.2,p+l*.35,v+c*.2);tR.forEach(E=>T.addColorStop(E.t,E.c)),h.lineJoin="round",h.miterLimit=2,h.lineWidth=Math.max(1.25,1.85*s),h.strokeStyle="rgba(8,12,10,0.22)",h.strokeText(m,p,v),h.fillStyle=T,h.fillText(m,p,v);const w=new Gv(f);return w.colorSpace=Zn,w.minFilter=Mn,w.magFilter=Mn,w.generateMipmaps=!1,w}function gv(r,e){r.generateMipmaps=!1,r.minFilter=Mn,r.magFilter=Mn,r.wrapS=zi,r.wrapT=zi;const i=e.capabilities.getMaxAnisotropy();r.anisotropy=Math.min(16,i),r.needsUpdate=!0}function PR(){const r=rn.useRef(null),e=rn.useRef(null),i=rn.useRef(null),s=rn.useRef(null),l=rn.useRef(!1),c=rn.useCallback(()=>{if(l.current)return;l.current=!0;const f=e.current;f==null||f.classList.add("flow-intro__sticky--exit"),window.setTimeout(()=>{document.body.classList.remove(Gs),ih(),requestAnimationFrame(()=>{ih(),requestAnimationFrame(()=>{ih(),window.setTimeout(()=>{l.current=!1},100)})})},ER)},[]);return rn.useLayoutEffect(()=>{const f=window.matchMedia("(prefers-reduced-motion: reduce)").matches,h=window.location.hash.replace(/^#/,"");return f||h!==""&&h!=="flow"&&h!=="hero"||document.body.classList.add(Gs),()=>{document.body.classList.remove(Gs)}},[]),rn.useEffect(()=>{const f=h=>{if(h.key!=="Escape")return;const m=document.getElementById("hero");m&&m.getBoundingClientRect().top>8&&(h.preventDefault(),c())};return window.addEventListener("keydown",f),()=>window.removeEventListener("keydown",f)},[c]),rn.useEffect(()=>{const f=window.location.hash.replace(/^#/,"");f&&f!=="flow"&&f!=="hero"&&requestAnimationFrame(()=>{var h;(h=document.getElementById(f))==null||h.scrollIntoView({block:"start"})})},[]),rn.useEffect(()=>{const f=i.current,h=r.current;if(!f||!h)return;const m=f,p=h;let v=!1;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){document.body.classList.remove(Gs);const M=s.current;M&&(M.style.height="0px");return}let g;return(async()=>{if(await MR(),v)return;const M=Math.min(window.devicePixelRatio,2),T=Math.max(320,m.clientWidth||window.innerWidth),w=Math.max(1,m.clientHeight||window.innerHeight),E=[],S=[],F=[];qr.forEach((Ye,Ze)=>{const rt=Yn-1-Ze,pt=qr[rt],Ct=pv(pt,rt,M,T);F.push(Ct);const wt=new au({map:Ct,transparent:!0,opacity:1,depthWrite:!0,depthTest:!0,side:Ua});E.push(wt);const ut=Qh,gt=ut*dp/hp,k=new Ci(new qs(gt,ut),wt);k.position.set(0,0,-Ze*Ca),k.renderOrder=Ze,S.push(k)});const z=mv(M,T),C=new au({map:z,transparent:!0,opacity:0,depthWrite:!1,depthTest:!0,side:ji}),I=z.image.height/z.image.width,{w:L,h:P}=hv(T,w,I),b=new Ci(new qs(L,P),C);b.position.set(0,0,-(Yn-1)*Ca),b.renderOrder=gR;const N=new Ny,Y=new Ti(fp,1,.08,120),G=new QA({antialias:!0,alpha:!1,powerPreference:"high-performance"});G.setPixelRatio(Math.min(window.devicePixelRatio,2)),G.outputColorSpace=Zn,G.sortObjects=!0,m.appendChild(G.domElement),gv(z,G);const j=new nl;S.forEach(Ye=>j.add(Ye)),j.add(b),N.add(j);const pe=new Gi({uniforms:{uStrength:{value:0}},vertexShader:_R,fragmentShader:vR,transparent:!0,toneMapped:!1,depthTest:!1,depthWrite:!1,blending:rh}),de=new Ci(new wi,pe);de.frustumCulled=!1,de.renderOrder=pR,de.visible=!1,N.add(de);const J=qr.map(Ye=>new Dt(Ye.mood.mid)),O=J[0].clone();N.background=O;const H=0,ee=-(Yn-1)*Ca,_e=rl,be=-.1*Ca,U=.1*Ca;function Z(Ye,Ze){const rt=Ye+rl;return(_e-rt)/Ze}function Ee(){const Ye=Math.max(1,window.innerHeight),{totalPx:Ze}=ah(Ye),rt=Math.max(1,Ze),pt=H+be,Ct=ee+U-eR,ut=(pt-Ct)/rt,gt=Z(pt,ut),k=Z(Ct,ut);return{ih:Ye,totalPx:rt,scrollToWorldFactor:ut,minScroll:gt,maxScroll:k}}let{scrollToWorldFactor:Ce,minScroll:Le,maxScroll:ie}=Ee();const Se=new Dt,Me=new Dt,ze=new Dt;function it(){var gt;const Ye=Math.max(320,m.clientWidth||window.innerWidth),Ze=Math.min(window.devicePixelRatio,2);F.forEach((k,St)=>{k.dispose();const vt=Yn-1-St,D=pv(qr[vt],vt,Ze,Ye);F[St]=D,E[St].map=D,E[St].needsUpdate=!0}),(gt=C.map)==null||gt.dispose();const rt=mv(Ze,Ye);C.map=rt,C.needsUpdate=!0,gv(rt,G);const pt=rt.image.height/rt.image.width,Ct=Math.max(1,m.clientHeight||window.innerHeight),{w:wt,h:ut}=hv(Ye,Ct,pt);b.geometry.dispose(),b.geometry=new qs(wt,ut)}function je(){const Ye=m.clientWidth,Ze=m.clientHeight;if(Ye<2||Ze<2)return;Y.aspect=Ye/Ze,Y.updateProjectionMatrix(),G.setSize(Ye,Ze,!1),it();const rt=Ee();Ce=rt.scrollToWorldFactor,Le=rt.minScroll,ie=rt.maxScroll;const pt=Math.max(1,window.innerHeight),{totalPx:Ct}=ah(pt),wt=s.current;if(wt){const ut=pt*uv,gt=Math.max(Math.ceil(Ct+ut+pt*fv+32),Math.ceil(pt*1.08));wt.style.height=`${gt}px`}}je();let Yt=0;function ct(){var Fn,Oa;if(v)return;Yt=requestAnimationFrame(ct);const Ye=Math.max(1,window.innerHeight),{cardPx:Ze,titlePx:rt,totalPx:pt}=ah(Ye),Ct=p.getBoundingClientRect(),wt=Math.max(1,p.offsetHeight-Ye),ut=Un.clamp(-Ct.top,0,wt),gt=Math.min(ut,pt),k=Math.max(1,pt),St=Ye*uv,vt=ol(Un.clamp((ut-pt)/Math.max(1,St),0,1)),D=Un.mapLinear(Ze,0,k,Le,ie),y=m.clientWidth,Q=m.clientHeight,te=Math.max(1,rt),ue=gt<te,Re=ue?Un.clamp(gt/te,0,1):0,De=Math.max(0,gt-te),fe=Math.max(1,Ze),Te=Un.clamp(De/fe,0,1)*(Yn-1),Be=tx(y,Q),Ue=document.getElementById("hero"),Ne=Ue?Ue.getBoundingClientRect().top:0,Je=Ue?yR(Ne):!0;l.current||document.body.classList.toggle(Gs,!Je);let Ke;ue?Ke=Un.mapLinear(gt,0,te,ie,D):Ke=Un.mapLinear(gt,te,k,D,Le),Ke=Un.clamp(Ke,Le,ie);const at=RR(Ze,Ye),X=CR(te,Ye),Ae=wR(Re,X),me=Yn-1;if(ue)ze.copy(J[0]);else{const hn=Math.min(Yn-2,Math.floor(Te)),yn=Math.min(hn+1,Yn-1),ii=ol(Te-hn);Se.copy(J[hn]),Me.copy(J[yn]),ze.lerpColors(Se,Me,ii)}N.background=O.copy(ze);const we=_e-Ke*Ce;Y.position.set(0,0,we),Y.lookAt(0,0,we-rl);const Pe=Un.clamp(gt/k,0,1);if(UR(gt,k)){const hn=LR(Pe,we,NR(y)),ii=new Wy(hn,!1,"centripetal").getSpacedPoints(lR);if(ii.length>=2){const pn=OR(ii,cR,uR,fR),Lt=de.geometry.getAttribute("position"),$t=pn.getAttribute("position");if(Lt&&$t&&Lt.count===$t.count&&((Fn=de.geometry.getIndex())==null?void 0:Fn.count)===((Oa=pn.getIndex())==null?void 0:Oa.count)&&Lt&&$t){Lt.array.set($t.array),Lt.needsUpdate=!0;const Kn=de.geometry.getAttribute("normal"),vs=pn.getAttribute("normal");Kn&&vs&&(Kn.array.set(vs.array),Kn.needsUpdate=!0);const Pa=de.geometry.getAttribute("uv"),Vi=pn.getAttribute("uv");Pa&&Vi&&(Pa.array.set(Vi.array),Pa.needsUpdate=!0),pn.dispose()}else de.geometry.dispose(),de.geometry=pn;de.visible=!0,pe.uniforms.uStrength.value=.36}else de.visible=!1,pe.uniforms.uStrength.value=0}else de.visible=!1,pe.uniforms.uStrength.value=0;const Xe=Math.floor((Yn-1)/2);S.forEach((hn,yn)=>{const ii=-yn*Ca,pn=Yn-1-yn;let{opacity:Lt}=DR(Te,pn,at);ue&&yn===me&&(Lt*=Ae.lastCardOp);let $t=1,Cn=0;!ue&&pn===Yn-1&&Lt>.02&&vt>0&&($t=1-.28*vt,Cn=-Ca*.32*vt),hn.position.set(0,0,ii+Cn),hn.scale.setScalar(Be*$t);const Kn=E[yn];Kn.opacity=Lt,Kn.depthWrite=Lt>=.995,hn.visible=Lt>.003,hn.renderOrder=yn<=Xe?hR+yn:mR+(yn-Xe-1)}),b.position.set(0,0,-me*Ca),b.scale.setScalar(Be),C.opacity=ue?Ae.titleOp:0,C.depthWrite=C.opacity>=.995,b.visible=C.opacity>.003;const He=pt+St;let Ht=0;if(wt>He&&ut>=He){const hn=Math.max(1,wt-He);Ht=ol(Un.clamp((ut-He)/hn,0,1))}Ht>.02&&(de.visible=!1,pe.uniforms.uStrength.value=0);const Ut=s.current;if(Ut){const hn=St+Ye*fv+32,yn=Math.max(Math.ceil(pt+hn),Math.ceil(Ye*1.08));Ut.style.height!==`${yn}px`&&(Ut.style.height=`${yn}px`)}const kn=1-Ht*.96;e.current&&e.current.style.setProperty("--intro-ui-opacity",String(kn)),G.domElement.style.opacity=String(1-Ht),G.render(N,Y)}ct(),window.addEventListener("resize",je,{passive:!0});const _t=new ResizeObserver(je);_t.observe(m),g=()=>{var Ye;cancelAnimationFrame(Yt),document.body.classList.remove(Gs),window.removeEventListener("resize",je),_t.disconnect(),E.forEach(Ze=>{var rt;(rt=Ze.map)==null||rt.dispose(),Ze.dispose()}),F.forEach(Ze=>Ze.dispose()),(Ye=C.map)==null||Ye.dispose(),C.dispose(),S.forEach(Ze=>Ze.geometry.dispose()),b.geometry.dispose(),de.geometry.dispose(),pe.dispose(),N.remove(de),G.dispose(),m.contains(G.domElement)&&m.removeChild(G.domElement)},v&&g()})(),()=>{v=!0,document.body.classList.remove(Gs),g==null||g()}},[]),q.jsxs("section",{ref:r,id:"flow",className:"flow-intro","aria-label":"Morpheum — Discover, Copy, Supervise, Isolate",children:[q.jsxs("div",{ref:e,className:"flow-intro__sticky",children:[q.jsx("div",{ref:i,className:"flow-intro__canvas","aria-hidden":!0}),q.jsxs("div",{className:"flow-intro__top",children:[q.jsx("p",{className:"flow-intro__eyebrow",children:"/// Morpheum"}),q.jsxs("button",{type:"button",className:"flow-intro__skip",onClick:c,children:["Skip ",q.jsx("span",{className:"flow-intro__skip-key",children:"Esc"})]})]}),q.jsx("div",{className:"flow-intro__sr","aria-live":"polite",children:qr.map((f,h)=>q.jsxs("p",{children:["Step ",String(h+1).padStart(2,"0"),": ",f.verb,". ",f.caption]},f.verb))})]}),q.jsx("div",{ref:s,className:"flow-intro__spacer","aria-hidden":!0})]})}function nx({label:r,status:e,live:i}){return q.jsxs("span",{className:`stat-chip ${i?"stat-chip--live":""}`,children:[q.jsx("span",{className:"stat-chip__label",children:r}),q.jsx("span",{className:"stat-chip__sep",children:"·"}),q.jsx("span",{className:"stat-chip__status",children:e})]})}function IR(r){return String(r).padStart(2,"0")}function FR(){return typeof window<"u"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function BR(){const[r,e]=rn.useState(()=>new Set),i=rn.useRef(new Map);rn.useLayoutEffect(()=>{if(FR()){e(new Set(Dr.steps.map(f=>`step-${f.n}`)));return}const c=new IntersectionObserver(f=>{e(h=>{const m=new Set(h);for(const p of f){const v=p.target.dataset.flowKey;v&&p.isIntersecting&&m.add(v)}return m})},{root:null,threshold:[0,.01,.08,.15,.25],rootMargin:"-42% 0px -42% 0px"});for(const f of i.current.values())c.observe(f);return()=>{c.disconnect()}},[]);const s=rn.useCallback((c,f)=>{f?i.current.set(c,f):i.current.delete(c)},[]),l=rn.useCallback(c=>{e(f=>new Set(f).add(c))},[]);return q.jsx("section",{id:"how",className:"section flow",children:q.jsxs("div",{className:"container",children:[q.jsx("p",{className:"section-kicker",children:Dr.kicker}),q.jsx("h2",{className:"section-title flow__title",children:Dr.title}),q.jsx("div",{className:"flow__chips",children:Dr.chips.map(c=>q.jsx(nx,{label:c.label,status:c.value},c.label))}),q.jsx("div",{className:"flow__steps",role:"list",children:Dr.steps.map(c=>{const f=`step-${c.n}`,h=r.has(f);return q.jsxs("article",{ref:m=>s(f,m),"data-flow-key":f,role:"listitem",className:`flow-step${h?" flow-step--expanded":""}`,"aria-expanded":h,style:{"--hub-cover-url":`url("${c.coverUrl}")`},children:[q.jsxs("button",{type:"button",className:"flow-step__head",onClick:()=>l(f),"aria-label":h?`${c.title}, expanded`:`${c.title}, tap to expand`,children:[q.jsxs("span",{className:"flow-step__idx",children:["Step ",IR(c.n)]}),q.jsx("h3",{className:"flow-step__title",children:c.title}),q.jsx("span",{className:"flow-step__chevron","aria-hidden":!0,children:h?"−":"+"})]}),q.jsx("div",{className:"flow-step__expand","aria-hidden":!h,children:q.jsxs("div",{className:"flow-step__expand-inner",children:[q.jsx("p",{className:"flow-step__meta",children:c.feature}),q.jsx("p",{className:"flow-step__detail",children:c.body}),q.jsxs("p",{className:"flow-step__example",children:[q.jsx("span",{"aria-hidden":!0,children:"> "}),c.example]}),q.jsx("div",{className:"flow-step__actions",children:q.jsx("a",{href:Tn.explore,className:"flow-step__open","aria-label":`Explore after ${c.title}`,children:q.jsx("span",{"aria-hidden":!0,className:"flow-step__open-arrow",children:"→"})})})]})})]},f)})}),q.jsx("p",{className:"flow__outcome",children:Dr.outcome})]})})}const zR=["M41.9213 3.43614C43.0393 3.43614 43.8716 3.77154 44.4182 4.44235C44.9647 5.138 45.1262 6.1939 44.9026 7.61005L41.884 26.8026C41.7846 27.4982 41.8467 28.0075 42.0703 28.3305C42.2691 28.6784 42.6542 28.8771 43.2256 28.9268L43.8591 28.9641L43.8219 29.2622L36.7784 30.492L36.4803 30.492L40.1324 7.46098C40.3064 6.26843 40.0206 5.67216 39.2753 5.67216C38.9523 5.67216 38.6045 5.75912 38.2318 5.93303C37.8343 6.10694 37.3995 6.44235 36.9275 6.93924L36.7411 6.79017C38.0828 4.55415 39.8095 3.43614 41.9213 3.43614Z","M29.9958 3.43614C31.1138 3.43614 31.9461 3.77154 32.4927 4.44235C33.0393 5.138 33.2007 6.1939 32.9771 7.61005L29.9585 26.8026C29.8591 27.4982 29.9212 28.0075 30.1449 28.3305C30.3436 28.6784 30.7287 28.8771 31.3001 28.9268L31.9337 28.9641L31.8964 29.2622L24.8529 30.492L24.5548 30.492L28.207 7.46098C28.3809 6.26843 28.0952 5.67216 27.3498 5.67216C27.0268 5.67216 26.679 5.75912 26.3063 5.93303C25.9088 6.10694 25.474 6.44235 25.002 6.93924L24.8157 6.79017C26.1573 4.55415 27.884 3.43614 29.9958 3.43614Z","M18.0703 3.43614C19.1883 3.43614 20.0206 3.77154 20.5672 4.44235C21.1138 5.138 21.2753 6.1939 21.0517 7.61005L18.033 26.8026C17.9337 27.4982 17.9958 28.0075 18.2194 28.3305C18.4181 28.6784 18.8032 28.8771 19.3747 28.9268L20.0082 28.9641L19.9709 29.2622L12.9275 30.492L12.6293 30.492L16.2815 7.46098C16.4554 6.26843 16.1697 5.67216 15.4243 5.67216C15.1014 5.67216 14.7535 5.75912 14.3809 5.93303C13.9834 6.10694 13.5486 6.44235 13.0765 6.93924L12.8902 6.79017C14.2318 4.55415 15.9585 3.43614 18.0703 3.43614Z","M45.5631 10.8482C46.0378 11.9189 46.0912 12.9315 45.7231 13.8861C45.3095 14.8231 44.3453 15.4956 42.8305 15.9035L16.576 22.853C15.2325 23.2226 14.7771 24.0651 15.2096 25.3806L15.7698 26.7714L13.8491 27.2839L9.924 22.1284L9.25377 20.6168L40.8242 12.2711C41.6674 12.048 42.2133 11.7494 42.4619 11.3754C42.6651 10.9838 42.669 10.5676 42.4735 10.1267C42.3199 9.78031 42.1016 9.5003 41.8185 9.2867C41.4899 9.05556 41.0511 8.87329 40.5021 8.7399L41.5734 7.5866C42.563 7.86379 43.3915 8.28774 44.0591 8.85845C44.7127 9.39767 45.214 10.0609 45.5631 10.8482Z"],HR=58,GR=35;function VR({fill:r="#C8F5A8",width:e=58,height:i=35,padding:s=10,"aria-hidden":l=!0,...c}){const f=[-s,-s,HR+s*2,GR+s*2].join(" ");return q.jsx("svg",{width:e,height:i,viewBox:f,fill:"none",xmlns:"http://www.w3.org/2000/svg","aria-hidden":l,...c,children:zR.map(h=>q.jsx("path",{d:h,fill:r},h.slice(0,24)))})}const kR={sm:{width:46,height:28},md:{width:46,height:28},lg:{width:69,height:42},hero:{width:119,height:72}};function pp({size:r="md",showWordmark:e=!0,className:i="",brandName:s="Morpheum"}){const l=kR[r];return q.jsxs("span",{className:`brand-mark brand-mark--${r} ${i}`.trim(),children:[q.jsx(VR,{className:"brand-mark__icon",width:l.width,height:l.height,padding:0,fill:"var(--terminal-brand)"}),e?q.jsx("span",{className:"brand-mark__word",children:s}):null]})}function XR(){return q.jsx("footer",{className:"site-footer",children:q.jsxs("div",{className:"container site-footer__inner",children:[q.jsxs("div",{className:"site-footer__brand",children:[q.jsx("a",{className:"site-footer__logo",href:"#hero","aria-label":"Morpheum home",children:q.jsx(pp,{size:"sm"})}),q.jsx("p",{className:"site-footer__legal",children:gM.legal})]}),q.jsxs("nav",{className:"site-footer__nav","aria-label":"Footer",children:[Wc.map(r=>q.jsx("a",{href:r.href,children:r.label},r.id)),q.jsx("a",{href:Tn.docs,children:"Docs"}),q.jsx("a",{href:Tn.manifesto,children:"Manifesto"}),q.jsx("a",{href:Tn.discord,children:"Discord"}),q.jsx("a",{href:Tn.x,children:"X"})]})]})})}function WR(){const[r,e]=wr.headline;return q.jsxs("section",{id:"hero",className:"hero","aria-labelledby":"hero-heading",children:[q.jsx("div",{className:"hero__atmosphere","aria-hidden":!0}),q.jsx("div",{className:"hero__grid","aria-hidden":!0}),q.jsx("div",{className:"hero__scanlines","aria-hidden":!0}),q.jsx("div",{className:"hero__grain","aria-hidden":!0}),q.jsx("div",{className:"hero__veil","aria-hidden":!0}),q.jsxs("div",{className:"container hero__content",children:[q.jsx(pp,{size:"hero"}),q.jsxs("h1",{id:"hero-heading",className:"hero__headline",children:[q.jsx("span",{className:"hero__line hero__line--lead",children:r}),q.jsx("span",{className:"hero__line hero__line--punch",children:e})]}),q.jsx("p",{className:"hero__subline",children:wr.subline}),q.jsxs("div",{className:"hero__ctas",children:[q.jsx(Qr,{href:wr.primaryCta.href,variant:"primary",children:wr.primaryCta.label}),q.jsx(Qr,{href:wr.secondaryCta.href,variant:"secondary",children:wr.secondaryCta.label})]})]})]})}function qR(){return q.jsx("div",{className:"manifesto-strip",children:q.jsx("a",{className:"manifesto-strip__link",href:l_.href,children:l_.text})})}function YR(){const r=[...c_,...c_];return q.jsx("div",{className:"marquee","aria-label":"Live status",children:q.jsx("div",{className:"marquee__viewport",children:q.jsx("div",{className:"marquee__track",children:r.map((e,i)=>q.jsx(nx,{label:e.label,status:e.status,live:"live"in e?e.live:!1},`${e.label}-${i}`))})})})}function ZR(){return q.jsx("section",{id:"personas",className:"section personas",children:q.jsxs("div",{className:"container",children:[q.jsx("p",{className:"section-kicker",children:Md.kicker}),q.jsx("h2",{className:"section-title personas__title",children:Md.title}),q.jsx("div",{className:"personas__grid",children:Md.items.map(r=>q.jsxs("article",{className:`persona-card persona-card--${r.weight}`,children:[q.jsx("h3",{className:"persona-card__title",children:r.title}),q.jsx("ol",{className:"persona-card__steps",children:r.steps.map(e=>q.jsxs("li",{children:[q.jsxs("span",{className:"persona-card__chevron","aria-hidden":!0,children:[">"," "]}),e]},e))}),q.jsx(Qr,{href:r.cta.href,variant:"ghost",className:"persona-card__cta",children:r.cta.label})]},r.title))})]})})}function KR(){const[r,e]=rn.useState(!1),[i,s]=rn.useState(!1),[l,c]=rn.useState("");return rn.useEffect(()=>{const f=()=>e(window.scrollY>24);return f(),window.addEventListener("scroll",f,{passive:!0}),()=>window.removeEventListener("scroll",f)},[]),rn.useEffect(()=>{const f=Wc.map(m=>m.id),h=new IntersectionObserver(m=>{var v;const p=m.filter(x=>x.isIntersecting).sort((x,g)=>g.intersectionRatio-x.intersectionRatio);(v=p[0])!=null&&v.target.id&&c(p[0].target.id)},{rootMargin:"-30% 0px -55% 0px",threshold:[0,.25,.5]});return f.forEach(m=>{const p=document.getElementById(m);p&&h.observe(p)}),()=>h.disconnect()},[]),rn.useEffect(()=>(document.body.style.overflow=i?"hidden":"",()=>{document.body.style.overflow=""}),[i]),q.jsxs(q.Fragment,{children:[q.jsx("header",{className:`sticky-header ${r?"sticky-header--solid":""}`,children:q.jsxs("div",{className:"sticky-header__inner",children:[q.jsx("a",{className:"sticky-header__logo",href:"#hero","aria-label":"Morpheum home",children:q.jsx(pp,{size:"sm",brandName:"Morpheum"})}),q.jsx("nav",{className:"sticky-header__nav","aria-label":"Primary",children:Wc.map(f=>q.jsx("a",{href:f.href,className:`sticky-header__link ${l===f.id?"is-active":""}`,children:f.label},f.id))}),q.jsxs("div",{className:"sticky-header__actions",children:[q.jsx("a",{className:"sticky-header__docs",href:Tn.docs,children:"Docs"}),q.jsx(Qr,{href:Tn.app,variant:"primary",className:"sticky-header__launch",children:"Launch app"}),q.jsxs("button",{type:"button",className:"sticky-header__menu","aria-expanded":i,"aria-controls":"mobile-nav","aria-label":i?"Close menu":"Open menu",onClick:()=>s(f=>!f),children:[q.jsx("span",{}),q.jsx("span",{}),q.jsx("span",{})]})]})]})}),q.jsx("div",{id:"mobile-nav",className:`mobile-sheet ${i?"is-open":""}`,hidden:!i,children:q.jsxs("nav",{className:"mobile-sheet__nav","aria-label":"Mobile",children:[Wc.map(f=>q.jsx("a",{href:f.href,onClick:()=>s(!1),className:l===f.id?"is-active":"",children:f.label},f.id)),q.jsx("a",{href:Tn.docs,onClick:()=>s(!1),children:"Docs"})]})})]})}function QR(){return q.jsx("section",{className:"thesis section","aria-label":"Thesis",children:q.jsxs("div",{className:"container thesis__inner",children:[q.jsx("p",{className:"section-kicker",children:"Two bad choices → Morpheum"}),q.jsx("div",{className:"thesis__choices",children:Sd.badChoices.map(r=>q.jsxs("div",{className:"thesis__choice",children:[q.jsx("p",{className:"thesis__choice-title",children:r.title}),q.jsxs("p",{className:"thesis__choice-detail",children:[q.jsx("span",{"aria-hidden":!0,children:"> "}),r.detail]})]},r.title))}),q.jsx("p",{className:"thesis__payoff",children:Sd.payoff}),q.jsx("p",{className:"thesis__close",children:Sd.close})]})})}function jR(){return q.jsxs("div",{className:"page",children:[q.jsx("a",{className:"skip-link",href:"#hero",children:"Skip to content"}),q.jsx(qR,{}),q.jsx(KR,{}),q.jsxs("main",{className:"page__main",children:[q.jsx(PR,{}),q.jsx(WR,{}),q.jsx(QR,{}),q.jsx(YR,{}),q.jsx(vM,{}),q.jsx(ZR,{}),q.jsx(BR,{}),q.jsx(SM,{}),q.jsx(_M,{})]}),q.jsx(XR,{})]})}pM.createRoot(document.getElementById("root")).render(q.jsx(rn.StrictMode,{children:q.jsx(jR,{})}));
