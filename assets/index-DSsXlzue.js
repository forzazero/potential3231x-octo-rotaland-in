 ...
 */var i_;function yM(){if(i_)return jo;i_=1;var s=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(r,l,c){var u=null;if(c!==void 0&&(u=""+c),l.key!==void 0&&(u=""+l.key),"key"in l){c={};for(var h in l)h!=="key"&&(c[h]=l[h])}else c=l;return l=c.ref,{$$typeof:s,type:r,key:u,ref:l!==void 0?l:null,props:c}}return jo.Fragment=e,jo.jsx=i,jo.jsxs=i,jo}var a_;function EM(){return a_||(a_=1,Md.exports=yM()),Md.exports}var V=EM(),yd={exports:{}},ot={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var o_;function TM(){return o_||(o_=1,(function(s){function e(I,H){var ee=I.length;I.push(H);e:for(;0<ee;){var _e=ee-1>>>1,be=I[_e];if(0<l(be,H))I[_e]=H,I[ee]=be,ee=_e;else break e}}function i(I){return I.length===0?null:I[0]}function r(I){if(I.length===0)return null;var H=I[0],ee=I.pop();if(ee!==H){I[0]=ee;e:for(var _e=0,be=I.length,N=be>>>1;_e<N;){var Z=2*(_e+1)-1,Ee=I[Z],Ce=Z+1,Le=I[Ce];if(0>l(Ee,ee))Ce<be&&0>l(Le,Ee)?(I[_e]=Le,I[Ce]=ee,_e=Ce):(I[_e]=Ee,I[Z]=ee,_e=Z);else if(Ce<be&&0>l(Le,ee))I[_e]=Le,I[Ce]=ee,_e=Ce;else break e}}return H}function l(I,H){var ee=I.sortIndex-H.sortIndex;return ee!==0?ee:I.id-H.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;s.unstable_now=function(){return c.now()}}else{var u=Date,h=u.now();s.unstable_now=function(){return u.now()-h}}var p=[],m=[],_=1,v=null,g=3,S=!1,b=!1,w=!1,y=!1,M=typeof setTimeout=="function"?setTimeout:null,F=typeof clearTimeout=="function"?clearTimeout:null,B=typeof setImmediate<"u"?setImmediate:null;function C(I){for(var H=i(m);H!==null;){if(H.callback===null)r(m);else if(H.startTime<=I)r(m),H.sortIndex=H.expirationTime,e(p,H);else break;H=i(m)}}function O(I){if(w=!1,C(I),!b)if(i(p)!==null)b=!0,U||(U=!0,Q());else{var H=i(m);H!==null&&J(O,H.startTime-I)}}var U=!1,P=-1,T=5,L=-1;function Y(){return y?!0:!(s.unstable_now()-L<T)}function G(){if(y=!1,U){var I=s.unstable_now();L=I;var H=!0;try{e:{b=!1,w&&(w=!1,F(P),P=-1),S=!0;var ee=g;try{t:{for(C(I),v=i(p);v!==null&&!(v.expirationTime>I&&Y());){var _e=v.callback;if(typeof _e=="function"){v.callback=null,g=v.priorityLevel;var be=_e(v.expirationTime<=I);if(I=s.unstable_now(),typeof be=="function"){v.callback=be,C(I),H=!0;break t}v===i(p)&&r(p),C(I)}else r(p);v=i(p)}if(v!==null)H=!0;else{var N=i(m);N!==null&&J(O,N.startTime-I),H=!1}}break e}finally{v=null,g=ee,S=!1}H=void 0}}finally{H?Q():U=!1}}}var Q;if(typeof B=="function")Q=function(){B(G)};else if(typeof MessageChannel<"u"){var pe=new MessageChannel,de=pe.port2;pe.port1.onmessage=G,Q=function(){de.postMessage(null)}}else Q=function(){M(G,0)};function J(I,H){P=M(function(){I(s.unstable_now())},H)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(I){I.callback=null},s.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<I?Math.floor(1e3/I):5},s.unstable_getCurrentPriorityLevel=function(){return g},s.unstable_next=function(I){switch(g){case 1:case 2:case 3:var H=3;break;default:H=g}var ee=g;g=H;try{return I()}finally{g=ee}},s.unstable_requestPaint=function(){y=!0},s.unstable_runWithPriority=function(I,H){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var ee=g;g=I;try{return H()}finally{g=ee}},s.unstable_scheduleCallback=function(I,H,ee){var _e=s.unstable_now();switch(typeof ee=="object"&&ee!==null?(ee=ee.delay,ee=typeof ee=="number"&&0<ee?_e+ee:_e):ee=_e,I){case 1:var be=-1;break;case 2:be=250;break;case 5:be=1073741823;break;case 4:be=1e4;break;default:be=5e3}return be=ee+be,I={id:_++,callback:H,priorityLevel:I,startTime:ee,expirationTime:be,sortIndex:-1},ee>_e?(I.sortIndex=ee,e(m,I),i(p)===null&&I===i(m)&&(w?(F(P),P=-1):w=!0,J(O,ee-_e))):(I.sortIndex=be,e(p,I),b||S||(b=!0,U||(U=!0,Q()))),I},s.unstable_shouldYield=Y,s.unstable_wrapCallback=function(I){var H=g;return function(){var ee=g;g=H;try{return I.apply(this,arguments)}finally{g=ee}}}})(Td)),Td}var l_;function AM(){return l_||(l_=1,bd.exports=TM()),bd.exports}var Ad={exports:{}},Hn={};/**
 * @license React
...
`),ae=R.split(`
`);for(f=o=0;o<z.length&&!z[o].includes("DetermineComponentFrameRoot");)o++;for(;f<ae.length&&!ae[f].includes("DetermineComponentFrameRoot");)f++;if(o===z.length||f===ae.length)for(o=z.length-1,f=ae.length-1;1<=o&&0<=f&&z[o]!==ae[f];)f--;for(;1<=o&&0<=f;o--,f--)if(z[o]!==ae[f]){if(o!==1||f!==1)do if(o--,f--,0>f||z[o]!==ae[f]){var ge=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Na,depthTest:!1,depthWrite:!1})}function u1(s,e,i){const r=new Float32Array(Zs),l=new $(0,1,0);return new Xi({name:"SphericalGaussianBlur",defines:{n:Zs,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:du(),fragmentShader:`
	...
	`}class ex extends aa{constructor(e=1,i={}){super(e,e,i),this.isWebGLCubeRenderTarget=!0;const r={width:e,height:e,depth:1},l=[r,r,r,r,r,r];this.texture=new qv(l),this._setTextureOptions(i),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,i){this.texture.type=i.type,this.texture.colorSpace=i.colorSpace,this.texture.generateMipmaps=i.generateMipmaps,this.texture.minFilter=i.minFilter,this.texture.magFilter=i.magFilter;const r={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},l=new gl(5,5,5),c=new Xi({name:"CubemapFromEquirect",uniforms:ao(r.uniforms),vertexShader:r.vertexShader,fragmentShader:r.fragmentShader,side:si,blending:Na});c.uniforms.tEquirect.value=i;const u=new Ui(l,c),h=i.minFilter;return i.minFilter===xs&&(i.minFilter=yn),new gE(1,10,this).update(e,u),i.minFilter=h,u.geometry.dispose(),u.material.dispose(),this}clear(e,i=!0,r=!0,l=!0){const c=e.getRenderTarget();for(let u=0;u<6;u++)e.setRenderTarget(this,u),e.clear(i,r,l);e.setRenderTarget(c)}}function f1(s){let e=new WeakMap,i=new WeakMap,r=null;function l(g,S=!1){return g==null?null:S?u(g):c(g)}function c(g){if(g&&g.isTexture){const S=g.mapping;if(S===Ud||S===Nd)if(e.has(g)){const b=e.get(g).texture;return h(b,g.mapping)}else{const b=g.image;if(b&&b.height>0){const w=new ex(b.height);return w.fromEquirectangularTexture(s,g),e.set(g,w),g.addEventListener("dispose",m),h(w.texture,g.mapping)}else return null}}return g}function u(g){if(g&&g.isTexture){const S=g.mapping,b=S===Ud||S===Nd,w=S===Qs||S===no;if(b||w){let y=i.get(g);const M=y!==void 0?y.texture.pmremVersion:0;if(g.isRenderTargetTexture&&g.pmremVersion!==M)return r===null&&(r=new Y_(s)),y=b?r.fromEquirectangular(g,y):r.fromCubemap(g,y),y.texture.pmremVersion=g.pmremVersion,i.set(g,y),y.texture;if(y!==void 0)return y.texture;{const F=g.image;return b&&F&&F.height>0||w&&F&&p(F)?(r===null&&(r=new Y_(s)),y=b?r.fromEquirectangular(g):r.fromCubemap(g),y.texture.pmremVersion=g.pmremVersion,i.set(g,y),g.addEventListener("dispose",_),y.texture):null}}}return g}function h(g,S){return S===Ud?g.mapping=Qs:S===Nd&&(g.mapping=no),g}function p(g){let S=0;const b=6;for(let w=0;w<b;w++)g[w]!==void 0&&S++;return S===b}function m(g){const S=g.target;S.removeEventListener("dispose",m);const b=e.get(S);b!==void 0&&(e.delete(S),b.dispose())}function _(g){const S=g.target;S.removeEventListener("dispose",_);const b=i.get(S);b!==void 0&&(i.delete(S),b.dispose())}function v(){e=new WeakMap,i=new WeakMap,r!==null&&(r.dispose(),r=null)}return{get:l,dispose:v}}function d1(s){const e={};function i(r){if(e[r]!==void 0)return e[r];const l=s.getExtension(r);return e[r]=l,l}return{has:function(r){return i(r)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(r){const l=i(r);return l===null&&Jr("WebGLRenderer: "+r+" extension not supported."),l}}}function h1(s,e,i,r){const l={},c=new WeakMap;function u(v){const g=v.target;g.index!==null&&e.remove(g.index);for(const b in g.attributes)e.remove(g.attributes[b]);g.removeEventListener("dispose",u),delete l[g.id];const S=c.get(g);S&&(e.remove(S),c.delete(g)),r.releaseStatesOfGeometry(g),g.isInstancedBufferGeometry===!0&&delete g._maxInstanceCount,i.memory.geometries--}function h(v,g){return l[g.id]===!0||(g.addEventListener("dispose",u),l[g.id]=!0,i.memory.geometries++),g}function p(v){const g=v.attributes;for(const S in g)e.update(g[S],s.ARRAY_BUFFER)}function m(v){const g=[],S=v.index,b=v.attributes.position;let w=0;if(b===void 0)return;if(S!==null){const F=S.array;w=S.version;for(let B=0,C=F.length;B<C;B+=3){const O=F[B+0],U=F[B+1],P=F[B+2];g.push(O,U,U,P,P,O)}}else{const F=b.array;w=b.version;for(let B=0,C=F.length/3-1;B<C;B+=3){const O=B+0,U=B+1,P=B+2;g.push(O,U,U,P,P,O)}}const y=new(b.count>=65535?Xv:kv)(g,1);y.version=w;const M=c.get(v);M&&e.remove(M),c.set(v,y)}function _(v){const g=c.get(v);if(g){const S=v.index;S!==null&&g.version<S.version&&m(v)}else m(v);return c.get(v)}return{get:h,update:p,getWireframeAttribute:_}}function p1(s,e,i){let r;function l(v){r=v}let c,u;function h(v){c=v.type,u=v.bytesPerElement}function p(v,g){s.drawElements(r,g,c,v*u),i.update(g,r,1)}function m(v,g,S){S!==0&&(s.drawElementsInstanced(r,g,c,v*u,S),i.update(g,r,S))}function _(v,g,S){if(S===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(r,g,0,c,v,0,S);let w=0;for(let y=0;y<S;y++)w+=g[y];i.update(w,r,1)}this.setMode=l,this.setIndex=h,this.render=p,this.renderInstances=m,this.renderMultiDraw=_}function m1(s){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function r(c,u,h){switch(i.calls++,u){case s.TRIANGLES:i.triangles+=h*(c/3);break;case s.LINES:i.lines+=h*(c/2);break;case s.LINE_STRIP:i.lines+=h*(c-1);break;case s.LINE_LOOP:i.lines+=h*c;break;case s.POINTS:i.points+=h*c;break;default:Nt("WebGLInfo: Unknown draw mode:",u);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:l,update:r}}function g1(s,e,i){const r=new WeakMap,l=new cn;function c(u,h,p){const m=u.morphTargetInfluences,_=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,v=_!==void 0?_.length:0;let g=r.get(h);if(g===void 0||g.count!==v){let Y=function(){T.dispose(),r.delete(h),h.removeEventListener("dispose",Y)};var S=Y;g!==void 0&&g.texture.dispose();const b=h.morphAttributes.position!==void 0,w=h.morphAttributes.normal!==void 0,y=h.morphAttributes.color!==void 0,M=h.morphAttributes.position||[],F=h.morphAttributes.normal||[],B=h.morphAttributes.color||[];let C=0;b===!0&&(C=1),w===!0&&(C=2),y===!0&&(C=3);let O=h.attributes.position.count*C,U=1;O>e.maxTextureSize&&(U=Math.ceil(O/e.maxTextureSize),O=e.maxTextureSize);const P=new Float32Array(O*U*4*v),T=new Hv(P,O,U,v);T.type=ta,T.needsUpdate=!0;const L=C*4;for(let G=0;G<v;G++){const Q=M[G],pe=F[G],de=B[G],J=O*U*4*G;for(let I=0;I<Q.count;I++){const H=I*L;b===!0&&(l.fromBufferAttribute(Q,I),P[J+H+0]=l.x,P[J+H+1]=l.y,P[J+H+2]=l.z,P[J+H+3]=0),w===!0&&(l.fromBufferAttribute(pe,I),P[J+H+4]=l.x,P[J+H+5]=l.y,P[J+H+6]=l.z,P[J+H+7]=0),y===!0&&(l.fromBufferAttribute(de,I),P[J+H+8]=l.x,P[J+H+9]=l.y,P[J+H+10]=l.z,P[J+H+11]=de.itemSize===4?l.w:1)}}g={count:v,texture:T,size:new Ft(O,U)},r.set(h,g),h.addEventListener("dispose",Y)}if(u.isInstancedMesh===!0&&u.morphTexture!==null)p.getUniforms().setValue(s,"morphTexture",u.morphTexture,i);else{let b=0;for(let y=0;y<m.length;y++)b+=m[y];const w=h.morphTargetsRelative?1:1-b;p.getUniforms().setValue(s,"morphTargetBaseInfluence",w),p.getUniforms().setValue(s,"morphTargetInfluences",m)}p.getUniforms().setValue(s,"morphTargetsTexture",g.texture,i),p.getUniforms().setValue(s,"morphTargetsTextureSize",g.size)}return{update:c}}function _1(s,e,i,r,l){let c=new WeakMap;function u(m){const _=l.render.frame,v=m.geometry,g=e.get(m,v);if(c.get(g)!==_&&(e.update(g),c.set(g,_)),m.isInstancedMesh&&(m.hasEventListener("dispose",p)===!1&&m.addEventListener("dispose",p),c.get(m)!==_&&(i.update(m.instanceMatrix,s.ARRAY_BUFFER),m.instanceColor!==null&&i.update(m.instanceColor,s.ARRAY_BUFFER),c.set(m,_))),m.isSkinnedMesh){const S=m.skeleton;c.get(S)!==_&&(S.update(),c.set(S,_))}return g}function h(){c=new WeakMap}function p(m){const _=m.target;_.removeEventListener("dispose",p),r.releaseStatesOfObject(_),i.remove(_.instanceMatrix),_.instanceColor!==null&&i.remove(_.instanceColor)}return{update:u,dispose:h}}const v1={[bv]:"LINEAR_TONE_MAPPING",[Tv]:"REINHARD_TONE_MAPPING",[Av]:"CINEON_TONE_MAPPING",[Rv]:"ACES_FILMIC_TONE_MAPPING",[wv]:"AGX_TONE_MAPPING",[Dv]:"NEUTRAL_TONE_MAPPING",[Cv]:"CUSTOM_TONE_MAPPING"};function x1(s,e,i,r,l,c){const u=new aa(e,i,{type:s,depthBuffer:l,stencilBuffer:c,samples:r?4:0,depthTexture:l?new io(e,i):void 0}),h=new aa(e,i,{type:Pa,depthBuffer:!1,stencilBuffer:!1}),p=new Ni;p.setAttribute("position",new Di([-1,3,0,-1,-1,0,3,-1,0],3)),p.setAttribute("uv",new Di([0,2,0,0,2,0],2));const m=new hE({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),_=new Ui(p,m),v=new Qv(-1,1,1,-1,0,1);let g=null,S=null,b=!1,w,y=null,M=[],F=!1;this.setSize=function(B,C){u.setSize(B,C),h.setSize(B,C);for(let O=0;O<M.length;O++){const U=M[O];U.setSize&&U.setSize(B,C)}},this.setEffects=function(B){M=B,F=M.length>0&&M[0].isRenderPass===!0;const C=u.width,O=u.height;for(let U=0;U<M.length;U++){const P=M[U];P.setSize&&P.setSize(C,O)}},this.begin=function(B,C){if(b||B.toneMapping===ia&&M.length===0)return!1;if(y=C,C!==null){const O=C.width,U=C.height;(u.width!==O||u.height!==U)&&this.setSize(O,U)}return F===!1&&B.setRenderTarget(u),w=B.toneMapping,B.toneMapping=ia,!0},this.hasRenderPass=function(){return F},this.end=function(B,C){B.toneMapping=w,b=!0;let O=u,U=h;for(let P=0;P<M.length;P++){const T=M[P];if(T.enabled!==!1&&(T.render(B,U,O,C),T.needsSwap!==!1)){const L=O;O=U,U=L}}if(g!==B.outputColorSpace||S!==B.toneMapping){g=B.outputColorSpace,S=B.toneMapping,m.defines={},Rt.getTransfer(g)===qt&&(m.defines.SRGB_TRANSFER="");const P=v1[S];P&&(m.defines[P]=""),m.needsUpdate=!0}m.uniforms.tDiffuse.value=O.texture,B.setRenderTarget(y),B.render(_,v),y=null,b=!1},this.isCompositing=function(){return b},this.dispose=function(){u.depthTexture&&u.depthTexture.dispose(),u.dispose(),h.dispose(),p.dispose(),m.dispose()}}const tx=new kn,np=new io(1,1),nx=new Hv,ix=new Gy,ax=new qv,Q_=[],J_=[],$_=new Float32Array(16),ev=new Float32Array(9),tv=new Float32Array(4);function oo(s,e,i){const r=s[0];if(r<=0||r>0)return s;const l=e*i;let c=Q_[l];if(c===void 0&&(c=new Float32Array(l),Q_[l]=c),e!==0){r.toArray(c,0);for(let u=1,h=0;u!==e;++u)h+=i,s[u].toArray(c,h)}return c}function An(s,e){if(s.length!==e.length)return!1;for(let i=0,r=s.length;i<r;i++)if(s[i]!==e[i])return!1;return!0}function Rn(s,e){for(let i=0,r=e.length;i<r;i++)s[i]=e[i]}function hu(s,e){let i=J_[e];i===void 0&&(i=new Int32Array(e),J_[e]=i);for(let r=0;r!==e;++r)i[r]=s.allocateTextureUnit();return i}function S1(s,e){const i=this.cache;i[0]!==e&&(s.uniform1f(this.addr,e),i[0]=e)}function M1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(An(i,e))return;s.uniform2fv(this.addr,e),Rn(i,e)}}function y1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else if(e.r!==void 0)(i[0]!==e.r||i[1]!==e.g||i[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),i[0]=e.r,i[1]=e.g,i[2]=e.b);else{if(An(i,e))return;s.uniform3fv(this.addr,e),Rn(i,e)}}function E1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(An(i,e))return;s.uniform4fv(this.addr,e),Rn(i,e)}}function b1(s,e){const i=this.cache,r=e.elements;if(r===void 0){if(An(i,e))return;s.uniformMatrix2fv(this.addr,!1,e),Rn(i,e)}else{if(An(i,r))return;tv.set(r),s.uniformMatrix2fv(this.addr,!1,tv),Rn(i,r)}}function T1(s,e){const i=this.cache,r=e.elements;if(r===void 0){if(An(i,e))return;s.uniformMatrix3fv(this.addr,!1,e),Rn(i,e)}else{if(An(i,r))return;ev.set(r),s.uniformMatrix3fv(this.addr,!1,ev),Rn(i,r)}}function A1(s,e){const i=this.cache,r=e.elements;if(r===void 0){if(An(i,e))return;s.uniformMatrix4fv(this.addr,!1,e),Rn(i,e)}else{if(An(i,r))return;$_.set(r),s.uniformMatrix4fv(this.addr,!1,$_),Rn(i,r)}}function R1(s,e){const i=this.cache;i[0]!==e&&(s.uniform1i(this.addr,e),i[0]=e)}function C1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(An(i,e))return;s.uniform2iv(this.addr,e),Rn(i,e)}}function w1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(An(i,e))return;s.uniform3iv(this.addr,e),Rn(i,e)}}function D1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(An(i,e))return;s.uniform4iv(this.addr,e),Rn(i,e)}}function U1(s,e){const i=this.cache;i[0]!==e&&(s.uniform1ui(this.addr,e),i[0]=e)}function N1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(An(i,e))return;s.uniform2uiv(this.addr,e),Rn(i,e)}}function L1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(An(i,e))return;s.uniform3uiv(this.addr,e),Rn(i,e)}}function O1(s,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(An(i,e))return;s.uniform4uiv(this.addr,e),Rn(i,e)}}function P1(s,e,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l);let c;this.type===s.SAMPLER_2D_SHADOW?(np.compareFunction=i.isReversedDepthBuffer()?pp:hp,c=np):c=tx,i.setTexture2D(e||c,l)}function I1(s,e,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTexture3D(e||ix,l)}function F1(s,e,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTextureCube(e||ax,l)}function B1(s,e,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTexture2DArray(e||nx,l)}function z1(s){switch(s){case 5126:return S1;case 35664:return M1;case 35665:return y1;case 35666:return E1;case 35674:return b1;case 35675:return T1;case 35676:return A1;case 5124:case 35670:return R1;case 35667:case 35671:return C1;case 35668:case 35672:return w1;case 35669:case 35673:return D1;case 5125:return U1;case 36294:return N1;case 36295:return L1;case 36296:return O1;case 35678:case 36198:case 36298:case 36306:case 35682:return P1;case 35679:case 36299:case 36307:return I1;case 35680:case 36300:case 36308:case 36293:return F1;case 36289:case 36303:case 36311:case 36292:return B1}}function H1(s,e){s.uniform1fv(this.addr,e)}function G1(s,e){const i=oo(e,this.size,2);s.uniform2fv(this.addr,i)}function V1(s,e){const i=oo(e,this.size,3);s.uniform3fv(this.addr,i)}function k1(s,e){const i=oo(e,this.size,4);s.uniform4fv(this.addr,i)}function X1(s,e){const i=oo(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,i)}function W1(s,e){const i=oo(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,i)}function q1(s,e){const i=oo(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,i)}function Y1(s,e){s.uniform1iv(this.addr,e)}function Z1(s,e){s.uniform2iv(this.addr,e)}function K1(s,e){s.uniform3iv(this.addr,e)}function j1(s,e){s.uniform4iv(this.addr,e)}function Q1(s,e){s.uniform1uiv(this.addr,e)}function J1(s,e){s.uniform2uiv(this.addr,e)}function $1(s,e){s.uniform3uiv(this.addr,e)}function eA(s,e){s.uniform4uiv(this.addr,e)}function tA(s,e,i){const r=this.cache,l=e.length,c=hu(i,l);An(r,c)||(s.uniform1iv(this.addr,c),Rn(r,c));let u;this.type===s.SAMPLER_2D_SHADOW?u=np:u=tx;for(let h=0;h!==l;++h)i.setTexture2D(e[h]||u,c[h])}function nA(s,e,i){const r=this.cache,l=e.length,c=hu(i,l);An(r,c)||(s.uniform1iv(this.addr,c),Rn(r,c));for(let u=0;u!==l;++u)i.setTexture3D(e[u]||ix,c[u])}function iA(s,e,i){const r=this.cache,l=e.length,c=hu(i,l);An(r,c)||(s.uniform1iv(this.addr,c),Rn(r,c));for(let u=0;u!==l;++u)i.setTextureCube(e[u]||ax,c[u])}function aA(s,e,i){const r=this.cache,l=e.length,c=hu(i,l);An(r,c)||(s.uniform1iv(this.addr,c),Rn(r,c));for(let u=0;u!==l;++u)i.setTexture2DArray(e[u]||nx,c[u])}function sA(s){switch(s){case 5126:return H1;case 35664:return G1;case 35665:return V1;case 35666:return k1;case 35674:return X1;case 35675:return W1;case 35676:return q1;case 5124:case 35670:return Y1;case 35667:case 35671:return Z1;case 35668:case 35672:return K1;case 35669:case 35673:return j1;case 5125:return Q1;case 36294:return J1;case 36295:return $1;case 36296:return eA;case 35678:case 36198:case 36298:case 36306:case 35682:return tA;case 35679:case 36299:case 36307:return nA;case 35680:case 36300:case 36308:case 36293:return iA;case 36289:case 36303:case 36311:case 36292:return aA}}class rA{constructor(e,i,r){this.id=e,this.addr=r,this.cache=[],this.type=i.type,this.setValue=z1(i.type)}}class oA{constructor(e,i,r){this.id=e,this.addr=r,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=sA(i.type)}}class lA{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,i,r){const l=this.seq;for(let c=0,u=l.length;c!==u;++c){const h=l[c];h.setValue(e,i[h.id],r)}}}const ch=/(\w+)(\])?(\[|\.)?/g;function nv(s,e){s.seq.push(e),s.map[e.id]=e}function cA(s,e,i){const r=s.name,l=r.length;for(ch.lastIndex=0;;){const c=ch.exec(r),u=ch.lastIndex;let h=c[1];const p=c[2]==="]",m=c[3];if(p&&(h=h|0),m===void 0||m==="["&&u+2===l){nv(i,m===void 0?new rA(h,s,e):new oA(h,s,e));break}else{let v=i.map[h];v===void 0&&(v=new lA(h),nv(i,v)),i=v}}}class tu{constructor(e,i){this.seq=[],this.map={};const r=e.getProgramParameter(i,e.ACTIVE_UNIFORMS);for(let u=0;u<r;++u){const h=e.getActiveUniform(i,u),p=e.getUniformLocation(i,h.name);cA(h,p,this)}const l=[],c=[];for(const u of this.seq)u.type===e.SAMPLER_2D_SHADOW||u.type===e.SAMPLER_CUBE_SHADOW||u.type===e.SAMPLER_2D_ARRAY_SHADOW?l.push(u):c.push(u);l.length>0&&(this.seq=l.concat(c))}setValue(e,i,r,l){const c=this.map[i];c!==void 0&&c.setValue(e,r,l)}setOptional(e,i,r){const l=i[r];l!==void 0&&this.setValue(e,r,l)}static upload(e,i,r,l){for(let c=0,u=i.length;c!==u;++c){const h=i[c],p=r[h.id];p.needsUpdate!==!1&&h.setValue(e,p.value,l)}}static seqWithValue(e,i){const r=[];for(let l=0,c=e.length;l!==c;++l){const u=e[l];u.id in i&&r.push(u)}return r}}function iv(s,e,i){const r=s.createShader(e);return s.shaderSource(r,i),s.compileShader(r),r}const uA=37297;let fA=0;function dA(s,e){const i=s.split(`
`),r=[],l=Math.max(e-6,0),c=Math.min(e+6,i.length);for(let u=l;u<c;u++){const h=u+1;r.push(`${h===e?">":" "} ${h}: ${i[u]}`)}return r.join(`
`)}const av=new lt;function hA(s){Rt._getMatrix(av,Rt.workingColorSpace,s);const e=`mat3( ${av.elements.map(i=>i.toFixed(4))} )`;switch(Rt.getTransfer(s)){case su:return[e,"LinearTransferOETF"];case qt:return[e,"sRGBTransferOETF"];default:return st("WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function sv(s,e,i){const r=s.getShaderParameter(e,s.COMPILE_STATUS),c=(s.getShaderInfoLog(e)||"").trim();if(r&&c==="")return"";const u=/ERROR: 0:(\d+)/.exec(c);if(u){const h=parseInt(u[1]);return i.toUpperCase()+`

`+c+`

`+dA(s.getShaderSource(e),h)}else return c}function pA(s,e){const i=hA(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}const mA={[bv]:"Linear",[Tv]:"Reinhard",[Av]:"Cineon",[Rv]:"ACESFilmic",[wv]:"AgX",[Dv]:"Neutral",[Cv]:"Custom"};function gA(s,e){const i=mA[e];return i===void 0?(st("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+s+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+s+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Zc=new $;function _A(){Rt.getLuminanceCoefficients(Zc);const s=Zc.x.toFixed(4),e=Zc.y.toFixed(4),i=Zc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
`)}function vA(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(rl).join(`
`)}function xA(s){const e=[];for(const i in s){const r=s[i];r!==!1&&e.push("#define "+i+" "+r)}return e.join(`
`)}function SA(s,e){const i={},r=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let l=0;l<r;l++){const c=s.getActiveAttrib(e,l),u=c.name;let h=1;c.type===s.FLOAT_MAT2&&(h=2),c.type===s.FLOAT_MAT3&&(h=3),c.type===s.FLOAT_MAT4&&(h=4),i[u]={type:c.type,location:s.getAttribLocation(e,u),locationSize:h}}return i}function rl(s){return s!==""}function rv(s,e){const i=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function ov(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const MA=/^[ \t]*#include +<([\w\d./]+)>/gm;function ip(s){return s.replace(MA,EA)}const yA=new Map;function EA(s,e){let i=mt[e];if(i===void 0){const r=yA.get(e);if(r!==void 0)i=mt[r],st('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,r);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return ip(i)}const bA=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function lv(s){return s.replace(bA,TA)}function TA(s,e,i,r){let l="";for(let c=parseInt(e);c<parseInt(i);c++)l+=r.replace(/\[\s*i\s*\]/g,"[ "+c+" ]").replace(/UNROLLED_LOOP_INDEX/g,c);return l}function cv(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}const AA={[jc]:"SHADOWMAP_TYPE_PCF",[al]:"SHADOWMAP_TYPE_VSM"};function RA(s){return AA[s.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const CA={[Qs]:"ENVMAP_TYPE_CUBE",[no]:"ENVMAP_TYPE_CUBE",[uu]:"ENVMAP_TYPE_CUBE_UV"};function wA(s){return s.envMap===!1?"ENVMAP_TYPE_CUBE":CA[s.envMapMode]||"ENVMAP_TYPE_CUBE"}const DA={[no]:"ENVMAP_MODE_REFRACTION"};function UA(s){return s.envMap===!1?"ENVMAP_MODE_REFLECTION":DA[s.envMapMode]||"ENVMAP_MODE_REFLECTION"}const NA={[Ev]:"ENVMAP_BLENDING_MULTIPLY",[sy]:"ENVMAP_BLENDING_MIX",[ry]:"ENVMAP_BLENDING_ADD"};function LA(s){return s.envMap===!1?"ENVMAP_BLENDING_NONE":NA[s.combine]||"ENVMAP_BLENDING_NONE"}function OA(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:r,maxMip:i}}function PA(s,e,i,r){const l=s.getContext(),c=i.defines;let u=i.vertexShader,h=i.fragmentShader;const p=RA(i),m=wA(i),_=UA(i),v=LA(i),g=OA(i),S=vA(i),b=xA(c),w=l.createProgram();let y,M,F=i.glslVersion?"#version "+i.glslVersion+`
...
`)+`
`+M);const B=F+y+u,C=F+M+h,O=iv(l,l.VERTEX_SHADER,B),U=iv(l,l.FRAGMENT_SHADER,C);l.attachShader(w,O),l.attachShader(w,U),i.index0AttributeName!==void 0?l.bindAttribLocation(w,0,i.index0AttributeName):i.hasPositionAttribute===!0&&l.bindAttribLocation(w,0,"position"),l.linkProgram(w);function P(G){if(s.debug.checkShaderErrors){const Q=l.getProgramInfoLog(w)||"",pe=l.getShaderInfoLog(O)||"",de=l.getShaderInfoLog(U)||"",J=Q.trim(),I=pe.trim(),H=de.trim();let ee=!0,_e=!0;if(l.getProgramParameter(w,l.LINK_STATUS)===!1)if(ee=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,w,O,U);else{const be=sv(l,O,"vertex"),N=sv(l,U,"fragment");Nt("WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(w,l.VALIDATE_STATUS)+`
...
`,j2='"Reckk Heading", Georgia, "Times New Roman", serif',mx="Morpheum Wordmark",pl=`"${mx}"`,Q2=[{t:0,c:"#e8ffe0"},{t:.45,c:"#c8f5a8"},{t:1,c:"#f0e6a0"}];async function J2(){if(typeof document>"u"||!document.fonts)return!1;try{const s=new FontFace(mx,`url(${g2})`,{weight:"normal",style:"normal"});document.fonts.add(await s.load()),await document.fonts.load(`normal 152px ${pl}`);const e=document.fonts.check(`normal 152px ${pl}`);return e||console.error("[FlowIntro] Morpheum Wordmark failed to bind — title will not use Reckk fallback"),e}catch(s){return console.error("[FlowIntro] Morpheum Wordmark load failed",s),!1}}async function $2(){if(!(typeof document>"u"||!document.fonts))try{await J2();const s=new FontFace("Reckk Title",`url(${m2})`,{weight:"normal",style:"normal"});document.fonts.add(await s.load());const e=new FontFace("Reckk Heading",`url(${p2})`,{weight:"normal",style:"normal"});document.fonts.add(await e.load()),await document.fonts.ready,await document.fonts.load(`normal 152px ${pl}`),await document.fonts.load('normal 64px "Reckk Heading"'),await document.fonts.load('normal 124px "Reckk Title"')}catch{}}const Ws="flow-intro-hide-chrome";function eR(s){return s<=72}const tR=280;function nR(s){const e=document.documentElement,i=e.style.scrollBehavior;e.style.scrollBehavior="auto",window.scrollTo(0,Math.max(0,s)),e.style.scrollBehavior=i}function fh(){const s=document.getElementById("hero");if(!s)return;const e=s.getBoundingClientRect().top+window.scrollY;nR(e)}function ul(s){const e=Un.clamp(s,0,1);return e*e*e*(e*(e*6-15)+10)}function dh(s){const e=Math.max(1,s),i=Math.max(1,Kn*e*U2),r=Math.max(1,i/Math.max(1,Kn-1));return{cardPx:i,titlePx:r,totalPx:i+r}}function gx(s,e){const i=s/Math.max(1,e),r=xp*Math.PI/180,l=2*cl*Math.tan(r/2),c=l*i,u=ap*dx/hx,h=.992,p=h*l/ap,m=h*c/u;return Un.clamp(Math.min(p,m),.52,2.35)}function _v(s,e,i){const r=px(s),l=gx(s,e),c=s/Math.max(1,e),u=xp*Math.PI/180,p=2*cl*Math.tan(u/2)*c,m=r.frustumFill*p/Math.max(1e-6,l),_=Math.min(r.planeBaseW,m);return{w:_,h:_*i}}function iR(s,e){const i=s/Math.max(1,Kn-1),r=Math.min(Math.max(1,e*.38),Math.max(1,i*.34));return i<=r+.001?0:1-r/i}function aR(s,e){const i=Math.min(Math.max(1,e*.38),Math.max(1,s*.34));return s<=i+.001?0:1-i/s}function sR(s,e){const i=Un.clamp(e,0,.999);if(s<i)return{titleOp:1,lastCardOp:0};const r=Math.max(1e-6,1-i),l=ul(Un.clamp((s-i)/r,0,1));return{titleOp:1-l,lastCardOp:l}}function rR(s,e,i){const r=Kn-1;if(s<=0)return{opacity:e===0?1:0};if(s>=r-1e-5)return{opacity:e===r?1:0};const l=Math.floor(s);if(l>=r)return{opacity:e===r?1:0};if(e!==l&&e!==l+1)return{opacity:0};const c=s-l,u=Un.clamp(i,0,.999);if(c<u)return{opacity:e===l?1:0};const h=ul(Un.clamp((c-u)/Math.max(1e-6,1-u),0,1));return{opacity:e===l?1-h:h}}function oR(s,e){return s>1.5&&s<e-.5}function lR(s){return Un.clamp(540/Math.max(s,340),.2,.55)}function cR(s,e,i){const r=[],l=F2;for(let c=0;c<l;c++){const u=Un.clamp(s-c/Math.max(1,l-1)*B2,-.08,1.08),h=Math.sin(u*Math.PI*2*L2)*P2*i,p=Math.sin(u*Math.PI*2*O2)*I2,m=gv+c/Math.max(1,l-1)*(k2-gv),_=e-m;r.push(new $(h,p,_))}return r}function uR(s,e,i,r){const l=s.length;if(l<2)return new Ni;const c=[],u=[],h=[],p=[],m=new $,_=new $,v=new $,g=new $(0,1,0),S=e+1;for(let w=0;w<l;w++){w===0?m.subVectors(s[1],s[0]).normalize():w===l-1?m.subVectors(s[l-1],s[l-2]).normalize():m.subVectors(s[w+1],s[w-1]).normalize(),_.copy(g).cross(m),_.lengthSq()<1e-8&&_.set(1,0,0).cross(m),_.normalize(),v.crossVectors(m,_).normalize();const y=l===1?0:w/(l-1),M=i+(r-i)*Math.pow(y,1.5);for(let F=0;F<=e;F++){const B=F/e*Math.PI*2,C=Math.cos(B),O=Math.sin(B),U=s[w];c.push(U.x+(C*_.x+O*v.x)*M,U.y+(C*_.y+O*v.y)*M,U.z+(C*_.z+O*v.z)*M),u.push(C*_.x+O*v.x,C*_.y+O*v.y,C*_.z+O*v.z),h.push(l===1?0:w/(l-1),F/e)}}for(let w=0;w<l-1;w++)for(let y=0;y<e;y++){const M=w*S+y,F=M+1,B=M+S,C=B+1;p.push(M,B,F,F,B,C)}const b=new Ni;return b.setAttribute("position",new Di(c,3)),b.setAttribute("normal",new Di(u,3)),b.setAttribute("uv",new Di(h,2)),b.setIndex(p),b.computeBoundingSphere(),b}function vv(s,e,i,r){const l={verb:s.verb,description:s.description};return D2(l,e,i,r,j2)}function xv(s,e){const i=px(e),r=Math.min(s*2.35,3.25),l=Math.round(i.canvasW*r),c=Math.round(i.canvasH*r),u=document.createElement("canvas");u.width=l,u.height=c;const h=u.getContext("2d");h.clearRect(0,0,l,c);const p="Morpheum";let m=i.fontPx;h.textAlign="left",h.textBaseline="alphabetic";const _=()=>{h.font=`normal ${m*r}px ${pl}`};_();const v=O=>{h.font=`normal ${O*r}px ${pl}`;const U=h.measureText(p),P=Math.abs(U.actualBoundingBoxLeft??0),T=Math.abs(U.actualBoundingBoxRight??U.width),L=Math.abs(U.actualBoundingBoxAscent??O*r*.8),Y=Math.abs(U.actualBoundingBoxDescent??O*r*.25);return{left:P,right:T,width:P+T,ascent:L,descent:Y}},g=Math.max(1.25,1.85*r)*2,S=64*r+g,b=40*r+g,w=O=>{const U=v(O);return U.width+S*2<=l&&U.ascent+U.descent+b*2<=c};for(;!w(m)&&m>64;)m-=2;for(;w(m+2)&&m<i.fontPx+24;)m+=2;_();const y=v(m),M=(l-y.width)/2+y.left,F=c/2+(y.ascent-y.descent)/2,B=h.createLinearGradient(M-y.left,F-y.ascent,M+y.right,F+y.descent);Q2.forEach(O=>B.addColorStop(O.t,O.c)),h.lineJoin="round",h.miterLimit=2,h.lineWidth=Math.max(1.25,1.85*r),h.strokeStyle="rgba(8,12,10,0.22)",h.strokeText(p,M,F),h.fillStyle=B,h.fillText(p,M,F);const C=new Yv(u);return C.colorSpace=jn,C.minFilter=yn,C.magFilter=yn,C.generateMipmaps=!1,C}function Sv(s,e){s.generateMipmaps=!1,s.minFilter=yn,s.magFilter=yn,s.wrapS=Vi,s.wrapT=Vi;const i=e.capabilities.getMaxAnisotropy();s.anisotropy=Math.min(16,i),s.needsUpdate=!0}function fR(){const s=$t.useRef(null),e=$t.useRef(null),i=$t.useRef(null),r=$t.useRef(null),l=$t.useRef(!1),c=$t.useCallback(()=>{if(l.current)return;l.current=!0;const u=e.current;u==null||u.classList.add("flow-intro__sticky--exit"),window.setTimeout(()=>{document.body.classList.remove(Ws),fh(),requestAnimationFrame(()=>{fh(),requestAnimationFrame(()=>{fh(),window.setTimeout(()=>{l.current=!1},100)})})},tR)},[]);return $t.useLayoutEffect(()=>{const u=window.matchMedia("(prefers-reduced-motion: reduce)").matches,h=window.location.hash.replace(/^#/,"");return u||h!==""&&h!=="flow"&&h!=="hero"||document.body.classList.add(Ws),()=>{document.body.classList.remove(Ws)}},[]),$t.useEffect(()=>{const u=h=>{if(h.key!=="Escape")return;const p=document.getElementById("hero");p&&p.getBoundingClientRect().top>8&&(h.preventDefault(),c())};return window.addEventListener("keydown",u),()=>window.removeEventListener("keydown",u)},[c]),$t.useEffect(()=>{const u=window.location.hash.replace(/^#/,"");u&&u!=="flow"&&u!=="hero"&&requestAnimationFrame(()=>{var h;(h=document.getElementById(u))==null||h.scrollIntoView({block:"start"})})},[]),$t.useEffect(()=>{const u=i.current,h=s.current;if(!u||!h)return;const p=u,m=h;let _=!1;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){document.body.classList.remove(Ws);const S=r.current;S&&(S.style.height="0px");return}let g;return(async()=>{if(await $2(),_)return;const S=Math.min(window.devicePixelRatio,2),b=Math.max(320,p.clientWidth||window.innerWidth),w=Math.max(1,p.clientHeight||window.innerHeight),y=[],M=[],F=[];jr.forEach((Ye,Ze)=>{const rt=Kn-1-Ze,pt=jr[rt],Ct=vv(pt,rt,S,b);F.push(Ct);const wt=new lu({map:Ct,transparent:!0,opacity:1,depthWrite:!0,depthTest:!0,side:Oa});y.push(wt);const ut=ap,gt=ut*dx/hx,X=new Ui(new js(gt,ut),wt);X.position.set(0,0,-Ze*Ua),X.renderOrder=Ze,M.push(X)});const B=xv(S,b),C=new lu({map:B,transparent:!0,opacity:0,depthWrite:!1,depthTest:!0,side:ea}),O=B.image.height/B.image.width,{w:U,h:P}=_v(b,w,O),T=new Ui(new js(U,P),C);T.position.set(0,0,-(Kn-1)*Ua),T.renderOrder=Y2;const L=new Ky,Y=new Ci(xp,1,.08,120),G=new h2({antialias:!0,alpha:!1,powerPreference:"high-performance"});G.setPixelRatio(Math.min(window.devicePixelRatio,2)),G.outputColorSpace=jn,G.sortObjects=!0,p.appendChild(G.domElement),Sv(B,G);const Q=new sl;M.forEach(Ye=>Q.add(Ye)),Q.add(T),L.add(Q);const pe=new Xi({uniforms:{uStrength:{value:0}},vertexShader:Z2,fragmentShader:K2,transparent:!0,toneMapped:!1,depthTest:!1,depthWrite:!1,blending:ph}),de=new Ui(new Ni,pe);de.frustumCulled=!1,de.renderOrder=W2,de.visible=!1,L.add(de);const J=jr.map(Ye=>new Dt(Ye.mood.mid)),I=J[0].clone();L.background=I;const H=0,ee=-(Kn-1)*Ua,_e=cl,be=-.1*Ua,N=.1*Ua;function Z(Ye,Ze){const rt=Ye+cl;return(_e-rt)/Ze}function Ee(){const Ye=Math.max(1,window.innerHeight),{totalPx:Ze}=dh(Ye),rt=Math.max(1,Ze),pt=H+be,Ct=ee+N-N2,ut=(pt-Ct)/rt,gt=Z(pt,ut),X=Z(Ct,ut);return{ih:Ye,totalPx:rt,scrollToWorldFactor:ut,minScroll:gt,maxScroll:X}}let{scrollToWorldFactor:Ce,minScroll:Le,maxScroll:ie}=Ee();const Se=new Dt,Me=new Dt,ze=new Dt;function nt(){var gt;const Ye=Math.max(320,p.clientWidth||window.innerWidth),Ze=Math.min(window.devicePixelRatio,2);F.forEach((X,St)=>{X.dispose();const vt=Kn-1-St,D=vv(jr[vt],vt,Ze,Ye);F[St]=D,y[St].map=D,y[St].needsUpdate=!0}),(gt=C.map)==null||gt.dispose();const rt=xv(Ze,Ye);C.map=rt,C.needsUpdate=!0,Sv(rt,G);const pt=rt.image.height/rt.image.width,Ct=Math.max(1,p.clientHeight||window.innerHeight),{w:wt,h:ut}=_v(Ye,Ct,pt);T.geometry.dispose(),T.geometry=new js(wt,ut)}function Qe(){const Ye=p.clientWidth,Ze=p.clientHeight;if(Ye<2||Ze<2)return;Y.aspect=Ye/Ze,Y.updateProjectionMatrix(),G.setSize(Ye,Ze,!1),nt();const rt=Ee();Ce=rt.scrollToWorldFactor,Le=rt.minScroll,ie=rt.maxScroll;const pt=Math.max(1,window.innerHeight),{totalPx:Ct}=dh(pt),wt=r.current;if(wt){const ut=pt*pv,gt=Math.max(Math.ceil(Ct+ut+pt*mv+32),Math.ceil(pt*1.08));wt.style.height=`${gt}px`}}Qe(),requestAnimationFrame(()=>{_||nt()});let Yt=0;function ct(){var Bn,Fa;if(_)return;Yt=requestAnimationFrame(ct);const Ye=Math.max(1,window.innerHeight),{cardPx:Ze,titlePx:rt,totalPx:pt}=dh(Ye),Ct=m.getBoundingClientRect(),wt=Math.max(1,m.offsetHeight-Ye),ut=Un.clamp(-Ct.top,0,wt),gt=Math.min(ut,pt),X=Math.max(1,pt),St=Ye*pv,vt=ul(Un.clamp((ut-pt)/Math.max(1,St),0,1)),D=Un.mapLinear(Ze,0,X,Le,ie),E=p.clientWidth,j=p.clientHeight,te=Math.max(1,rt),ue=gt<te,Re=ue?Un.clamp(gt/te,0,1):0,De=Math.max(0,gt-te),fe=Math.max(1,Ze),Te=Un.clamp(De/fe,0,1)*(Kn-1),Be=gx(E,j),Ue=document.getElementById("hero"),Ne=Ue?Ue.getBoundingClientRect().top:0,Je=Ue?eR(Ne):!0;l.current||document.body.classList.toggle(Ws,!Je);let Ke;ue?Ke=Un.mapLinear(gt,0,te,ie,D):Ke=Un.mapLinear(gt,te,X,D,Le),Ke=Un.clamp(Ke,Le,ie);const at=iR(Ze,Ye),W=aR(te,Ye),Ae=sR(Re,W),me=Kn-1;if(ue)ze.copy(J[0]);else{const hn=Math.min(Kn-2,Math.floor(Te)),En=Math.min(hn+1,Kn-1),ri=ul(Te-hn);Se.copy(J[hn]),Me.copy(J[En]),ze.lerpColors(Se,Me,ri)}L.background=I.copy(ze);const we=_e-Ke*Ce;Y.position.set(0,0,we),Y.lookAt(0,0,we-cl);const Pe=Un.clamp(gt/X,0,1);if(oR(gt,X)){const hn=cR(Pe,we,lR(E)),ri=new lE(hn,!1,"centripetal").getSpacedPoints(z2);if(ri.length>=2){const pn=uR(ri,H2,G2,V2),Lt=de.geometry.getAttribute("position"),en=pn.getAttribute("position");if(Lt&&en&&Lt.count===en.count&&((Bn=de.geometry.getIndex())==null?void 0:Bn.count)===((Fa=pn.getIndex())==null?void 0:Fa.count)&&Lt&&en){Lt.array.set(en.array),Lt.needsUpdate=!0;const Qn=de.geometry.getAttribute("normal"),Ms=pn.getAttribute("normal");Qn&&Ms&&(Qn.array.set(Ms.array),Qn.needsUpdate=!0);const Ba=de.geometry.getAttribute("uv"),Wi=pn.getAttribute("uv");Ba&&Wi&&(Ba.array.set(Wi.array),Ba.needsUpdate=!0),pn.dispose()}else de.geometry.dispose(),de.geometry=pn;de.visible=!0,pe.uniforms.uStrength.value=.36}else de.visible=!1,pe.uniforms.uStrength.value=0}else de.visible=!1,pe.uniforms.uStrength.value=0;const Xe=Math.floor((Kn-1)/2);M.forEach((hn,En)=>{const ri=-En*Ua,pn=Kn-1-En;let{opacity:Lt}=rR(Te,pn,at);ue&&En===me&&(Lt*=Ae.lastCardOp);let en=1,Cn=0;!ue&&pn===Kn-1&&Lt>.02&&vt>0&&(en=1-.28*vt,Cn=-Ua*.32*vt),hn.position.set(0,0,ri+Cn),hn.scale.setScalar(Be*en);const Qn=y[En];Qn.opacity=Lt,Qn.depthWrite=Lt>=.995,hn.visible=Lt>.003,hn.renderOrder=En<=Xe?X2+En:q2+(En-Xe-1)}),T.position.set(0,0,-me*Ua),T.scale.setScalar(Be),C.opacity=ue?Ae.titleOp:0,C.depthWrite=C.opacity>=.995,T.visible=C.opacity>.003;const He=pt+St;let Ht=0;if(wt>He&&ut>=He){const hn=Math.max(1,wt-He);Ht=ul(Un.clamp((ut-He)/hn,0,1))}Ht>.02&&(de.visible=!1,pe.uniforms.uStrength.value=0);const Ut=r.current;if(Ut){const hn=St+Ye*mv+32,En=Math.max(Math.ceil(pt+hn),Math.ceil(Ye*1.08));Ut.style.height!==`${En}px`&&(Ut.style.height=`${En}px`)}const Wn=1-Ht*.96;e.current&&e.current.style.setProperty("--intro-ui-opacity",String(Wn)),G.domElement.style.opacity=String(1-Ht),G.render(L,Y)}ct(),window.addEventListener("resize",Qe,{passive:!0});const _t=new ResizeObserver(Qe);_t.observe(p),g=()=>{var Ye;cancelAnimationFrame(Yt),document.body.classList.remove(Ws),window.removeEventListener("resize",Qe),_t.disconnect(),y.forEach(Ze=>{var rt;(rt=Ze.map)==null||rt.dispose(),Ze.dispose()}),F.forEach(Ze=>Ze.dispose()),(Ye=C.map)==null||Ye.dispose(),C.dispose(),M.forEach(Ze=>Ze.geometry.dispose()),T.geometry.dispose(),de.geometry.dispose(),pe.dispose(),L.remove(de),G.dispose(),p.contains(G.domElement)&&p.removeChild(G.domElement)},_&&g()})(),()=>{_=!0,document.body.classList.remove(Ws),g==null||g()}},[]),V.jsxs("section",{ref:s,id:"flow",className:"flow-intro","aria-label":"Morpheum — Discover, Copy, Supervise, Isolate",children:[V.jsxs("div",{ref:e,className:"flow-intro__sticky",children:[V.jsx("div",{ref:i,className:"flow-intro__canvas","aria-hidden":!0}),V.jsxs("div",{className:"flow-intro__top",children:[V.jsx("p",{className:"flow-intro__eyebrow",children:"/// Morpheum"}),V.jsxs("button",{type:"button",className:"flow-intro__skip",onClick:c,children:["Skip ",V.jsx("span",{className:"flow-intro__skip-key",children:"Esc"})]})]}),V.jsx("div",{className:"flow-intro__sr","aria-live":"polite",children:jr.map((u,h)=>V.jsxs("p",{children:["Step ",String(h+1).padStart(2,"0"),": ",u.verb,". ",u.description]},u.verb))})]}),V.jsx("div",{ref:r,className:"flow-intro__spacer","aria-hidden":!0})]})}const dR=280,hR=5/4;function pR({stepIndex:s,kind:e,className:i,width:r=dR}){const l=$t.useRef(null),c=e??rx(s),u=Math.round(r*hR);return $t.useEffect(()=>{const h=l.current;if(!h)return;const p=()=>{const _=Math.min(window.devicePixelRatio||1,2),v=Math.round(r*_),g=Math.round(u*_);(h.width!==v||h.height!==g)&&(h.width=v,h.height=g);const S=h.getContext("2d");S&&w2(S,c,v,g)};p();const m=()=>p();return window.addEventListener("resize",m),()=>window.removeEventListener("resize",m)},[c,r,u]),V.jsx("div",{className:["loop-step-sheet",i].filter(Boolean).join(" "),style:{width:r,height:u},children:V.jsx("canvas",{ref:l,className:"loop-step-sheet__canvas",style:{width:r,height:u},"aria-hidden":!0})})}function _x({label:s,status:e,live:i}){return V.jsxs("span",{className:`stat-chip ${i?"stat-chip--live":""}`,children:[V.jsx("span",{className:"stat-chip__label",children:s}),V.jsx("span",{className:"stat-chip__sep",children:"·"}),V.jsx("span",{className:"stat-chip__status",children:e})]})}function mR(s){return String(s).padStart(2,"0")}function gR(){return typeof window<"u"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function _R(){const[s,e]=$t.useState(()=>new Set),i=$t.useRef(new Map);$t.useLayoutEffect(()=>{if(gR()){e(new Set(Lr.steps.map(u=>`step-${u.n}`)));return}const c=new IntersectionObserver(u=>{e(h=>{const p=new Set(h);for(const m of u){const _=m.target.dataset.flowKey;_&&m.isIntersecting&&p.add(_)}return p})},{root:null,threshold:[0,.01,.08,.15,.25],rootMargin:"-42% 0px -42% 0px"});for(const u of i.current.values())c.observe(u);return()=>{c.disconnect()}},[]);const r=$t.useCallback((c,u)=>{u?i.current.set(c,u):i.current.delete(c)},[]),l=$t.useCallback(c=>{e(u=>new Set(u).add(c))},[]);return V.jsx("section",{id:"how",className:"section flow",children:V.jsxs("div",{className:"container",children:[V.jsx("p",{className:"section-kicker",children:Lr.kicker}),V.jsx("h2",{className:"section-title flow__title",children:Lr.title}),V.jsx("div",{className:"flow__chips",children:Lr.chips.map(c=>V.jsx(_x,{label:c.label,status:c.value},c.label))}),V.jsx("div",{className:"flow__steps",role:"list",children:Lr.steps.map((c,u)=>{const h=`step-${c.n}`,p=s.has(h);return V.jsxs("article",{ref:m=>r(h,m),"data-flow-key":h,role:"listitem",className:`flow-step${p?" flow-step--expanded":""}`,"aria-expanded":p,children:[V.jsxs("button",{type:"button",className:"flow-step__head",onClick:()=>l(h),"aria-label":p?`${c.title}, expanded`:`${c.title}, tap to expand`,children:[V.jsxs("span",{className:"flow-step__idx",children:["Step ",mR(c.n)]}),V.jsx("h3",{className:"flow-step__title",children:c.title}),V.jsx("span",{className:"flow-step__chevron","aria-hidden":!0,children:p?"−":"+"})]}),V.jsx("div",{className:"flow-step__expand","aria-hidden":!p,children:V.jsx("div",{className:"flow-step__expand-inner",children:V.jsxs("div",{className:"flow-step__split",children:[V.jsxs("div",{className:"flow-step__copy",children:[V.jsx("p",{className:"flow-step__meta",children:c.feature}),V.jsx("p",{className:"flow-step__detail",children:c.body}),V.jsxs("p",{className:"flow-step__example",children:[V.jsx("span",{"aria-hidden":!0,children:"> "}),c.example]}),V.jsx("div",{className:"flow-step__actions",children:V.jsx("a",{href:Mn.explore,className:"flow-step__open","aria-label":`Explore after ${c.title}`,children:V.jsx("span",{"aria-hidden":!0,className:"flow-step__open-arrow",children:"→"})})})]}),V.jsx("div",{className:"flow-step__sheet","aria-hidden":!p,children:p?V.jsx(pR,{stepIndex:u,width:280}):null})]})})})]},h)})}),V.jsx("p",{className:"flow__outcome",children:Lr.outcome})]})})}const vR=["M41.9213 3.43614C43.0393 3.43614 43.8716 3.77154 44.4182 4.44235C44.9647 5.138 45.1262 6.1939 44.9026 7.61005L41.884 26.8026C41.7846 27.4982 41.8467 28.0075 42.0703 28.3305C42.2691 28.6784 42.6542 28.8771 43.2256 28.9268L43.8591 28.9641L43.8219 29.2622L36.7784 30.492L36.4803 30.492L40.1324 7.46098C40.3064 6.26843 40.0206 5.67216 39.2753 5.67216C38.9523 5.67216 38.6045 5.75912 38.2318 5.93303C37.8343 6.10694 37.3995 6.44235 36.9275 6.93924L36.7411 6.79017C38.0828 4.55415 39.8095 3.43614 41.9213 3.43614Z","M29.9958 3.43614C31.1138 3.43614 31.9461 3.77154 32.4927 4.44235C33.0393 5.138 33.2007 6.1939 32.9771 7.61005L29.9585 26.8026C29.8591 27.4982 29.9212 28.0075 30.1449 28.3305C30.3436 28.6784 30.7287 28.8771 31.3001 28.9268L31.9337 28.9641L31.8964 29.2622L24.8529 30.492L24.5548 30.492L28.207 7.46098C28.3809 6.26843 28.0952 5.67216 27.3498 5.67216C27.0268 5.67216 26.679 5.75912 26.3063 5.93303C25.9088 6.10694 25.474 6.44235 25.002 6.93924L24.8157 6.79017C26.1573 4.55415 27.884 3.43614 29.9958 3.43614Z","M18.0703 3.43614C19.1883 3.43614 20.0206 3.77154 20.5672 4.44235C21.1138 5.138 21.2753 6.1939 21.0517 7.61005L18.033 26.8026C17.9337 27.4982 17.9958 28.0075 18.2194 28.3305C18.4181 28.6784 18.8032 28.8771 19.3747 28.9268L20.0082 28.9641L19.9709 29.2622L12.9275 30.492L12.6293 30.492L16.2815 7.46098C16.4554 6.26843 16.1697 5.67216 15.4243 5.67216C15.1014 5.67216 14.7535 5.75912 14.3809 5.93303C13.9834 6.10694 13.5486 6.44235 13.0765 6.93924L12.8902 6.79017C14.2318 4.55415 15.9585 3.43614 18.0703 3.43614Z","M45.5631 10.8482C46.0378 11.9189 46.0912 12.9315 45.7231 13.8861C45.3095 14.8231 44.3453 15.4956 42.8305 15.9035L16.576 22.853C15.2325 23.2226 14.7771 24.0651 15.2096 25.3806L15.7698 26.7714L13.8491 27.2839L9.924 22.1284L9.25377 20.6168L40.8242 12.2711C41.6674 12.048 42.2133 11.7494 42.4619 11.3754C42.6651 10.9838 42.669 10.5676 42.4735 10.1267C42.3199 9.78031 42.1016 9.5003 41.8185 9.2867C41.4899 9.05556 41.0511 8.87329 40.5021 8.7399L41.5734 7.5866C42.563 7.86379 43.3915 8.28774 44.0591 8.85845C44.7127 9.39767 45.214 10.0609 45.5631 10.8482Z"],xR=58,SR=35;function MR({fill:s="#C8F5A8",width:e=58,height:i=35,padding:r=10,"aria-hidden":l=!0,...c}){const u=[-r,-r,xR+r*2,SR+r*2].join(" ");return V.jsx("svg",{width:e,height:i,viewBox:u,fill:"none",xmlns:"http://www.w3.org/2000/svg","aria-hidden":l,...c,children:vR.map(h=>V.jsx("path",{d:h,fill:s},h.slice(0,24)))})}const yR={sm:{width:46,height:28},md:{width:46,height:28},lg:{width:69,height:42},hero:{width:119,height:72}};function vx({size:s="md",showWordmark:e=!0,className:i="",brandName:r="Morpheum"}){const l=yR[s];return V.jsxs("span",{className:`brand-mark brand-mark--${s} ${i}`.trim(),children:[V.jsx(MR,{className:"brand-mark__icon",width:l.width,height:l.height,padding:0,fill:"var(--terminal-brand)"}),e?V.jsx("span",{className:"brand-mark__word",children:r}):null]})}function ER(){return V.jsx("footer",{className:"site-footer",children:V.jsxs("div",{className:"container site-footer__inner",children:[V.jsxs("div",{className:"site-footer__brand",children:[V.jsx("a",{className:"site-footer__logo",href:"#hero","aria-label":"Morpheum home",children:V.jsx(vx,{size:"sm"})}),V.jsx("p",{className:"site-footer__legal",children:LM.legal})]}),V.jsxs("nav",{className:"site-footer__nav","aria-label":"Footer",children:[Kc.map(s=>V.jsx("a",{href:s.href,children:s.label},s.id)),V.jsx("a",{href:Mn.docs,children:"Docs"}),V.jsx("a",{href:Mn.manifesto,children:"Manifesto"}),V.jsx("a",{href:Mn.discord,children:"Discord"}),V.jsx("a",{href:Mn.x,children:"X"})]})]})})}function bR(){const[s,e]=Hs.headline;return V.jsxs("section",{id:"hero",className:"hero","aria-labelledby":"hero-heading",children:[V.jsx("div",{className:"hero__atmosphere","aria-hidden":!0}),V.jsx("div",{className:"hero__grid","aria-hidden":!0}),V.jsx("div",{className:"hero__scanlines","aria-hidden":!0}),V.jsx("div",{className:"hero__grain","aria-hidden":!0}),V.jsx("div",{className:"hero__veil","aria-hidden":!0}),V.jsxs("div",{className:"container hero__content",children:[V.jsxs("a",{className:"hero__eyebrow",href:Hs.eyebrow.href,children:[Hs.eyebrow.label,V.jsx("span",{className:"hero__eyebrow-chevron","aria-hidden":!0,children:"›"})]}),V.jsxs("h1",{id:"hero-heading",className:"hero__headline",children:[V.jsx("span",{className:"hero__line hero__line--lead",children:s}),V.jsx("span",{className:"hero__line hero__line--punch",children:e})]}),V.jsxs("div",{className:"hero__ctas",children:[V.jsx(eo,{href:Hs.primaryCta.href,variant:"primary",children:Hs.primaryCta.label}),V.jsx(eo,{href:Hs.secondaryCta.href,variant:"secondary",children:Hs.secondaryCta.label})]})]})]})}const Mv="!@#$%^&*()_+{}[]|;:,.<>?/0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ",TR=50,xx=3500,AR=4e3,RR=xx+AR;function CR(){return typeof window>"u"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches}function yv(s){return/[A-Za-z0-9]/.test(s)}function wR(){return Mv[Math.floor(Math.random()*Mv.length)]??"?"}function DR(s){return Math.random()<.5?wR():s}function UR(s,e){const i=[];for(let p=0;p<s.length;p++)yv(s[p]??"")&&i.push(p);const r=i.length,l=r===0?1:Math.min(e/xx,1),c=Math.floor(l*r),u=new Set(i.slice(0,c));let h="";for(let p=0;p<s.length;p++){const m=s[p]??"";!yv(m)||u.has(p)?h+=m:h+=DR(m)}return h}function NR(s,e=!0){const[i,r]=$t.useState(s);return $t.useEffect(()=>{if(!e||CR()){r(s);return}let l=Date.now();const c=()=>{const h=Date.now();let p=h-l;p>=RR&&(l=h,p=0),r(UR(s,p))};c();const u=setInterval(c,TR);return()=>{clearInterval(u)}},[s,e]),i}function LR(){const s=NR(Rd.text);return V.jsx("div",{className:"manifesto-strip",children:V.jsx("a",{className:"manifesto-strip__link manifesto-strip__link--matrix",href:Rd.href,"aria-label":Rd.text,children:s})})}function OR(){const s=[...h_,...h_];return V.jsx("div",{className:"marquee","aria-label":"Live status",children:V.jsx("div",{className:"marquee__viewport",children:V.jsx("div",{className:"marquee__track",children:s.map((e,i)=>V.jsx(_x,{label:e.label,status:e.status,live:"live"in e?e.live:!1},`${e.label}-${i}`))})})})}function PR(){return V.jsx("section",{id:"personas",className:"section personas",children:V.jsxs("div",{className:"container",children:[V.jsx("p",{className:"section-kicker",children:wd.kicker}),V.jsx("h2",{className:"section-title personas__title",children:wd.title}),V.jsx("div",{className:"personas__grid",children:wd.items.map(s=>V.jsxs("article",{className:`persona-card persona-card--${s.weight}`,children:[V.jsx("h3",{className:"persona-card__title",children:s.title}),V.jsx("ol",{className:"persona-card__steps",children:s.steps.map(e=>V.jsxs("li",{children:[V.jsxs("span",{className:"persona-card__chevron","aria-hidden":!0,children:[">"," "]}),e]},e))}),V.jsx(eo,{href:s.cta.href,variant:"ghost",className:"persona-card__cta",children:s.cta.label})]},s.title))})]})})}function IR(){const[s,e]=$t.useState(!1),[i,r]=$t.useState(!1),[l,c]=$t.useState("");return $t.useEffect(()=>{const u=()=>e(window.scrollY>24);return u(),window.addEventListener("scroll",u,{passive:!0}),()=>window.removeEventListener("scroll",u)},[]),$t.useEffect(()=>{const u=Kc.map(p=>p.id),h=new IntersectionObserver(p=>{var _;const m=p.filter(v=>v.isIntersecting).sort((v,g)=>g.intersectionRatio-v.intersectionRatio);(_=m[0])!=null&&_.target.id&&c(m[0].target.id)},{rootMargin:"-30% 0px -55% 0px",threshold:[0,.25,.5]});return u.forEach(p=>{const m=document.getElementById(p);m&&h.observe(m)}),()=>h.disconnect()},[]),$t.useEffect(()=>(document.body.style.overflow=i?"hidden":"",()=>{document.body.style.overflow=""}),[i]),V.jsxs(V.Fragment,{children:[V.jsx("header",{className:`sticky-header ${s?"sticky-header--solid":""}`,children:V.jsxs("div",{className:"sticky-header__inner",children:[V.jsx("a",{className:"sticky-header__logo",href:"#hero","aria-label":"Morpheum home",children:V.jsx(vx,{size:"sm",brandName:"Morpheum"})}),V.jsx("nav",{className:"sticky-header__nav","aria-label":"Primary",children:Kc.map(u=>V.jsx("a",{href:u.href,className:`sticky-header__link ${l===u.id?"is-active":""}`,children:u.label},u.id))}),V.jsxs("div",{className:"sticky-header__actions",children:[V.jsx("a",{className:"sticky-header__docs",href:Mn.docs,children:"Docs"}),V.jsx(eo,{href:Mn.app,variant:"primary",className:"sticky-header__launch",children:"Launch app"}),V.jsxs("button",{type:"button",className:"sticky-header__menu","aria-expanded":i,"aria-controls":"mobile-nav","aria-label":i?"Close menu":"Open menu",onClick:()=>r(u=>!u),children:[V.jsx("span",{}),V.jsx("span",{}),V.jsx("span",{})]})]})]})}),V.jsx("div",{id:"mobile-nav",className:`mobile-sheet ${i?"is-open":""}`,hidden:!i,children:V.jsxs("nav",{className:"mobile-sheet__nav","aria-label":"Mobile",children:[Kc.map(u=>V.jsx("a",{href:u.href,onClick:()=>r(!1),className:l===u.id?"is-active":"",children:u.label},u.id)),V.jsx("a",{href:Mn.docs,onClick:()=>r(!1),children:"Docs"})]})})]})}function FR(){return V.jsx("section",{className:"thesis section","aria-label":"Thesis",children:V.jsxs("div",{className:"container thesis__inner",children:[V.jsx("p",{className:"section-kicker",children:"Two bad choices → Morpheum"}),V.jsx("div",{className:"thesis__choices",children:Cd.badChoices.map(s=>V.jsxs("div",{className:"thesis__choice",children:[V.jsx("p",{className:"thesis__choice-title",children:s.title}),V.jsxs("p",{className:"thesis__choice-detail",children:[V.jsx("span",{"aria-hidden":!0,children:"> "}),s.detail]})]},s.title))}),V.jsx("p",{className:"thesis__payoff",children:Cd.payoff}),V.jsx("p",{className:"thesis__close",children:Cd.close})]})})}function BR(){return V.jsxs("div",{className:"page",children:[V.jsx("a",{className:"skip-link",href:"#hero",children:"Skip to content"}),V.jsx(LR,{}),V.jsx(IR,{}),V.jsxs("main",{className:"page__main",children:[V.jsx(fR,{}),V.jsx(bR,{}),V.jsx(FR,{}),V.jsx(OR,{}),V.jsx(PM,{}),V.jsx(PR,{}),V.jsx(_R,{}),V.jsx(FM,{}),V.jsx(OM,{})]}),V.jsx(ER,{})]})}UM.createRoot(document.getElementById("root")).render(V.jsx($t.StrictMode,{children:V.jsx(BR,{})}));
