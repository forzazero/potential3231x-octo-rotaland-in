 ...
 */var Q_;function Uy(){if(Q_)return Il;Q_=1;var a=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(r,o,c){var u=null;if(c!==void 0&&(u=""+c),o.key!==void 0&&(u=""+o.key),"key"in o){c={};for(var d in o)d!=="key"&&(c[d]=o[d])}else c=o;return o=c.ref,{$$typeof:a,type:r,key:u,ref:o!==void 0?o:null,props:c}}return Il.Fragment=e,Il.jsx=i,Il.jsxs=i,Il}var J_;function Oy(){return J_||(J_=1,lh.exports=Uy()),lh.exports}var D=Oy(),ch={exports:{}},_t={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:rs,depthTest:!1,depthWrite:!1})}function xA(a,e,i){const r=new Float32Array(Rr),o=new te(0,1,0);return new Ji({name:"SphericalGaussianBlur",defines:{n:Rr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${a}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:o}},vertexShader:sf(),fragmentShader:`
	...
	`}class SS extends La{constructor(e=1,i={}){super(e,e,i),this.isWebGLCubeRenderTarget=!0;const r={width:e,height:e,depth:1},o=[r,r,r,r,r,r];this.texture=new hS(o),this._setTextureOptions(i),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,i){this.texture.type=i.type,this.texture.colorSpace=i.colorSpace,this.texture.generateMipmaps=i.generateMipmaps,this.texture.minFilter=i.minFilter,this.texture.magFilter=i.magFilter;const r={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}const b2={[Wx]:"Linear",[Yx]:"Reinhard",[qx]:"Cineon",[jx]:"ACESFilmic",[Kx]:"AgX",[Qx]:"Neutral",[Zx]:"Custom"};function T2(a,e){const i=b2[e];return i===void 0?(ct("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+a+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+a+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Ou=new te;function A2(){Pt.getLuminanceCoefficients(Ou);const a=Ou.x.toFixed(4),e=Ou.y.toFixed(4),i=Ou.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${a}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
`)}function R2(a){return[a.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",a.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Yl).join(`
`)}function C2(a){const e=[];for(const i in a){const r=a[i];r!==!1&&e.push("#define "+i+" "+r)}return e.join(`
`)}function w2(a,e){const i={},r=a.getProgramParameter(e,a.ACTIVE_ATTRIBUTES);for(let o=0;o<r;o++){const c=a.getActiveAttrib(e,o),u=c.name;let d=1;c.type===a.FLOAT_MAT2&&(d=2),c.type===a.FLOAT_MAT3&&(d=3),c.type===a.FLOAT_MAT4&&(d=4),i[u]={type:c.type,location:a.getAttribLocation(e,u),locationSize:d}}return i}function Yl(a){return a!==""}function nx(a,e){const i=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return a.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function ix(a,e){return a.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const D2=/^[ \t]*#include +<([\w\d./]+)>/gm;function Zp(a){return a.replace(D2,N2)}const L2=new Map;function N2(a,e){let i=bt[e];if(i===void 0){const r=L2.get(e);if(r!==void 0)i=bt[r],ct('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,r);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return Zp(i)}const U2=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ax(a){return a.replace(U2,O2)}function O2(a,e,i,r){let o="";for(let c=parseInt(e);c<parseInt(i);c++)o+=r.replace(/\[\s*i\s*\]/g,"[ "+c+" ]").replace(/UNROLLED_LOOP_INDEX/g,c);return o}function sx(a){let e=`precision ${a.precision} float;
...
#define LOW_PRECISION`),e}const P2={[Fu]:"SHADOWMAP_TYPE_PCF",[Xl]:"SHADOWMAP_TYPE_VSM"};function I2(a){return P2[a.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const B2={[wr]:"ENVMAP_TYPE_CUBE",[Vo]:"ENVMAP_TYPE_CUBE",[nf]:"ENVMAP_TYPE_CUBE_UV"};function F2(a){return a.envMap===!1?"ENVMAP_TYPE_CUBE":B2[a.envMapMode]||"ENVMAP_TYPE_CUBE"}const z2={[Vo]:"ENVMAP_MODE_REFRACTION"};function H2(a){return a.envMap===!1?"ENVMAP_MODE_REFLECTION":z2[a.envMapMode]||"ENVMAP_MODE_REFLECTION"}const G2={[Xx]:"ENVMAP_BLENDING_MULTIPLY",[pE]:"ENVMAP_BLENDING_MIX",[mE]:"ENVMAP_BLENDING_ADD"};function V2(a){return a.envMap===!1?"ENVMAP_BLENDING_NONE":G2[a.combine]||"ENVMAP_BLENDING_NONE"}function k2(a){const e=a.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:r,maxMip:i}}function X2(a,e,i,r){const o=a.getContext(),c=i.defines;let u=i.vertexShader,d=i.fragmentShader;const m=I2(i),h=F2(i),g=H2(i),_=V2(i),v=k2(i),S=R2(i),E=C2(c),C=o.createProgram();let y,x,O=i.glslVersion?"#version "+i.glslVersion+`
...
`,k3='"Reckk Heading", Georgia, "Times New Roman", serif',BS="Morpheum Wordmark",nc=`"${BS}"`,X3=[{t:0,c:"#e8ffe0"},{t:.45,c:"#c8f5a8"},{t:1,c:"#f0e6a0"}];async function W3(){if(typeof document>"u"||!document.fonts)return!1;try{const a=new FontFace(BS,`url(${TR})`,{weight:"normal",style:"normal"});document.fonts.add(await a.load()),await document.fonts.load(`normal 152px ${nc}`);const e=document.fonts.check(`normal 152px ${nc}`);return e||console.error("[FlowIntro] Morpheum Wordmark failed to bind — title will not use Reckk fallback"),e}catch(a){return console.error("[FlowIntro] Morpheum Wordmark load failed",a),!1}}async function Y3(){if(!(typeof document>"u"||!document.fonts))try{await W3();const a=new FontFace("Reckk Title",`url(${bR})`,{weight:"normal",style:"normal"});document.fonts.add(await a.load());const e=new FontFace("Reckk Heading",`url(${ER})`,{weight:"normal",style:"normal"});document.fonts.add(await e.load()),await document.fonts.ready,await document.fonts.load(`normal 152px ${nc}`),await document.fonts.load('normal 64px "Reckk Heading"'),await document.fonts.load('normal 124px "Reckk Title"')}catch{}}const qs="flow-intro-hide-chrome",q3=72,j3=120,tp=80;function Z3(a){return a<=q3}const K3=280,np=.42;function js(a){const e=document.documentElement,i=e.style.scrollBehavior;e.style.scrollBehavior="auto",window.scrollTo(0,Math.max(0,a)),e.style.scrollBehavior=i}function ip(){const a=document.getElementById("hero");if(!a)return;const e=a.getBoundingClientRect().top+window.scrollY;js(e)}function Cx(){document.body.classList.remove(qs),ip(),requestAnimationFrame(()=>{ip(),requestAnimationFrame(()=>{ip()})})}function as(a){const e=Ht.clamp(a,0,1);return e*e*e*(e*(e*6-15)+10)}function Po(a){const e=Math.max(1,a),i=Math.max(1,un*e*l3),r=Math.max(1,c3);return{cardPx:i,titlePx:r,totalPx:i+r}}const Q3=900,J3=1100,$3=1300,eC=1500,tC=6,nC=36,iC=50,aC=.5,sC=1024,rC=.75,cf=.8;function _m(a){return a>=sC}function oC(a){return _m(a)?Q3:J3}function lC(a){return _m(a)?$3:eC}function FS(a){return Math.max(2,Math.max(1,a)*.004)}function cC(a,e){const{cardPx:i,titlePx:r}=Po(e),o=Math.max(1,un-1),c=Ht.clamp(Math.round(a),0,un-1);return r+c/o*i}function uC(a){return a.offsetTop}function fC(a,e,i){return a.offsetTop+cC(e,i)}function Iu(){const a=document.getElementById("hero");return a?a.getBoundingClientRect().top+window.scrollY:null}function dC(a){const e=un-1;return Ht.clamp(Math.round(a),0,e)}function ap(a,e,i,r){const o=FS(r);return a<e-o?{kind:"title"}:{kind:"card",idx:dC(i)}}function hC(a,e,i,r,o,c,u){if(o)return!1;const d=i/Math.max(1,un-1),m=r+d*aC;return!(a>m||c<u*.5)}function uf(a,e){const i=a/Math.max(1,e),r=Wo*Math.PI/180,o=2*$s*Math.tan(r/2),c=o*i,u=Ju*mm/gm,d=.992,m=d*o/Ju,h=d*c/u;return Ht.clamp(Math.min(m,h),.52,2.35)}function zS(a,e,i=cf){const r=uf(a,e);return(_m(a)?r*rC:r)*i}function pC(a,e){const i=window.devicePixelRatio||1,r=e<520?2.5:e<900?2.75:3;return Math.min(Math.max(a*1.25,Math.min(i,r)),3)}function mC(a,e,i=cf){const r=zS(a,e,i),o=Ju*r,c=o*mm/gm,u=a/Math.max(1,e),d=Wo*Math.PI/180,m=2*$s*Math.tan(d/2),h=m*u;return{w:c/Math.max(1e-6,h)*a,h:o/Math.max(1e-6,m)*e}}function Qp(a,e,i){const r=US(a),o=uf(a,e),c=a/Math.max(1,e),u=Wo*Math.PI/180,m=2*$s*Math.tan(u/2)*c,h=r.frustumFill*m/Math.max(1e-6,o),g=Math.min(r.planeBaseW,h);return{w:g,h:g*i}}function gC(a,e){const i=a/Math.max(1,un-1),r=Math.min(Math.max(1,e*.38),Math.max(1,i*.34));return i<=r+.001?0:1-r/i}function _C(a,e){const i=Math.min(Math.max(1,e*.55),Math.max(1,a*.52));return a<=i+.001?0:1-i/a}function vC(a,e){const i=Ht.clamp(e,0,.999);if(a<i)return{titleOp:1,lastCardOp:0};const r=Math.max(1e-6,1-i),o=as(Ht.clamp((a-i)/r,0,1));return{titleOp:1-o,lastCardOp:o}}function xC(a,e,i,r=0){const o=un-1;if(a<=0)return{opacity:e===0?1:0};if(a>=o-1e-5)return{opacity:e===o?1:0};const c=Math.floor(a);if(c>=o)return{opacity:e===o?1:0};if(e!==c&&e!==c+1)return{opacity:0};const u=a-c,d=Ht.clamp(i,0,.999);if(u<d)return{opacity:e===c?1:0};const m=as(Ht.clamp((u-d)/Math.max(1e-6,1-d),0,1));return e===c?{opacity:r>=.999?0:1}:{opacity:Math.max(m,r)}}function SC(a){return new Ji({uniforms:{uMap:{value:a},uOpacity:{value:1},uWipe:{value:0},uWipeEdge:{value:f3}},vertexShader:G3,fragmentShader:V3,transparent:!0,depthWrite:!0,depthTest:!0,side:ls})}function MC(a,e){return a>1.5&&a<e-.5}function yC(a){return Ht.clamp(540/Math.max(a,340),.2,.55)}function EC(a,e,i){const r=[],o=x3;for(let c=0;c<o;c++){const u=Ht.clamp(a-c/Math.max(1,o-1)*S3,-.08,1.08),d=Math.sin(u*Math.PI*2*m3)*_3*i,m=Math.sin(u*Math.PI*2*g3)*v3,h=yx+c/Math.max(1,o-1)*(T3-yx),g=e-h;r.push(new te(d,m,g))}return r}function bC(a,e,i,r){const o=a.length;if(o<2)return new Qi;const c=[],u=[],d=[],m=[],h=new te,g=new te,_=new te,v=new te(0,1,0),S=e+1;for(let C=0;C<o;C++){C===0?h.subVectors(a[1],a[0]).normalize():C===o-1?h.subVectors(a[o-1],a[o-2]).normalize():h.subVectors(a[C+1],a[C-1]).normalize(),g.copy(v).cross(h),g.lengthSq()<1e-8&&g.set(1,0,0).cross(h),g.normalize(),_.crossVectors(h,g).normalize();const y=o===1?0:C/(o-1),x=i+(r-i)*Math.pow(y,1.5);for(let O=0;O<=e;O++){const P=O/e*Math.PI*2,A=Math.cos(P),N=Math.sin(P),L=a[C];c.push(L.x+(A*g.x+N*_.x)*x,L.y+(A*g.y+N*_.y)*x,L.z+(A*g.z+N*_.z)*x),u.push(A*g.x+N*_.x,A*g.y+N*_.y,A*g.z+N*_.z),d.push(o===1?0:C/(o-1),O/e)}}for(let C=0;C<o-1;C++)for(let y=0;y<e;y++){const x=C*S+y,O=x+1,P=x+S,A=P+1;m.push(x,P,O,O,P,A)}const E=new Qi;return E.setAttribute("position",new Ki(c,3)),E.setAttribute("normal",new Ki(u,3)),E.setAttribute("uv",new Ki(d,2)),E.setIndex(m),E.computeBoundingSphere(),E}function wx(a,e,i,r,o,c,u,d=cf){const m={verb:a.verb,description:a.description},h=mC(r,o,d),g=pC(i,r);return QR(m,e,g,h.w,k3,c,u)}function Dx(a,e,i){const r=US(e),o=d3(a,e),c=p3(e,i,1/r.canvasAspect);let u=Math.round(Math.max(256,c.w*o*Mx)),d=Math.round(Math.max(64,c.h*o*Mx));const m=Math.round(u/r.canvasAspect);if(Math.abs(m-d)/Math.max(d,1)>.08&&(d=Math.max(64,m)),u>ep||d>ep){const k=ep/Math.max(u,d);u=Math.max(256,Math.round(u*k)),d=Math.max(64,Math.round(d*k))}const h=document.createElement("canvas");h.width=u,h.height=d;const g=h.getContext("2d");g.clearRect(0,0,u,d);const _="Morpheum",v=d/o;let S=r.fontPx*(v/r.fontRefH);g.textAlign="left",g.textBaseline="alphabetic";const E=()=>{g.font=`normal ${S*o}px ${nc}`};E();const C=k=>{g.font=`normal ${k*o}px ${nc}`;const G=g.measureText(_),q=Math.abs(G.actualBoundingBoxLeft??0),fe=Math.abs(G.actualBoundingBoxRight??G.width),ue=Math.abs(G.actualBoundingBoxAscent??k*o*.8),X=Math.abs(G.actualBoundingBoxDescent??k*o*.25);return{left:q,right:fe,width:q+fe,ascent:ue,descent:X}},y=Math.max(1.25,1.85*o)*2,x=64*o+y,O=40*o+y,P=k=>{const G=C(k);return G.width+x*2<=u&&G.ascent+G.descent+O*2<=d},A=S+24;for(;!P(S)&&S>48;)S-=2;for(;P(S+2)&&S<A;)S+=2;E();const N=C(S),L=(u-N.width)/2+N.left,F=d/2+(N.ascent-N.descent)/2,T=g.createLinearGradient(L-N.left,F-N.ascent,L+N.right,F+N.descent);X3.forEach(k=>T.addColorStop(k.t,k.c)),g.lineJoin="round",g.miterLimit=2,g.lineWidth=Math.max(1.25,1.85*o),g.strokeStyle="rgba(8,12,10,0.22)",g.shadowColor="rgba(10, 14, 23, 0.55)",g.shadowBlur=Math.max(10,16*o),g.shadowOffsetX=0,g.shadowOffsetY=Math.max(1,2*o),g.strokeText(_,L,F),g.fillStyle=T,g.fillText(_,L,F),g.shadowColor="transparent",g.shadowBlur=0,g.shadowOffsetY=0;const U=new fm(h);return U.colorSpace=ni,U.minFilter=yn,U.magFilter=yn,U.generateMipmaps=!1,U}function Lx(a,e){a.generateMipmaps=!1,a.minFilter=yn,a.magFilter=yn,a.wrapS=da,a.wrapT=da;const i=e.capabilities.getMaxAnisotropy();a.anisotropy=Math.min(16,i),a.needsUpdate=!0}function TC({cardAlpha:a=.8,modalChassisAlpha:e=1,cardSize:i=cf,skipAnimationSpeed:r=1,subtitleFadeEffect:o="matrix"}){const c=ke.useRef(null),u=ke.useRef(null),d=ke.useRef(null),m=ke.useRef(null),h=ke.useRef(!1),g=ke.useRef(!1),_=ke.useRef(null),v=ke.useRef(null),S=ke.useRef(a);S.current=Math.min(1,Math.max(0,a));const E=ke.useRef(e);E.current=Math.min(1,Math.max(0,e));const C=ke.useRef(i);C.current=Math.max(.1,i);const y=ke.useRef(r);y.current=Math.max(.1,r);const x=ke.useCallback(()=>{var N;if(h.current)return;h.current=!0,g.current=!1,(N=_.current)==null||N.call(_);const O=()=>{const L=u.current;L==null||L.classList.add("flow-intro__sticky--exit"),window.setTimeout(()=>{Cx(),window.setTimeout(()=>{h.current=!1},100)},K3)};if(window.matchMedia("(prefers-reduced-motion: reduce)").matches||!v.current){O();return}v.current()||O()},[]);return ke.useLayoutEffect(()=>{const O=window.matchMedia("(prefers-reduced-motion: reduce)").matches,P=window.location.hash.replace(/^#/,"");return O||P!==""&&P!=="flow"&&P!=="hero"||document.body.classList.add(qs),()=>{document.body.classList.remove(qs)}},[]),ke.useEffect(()=>{const O=P=>{if(P.key!=="Escape")return;const A=document.getElementById("hero");A&&A.getBoundingClientRect().top>8&&(P.preventDefault(),x())};return window.addEventListener("keydown",O),()=>window.removeEventListener("keydown",O)},[x]),ke.useEffect(()=>{const O=window.location.hash.replace(/^#/,"");O&&O!=="flow"&&O!=="hero"&&requestAnimationFrame(()=>{var P;(P=document.getElementById(O))==null||P.scrollIntoView({block:"start"})})},[]),ke.useEffect(()=>{const O=d.current,P=c.current;if(!O||!P)return;const A=O,N=P;let L=!1;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){document.body.classList.remove(qs);const U=m.current;U&&(U.style.height="0px");return}let T;return(async()=>{if(await Y3(),L)return;const U=Pu(),k=Math.max(320,A.clientWidth||window.innerWidth),G=Math.max(1,A.clientHeight||window.innerHeight),q=[],fe=[],ue=[],X=new Float64Array(un).fill(-1);jl.forEach((ce,Me)=>{const Le=un-1-Me,Ge=jl[Le],Re=wx(Ge,Le,U,k,G,S.current,E.current,C.current);ue.push(Re);const mt=SC(Re);q.push(mt);const rt=Ju,zt=rt*mm/gm,sn=new Li(new Qs(zt,rt),mt);sn.position.set(0,0,-Me*ua),sn.renderOrder=Me,fe.push(sn)});const z=Dx(U,k,G),H=new Qu({map:z,transparent:!0,opacity:0,depthWrite:!1,depthTest:!1,side:Ra}),$=z.image.height/z.image.width,{w:me,h:ye}=Qp(k,G,$),I=new Li(new Qs(me,ye),H);I.position.set(0,0,-(un-1)*ua+.05),I.renderOrder=R3;const K=new ab,Se=new ji(Wo,1,.08,120),Ne=typeof window.matchMedia=="function"&&window.matchMedia("(pointer: coarse)").matches,we=new yR({antialias:!Ne,alpha:!1,powerPreference:"high-performance"});we.setPixelRatio(Pu()),we.outputColorSpace=ni,we.sortObjects=!0,A.appendChild(we.domElement),Lx(z,we);const ne=new Wl;fe.forEach(ce=>ne.add(ce)),ne.add(I),K.add(ne);const be=new Ji({uniforms:{uStrength:{value:0}},vertexShader:z3,fragmentShader:H3,transparent:!0,toneMapped:!1,depthTest:!1,depthWrite:!1,blending:rp}),ve=new Li(new Qi,be);ve.frustumCulled=!1,ve.renderOrder=Ex,ve.visible=!1,K.add(ve);let Ie=null,nt=null,Xe=null,yt=-1,ut=Tx(window.innerWidth),dt=ut.w,ht=ut.h;const pt=document.createElement("canvas");pt.width=dt,pt.height=ht;const Ft=pt.getContext("2d",{alpha:!1,desynchronized:!0});function on(ce,Me){L||!Ft||!Ie||ce===0&&yt<0&&(Ft.drawImage(Me,0,0,dt,ht),Ie.needsUpdate=!0,yt=0)}let Zt=Rx(ut,on);function gn(ce){const Me=Zt.frames[ce];if(Me)return Me;for(let Le=1;Le<12;Le+=1){const Ge=Zt.frames[ce-Le];if(Ge)return Ge;const Re=Zt.frames[ce+Le];if(Re)return Re}return null}function Yt(ce){if(!Ft||!Ie)return;const Me=B3(ce);if(Me===yt)return;const Le=gn(Me);Le&&(Ft.drawImage(Le,0,0,dt,ht),Ie.needsUpdate=!0,yt=Me)}function dn(ce){const Me=Tx(ce);Me.dir!==ut.dir&&(Zt.cancel(),ut=Me,dt=Me.w,ht=Me.h,pt.width=dt,pt.height=ht,yt=-1,Ft&&(Ft.fillStyle="#000",Ft.fillRect(0,0,dt,ht),Ie&&(Ie.needsUpdate=!0)),Zt=Rx(ut,on),j())}Ft&&(Ft.fillStyle="#000",Ft.fillRect(0,0,dt,ht),Ie=new fm(pt),Ie.colorSpace=ni,Ie.minFilter=yn,Ie.magFilter=yn,Ie.generateMipmaps=!1,nt=new Qu({map:Ie,depthTest:!1,depthWrite:!1,toneMapped:!1}),Xe=new Li(new Qs(1,1),nt),Xe.frustumCulled=!1,Xe.renderOrder=w3,Xe.position.set(0,0,-bx),Se.add(Xe),K.add(Se),Yt(IS[0]));function j(){if(!Xe)return;const ce=bx,Me=Wo*Math.PI/180,Le=2*Math.tan(Me/2)*ce,Ge=Le*Se.aspect,Re=dt/ht;Ge/Math.max(1e-6,Le)>Re?Xe.scale.set(Ge,Ge/Re,1):Xe.scale.set(Le*Re,Le,1)}const qt=-(un-1)*ua,It=-.1*ua,B=qt+$s+It,b=B-DS;function J(ce){const Me=un-1,Le=Ht.clamp(ce,0,Me);return-(Me-Le)*ua+$s+It}let ee=Math.max(1,A.clientHeight||window.innerHeight),de=!1,De=window.innerWidth,Fe=!1,pe=!1;function ge(){return Math.max(1,window.innerHeight)}function Oe(ce){return Fe?ce>j3&&(Fe=!1):Z3(ce)&&(Fe=!0),Fe}function Ye(){const ce=m.current;if(!ce)return;const{totalPx:Me}=Po(ee),Le=ee*vx,Re=`${Math.max(Math.ceil(Me+Le+ee*$h+32-xx),Math.ceil(ee*1.08))}px`;ce.style.height!==Re&&(ce.style.height=Re)}function He(){var zt;const ce=Math.max(320,A.clientWidth||window.innerWidth),Me=Math.max(1,A.clientHeight||ee),Le=Pu();ue.forEach((sn,Bt)=>{sn.dispose();const nn=un-1-Bt,gt=wx(jl[nn],nn,Le,ce,Me,S.current,E.current,C.current);ue[Bt]=gt,q[Bt].uniforms.uMap.value=gt}),(zt=H.map)==null||zt.dispose();const Ge=Dx(Le,ce,Me);H.map=Ge,H.needsUpdate=!0,Lx(Ge,we);const Re=Ge.image.height/Ge.image.width,{w:mt,h:rt}=Qp(ce,Me,Re);I.geometry.dispose(),I.geometry=new Qs(mt,rt)}function Be(){const ce=A.clientWidth,Me=A.clientHeight;ce<2||Me<2||(dn(window.innerWidth),Se.aspect=ce/Me,Se.updateProjectionMatrix(),we.setPixelRatio(Pu()),we.setSize(ce,Me,!1),j(),He(),de||Ye())}function it(){de=!1,ee=ge(),De=window.innerWidth,Be()}Be(),requestAnimationFrame(()=>{L||He()});let Qe=null;function lt(){if(L||Qe)return!1;const ce=Math.max(1,ee),{cardPx:Me,titlePx:Le,totalPx:Ge}=Po(ce),Re=N.getBoundingClientRect(),mt=Math.max(1,N.offsetHeight-ce),rt=Ht.clamp(-Re.top,0,mt),zt=ce*vx,sn=Ge+zt,Bt=Ax(rt,Le,Me,Ge,sn),nn=Math.max(.08,$u-Bt),gt=Iu()??N.offsetTop+mt,St=Math.max(.1,y.current);Qe={startMs:performance.now(),startBgSec:Bt,startScrollY:window.scrollY,endScrollY:gt,durationMs:nn/St*1e3,camZ:Se.position.z};const hn=u.current;return hn&&(hn.style.setProperty("--intro-ui-opacity","0"),hn.classList.contains("flow-intro__sticky--exit")&&(hn.style.transition="none",hn.classList.remove("flow-intro__sticky--exit"),hn.offsetWidth,hn.style.transition="")),!0}v.current=lt;let Y=0;function Ue(){var Hr,oc;if(L)return;if(Y=requestAnimationFrame(Ue),Qe){const At=Qe,Vn=Math.min(1,(performance.now()-At.startMs)/At.durationMs),Fi=as(Vn);Yt(Ht.lerp(At.startBgSec,$u,Vn)),j(),Se.position.set(0,0,At.camZ),Se.lookAt(0,0,At.camZ-$s),fe.forEach((Mi,Jn)=>{const ia=q[Jn];ia.uniforms.uOpacity.value=0,ia.uniforms.uWipe.value=1,Mi.visible=!1}),H.opacity=0,I.visible=!1,ve.visible=!1,be.uniforms.uStrength.value=0,js(Ht.lerp(At.startScrollY,At.endScrollY,Fi));let In=0;Vn>np&&(In=as((Vn-np)/Math.max(1e-6,1-np))),u.current&&(u.current.style.setProperty("--intro-ui-opacity","0"),u.current.style.setProperty("--intro-tagline-opacity","0")),we.domElement.style.opacity=String(1-In),document.body.classList.add(qs),we.render(K,Se),Vn>=1&&(Qe=null,Cx(),window.setTimeout(()=>{h.current=!1},100));return}const ce=ge(),Me=document.getElementById("hero"),Le=Me?Me.getBoundingClientRect().top:0,Ge=Me?Oe(Le):!0,{totalPx:Re}=Po(ee),mt=N.getBoundingClientRect(),rt=Math.max(1,N.offsetHeight-ee),zt=Ht.clamp(-mt.top,0,rt);!Ge&&zt<=Re?(de=!1,Math.abs(ce-ee)>tp&&(ee=ce,Ye())):de=!0;const Bt=ee,{cardPx:nn,titlePx:gt,totalPx:St}=Po(Bt),hn=Math.max(1,N.offsetHeight-Bt),Et=Ht.clamp(-mt.top,0,hn),fi=Math.min(Et,St),ta=Math.max(1,St),na=Bt*LS,Ii=Bt*NS,ds=na+Ii,ir=Et-St,ma=as(Ht.clamp(ir/Math.max(1,na),0,1)),Ia=as(Ht.clamp((ir-na)/Math.max(1,Ii),0,1)),Ur=A.clientWidth,Or=A.clientHeight,hs=Math.max(1,gt),di=fi<hs,Bi=di?Ht.clamp(fi/hs,0,1):0,Zo=Math.max(0,fi-hs),ar=Math.max(1,nn),ga=Ht.clamp(Zo/ar,0,1)*(un-1),Pr=uf(Ur,Or),sc=zS(Ur,Or,C.current),ps=di?Ht.lerp(b,B,Bi):J(ga),ms=gC(nn,Bt),rc=_C(hs,Bt),Wn=vC(Bi,rc),_a=un-1,Ir=St+ds;Yt(Ax(Et,hs,nn,St,Ir)),j(),Se.position.set(0,0,ps),Se.lookAt(0,0,ps-$s);const va=St+ds;let Br=0;if(hn>va&&Et>=va){const At=Math.max(1,hn-va);Br=as(Ht.clamp((Et-va)/At,0,1))}const Ko=Math.max(1,ds+Bt*$h),Qo=Et<=ta?Ht.clamp(Et/ta,0,1):1+Ht.clamp(ir/Ko,0,1)*.45;if(MC(Et,hn)){const At=EC(Qo,ps,yC(Ur)),Fi=new _b(At,!1,"centripetal").getSpacedPoints(M3);if(Fi.length>=2){const In=bC(Fi,y3,E3,b3),Mi=ve.geometry.getAttribute("position"),Jn=In.getAttribute("position");if(Mi&&Jn&&Mi.count===Jn.count&&((Hr=ve.geometry.getIndex())==null?void 0:Hr.count)===((oc=In.getIndex())==null?void 0:oc.count)&&Mi&&Jn){Mi.array.set(Jn.array),Mi.needsUpdate=!0;const gs=ve.geometry.getAttribute("normal"),xa=In.getAttribute("normal");gs&&xa&&(gs.array.set(xa.array),gs.needsUpdate=!0);const Jo=ve.geometry.getAttribute("uv"),lc=In.getAttribute("uv");Jo&&lc&&(Jo.array.set(lc.array),Jo.needsUpdate=!0),In.dispose()}else ve.geometry.dispose(),ve.geometry=In;ve.visible=!0;const Gr=di||ga<Ht.clamp(ms,0,.999);ve.renderOrder=Gr?C3:Ex,be.uniforms.uStrength.value=.36*(1-Br*.92)}else ve.visible=!1,be.uniforms.uStrength.value=0}else ve.visible=!1,be.uniforms.uStrength.value=0;const sr=Math.floor((un-1)/2),zr=performance.now(),ff=Ht.clamp(ms,0,.999);for(let At=0;At<un;At++){if(di||ga<=At+1e-5||ga<At+ff){X[At]=-1;continue}X[At]<0&&(ga>=At+1-1e-5?X[At]=zr-Sx:X[At]=zr)}if(fe.forEach((At,Vn)=>{const Fi=-Vn*ua,In=un-1-Vn,Mi=X[In];let Jn=Mi<0?0:as(Ht.clamp((zr-Mi)/Sx,0,1));!di&&In===un-1&&Ia>0&&(Jn=Math.max(Jn,Ia));let{opacity:ia}=xC(ga,In,ms,Jn);di&&Vn===_a&&(ia*=Wn.lastCardOp,Jn=0);let Gr=1,gs=0;!di&&In===un-1&&ia>.02&&ma>0&&(Gr=1-.28*ma,gs=-ua*.32*ma),At.position.set(0,0,Fi+gs),At.scale.setScalar(sc*Gr);const xa=q[Vn];xa.uniforms.uOpacity.value=ia,xa.uniforms.uWipe.value=Jn,xa.depthWrite=ia>=.995&&Jn<.02,At.visible=ia>.003&&Jn<.997,At.renderOrder=Vn<=sr?OS+Vn:A3+(Vn-sr-1)}),I.position.set(0,0,-_a*ua+.05),I.scale.setScalar(Pr),H.opacity=di?Wn.titleOp:0,I.visible=H.opacity>.003,!h.current){g.current?pe=!1:Ge?pe=!0:pe&&Et<St-Bt*.25&&(pe=!1),document.body.classList.toggle(qs,!pe);const At=u.current;At!=null&&At.classList.contains("flow-intro__sticky--exit")&&!Ge&&(At.style.transition="none",At.classList.remove("flow-intro__sticky--exit"),At.offsetWidth,At.style.transition="")}if(!de){const At=ds+Bt*$h+32-xx,Vn=Math.max(Math.ceil(St+At),Math.ceil(Bt*1.08)),Fi=m.current;if(Fi){const In=`${Vn}px`;Fi.style.height!==In&&(Fi.style.height=In)}}const df=1-Br*.96;u.current&&(u.current.style.setProperty("--intro-ui-opacity",String(df)),u.current.style.setProperty("--intro-tagline-opacity","1"));const hf=String(1-Br);we.domElement.style.opacity=hf,we.render(K,Se)}Ue();let _e=0,Pe=0,Ce=!1,Te="page",je=!1,qe=!1,Dt=!1,Tt=0,An=0,Hn=0,$i=!1,Si=!1,fs=0,Oa=window.scrollY,ai={kind:"title"};const vn=8;function Rn(){Pe&&(window.clearTimeout(Pe),Pe=0)}function Gn(){_e&&(cancelAnimationFrame(_e),_e=0),Ce=!1,Te="page",g.current=!1}function Cn(){Gn(),Rn(),je=!1}_.current=Cn;function ci(){var St;const ce=Math.max(1,ee),{cardPx:Me,titlePx:Le,totalPx:Ge}=Po(ce),Re=N.getBoundingClientRect(),mt=Math.max(1,N.offsetHeight-ce),rt=Ht.clamp(-Re.top,0,mt),zt=document.getElementById("hero"),sn=zt?Oe(zt.getBoundingClientRect().top):!0,Bt=((St=u.current)==null?void 0:St.getBoundingClientRect().bottom)??ce,gt=Math.max(0,Math.min(rt,Ge)-Le)/Math.max(1,Me)*(un-1);return{innerH:ce,cardPx:Me,titlePx:Le,totalPx:Ge,scrolledPx:rt,landed:sn,stickyBottom:Bt,depthT:gt}}function Pn(ce=ci()){return hC(ce.scrolledPx,ce.titlePx,ce.cardPx,ce.totalPx,ce.landed,ce.stickyBottom,ce.innerH)}function Pa(){return Ce||Pn()}function pa(ce){let Me=ce.deltaY;return ce.deltaMode===1?Me*=16:ce.deltaMode===2&&(Me*=window.innerHeight),Me}function Ui(){Rn(),je=!0,Pe=window.setTimeout(()=>{Pe=0,je=!1},iC)}function ea(ce,Me){return ce.kind==="title"?uC(N):ce.kind==="card"?fC(N,ce.idx,Me.innerH):Iu()}function ui(ce){if(L||h.current||Ce)return;const Me=ci(),Le=ce.kind==="hero";if(!Le&&!Pn(Me))return;const Ge=ea(ce,Me);if(Ge==null)return;const Re=window.scrollY,mt=Ge-Re;if(ai=ce.kind==="hero"?{kind:"card",idx:un-1}:ce,Math.abs(mt)<FS(Me.innerH)){js(Ge),Ui();return}Ce=!0,Te=Le?"exit":"page",g.current=Le,je=!0;const rt=Le?lC(window.innerWidth):oC(window.innerWidth),zt=performance.now(),sn=nn=>{if(js(nn),Ce=!1,Te="page",_e=0,!Le){g.current=!1,Ui();return}g.current=!1,requestAnimationFrame(()=>{const gt=Iu();gt!=null&&js(gt),requestAnimationFrame(()=>{const St=Iu();St!=null&&js(St),Ui()})})},Bt=nn=>{if(L||h.current){Ce=!1,Te="page",_e=0,g.current=!1;return}if(Te==="page"&&!Pn(ci())){Gn(),je=!1;return}const gt=Math.min(1,(nn-zt)/rt);js(Re+mt*as(gt)),gt<1?_e=requestAnimationFrame(Bt):sn(Ge)};_e=requestAnimationFrame(Bt)}function Oi(ce,Me){const Le=un-1,Ge=Me>0?1:-1,Re=ap(ce.scrolledPx,ce.titlePx,ce.depthT,ce.innerH);if(Re.kind==="title")return Ge<0?null:{kind:"card",idx:0};const mt=Re.idx+Ge;return mt<0?{kind:"title"}:mt>Le?Ge>0?{kind:"hero"}:{kind:"card",idx:Le}:{kind:"card",idx:mt}}function Pi(ce){const Me=ci();if(!Pn(Me)&&!(Ce&&Te==="exit"))return!1;const Le=Oi(Me,ce);return Le===null?!1:(ui(Le),!0)}function _n(ce,Me){return Oi(ce,Me)===null}function nr(ce){if(h.current||Qe){ce.preventDefault();return}if(!Pa())return;const Me=pa(ce),Le=ci();if(!Pn(Le)&&Te!=="exit")return;const Ge=Oi(Le,Me>0?1:-1);if(Ge===null){(Ce||je)&&Cn();return}if(Ce||je){ce.preventDefault();return}if(Math.abs(Me)<tC){ce.preventDefault();return}ce.preventDefault(),ui(Ge)}function R(ce){var Me;if(!(h.current||Qe)&&(An=((Me=ce.touches[0])==null?void 0:Me.clientY)??An,Tt=An,Hn=window.scrollY,qe=!1,Dt=Ce||Pn(),Dt&&!Ce)){const Le=ci();ai=ap(Le.scrolledPx,Le.titlePx,Le.depthT,Le.innerH)}}function Z(ce){var Le;if(h.current||Qe){ce.preventDefault();return}const Me=((Le=ce.touches[0])==null?void 0:Le.clientY)??Tt;if(!qe){if(!Dt&&(Ce||Pn())&&(Dt=!0,An=Me,Tt=Me,Hn=window.scrollY),!Dt)return;const Ge=An-Me;if(Math.abs(Ge)<vn){Tt=Me;return}const Re=Ge>0?1:-1,mt=ci();if(!Ce&&!Pn(mt)){Dt=!1,Tt=Me;return}if(_n(mt,Re)){Dt=!1,Cn(),Tt=Me;return}Ce&&Cn(),qe=!0,Dt=!1,Hn=window.scrollY,ai=ap(mt.scrolledPx,mt.titlePx,mt.depthT,mt.innerH)}ce.preventDefault(),Tt=Me,Ce||js(Hn)}function oe(){if(h.current||Qe){qe=!1,Dt=!1;return}const ce=qe,Me=Dt,Le=An-Tt;if(qe=!1,Dt=!1,Ce)return;if(!ce){Me&&Cn();return}if(!Pn())return;if(Math.abs(Le)<nC){ui(ai);return}const Ge=Le>0?1:-1,Re=ci();if(_n(Re,Ge)){Cn();return}Pi(Ge)}function ie(ce){ce.pointerType!=="touch"&&ce.button===0&&($i=!0,Si=!1,fs=window.scrollY,Pn()&&Gn())}function ae(ce){if(ce.pointerType==="touch"||!$i)return;if($i=!1,!Si||!Pn()){Si=!1;return}const Me=ci(),Le=window.scrollY>=fs?1:-1,Ge=Oi(Me,Le);if(Si=!1,Ge===null){Cn();return}ui(Ge)}function Ve(ce){ce.pointerType!=="touch"&&($i=!1,Si=!1)}function Ze(ce){ce.button===0&&(h.current||Qe||Si||Ce||je||Pn()&&(ce.preventDefault(),Pi(1)))}function ze(ce){var Re;const Me=ce.target;if((Re=Me==null?void 0:Me.closest)!=null&&Re.call(Me,"input, textarea, select, [contenteditable=true]"))return;if(h.current||Qe){(ce.key==="ArrowDown"||ce.key==="ArrowRight"||ce.key==="ArrowUp"||ce.key==="ArrowLeft"||ce.key==="Enter"||ce.key===" ")&&ce.preventDefault();return}const Le=ce.key==="ArrowDown"||ce.key==="ArrowRight"||ce.key==="Enter"||ce.key===" ",Ge=ce.key==="ArrowUp"||ce.key==="ArrowLeft";if(!(!Le&&!Ge)){if(Ce||je){ce.preventDefault();return}Pn()&&(ce.preventDefault(),Pi(Le?1:-1))}}function Je(){const ce=window.scrollY,Me=ce-Oa;Oa=ce,$i&&Math.abs(Me)>.5&&(Si=!0),Ce&&Te==="page"&&!Pn()&&Cn()}function Ke(){Cn(),it()}function at(){Cn();const ce=ge(),Me=window.innerWidth,Le=Math.abs(ce-ee),Ge=Math.abs(Me-De)>1;if(de){Le>tp||Ge?it():Be();return}ee=ce,De=Me,Be()}function ft(){Cn();const ce=ge();Math.abs(ce-ee)<=tp||(de?it():(ee=ce,De=window.innerWidth,Be()))}window.addEventListener("wheel",nr,{passive:!1}),window.addEventListener("touchstart",R,{passive:!0}),window.addEventListener("touchmove",Z,{passive:!1}),window.addEventListener("touchend",oe,{passive:!0}),window.addEventListener("touchcancel",oe,{passive:!0}),window.addEventListener("pointerdown",ie,{passive:!0}),window.addEventListener("pointerup",ae,{passive:!0}),window.addEventListener("pointercancel",Ve,{passive:!0}),window.addEventListener("scroll",Je,{passive:!0}),window.addEventListener("resize",at,{passive:!0}),window.addEventListener("orientationchange",Ke,{passive:!0}),A.addEventListener("click",Ze),window.addEventListener("keydown",ze);const et=window.visualViewport;et&&et.addEventListener("resize",ft);const Ut=new ResizeObserver(Be);Ut.observe(A),T=()=>{var ce;Cn(),_.current=null,v.current=null,Qe=null,cancelAnimationFrame(Y),document.body.classList.remove(qs),window.removeEventListener("wheel",nr),window.removeEventListener("touchstart",R),window.removeEventListener("touchmove",Z),window.removeEventListener("touchend",oe),window.removeEventListener("touchcancel",oe),window.removeEventListener("pointerdown",ie),window.removeEventListener("pointerup",ae),window.removeEventListener("pointercancel",Ve),window.removeEventListener("scroll",Je),window.removeEventListener("resize",at),window.removeEventListener("orientationchange",Ke),A.removeEventListener("click",Ze),window.removeEventListener("keydown",ze),et&&et.removeEventListener("resize",ft),Ut.disconnect(),q.forEach(Me=>{Me.dispose()}),ue.forEach(Me=>Me.dispose()),(ce=H.map)==null||ce.dispose(),H.dispose(),fe.forEach(Me=>Me.geometry.dispose()),I.geometry.dispose(),ve.geometry.dispose(),be.dispose(),K.remove(ve),Xe&&(Se.remove(Xe),Xe.geometry.dispose()),nt==null||nt.dispose(),Ie==null||Ie.dispose(),Zt.cancel(),we.dispose(),A.contains(we.domElement)&&A.removeChild(we.domElement)},L&&T()})(),()=>{var U;L=!0,(U=_.current)==null||U.call(_),_.current=null,v.current=null,document.body.classList.remove(qs),T==null||T()}},[]),D.jsxs("section",{ref:c,id:"flow",className:"flow-intro","aria-label":"Morpheum — Discover, Copy, Supervise, Isolate",children:[D.jsxs("div",{ref:u,className:"flow-intro__sticky",children:[D.jsx("div",{ref:d,className:"flow-intro__canvas","aria-hidden":!0}),D.jsxs("div",{className:"flow-intro__top",children:[D.jsx("div",{className:"flow-intro__brand",children:D.jsx(pm,{size:"sm",brandName:"Morpheum",className:"flow-intro__brand-mark"})}),D.jsxs("button",{type:"button",className:"flow-intro__skip",onClick:x,children:["Skip ",D.jsx("span",{className:"flow-intro__skip-key",children:"Esc"})]})]}),D.jsx("div",{className:"flow-intro__tagline-wrap",children:D.jsx(r3,{text:o3,className:"flow-intro__tagline",scrollerRef:c,effect:o})}),D.jsx("div",{className:"flow-intro__sr","aria-live":"polite",children:jl.map((O,P)=>D.jsxs("p",{children:["Step ",String(P+1).padStart(2,"0"),": ",O.verb,". ",O.description]},O.verb))})]}),D.jsx("div",{ref:m,className:"flow-intro__spacer","aria-hidden":!0})]})}const AC=280,RC=5/4,CC=3800,wC={discover:ql,copy:WR};function DC(){return typeof window<"u"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function LC({stepIndex:a,kind:e,className:i,width:r=AC}){const o=ke.useRef(null),c=e??AS(a),u=Math.round(r*RC);return ke.useEffect(()=>{const d=o.current;if(!d)return;let m=0,h;const g=()=>{const S=Math.min(window.devicePixelRatio||1,2),E=Math.round(r*S),C=Math.round(u*S);(d.width!==E||d.height!==C)&&(d.width=E,d.height=C);const y=d.getContext("2d");y&&KR(y,c,E,C,m)};g();const _=wC[c];_&&_>1&&!DC()&&(h=setInterval(()=>{m=(m+1)%_,g()},CC));const v=()=>g();return window.addEventListener("resize",v),()=>{window.removeEventListener("resize",v),h&&clearInterval(h)}},[c,r,u]),D.jsx("div",{className:["loop-step-sheet",i].filter(Boolean).join(" "),style:{width:r,height:u},children:D.jsx("canvas",{ref:o,className:"loop-step-sheet__canvas",style:{width:r,height:u},"aria-hidden":!0})})}const Nx=[{id:"want-eth",agent:"SharpeShark",timestamp:"2026-07-08T15:42:00.000Z",timeLabel:"07-08, 15:42:00",status:"want-to",statusLabel:"Want to",action:"Open ETH long · 1.2 ETH",showActions:!0},{id:"rejected-btc",agent:"NightOwl",timestamp:"2026-07-08T15:31:00.000Z",timeLabel:"07-08, 15:31:00",status:"rejected",statusLabel:"Rejected",action:"Open BTC short · 0.04 BTC"},{id:"close-btc-profit",agent:"SharpeShark",timestamp:"2026-07-08T15:25:00.000Z",timeLabel:"07-08, 15:25:00",status:"short",statusLabel:"Close Long",action:"BTCUSDT · 0.04 BTC · 2,465.12 USDT",pnl:{text:"+103.09",tone:"long"}},{id:"open-eth-long",agent:"FluxRunner",timestamp:"2026-07-08T14:10:00.000Z",timeLabel:"07-08, 14:10:00",status:"long",statusLabel:"Open Long",action:"ETHUSDT · 0.8 ETH · 2,560.00 USDT"},{id:"open-sol-short",agent:"NightOwl",timestamp:"2026-07-07T09:42:00.000Z",timeLabel:"07-07, 09:42:00",status:"short",statusLabel:"Open Short",action:"SOLUSDT · 12 SOL · 1,824.00 USDT"}];function NC(){return D.jsxs("aside",{className:"supervise-log","aria-label":"Agent activity log",children:[D.jsx("header",{className:"supervise-log__header",children:D.jsx("span",{className:"supervise-log__kicker",children:"Activity log"})}),D.jsx("ol",{className:"supervise-log__timeline",children:Nx.map((a,e)=>{const i=e===Nx.length-1,r=e===0;return D.jsxs("li",{className:"supervise-log__item",children:[D.jsxs("div",{className:"supervise-log__meta",children:[D.jsx("span",{className:"supervise-log__agent",children:a.agent}),D.jsx("time",{className:"supervise-log__time",dateTime:a.timestamp,children:a.timeLabel})]}),D.jsxs("div",{className:"supervise-log__track","aria-hidden":!0,children:[i?null:D.jsx("span",{className:"supervise-log__track-line"}),D.jsx("span",{className:["supervise-log__dot",r?"supervise-log__dot--latest":""].filter(Boolean).join(" ")})]}),D.jsxs("div",{className:"supervise-log__body",children:[D.jsx("span",{className:`supervise-log__badge supervise-log__badge--${a.status}`,children:a.statusLabel}),D.jsxs("p",{className:"supervise-log__action",children:[a.action,a.pnl?D.jsxs(D.Fragment,{children:[" · ",D.jsx("span",{className:`supervise-log__pnl supervise-log__pnl--${a.pnl.tone}`,children:a.pnl.text})]}):null]}),a.showActions?D.jsxs("div",{className:"supervise-log__actions",children:[D.jsx("button",{type:"button",className:"supervise-log__btn supervise-log__btn--reject",children:"Reject"}),D.jsx("button",{type:"button",className:"supervise-log__btn supervise-log__btn--approve",children:"Approve"})]}):null]})]},a.id)})})]})}const UC=/^(action)$/i;function OC(a){return a.split(/(\s*[·/]\s*)/).map((i,r)=>UC.test(i.trim())?D.jsx("span",{className:"stat-chip__brand",children:i},r):D.jsx("span",{children:i},r))}function HS({label:a,status:e,live:i}){return D.jsxs("span",{className:`stat-chip ${i?"stat-chip--live":""}`,children:[D.jsx("span",{className:"stat-chip__label",children:a}),D.jsx("span",{className:"stat-chip__sep",children:"·"}),D.jsx("span",{className:"stat-chip__status",children:OC(e)})]})}var PC=kx();function IC(a,e,i=!1){a.style.fontFamily=e.fontFamily,a.style.fontSize=e.fontSize,a.style.fontWeight=e.fontWeight,a.style.letterSpacing=e.letterSpacing,a.style.lineHeight=e.lineHeight,a.style.textTransform=e.textTransform,a.style.whiteSpace=i?"nowrap":"normal",a.style.wordBreak=i?"normal":"break-word"}function BC(a,e,i,r){const o=getComputedStyle(i),c=document.createElement("div");c.style.position="fixed",c.style.left="-99999px",c.style.top="0",c.style.visibility="hidden",c.style.pointerEvents="none",c.style.width=`${e}px`,IC(c,o,!r);const u=document.createTextNode(a);return c.appendChild(u),document.body.appendChild(c),{probe:c,textNode:u}}function Ux(a,e,i,r=!0){if(!a)return{lines:[],blockHeight:0};if(e<=0)return{lines:[a],blockHeight:0};const{probe:o,textNode:c}=BC(a,e,i,r),u=o.offsetHeight;if(!r)return document.body.removeChild(o),{lines:[a],blockHeight:u};const d=document.createRange(),m=[];let h=0,g=0;for(let _=1;_<=a.length;_++){d.setStart(c,0),d.setEnd(c,_);const v=d.getClientRects().length;v>g&&g>0&&(m.push(a.slice(h,_-1)),h=_-1),g=v}return h<a.length&&m.push(a.slice(h)),document.body.removeChild(o),{lines:m.length>0?m:[a],blockHeight:u}}const FC=40,zC=5,HC="typewriter-reveal",Ox=1e3,GC=4e3;function Px(){return Ox+Math.random()*(GC-Ox)}function GS(){return typeof window>"u"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches}function VC({text:a,content:e,speed:i,cursorWidth:r,active:o,waiting:c,completed:u,holdCursor:d=!1,onComplete:m}){const h=ke.useRef(null),g=ke.useRef(m),_=ke.useRef(null),v=ke.useRef(null),S=ke.useRef(null),E=ke.useRef("idle"),[C,y]=ke.useState("idle");g.current=m;const x=ke.useCallback(()=>{_.current&&(clearTimeout(_.current),_.current=null)},[]),O=ke.useCallback(()=>{var U;x(),v.current=null,S.current=null,E.current="complete",y("complete"),(U=g.current)==null||U.call(g)},[x]),P=ke.useCallback(U=>{x(),v.current=Date.now()+U,_.current=setTimeout(O,U)},[x,O]);ke.useLayoutEffect(()=>{E.current="idle",y("idle"),S.current=null,v.current=null,x()},[a,i,r,x]),ke.useLayoutEffect(()=>{var H,$,me;if(c||u||E.current==="complete")return;if(!o){E.current==="cursor-hold"&&_.current&&v.current!=null&&(x(),S.current=Math.max(0,v.current-Date.now()),v.current=null);return}if(E.current==="cursor-hold"&&!_.current){const ye=S.current??Px();S.current=null,P(ye);return}if(E.current==="animating"||E.current==="cursor-hold")return;if(GS()){(H=g.current)==null||H.call(g);return}const U=h.current;if(!U||!a){($=g.current)==null||$.call(g);return}U.style.width="",U.offsetWidth;const k=Math.max(a.length/i*1e3,120),G=Math.max(a.length,1),q=U.closest(".typewriter-block"),fe=(q==null?void 0:q.clientWidth)??((me=U.parentElement)==null?void 0:me.clientWidth)??0;U.style.whiteSpace="nowrap",U.style.width="auto";const ue=U.scrollWidth,X=fe>0?Math.min(ue,fe):ue;U.style.width="0",U.style.setProperty("--tw-duration",`${k}ms`),U.style.setProperty("--tw-target-width",`${X}px`),U.style.setProperty("--tw-steps",String(G)),U.style.setProperty("--tw-cursor-width",`${r}px`),U.offsetWidth,E.current="animating",y("animating");const z=ye=>{if(ye.animationName===HC){if(d){U.style.width=`${X}px`,E.current="cursor-hold",y("cursor-hold"),P(Px());return}U.style.width="",O()}};return U.addEventListener("animationend",z),()=>{U.removeEventListener("animationend",z)}},[o,u,O,d,P,i,a,c,x,r]);const A=C==="animating",N=C==="cursor-hold",L=C==="complete",T=["typewriter","typewriter-line",c?"is-waiting":"",A?"is-animating":"",N?"is-cursor-hold":"",u||L?"is-complete":"",!o&&!c&&!u&&!L&&(A||N)?"is-paused":""].filter(Boolean).join(" ");return D.jsx("span",{ref:h,className:T,children:e??a})}function vm({text:a,children:e,className:i,speed:r=FC,cursorWidth:o=zC,multiline:c="auto",active:u=!0,holdCursor:d=!0,onComplete:m}){const h=ke.useRef(null),g=ke.useRef(m),[_,v]=ke.useState([]),[S,E]=ke.useState(0),[C,y]=ke.useState(0),[x,O]=ke.useState(!1),[P,A]=ke.useState(!1),N=GS();g.current=m;const L=ke.useCallback(()=>{const ue=h.current;if(!ue||!a)return v([]),E(0),A(!0),!0;const X=ue.clientWidth;if(X<1)return!1;const H=(c==="auto"||c===!0)&&!N,{lines:$,blockHeight:me}=Ux(a,X,ue,H);let ye=me;if(!H){const I=Ux(a,X,ue,!0);ye=Math.max(me,I.blockHeight)}return v($),E(ye),A(!0),!0},[a,c,N]);ke.useLayoutEffect(()=>{var ue,X;if(y(0),O(!1),A(!1),v([]),E(0),N){(ue=g.current)==null||ue.call(g),A(!0);return}if(!a){(X=g.current)==null||X.call(g),A(!0);return}if(!L()){const z=new ResizeObserver(()=>{L()&&z.disconnect()});return h.current&&z.observe(h.current),()=>z.disconnect()}},[a,c,L,N]);const F=ke.useCallback(ue=>{var z;const X=ue>=_.length-1;PC.flushSync(()=>{if(!X){y(ue+1);return}O(!0)}),X&&((z=g.current)==null||z.call(g))},[_]),U=["typewriter-block",_.length>1?"typewriter-lines":"typewriter-host",i??"",x?"is-complete":"",P?"":"is-measuring",N?"is-static":""].filter(Boolean).join(" "),k={...!x&&!N&&S>0?{height:S,minHeight:S}:void 0},G=e??a;if(!P)return D.jsx("span",{ref:h,className:U,style:k,children:G});if(N||!a)return D.jsx("span",{ref:h,className:["typewriter","is-static",i??""].filter(Boolean).join(" "),children:G});if(x)return D.jsx("span",{ref:h,className:["typewriter-block","typewriter-host","is-complete",i??""].filter(Boolean).join(" "),children:G});const q=_.length>0?_:[a],fe=!!e&&q.length<=1;return D.jsxs("span",{ref:h,className:U,style:k,"aria-label":a,children:[D.jsx("span",{className:"typewriter-ghost","aria-hidden":!0,children:G}),D.jsx("span",{className:"typewriter-overlay","aria-hidden":!0,children:q.map((ue,X)=>D.jsx(VC,{text:ue,content:fe?e:void 0,speed:r,cursorWidth:o,waiting:X>C,active:u&&X===C,completed:X<C,holdCursor:d&&X===q.length-1,onComplete:X===C?()=>F(X):void 0},`${X}-${ue}`))})]})}function kC(){return typeof window<"u"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function xm(a,e){const i=(e==null?void 0:e.amount)??.2,[r,o]=ke.useState(!1);return ke.useLayoutEffect(()=>{if(r)return;if(kC()){o(!0);return}const c=a.current;if(!c)return;const u=new IntersectionObserver(d=>{for(const m of d)if(m.isIntersecting&&m.intersectionRatio>=Math.min(i,1)){o(!0),u.disconnect();return}},{root:null,threshold:[0,i,Math.min(i+.15,1),1],rootMargin:"0px"});return u.observe(c),()=>u.disconnect()},[i,r,a]),r}function XC(a){return String(a).padStart(2,"0")}function ef(){return typeof window<"u"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}const WC=1600,YC=1500,Ix=5e3,qC=7e3;function jC(){return Ix+Math.random()*(qC-Ix)}function ZC({text:a,active:e}){const[i,r]=ke.useState(!1),[o,c]=ke.useState(0),u=ke.useRef(null),d=`> ${a}`,m=ke.useCallback(()=>{u.current&&(clearTimeout(u.current),u.current=null)},[]);ke.useLayoutEffect(()=>{if(m(),!e){r(!1),c(0);return}if(ef()){r(!0);return}const g=window.setTimeout(()=>r(!0),YC);return()=>{window.clearTimeout(g),m()}},[e,m]);const h=ke.useCallback(()=>{ef()||(m(),u.current=setTimeout(()=>{u.current=null,c(g=>g+1)},jC()))},[m]);return D.jsx("p",{className:"flow-step__example",children:i?D.jsx(vm,{text:d,className:"flow-step__example-type",speed:42,multiline:"auto",active:!0,holdCursor:!0,onComplete:h},o):D.jsx("span",{className:"flow-step__example-type","aria-hidden":!0,children:d})})}function KC(){const[a,e]=ke.useState(()=>new Set),[i,r]=ke.useState(!1),o=ke.useRef(new Map),c=ke.useRef(null),u=xm(c,{amount:.35}),d=Hs.steps.every(_=>a.has(`step-${_.n}`));ke.useLayoutEffect(()=>{if(ef()){e(new Set(Hs.steps.map(v=>`step-${v.n}`))),r(!0);return}const _=new IntersectionObserver(v=>{e(S=>{const E=new Set(S);for(const C of v){const y=C.target.dataset.flowKey;y&&C.isIntersecting&&E.add(y)}return E})},{root:null,threshold:[0,.01,.08,.15,.25],rootMargin:"-42% 0px -42% 0px"});for(const v of o.current.values())_.observe(v);return()=>{_.disconnect()}},[]),ke.useLayoutEffect(()=>{if(ef())return;if(!d){r(!1);return}const _=window.setTimeout(()=>{r(!0)},WC);return()=>window.clearTimeout(_)},[d]);const m=ke.useCallback((_,v)=>{v?o.current.set(_,v):o.current.delete(_)},[]),h=ke.useCallback(_=>{e(v=>new Set(v).add(_))},[]),g=u&&i;return D.jsx("section",{id:"how",className:"section flow",children:D.jsxs("div",{className:"container",children:[D.jsx("p",{className:"section-kicker",children:Hs.kicker}),D.jsx("h2",{className:"section-title flow__title",children:Hs.title}),D.jsx("div",{className:"flow__chips",children:Hs.chips.map(_=>D.jsx(HS,{label:_.label,status:_.value},_.label))}),D.jsx("div",{className:"flow__steps",role:"list",children:Hs.steps.map((_,v)=>{const S=`step-${_.n}`,E=a.has(S);return D.jsxs("article",{ref:C=>m(S,C),"data-flow-key":S,role:"listitem",className:`flow-step${E?" flow-step--expanded":""}`,"aria-expanded":E,children:[D.jsxs("button",{type:"button",className:"flow-step__head",onClick:()=>h(S),"aria-label":E?`${_.title}, expanded`:`${_.title}, tap to expand`,children:[D.jsxs("span",{className:"flow-step__idx",children:["Step ",XC(_.n)]}),D.jsx("h3",{className:"flow-step__title",children:_.title}),D.jsx("span",{className:"flow-step__chevron","aria-hidden":!0,children:E?"−":"+"})]}),D.jsx("div",{className:"flow-step__expand","aria-hidden":!E,children:D.jsx("div",{className:"flow-step__expand-inner",children:D.jsxs("div",{className:`flow-step__split${v===2?" flow-step__split--supervise":""}`,children:[D.jsx("p",{className:"flow-step__meta",children:_.feature}),D.jsxs("div",{className:"flow-step__copy",children:[D.jsx("p",{className:"flow-step__detail",children:_.body}),D.jsx(ZC,{text:_.example,active:E}),D.jsx("div",{className:"flow-step__actions",children:D.jsx("a",{href:On.explore,className:"flow-step__open","aria-label":`Explore after ${_.title}`,children:D.jsx("span",{"aria-hidden":!0,className:"flow-step__open-arrow",children:"→"})})})]}),D.jsx("div",{className:`flow-step__sheet${v===2?" flow-step__sheet--log":""}`,"aria-hidden":!E,children:E?v===2?D.jsx(NC,{}):D.jsx(LC,{stepIndex:v,width:280}):null})]})})})]},S)})}),D.jsx("p",{ref:c,className:"flow__outcome",children:g?D.jsx(vm,{text:Hs.outcome,className:"flow__outcome-type",speed:42,multiline:"auto",active:!0,holdCursor:!0}):D.jsx("span",{className:"flow__outcome-type","aria-hidden":!0,children:Hs.outcome})})]})})}function QC(){return D.jsx("footer",{className:"site-footer",children:D.jsxs("div",{className:"container site-footer__inner",children:[D.jsxs("div",{className:"site-footer__brand",children:[D.jsx("a",{className:"site-footer__logo",href:"#hero","aria-label":"Morpheum home",children:D.jsx(pm,{size:"sm"})}),D.jsx("p",{className:"site-footer__legal",children:cv.legal})]}),D.jsxs("div",{className:"site-footer__meta",children:[D.jsxs("nav",{className:"site-footer__nav","aria-label":"Footer",children:[Bu.map(a=>D.jsx("a",{href:a.href,children:a.label},a.id)),D.jsx("a",{href:On.docs,children:"Docs"}),D.jsx("a",{href:On.manifesto,children:"Manifesto"}),D.jsx("a",{href:On.discord,children:"Discord"}),D.jsx("a",{href:On.x,children:"X"})]}),D.jsx("div",{className:"site-footer__labels","aria-label":"Protocol",children:cv.labels.map(a=>D.jsx("span",{className:"site-footer__label",children:a},a))})]})]})})}const Bx="!@#$%^&*()_+{}[]|;:,.<>?/0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ",VS=50,Fx=3500,zx=4e3,JC=1400,$C=1200,ew=4500;function kS(){return typeof window>"u"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Hx(a){return/[A-Za-z0-9]/.test(a)}function tw(){return Bx[Math.floor(Math.random()*Bx.length)]??"?"}function nw(a){return Math.random()<.5?tw():a}function XS(a,e,i){const r=[];for(let h=0;h<a.length;h++)Hx(a[h]??"")&&r.push(h);const o=r.length,c=o===0?1:Math.min(e/i,1),u=Math.floor(c*o),d=new Set(r.slice(0,u));let m="";for(let h=0;h<a.length;h++){const g=a[h]??"";!Hx(g)||d.has(h)?m+=g:m+=nw(g)}return m}function iw(a){return typeof a=="boolean"?{enabled:a,decryptMs:Fx,pauseMs:zx}:{enabled:a.enabled??!0,decryptMs:a.decryptMs??Fx,pauseMs:a.pauseMs??zx}}function Kn(a,e=!0){const{enabled:i,decryptMs:r,pauseMs:o}=iw(e),c=r+o,[u,d]=ke.useState(a);return ke.useEffect(()=>{if(!i||kS()){d(a);return}let m=Date.now();const h=()=>{const _=Date.now();let v=_-m;v>=c&&(m=_,v=0),d(XS(a,v,r))};h();const g=setInterval(h,VS);return()=>{clearInterval(g)}},[a,i,r,c]),u}function Gx(a,e={}){const i=e.enabled??!0,r=e.stepDelayMs??JC,o=e.stepDecryptMs??$C,c=e.holdMs??ew,u=a.join("\0"),[d,m]=ke.useState(a),[h,g]=ke.useState(()=>a.map(()=>!1));return ke.useEffect(()=>{const _=u.length>0?u.split("\0"):[];if(!i||kS()||_.length===0){m(_),g(_.map(()=>!0));return}const S=(_.length-1)*r+o+c;let E=Date.now();const C=()=>{const x=Date.now();let O=x-E;O>=S&&(E=x,O=0);const P=[],A=[];for(let N=0;N<_.length;N++){const L=_[N]??"",F=N*r,T=O>=F;if(A.push(T),!T){P.push(L);continue}const U=O-F;P.push(XS(L,U,o))}m(P),g(A)};C();const y=setInterval(C,VS);return()=>{clearInterval(y)}},[u,i,r,o,c]),{displays:d,started:h}}function aw(){const a=[...lv,...lv];return D.jsx("div",{className:"marquee","aria-label":"Live status",children:D.jsx("div",{className:"marquee__viewport",children:D.jsx("div",{className:"marquee__track",children:a.map((e,i)=>D.jsx(HS,{label:e.label,status:e.status,live:"live"in e?e.live:!1},`${e.label}-${i}`))})})})}function sw({showGrid:a=!1,maskAlpha:e=.72,contentOffsetY:i=-50}){const[r,o]=zs.headline,c=Kn(zs.eyebrow.label),u=Math.min(1,Math.max(0,e));return D.jsxs("section",{id:"hero",className:"hero","aria-labelledby":"hero-heading",children:[D.jsx("video",{className:"hero__video",autoPlay:!0,muted:!0,loop:!0,playsInline:!0,"aria-hidden":!0,children:D.jsx("source",{src:"/Morm_IntroAnimation_2.mp4",type:"video/mp4"})}),D.jsx("div",{className:"hero__video-mask",style:{"--hero-mask-alpha":u},"aria-hidden":!0}),D.jsx("div",{className:"hero__atmosphere","aria-hidden":!0}),a?D.jsx("div",{className:"hero__grid","aria-hidden":!0}):null,D.jsx("div",{className:"hero__logo-anim","aria-hidden":!0,children:D.jsxs("svg",{className:"hero__logo-anim-svg",viewBox:JR,fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[D.jsx("g",{className:"hero__logo-anim-ghost",children:Kp.map(d=>D.jsx("path",{d,fill:"#C8F5A8"},`ghost-${d.slice(0,24)}`))}),D.jsx("g",{className:"hero__logo-anim-fill",children:Kp.map(d=>D.jsx("path",{d,fill:"#C8F5A8"},`fill-${d.slice(0,24)}`))})]})}),D.jsx("div",{className:"hero__scanlines","aria-hidden":!0}),D.jsx("div",{className:"hero__grain","aria-hidden":!0}),D.jsx("div",{className:"hero__veil","aria-hidden":!0}),D.jsxs("div",{className:"container hero__content",style:{"--hero-content-offset-y":`${i}px`},children:[D.jsxs("a",{className:"hero__eyebrow hero__eyebrow--matrix",href:zs.eyebrow.href,"aria-label":`${zs.eyebrow.label}›`,children:[c,D.jsx("span",{className:"hero__eyebrow-chevron","aria-hidden":!0,children:"›"})]}),D.jsxs("h1",{id:"hero-heading",className:"hero__headline",children:[D.jsx("span",{className:"hero__line hero__line--lead",children:r}),D.jsx("span",{className:"hero__line hero__line--punch",children:o})]}),D.jsxs("div",{className:"hero__ctas",children:[D.jsx(Ho,{href:zs.primaryCta.href,variant:"primary",children:zs.primaryCta.label}),D.jsx(Ho,{href:zs.secondaryCta.href,variant:"secondary",children:zs.secondaryCta.label})]})]}),D.jsx(aw,{})]})}function rw(){const a=Kn(ph.text);return D.jsx("div",{className:"manifesto-strip",children:D.jsx("a",{className:"manifesto-strip__link manifesto-strip__link--matrix",href:ph.href,"aria-label":ph.text,children:a})})}const li={decryptMs:2800,pauseMs:5200},Vx={stepDelayMs:1400,stepDecryptMs:1200,holdMs:4500};function WS(a){return String(a+1).padStart(2,"0")}function ow(a,e,i,r){return`${WS(a)}  ${e}  ·  ${i}  ·  ${r}`}function lw(a,e,i){return`${WS(a)}  ${e}  ·  ${i}`}function cw(a){return!a.from||!a.to||!a.asset||!a.amt?null:`${a.from} → ${a.to} · ${a.asset} ${a.amt}`}function vi({label:a,value:e,display:i}){return D.jsxs("div",{className:"persona-card__meta-row",children:[D.jsx("span",{className:"terminal-label",children:a}),D.jsx("span",{className:"terminal-value persona-card__meta-value persona-card__meta-value--matrix","aria-label":e,children:i})]})}function fn({value:a,display:e,className:i="terminal-value persona-card__meta-value persona-card__meta-value--matrix",hidden:r=!1}){return D.jsx("p",{className:i,"aria-label":a,"aria-hidden":r||void 0,"data-pending":r?"true":void 0,children:e})}function uw({meta:a}){const e=Kn(a.name,li),i=Kn(a.tx,li),r=Kn(a.hash,li),o=Kn(a.chain,li),c=Kn(a.verified,li),u=Kn(a.rep,li),d=Kn(a.portable,li),m=Kn(a.next,li),h=`tx ${a.tx}`,g=`tx ${i}`,_=`did · ${a.name}`,v=`identity · ${e}`,S=`hash ${a.hash}`,E=`hash ${r}`,C=`chain ${a.chain}`,y=`chain ${o}`,x=`verified ${a.verified} · rep ${a.rep} · portable ${a.portable}`,O=`verified ${c} · rep ${u} · portable ${d}`,P=`next ${a.next}`,A=`next ${m}`,N=`rep ${a.rep} · portable ${a.portable}`,L=`rep ${u} · portable ${d}`,F=`verified ${a.verified}`,T=`verified ${c}`;return D.jsxs("div",{className:"persona-card__meta persona-card__meta--identity",children:[D.jsx("p",{className:"persona-card__meta-kind terminal-label",children:"become an operator"}),D.jsx("p",{className:"terminal-label",children:"on-chain transaction"}),D.jsxs("div",{className:"persona-card__meta-rows",children:[D.jsx(vi,{label:"tx",value:a.tx,display:i}),D.jsx(vi,{label:"hash",value:a.hash,display:r}),D.jsx(vi,{label:"chain",value:a.chain,display:o}),D.jsx(vi,{label:"verified",value:a.verified,display:c}),D.jsx(vi,{label:"rep",value:a.rep,display:u}),D.jsx(vi,{label:"portable",value:a.portable,display:d}),D.jsx(vi,{label:"next",value:a.next,display:m})]}),D.jsxs("div",{className:"persona-card__meta-compact",children:[D.jsx(fn,{value:h,display:g}),D.jsx(fn,{value:_,display:v,className:"terminal-value persona-card__meta-value--matrix"}),D.jsx(fn,{value:S,display:E}),D.jsx(fn,{value:C,display:y}),D.jsx(fn,{value:x,display:O}),D.jsx(fn,{value:P,display:A})]}),D.jsxs("div",{className:"persona-card__meta-xxs",children:[D.jsx(fn,{value:h,display:g}),D.jsx(fn,{value:a.name,display:e,className:"terminal-value persona-card__meta-value--matrix"}),D.jsx(fn,{value:S,display:E}),D.jsx(fn,{value:C,display:y}),D.jsx(fn,{value:F,display:T}),D.jsx(fn,{value:N,display:L}),D.jsx(fn,{value:P,display:A})]})]})}function fw({meta:a}){const e=Kn(a.tx,li),i=Kn(a.from,li),r=Kn(a.to,li),o=Kn(a.asset,li),c=Kn(a.amt,li),u=Kn(a.chain,li),d=Kn(a.status,li),m=`${a.from} → ${a.to}`,h=`${i} → ${r}`,g=`tx ${a.tx}`,_=`tx ${e}`,v=`${a.asset} ${a.amt} · ${a.chain}`,S=`${o} ${c} · ${u}`,E=`${a.asset} ${a.amt}`,C=`${o} ${c}`,y=`status ${a.status}`,x=`status ${d}`;return D.jsxs("div",{className:"persona-card__meta persona-card__meta--community",children:[D.jsx("p",{className:"persona-card__meta-kind terminal-label",children:a.label}),D.jsxs("div",{className:"persona-card__meta-rows",children:[D.jsx(vi,{label:"tx",value:a.tx,display:e}),D.jsx(vi,{label:"from",value:a.from,display:i}),D.jsx(vi,{label:"to",value:a.to,display:r}),D.jsx(vi,{label:"asset",value:a.asset,display:o}),D.jsx(vi,{label:"amt",value:a.amt,display:c}),D.jsx(vi,{label:"chain",value:a.chain,display:u}),D.jsx(vi,{label:"status",value:a.status,display:d})]}),D.jsxs("div",{className:"persona-card__meta-compact",children:[D.jsx("p",{className:"terminal-label",children:a.label}),D.jsx(fn,{value:g,display:_}),D.jsx(fn,{value:m,display:h}),D.jsx(fn,{value:v,display:S}),D.jsx(fn,{value:y,display:x})]}),D.jsxs("div",{className:"persona-card__meta-xxs",children:[D.jsx("p",{className:"terminal-label",children:a.label}),D.jsx(fn,{value:g,display:_}),D.jsx(fn,{value:m,display:h}),D.jsx(fn,{value:E,display:C}),D.jsx(fn,{value:a.chain,display:u}),D.jsx(fn,{value:y,display:x})]})]})}function dw({meta:a}){const e=ke.useRef(null),i=xm(e,{amount:.15}),r=a.steps.find(h=>h.from&&h.to&&h.asset&&h.amt),o=r?cw(r):null,c=ke.useMemo(()=>{const h=a.steps.map((g,_)=>ow(_,g.op,g.tx,g.status));return o&&h.push(o),h.push(a.chain),h},[a.steps,a.chain,o]),u=ke.useMemo(()=>{const h=a.steps.map((g,_)=>lw(_,g.op,g.tx));return o&&h.push(o),h},[a.steps,o]),d=Gx(c,{...Vx,enabled:i}),m=Gx(u,{...Vx,enabled:i});return D.jsxs("div",{ref:e,className:"persona-card__meta persona-card__meta--chain",children:[D.jsx("p",{className:"persona-card__meta-kind terminal-label",children:a.label}),D.jsx("div",{className:"persona-card__meta-rows",children:c.map((h,g)=>D.jsx(fn,{value:h,display:d.displays[g]??h,hidden:!(d.started[g]??!0)},`rows-${h}`))}),D.jsxs("div",{className:"persona-card__meta-compact",children:[D.jsx("p",{className:"terminal-label",children:a.label}),c.map((h,g)=>D.jsx(fn,{value:h,display:d.displays[g]??h,hidden:!(d.started[g]??!0)},`compact-${h}`))]}),D.jsxs("div",{className:"persona-card__meta-xxs",children:[D.jsx("p",{className:"terminal-label",children:a.label}),u.map((h,g)=>D.jsx(fn,{value:h,display:m.displays[g]??h,hidden:!(m.started[g]??!0)},`xxs-${h}`))]})]})}function hw({meta:a}){return a.kind==="identity"?D.jsx(uw,{meta:a}):a.kind==="chain"?D.jsx(dw,{meta:a}):D.jsx(fw,{meta:a})}function pw({persona:a}){return D.jsxs("article",{className:`persona-card persona-card--${a.weight}`,children:[D.jsx("h3",{className:"persona-card__title",children:a.title}),D.jsx("ol",{className:"persona-card__steps",children:a.steps.map(e=>D.jsxs("li",{children:[D.jsxs("span",{className:"persona-card__chevron","aria-hidden":!0,children:[">"," "]}),e]},e))}),D.jsx(Ho,{href:a.cta.href,variant:"ghost",className:"persona-card__cta",children:a.cta.label}),D.jsx(hw,{meta:a.meta})]})}function mw(){return D.jsx("section",{id:"personas",className:"section personas",children:D.jsxs("div",{className:"container",children:[D.jsx("p",{className:"section-kicker",children:mh.kicker}),D.jsx("h2",{className:"section-title personas__title",children:mh.title}),D.jsx("div",{className:"personas__grid",children:mh.items.map(a=>D.jsx(pw,{persona:a},a.title))})]})})}function gw(){const[a,e]=ke.useState(!1),[i,r]=ke.useState(!1),[o,c]=ke.useState("");return ke.useEffect(()=>{const u=()=>e(window.scrollY>24);return u(),window.addEventListener("scroll",u,{passive:!0}),()=>window.removeEventListener("scroll",u)},[]),ke.useEffect(()=>{const u=Bu.map(m=>m.id),d=new IntersectionObserver(m=>{var g;const h=m.filter(_=>_.isIntersecting).sort((_,v)=>v.intersectionRatio-_.intersectionRatio);(g=h[0])!=null&&g.target.id&&c(h[0].target.id)},{rootMargin:"-30% 0px -55% 0px",threshold:[0,.25,.5]});return u.forEach(m=>{const h=document.getElementById(m);h&&d.observe(h)}),()=>d.disconnect()},[]),ke.useEffect(()=>(document.body.style.overflow=i?"hidden":"",()=>{document.body.style.overflow=""}),[i]),D.jsxs(D.Fragment,{children:[D.jsx("header",{className:`sticky-header ${a?"sticky-header--solid":""}`,children:D.jsxs("div",{className:"sticky-header__inner",children:[D.jsx("a",{className:"sticky-header__logo",href:"#hero","aria-label":"Morpheum home",children:D.jsx(pm,{size:"sm",brandName:"Morpheum"})}),D.jsx("nav",{className:"sticky-header__nav","aria-label":"Primary",children:Bu.map(u=>D.jsx("a",{href:u.href,className:`sticky-header__link ${o===u.id?"is-active":""}`,children:u.label},u.id))}),D.jsxs("div",{className:"sticky-header__actions",children:[D.jsx("a",{className:"sticky-header__docs",href:On.docs,children:"Docs"}),D.jsx(Ho,{href:On.app,variant:"primary",className:"sticky-header__launch",children:"Launch Demo"}),D.jsxs("button",{type:"button",className:"sticky-header__menu","aria-expanded":i,"aria-controls":"mobile-nav","aria-label":i?"Close menu":"Open menu",onClick:()=>r(u=>!u),children:[D.jsx("span",{}),D.jsx("span",{}),D.jsx("span",{})]})]})]})}),D.jsx("div",{id:"mobile-nav",className:`mobile-sheet ${i?"is-open":""}`,hidden:!i,children:D.jsxs("nav",{className:"mobile-sheet__nav","aria-label":"Mobile",children:[Bu.map(u=>D.jsx("a",{href:u.href,onClick:()=>r(!1),className:o===u.id?"is-active":"",children:u.label},u.id)),D.jsx("a",{href:On.docs,onClick:()=>r(!1),children:"Docs"})]})})]})}function _w(){const a=ke.useRef(null),e=xm(a,{amount:.35});return D.jsx("section",{className:"thesis section","aria-label":"Thesis",children:D.jsxs("div",{className:"container thesis__inner",children:[D.jsx("p",{ref:a,className:"thesis__close",children:e?D.jsxs(vm,{text:ov.close,className:"thesis__close-type",speed:36,multiline:"auto",active:!0,holdCursor:!0,children:["The Agent-native"," ",D.jsx("span",{className:"thesis__close-accent",children:"L1 DEX"})," — ",D.jsx("span",{className:"thesis__close-phrase",children:"faster, safer trades."})]}):D.jsxs("span",{className:"thesis__close-type","aria-hidden":!0,children:["The Agent-native"," ",D.jsx("span",{className:"thesis__close-accent",children:"L1 DEX"})," — ",D.jsx("span",{className:"thesis__close-phrase",children:"faster, safer trades."})]})}),D.jsx("p",{className:"section-kicker",children:"Two Risks in Agentic Economy"}),D.jsx("div",{className:"thesis__risks",children:ov.risks.map(i=>D.jsxs("article",{className:"thesis__pair",children:[D.jsxs("div",{className:"thesis__risk",children:[D.jsx("p",{className:"thesis__label",children:"Risk"}),D.jsx("h3",{className:"thesis__risk-title",children:i.risk}),D.jsxs("p",{className:"thesis__failure",children:[D.jsx("span",{"aria-hidden":!0,children:"> "}),i.failure]})]}),D.jsxs("div",{className:"thesis__solve",children:[D.jsx("p",{className:"thesis__label thesis__label--solve",children:"Solution"}),D.jsx("p",{className:"thesis__solve-body",children:i.solve})]})]},i.risk))})]})})}function vw(){return D.jsxs("div",{className:"page",children:[D.jsx("a",{className:"skip-link",href:"#hero",children:"Skip to content"}),D.jsx(rw,{}),D.jsx(gw,{}),D.jsxs("main",{className:"page__main",children:[D.jsx(TC,{cardAlpha:0,modalChassisAlpha:.8,cardSize:.8,subtitleFadeEffect:"matrix",skipAnimationSpeed:1.2}),D.jsx(sw,{contentOffsetY:0,maskAlpha:.5}),D.jsx(_w,{}),D.jsx(Xy,{}),D.jsx(mw,{}),D.jsx(KC,{}),D.jsx(Yy,{}),D.jsx(ky,{})]}),D.jsx(QC,{})]})}Gy.createRoot(document.getElementById("root")).render(D.jsx(ke.StrictMode,{children:D.jsx(vw,{})}));
