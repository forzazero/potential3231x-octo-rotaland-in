 ...
 */var o_;function PM(){if(o_)return Qo;o_=1;var a=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(r,o,c){var u=null;if(c!==void 0&&(u=""+c),o.key!==void 0&&(u=""+o.key),"key"in o){c={};for(var h in o)h!=="key"&&(c[h]=o[h])}else c=o;return o=c.ref,{$$typeof:a,type:r,key:u,ref:o!==void 0?o:null,props:c}}return Qo.Fragment=e,Qo.jsx=i,Qo.jsxs=i,Qo}var l_;function IM(){return l_||(l_=1,Ed.exports=PM()),Ed.exports}var F=IM(),bd={exports:{}},lt={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var f_;function BM(){return f_||(f_=1,(function(a){function e(B,H){var $=B.length;B.push(H);e:for(;0<$;){var me=$-1>>>1,Se=B[me];if(0<o(Se,H))B[me]=H,B[$]=Se,$=me;else break e}}function i(B){return B.length===0?null:B[0]}function r(B){if(B.length===0)return null;var H=B[0],$=B.pop();if($!==H){B[0]=$;e:for(var me=0,Se=B.length,U=Se>>>1;me<U;){var K=2*(me+1)-1,xe=B[K],Te=K+1,Ue=B[Te];if(0>o(xe,$))Te<Se&&0>o(Ue,xe)?(B[me]=Ue,B[Te]=$,me=Te):(B[me]=xe,B[K]=$,me=K);else if(Te<Se&&0>o(Ue,$))B[me]=Ue,B[Te]=$,me=Te;else break e}}return H}function o(B,H){var $=B.sortIndex-H.sortIndex;return $!==0?$:B.id-H.id}if(a.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;a.unstable_now=function(){return c.now()}}else{var u=Date,h=u.now();a.unstable_now=function(){return u.now()-h}}var m=[],p=[],g=1,v=null,_=3,x=!1,b=!1,w=!1,y=!1,M=typeof setTimeout=="function"?setTimeout:null,P=typeof clearTimeout=="function"?clearTimeout:null,z=typeof setImmediate<"u"?setImmediate:null;function C(B){for(var H=i(p);H!==null;){if(H.callback===null)r(p);else if(H.startTime<=B)r(p),H.sortIndex=H.expirationTime,e(m,H);else break;H=i(p)}}function O(B){if(w=!1,C(B),!b)if(i(m)!==null)b=!0,N||(N=!0,Z());else{var H=i(p);H!==null&&Y(O,H.startTime-B)}}var N=!1,I=-1,T=5,D=-1;function q(){return y?!0:!(a.unstable_now()-D<T)}function G(){if(y=!1,N){var B=a.unstable_now();D=B;var H=!0;try{e:{b=!1,w&&(w=!1,P(I),I=-1),x=!0;var $=_;try{t:{for(C(B),v=i(m);v!==null&&!(v.expirationTime>B&&q());){var me=v.callback;if(typeof me=="function"){v.callback=null,_=v.priorityLevel;var Se=me(v.expirationTime<=B);if(B=a.unstable_now(),typeof Se=="function"){v.callback=Se,C(B),H=!0;break t}v===i(m)&&r(m),C(B)}else r(m);v=i(m)}if(v!==null)H=!0;else{var U=i(p);U!==null&&Y(O,U.startTime-B),H=!1}}break e}finally{v=null,_=$,x=!1}H=void 0}}finally{H?Z():N=!1}}}var Z;if(typeof z=="function")Z=function(){z(G)};else if(typeof MessageChannel<"u"){var de=new MessageChannel,oe=de.port2;de.port1.onmessage=G,Z=function(){oe.postMessage(null)}}else Z=function(){M(G,0)};function Y(B,H){I=M(function(){B(a.unstable_now())},H)}a.unstable_IdlePriority=5,a.unstable_ImmediatePriority=1,a.unstable_LowPriority=4,a.unstable_NormalPriority=3,a.unstable_Profiling=null,a.unstable_UserBlockingPriority=2,a.unstable_cancelCallback=function(B){B.callback=null},a.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<B?Math.floor(1e3/B):5},a.unstable_getCurrentPriorityLevel=function(){return _},a.unstable_next=function(B){switch(_){case 1:case 2:case 3:var H=3;break;default:H=_}var $=_;_=H;try{return B()}finally{_=$}},a.unstable_requestPaint=function(){y=!0},a.unstable_runWithPriority=function(B,H){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var $=_;_=B;try{return H()}finally{_=$}},a.unstable_scheduleCallback=function(B,H,$){var me=a.unstable_now();switch(typeof $=="object"&&$!==null?($=$.delay,$=typeof $=="number"&&0<$?me+$:me):$=me,B){case 1:var Se=-1;break;case 2:Se=250;break;case 5:Se=1073741823;break;case 4:Se=1e4;break;default:Se=5e3}return Se=$+Se,B={id:g++,callback:H,priorityLevel:B,startTime:$,expirationTime:Se,sortIndex:-1},$>me?(B.sortIndex=$,e(p,B),i(m)===null&&B===i(p)&&(w?(P(I),I=-1):w=!0,Y(O,$-me))):(B.sortIndex=Se,e(m,B),b||x||(b=!0,N||(N=!0,Z()))),B},a.unstable_shouldYield=q,a.unstable_wrapCallback=function(B){var H=_;return function(){var $=_;_=H;try{return B.apply(this,arguments)}finally{_=$}}}})(Rd)),Rd}var d_;function zM(){return d_||(d_=1,Ad.exports=BM()),Ad.exports}var Cd={exports:{}},Gn={};/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:La,depthTest:!1,depthWrite:!1})}function tv(){return new ki({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:mu(),fragmentShader:`
		...
		`,blending:La,depthTest:!1,depthWrite:!1})}function nv(){return new ki({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:mu(),fragmentShader:`
	...
	`}class hS extends ia{constructor(e=1,i={}){super(e,e,i),this.isWebGLCubeRenderTarget=!0;const r={width:e,height:e,depth:1},o=[r,r,r,r,r,r];this.texture=new sS(o),this._setTextureOptions(i),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,i){this.texture.type=i.type,this.texture.colorSpace=i.colorSpace,this.texture.generateMipmaps=i.generateMipmaps,this.texture.minFilter=i.minFilter,this.texture.magFilter=i.magFilter;const r={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}const AA={[Fv]:"Linear",[Bv]:"Reinhard",[zv]:"Cineon",[Hv]:"ACESFilmic",[Vv]:"AgX",[kv]:"Neutral",[Gv]:"Custom"};function RA(a,e){const i=AA[e];return i===void 0?(rt("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+a+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+a+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Kc=new ee;function CA(){Ct.getLuminanceCoefficients(Kc);const a=Kc.x.toFixed(4),e=Kc.y.toFixed(4),i=Kc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${a}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(ol).join(`
`)),u=ap(u),u=dv(u,i),u=hv(u,i),h=ap(h),h=dv(h,i),h=hv(h,i),u=pv(u),h=pv(h),i.isRawShaderMaterial!==!0&&(P=`#version 300 es
...
`)+`
`+M);const z=P+y+u,C=P+M+h,O=cv(o,o.VERTEX_SHADER,z),N=cv(o,o.FRAGMENT_SHADER,C);o.attachShader(w,O),o.attachShader(w,N),i.index0AttributeName!==void 0?o.bindAttribLocation(w,0,i.index0AttributeName):i.hasPositionAttribute===!0&&o.bindAttribLocation(w,0,"position"),o.linkProgram(w);function I(G){if(a.debug.checkShaderErrors){const Z=o.getProgramInfoLog(w)||"",de=o.getShaderInfoLog(O)||"",oe=o.getShaderInfoLog(N)||"",Y=Z.trim(),B=de.trim(),H=oe.trim();let $=!0,me=!0;if(o.getProgramParameter(w,o.LINK_STATUS)===!1)if($=!1,typeof a.debug.onShaderError=="function")a.debug.onShaderError(o,w,O,N);else{const Se=fv(o,O,"vertex"),U=fv(o,N,"fragment");Ut("WebGLProgram: Shader Error "+o.getError()+" - VALIDATE_STATUS "+o.getProgramParameter(w,o.VALIDATE_STATUS)+`
...
`,xR='"Reckk Heading", Georgia, "Times New Roman", serif',AS="Morpheum Wordmark",gl=`"${AS}"`,MR=[{t:0,c:"#e8ffe0"},{t:.45,c:"#c8f5a8"},{t:1,c:"#f0e6a0"}];async function yR(){if(typeof document>"u"||!document.fonts)return!1;try{const a=new FontFace(AS,`url(${R2})`,{weight:"normal",style:"normal"});document.fonts.add(await a.load()),await document.fonts.load(`normal 152px ${gl}`);const e=document.fonts.check(`normal 152px ${gl}`);return e||console.error("[FlowIntro] Morpheum Wordmark failed to bind — title will not use Reckk fallback"),e}catch(a){return console.error("[FlowIntro] Morpheum Wordmark load failed",a),!1}}async function ER(){if(!(typeof document>"u"||!document.fonts))try{await yR();const a=new FontFace("Reckk Title",`url(${A2})`,{weight:"normal",style:"normal"});document.fonts.add(await a.load());const e=new FontFace("Reckk Heading",`url(${T2})`,{weight:"normal",style:"normal"});document.fonts.add(await e.load()),await document.fonts.ready,await document.fonts.load(`normal 152px ${gl}`),await document.fonts.load('normal 64px "Reckk Heading"'),await document.fonts.load('normal 124px "Reckk Title"')}catch{}}const qs="flow-intro-hide-chrome";function bR(a){return a<=72}const TR=280;function AR(a){const e=document.documentElement,i=e.style.scrollBehavior;e.style.scrollBehavior="auto",window.scrollTo(0,Math.max(0,a)),e.style.scrollBehavior=i}function dh(){const a=document.getElementById("hero");if(!a)return;const e=a.getBoundingClientRect().top+window.scrollY;AR(e)}function dl(a){const e=Un.clamp(a,0,1);return e*e*e*(e*(e*6-15)+10)}function hh(a){const e=Math.max(1,a),i=Math.max(1,jn*e*tR),r=Math.max(1,i/Math.max(1,jn-1));return{cardPx:i,titlePx:r,totalPx:i+r}}function RS(a,e){const i=a/Math.max(1,e),r=Mp*Math.PI/180,o=2*fl*Math.tan(r/2),c=o*i,u=sp*ES/bS,h=.992,m=h*o/sp,p=h*c/u;return Un.clamp(Math.min(m,p),.52,2.35)}function bv(a,e,i){const r=TS(a),o=RS(a,e),c=a/Math.max(1,e),u=Mp*Math.PI/180,m=2*fl*Math.tan(u/2)*c,p=r.frustumFill*m/Math.max(1e-6,o),g=Math.min(r.planeBaseW,p);return{w:g,h:g*i}}function RR(a,e){const i=a/Math.max(1,jn-1),r=Math.min(Math.max(1,e*.38),Math.max(1,i*.34));return i<=r+.001?0:1-r/i}function CR(a,e){const i=Math.min(Math.max(1,e*.38),Math.max(1,a*.34));return a<=i+.001?0:1-i/a}function wR(a,e){const i=Un.clamp(e,0,.999);if(a<i)return{titleOp:1,lastCardOp:0};const r=Math.max(1e-6,1-i),o=dl(Un.clamp((a-i)/r,0,1));return{titleOp:1-o,lastCardOp:o}}function DR(a,e,i){const r=jn-1;if(a<=0)return{opacity:e===0?1:0};if(a>=r-1e-5)return{opacity:e===r?1:0};const o=Math.floor(a);if(o>=r)return{opacity:e===r?1:0};if(e!==o&&e!==o+1)return{opacity:0};const c=a-o,u=Un.clamp(i,0,.999);if(c<u)return{opacity:e===o?1:0};const h=dl(Un.clamp((c-u)/Math.max(1e-6,1-u),0,1));return{opacity:e===o?1:h}}function NR(a,e){return a>1.5&&a<e-.5}function LR(a){return Un.clamp(540/Math.max(a,340),.2,.55)}function UR(a,e,i){const r=[],o=oR;for(let c=0;c<o;c++){const u=Un.clamp(a-c/Math.max(1,o-1)*lR,-.08,1.08),h=Math.sin(u*Math.PI*2*iR)*sR*i,m=Math.sin(u*Math.PI*2*aR)*rR,p=Ev+c/Math.max(1,o-1)*(hR-Ev),g=e-p;r.push(new ee(h,m,g))}return r}function OR(a,e,i,r){const o=a.length;if(o<2)return new Ni;const c=[],u=[],h=[],m=[],p=new ee,g=new ee,v=new ee,_=new ee(0,1,0),x=e+1;for(let w=0;w<o;w++){w===0?p.subVectors(a[1],a[0]).normalize():w===o-1?p.subVectors(a[o-1],a[o-2]).normalize():p.subVectors(a[w+1],a[w-1]).normalize(),g.copy(_).cross(p),g.lengthSq()<1e-8&&g.set(1,0,0).cross(p),g.normalize(),v.crossVectors(p,g).normalize();const y=o===1?0:w/(o-1),M=i+(r-i)*Math.pow(y,1.5);for(let P=0;P<=e;P++){const z=P/e*Math.PI*2,C=Math.cos(z),O=Math.sin(z),N=a[w];c.push(N.x+(C*g.x+O*v.x)*M,N.y+(C*g.y+O*v.y)*M,N.z+(C*g.z+O*v.z)*M),u.push(C*g.x+O*v.x,C*g.y+O*v.y,C*g.z+O*v.z),h.push(o===1?0:w/(o-1),P/e)}}for(let w=0;w<o-1;w++)for(let y=0;y<e;y++){const M=w*x+y,P=M+1,z=M+x,C=z+1;m.push(M,z,P,P,z,C)}const b=new Ni;return b.setAttribute("position",new wi(c,3)),b.setAttribute("normal",new wi(u,3)),b.setAttribute("uv",new wi(h,2)),b.setIndex(m),b.computeBoundingSphere(),b}function Tv(a,e,i,r){const o={verb:a.verb,description:a.description};return eR(o,e,i,r,xR)}function Av(a,e){const i=TS(e),r=Math.min(a*2.35,3.25),o=Math.round(i.canvasW*r),c=Math.round(i.canvasH*r),u=document.createElement("canvas");u.width=o,u.height=c;const h=u.getContext("2d");h.clearRect(0,0,o,c);const m="Morpheum";let p=i.fontPx;h.textAlign="left",h.textBaseline="alphabetic";const g=()=>{h.font=`normal ${p*r}px ${gl}`};g();const v=O=>{h.font=`normal ${O*r}px ${gl}`;const N=h.measureText(m),I=Math.abs(N.actualBoundingBoxLeft??0),T=Math.abs(N.actualBoundingBoxRight??N.width),D=Math.abs(N.actualBoundingBoxAscent??O*r*.8),q=Math.abs(N.actualBoundingBoxDescent??O*r*.25);return{left:I,right:T,width:I+T,ascent:D,descent:q}},_=Math.max(1.25,1.85*r)*2,x=64*r+_,b=40*r+_,w=O=>{const N=v(O);return N.width+x*2<=o&&N.ascent+N.descent+b*2<=c};for(;!w(p)&&p>64;)p-=2;for(;w(p+2)&&p<i.fontPx+24;)p+=2;g();const y=v(p),M=(o-y.width)/2+y.left,P=c/2+(y.ascent-y.descent)/2,z=h.createLinearGradient(M-y.left,P-y.ascent,M+y.right,P+y.descent);MR.forEach(O=>z.addColorStop(O.t,O.c)),h.lineJoin="round",h.miterLimit=2,h.lineWidth=Math.max(1.25,1.85*r),h.strokeStyle="rgba(8,12,10,0.22)",h.strokeText(m,M,P),h.fillStyle=z,h.fillText(m,M,P);const C=new rS(u);return C.colorSpace=Kn,C.minFilter=bn,C.magFilter=bn,C.generateMipmaps=!1,C}function Rv(a,e){a.generateMipmaps=!1,a.minFilter=bn,a.magFilter=bn,a.wrapS=Gi,a.wrapT=Gi;const i=e.capabilities.getMaxAnisotropy();a.anisotropy=Math.min(16,i),a.needsUpdate=!0}function PR(){const a=Qe.useRef(null),e=Qe.useRef(null),i=Qe.useRef(null),r=Qe.useRef(null),o=Qe.useRef(!1),c=Qe.useCallback(()=>{if(o.current)return;o.current=!0;const u=e.current;u==null||u.classList.add("flow-intro__sticky--exit"),window.setTimeout(()=>{document.body.classList.remove(qs),dh(),requestAnimationFrame(()=>{dh(),requestAnimationFrame(()=>{dh(),window.setTimeout(()=>{o.current=!1},100)})})},TR)},[]);return Qe.useLayoutEffect(()=>{const u=window.matchMedia("(prefers-reduced-motion: reduce)").matches,h=window.location.hash.replace(/^#/,"");return u||h!==""&&h!=="flow"&&h!=="hero"||document.body.classList.add(qs),()=>{document.body.classList.remove(qs)}},[]),Qe.useEffect(()=>{const u=h=>{if(h.key!=="Escape")return;const m=document.getElementById("hero");m&&m.getBoundingClientRect().top>8&&(h.preventDefault(),c())};return window.addEventListener("keydown",u),()=>window.removeEventListener("keydown",u)},[c]),Qe.useEffect(()=>{const u=window.location.hash.replace(/^#/,"");u&&u!=="flow"&&u!=="hero"&&requestAnimationFrame(()=>{var h;(h=document.getElementById(u))==null||h.scrollIntoView({block:"start"})})},[]),Qe.useEffect(()=>{const u=i.current,h=a.current;if(!u||!h)return;const m=u,p=h;let g=!1;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){document.body.classList.remove(qs);const x=r.current;x&&(x.style.height="0px");return}let _;return(async()=>{if(await ER(),g)return;const x=Math.min(window.devicePixelRatio,2),b=Math.max(320,m.clientWidth||window.innerWidth),w=Math.max(1,m.clientHeight||window.innerHeight),y=[],M=[],P=[];Kr.forEach((Ye,Ze)=>{const ot=jn-1-Ze,mt=Kr[ot],wt=Tv(mt,ot,x,b);P.push(wt);const Dt=new uu({map:wt,transparent:!0,opacity:1,depthWrite:!0,depthTest:!0,side:Oa});y.push(Dt);const ft=sp,_t=ft*ES/bS,X=new Di(new Qs(_t,ft),Dt);X.position.set(0,0,-Ze*Da),X.renderOrder=Ze,M.push(X)});const z=Av(x,b),C=new uu({map:z,transparent:!0,opacity:0,depthWrite:!1,depthTest:!0,side:$i}),O=z.image.height/z.image.width,{w:N,h:I}=bv(b,w,O),T=new Di(new Qs(N,I),C);T.position.set(0,0,-(jn-1)*Da),T.renderOrder=_R;const D=new rE,q=new Ri(Mp,1,.08,120),G=new b2({antialias:!0,alpha:!1,powerPreference:"high-performance"});G.setPixelRatio(Math.min(window.devicePixelRatio,2)),G.outputColorSpace=Kn,G.sortObjects=!0,m.appendChild(G.domElement),Rv(z,G);const Z=new rl;M.forEach(Ye=>Z.add(Ye)),Z.add(T),D.add(Z);const de=new ki({uniforms:{uStrength:{value:0}},vertexShader:vR,fragmentShader:SR,transparent:!0,toneMapped:!1,depthTest:!1,depthWrite:!1,blending:mh}),oe=new Di(new Ni,de);oe.frustumCulled=!1,oe.renderOrder=mR,oe.visible=!1,D.add(oe);const Y=Kr.map(Ye=>new Nt(Ye.mood.mid)),B=Y[0].clone();D.background=B;const H=0,$=-(jn-1)*Da,me=fl,Se=-.1*Da,U=.1*Da;function K(Ye,Ze){const ot=Ye+fl;return(me-ot)/Ze}function xe(){const Ye=Math.max(1,window.innerHeight),{totalPx:Ze}=hh(Ye),ot=Math.max(1,Ze),mt=H+Se,wt=$+U-nR,ft=(mt-wt)/ot,_t=K(mt,ft),X=K(wt,ft);return{ih:Ye,totalPx:ot,scrollToWorldFactor:ft,minScroll:_t,maxScroll:X}}let{scrollToWorldFactor:Te,minScroll:Ue,maxScroll:ie}=xe();const ye=new Nt,Ee=new Nt,ze=new Nt;function it(){var _t;const Ye=Math.max(320,m.clientWidth||window.innerWidth),Ze=Math.min(window.devicePixelRatio,2);P.forEach((X,Mt)=>{X.dispose();const St=jn-1-Mt,L=Tv(Kr[St],St,Ze,Ye);P[Mt]=L,y[Mt].map=L,y[Mt].needsUpdate=!0}),(_t=C.map)==null||_t.dispose();const ot=Av(Ze,Ye);C.map=ot,C.needsUpdate=!0,Rv(ot,G);const mt=ot.image.height/ot.image.width,wt=Math.max(1,m.clientHeight||window.innerHeight),{w:Dt,h:ft}=bv(Ye,wt,mt);T.geometry.dispose(),T.geometry=new Qs(Dt,ft)}function Je(){const Ye=m.clientWidth,Ze=m.clientHeight;if(Ye<2||Ze<2)return;q.aspect=Ye/Ze,q.updateProjectionMatrix(),G.setSize(Ye,Ze,!1),it();const ot=xe();Te=ot.scrollToWorldFactor,Ue=ot.minScroll,ie=ot.maxScroll;const mt=Math.max(1,window.innerHeight),{totalPx:wt}=hh(mt),Dt=r.current;if(Dt){const ft=mt*Mv,_t=Math.max(Math.ceil(wt+ft+mt*yv+32),Math.ceil(mt*1.08));Dt.style.height=`${_t}px`}}Je(),requestAnimationFrame(()=>{g||it()});let Zt=0;function ut(){var zn,Fa;if(g)return;Zt=requestAnimationFrame(ut);const Ye=Math.max(1,window.innerHeight),{cardPx:Ze,titlePx:ot,totalPx:mt}=hh(Ye),wt=p.getBoundingClientRect(),Dt=Math.max(1,p.offsetHeight-Ye),ft=Un.clamp(-wt.top,0,Dt),_t=Math.min(ft,mt),X=Math.max(1,mt),Mt=Ye*Mv,St=dl(Un.clamp((ft-mt)/Math.max(1,Mt),0,1)),L=Un.mapLinear(Ze,0,X,Ue,ie),E=m.clientWidth,J=m.clientHeight,te=Math.max(1,ot),fe=_t<te,Ce=fe?Un.clamp(_t/te,0,1):0,De=Math.max(0,_t-te),he=Math.max(1,Ze),Ae=Un.clamp(De/he,0,1)*(jn-1),Be=RS(E,J),Ne=document.getElementById("hero"),Le=Ne?Ne.getBoundingClientRect().top:0,$e=Ne?bR(Le):!0;let je;fe?je=Un.mapLinear(_t,0,te,ie,L):je=Un.mapLinear(_t,te,X,L,Ue),je=Un.clamp(je,Ue,ie);const st=RR(Ze,Ye),W=CR(te,Ye),Re=wR(Ce,W),ge=jn-1;if(fe)ze.copy(Y[0]);else{const jt=Math.min(jn-2,Math.floor(Ae)),Tn=Math.min(jt+1,jn-1),si=dl(Ae-jt);ye.copy(Y[jt]),Ee.copy(Y[Tn]),ze.lerpColors(ye,Ee,si)}D.background=B.copy(ze);const we=me-je*Te;q.position.set(0,0,we),q.lookAt(0,0,we-fl);const Pe=Un.clamp(_t/X,0,1);if(NR(_t,X)){const jt=UR(Pe,we,LR(E)),si=new SE(jt,!1,"centripetal").getSpacedPoints(cR);if(si.length>=2){const gn=OR(si,uR,fR,dR),Ot=oe.geometry.getAttribute("position"),tn=gn.getAttribute("position");if(Ot&&tn&&Ot.count===tn.count&&((zn=oe.geometry.getIndex())==null?void 0:zn.count)===((Fa=gn.getIndex())==null?void 0:Fa.count)&&Ot&&tn){Ot.array.set(tn.array),Ot.needsUpdate=!0;const Qn=oe.geometry.getAttribute("normal"),Es=gn.getAttribute("normal");Qn&&Es&&(Qn.array.set(Es.array),Qn.needsUpdate=!0);const Ba=oe.geometry.getAttribute("uv"),Xi=gn.getAttribute("uv");Ba&&Xi&&(Ba.array.set(Xi.array),Ba.needsUpdate=!0),gn.dispose()}else oe.geometry.dispose(),oe.geometry=gn;oe.visible=!0,de.uniforms.uStrength.value=.36}else oe.visible=!1,de.uniforms.uStrength.value=0}else oe.visible=!1,de.uniforms.uStrength.value=0;const Xe=Math.floor((jn-1)/2);M.forEach((jt,Tn)=>{const si=-Tn*Da,gn=jn-1-Tn;let{opacity:Ot}=DR(Ae,gn,st);fe&&Tn===ge&&(Ot*=Re.lastCardOp);let tn=1,Dn=0;!fe&&gn===jn-1&&Ot>.02&&St>0&&(tn=1-.28*St,Dn=-Da*.32*St),jt.position.set(0,0,si+Dn),jt.scale.setScalar(Be*tn);const Qn=y[Tn];Qn.opacity=Ot,Qn.depthWrite=Ot>=.995,jt.visible=Ot>.003,jt.renderOrder=Tn<=Xe?pR+Tn:gR+(Tn-Xe-1)}),T.position.set(0,0,-ge*Da),T.scale.setScalar(Be),C.opacity=fe?Re.titleOp:0,C.depthWrite=C.opacity>=.995,T.visible=C.opacity>.003;const He=mt+Mt;let Gt=0;if(Dt>He&&ft>=He){const jt=Math.max(1,Dt-He);Gt=dl(Un.clamp((ft-He)/jt,0,1))}if(Gt>.02&&(oe.visible=!1,de.uniforms.uStrength.value=0),!o.current){document.body.classList.toggle(qs,!$e);const jt=e.current;jt!=null&&jt.classList.contains("flow-intro__sticky--exit")&&!$e&&(jt.style.transition="none",jt.classList.remove("flow-intro__sticky--exit"),jt.offsetWidth,jt.style.transition="")}const Lt=r.current;if(Lt){const jt=Mt+Ye*yv+32,Tn=Math.max(Math.ceil(mt+jt),Math.ceil(Ye*1.08));Lt.style.height!==`${Tn}px`&&(Lt.style.height=`${Tn}px`)}const Wn=1-Gt*.96;e.current&&e.current.style.setProperty("--intro-ui-opacity",String(Wn)),G.domElement.style.opacity=String(1-Gt),G.render(D,q)}ut(),window.addEventListener("resize",Je,{passive:!0});const vt=new ResizeObserver(Je);vt.observe(m),_=()=>{var Ye;cancelAnimationFrame(Zt),document.body.classList.remove(qs),window.removeEventListener("resize",Je),vt.disconnect(),y.forEach(Ze=>{var ot;(ot=Ze.map)==null||ot.dispose(),Ze.dispose()}),P.forEach(Ze=>Ze.dispose()),(Ye=C.map)==null||Ye.dispose(),C.dispose(),M.forEach(Ze=>Ze.geometry.dispose()),T.geometry.dispose(),oe.geometry.dispose(),de.dispose(),D.remove(oe),G.dispose(),m.contains(G.domElement)&&m.removeChild(G.domElement)},g&&_()})(),()=>{g=!0,document.body.classList.remove(qs),_==null||_()}},[]),F.jsxs("section",{ref:a,id:"flow",className:"flow-intro","aria-label":"Morpheum — Discover, Copy, Supervise, Isolate",children:[F.jsxs("div",{ref:e,className:"flow-intro__sticky",children:[F.jsx("div",{ref:i,className:"flow-intro__canvas","aria-hidden":!0}),F.jsxs("div",{className:"flow-intro__top",children:[F.jsx("p",{className:"flow-intro__eyebrow",children:"/// Morpheum"}),F.jsxs("button",{type:"button",className:"flow-intro__skip",onClick:c,children:["Skip ",F.jsx("span",{className:"flow-intro__skip-key",children:"Esc"})]})]}),F.jsx("div",{className:"flow-intro__sr","aria-live":"polite",children:Kr.map((u,h)=>F.jsxs("p",{children:["Step ",String(h+1).padStart(2,"0"),": ",u.verb,". ",u.description]},u.verb))})]}),F.jsx("div",{ref:r,className:"flow-intro__spacer","aria-hidden":!0})]})}const IR=280,FR=5/4,BR=3800,zR={discover:ll,copy:Z2};function HR(){return typeof window<"u"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function GR({stepIndex:a,kind:e,className:i,width:r=IR}){const o=Qe.useRef(null),c=e??SS(a),u=Math.round(r*FR);return Qe.useEffect(()=>{const h=o.current;if(!h)return;let m=0,p;const g=()=>{const x=Math.min(window.devicePixelRatio||1,2),b=Math.round(r*x),w=Math.round(u*x);(h.width!==b||h.height!==w)&&(h.width=b,h.height=w);const y=h.getContext("2d");y&&$2(y,c,b,w,m)};g();const v=zR[c];v&&v>1&&!HR()&&(p=setInterval(()=>{m=(m+1)%v,g()},BR));const _=()=>g();return window.addEventListener("resize",_),()=>{window.removeEventListener("resize",_),p&&clearInterval(p)}},[c,r,u]),F.jsx("div",{className:["loop-step-sheet",i].filter(Boolean).join(" "),style:{width:r,height:u},children:F.jsx("canvas",{ref:o,className:"loop-step-sheet__canvas",style:{width:r,height:u},"aria-hidden":!0})})}const Cv=[{id:"want-eth",agent:"SharpeShark",timestamp:"2026-07-08T15:42:00.000Z",timeLabel:"07-08, 15:42:00",status:"want-to",statusLabel:"Want to",action:"Open ETH long · 1.2 ETH",showActions:!0},{id:"rejected-btc",agent:"NightOwl",timestamp:"2026-07-08T15:31:00.000Z",timeLabel:"07-08, 15:31:00",status:"rejected",statusLabel:"Rejected",action:"Open BTC short · 0.04 BTC"},{id:"close-btc-profit",agent:"SharpeShark",timestamp:"2026-07-08T15:25:00.000Z",timeLabel:"07-08, 15:25:00",status:"short",statusLabel:"Close Long",action:"BTCUSDT · 0.04 BTC · 2,465.12 USDT",pnl:{text:"+103.09",tone:"long"}},{id:"open-eth-long",agent:"FluxRunner",timestamp:"2026-07-08T14:10:00.000Z",timeLabel:"07-08, 14:10:00",status:"long",statusLabel:"Open Long",action:"ETHUSDT · 0.8 ETH · 2,560.00 USDT"},{id:"open-sol-short",agent:"NightOwl",timestamp:"2026-07-07T09:42:00.000Z",timeLabel:"07-07, 09:42:00",status:"short",statusLabel:"Open Short",action:"SOLUSDT · 12 SOL · 1,824.00 USDT"}];function VR(){return F.jsxs("aside",{className:"supervise-log","aria-label":"Agent activity log",children:[F.jsx("header",{className:"supervise-log__header",children:F.jsx("span",{className:"supervise-log__kicker",children:"Activity log"})}),F.jsx("ol",{className:"supervise-log__timeline",children:Cv.map((a,e)=>{const i=e===Cv.length-1,r=e===0;return F.jsxs("li",{className:"supervise-log__item",children:[F.jsxs("div",{className:"supervise-log__meta",children:[F.jsx("span",{className:"supervise-log__agent",children:a.agent}),F.jsx("time",{className:"supervise-log__time",dateTime:a.timestamp,children:a.timeLabel})]}),F.jsxs("div",{className:"supervise-log__track","aria-hidden":!0,children:[i?null:F.jsx("span",{className:"supervise-log__track-line"}),F.jsx("span",{className:["supervise-log__dot",r?"supervise-log__dot--latest":""].filter(Boolean).join(" ")})]}),F.jsxs("div",{className:"supervise-log__body",children:[F.jsx("span",{className:`supervise-log__badge supervise-log__badge--${a.status}`,children:a.statusLabel}),F.jsxs("p",{className:"supervise-log__action",children:[a.action,a.pnl?F.jsxs(F.Fragment,{children:[" · ",F.jsx("span",{className:`supervise-log__pnl supervise-log__pnl--${a.pnl.tone}`,children:a.pnl.text})]}):null]}),a.showActions?F.jsxs("div",{className:"supervise-log__actions",children:[F.jsx("button",{type:"button",className:"supervise-log__btn supervise-log__btn--reject",children:"Reject"}),F.jsx("button",{type:"button",className:"supervise-log__btn supervise-log__btn--approve",children:"Approve"})]}):null]})]},a.id)})})]})}const kR=/^(action)$/i;function XR(a){return a.split(/(\s*[·/]\s*)/).map((i,r)=>kR.test(i.trim())?F.jsx("span",{className:"stat-chip__brand",children:i},r):F.jsx("span",{children:i},r))}function CS({label:a,status:e,live:i}){return F.jsxs("span",{className:`stat-chip ${i?"stat-chip--live":""}`,children:[F.jsx("span",{className:"stat-chip__label",children:a}),F.jsx("span",{className:"stat-chip__sep",children:"·"}),F.jsx("span",{className:"stat-chip__status",children:XR(e)})]})}var WR=Pv();function qR(a,e,i=!1){a.style.fontFamily=e.fontFamily,a.style.fontSize=e.fontSize,a.style.fontWeight=e.fontWeight,a.style.letterSpacing=e.letterSpacing,a.style.lineHeight=e.lineHeight,a.style.textTransform=e.textTransform,a.style.whiteSpace=i?"nowrap":"normal",a.style.wordBreak=i?"normal":"break-word"}function YR(a,e,i,r){const o=getComputedStyle(i),c=document.createElement("div");c.style.position="fixed",c.style.left="-99999px",c.style.top="0",c.style.visibility="hidden",c.style.pointerEvents="none",c.style.width=`${e}px`,qR(c,o,!r);const u=document.createTextNode(a);return c.appendChild(u),document.body.appendChild(c),{probe:c,textNode:u}}function wv(a,e,i,r=!0){if(!a)return{lines:[],blockHeight:0};if(e<=0)return{lines:[a],blockHeight:0};const{probe:o,textNode:c}=YR(a,e,i,r),u=o.offsetHeight;if(!r)return document.body.removeChild(o),{lines:[a],blockHeight:u};const h=document.createRange(),m=[];let p=0,g=0;for(let v=1;v<=a.length;v++){h.setStart(c,0),h.setEnd(c,v);const _=h.getClientRects().length;_>g&&g>0&&(m.push(a.slice(p,v-1)),p=v-1),g=_}return p<a.length&&m.push(a.slice(p)),document.body.removeChild(o),{lines:m.length>0?m:[a],blockHeight:u}}const ZR=40,jR=5,KR="typewriter-reveal",Dv=1e3,QR=4e3;function Nv(){return Dv+Math.random()*(QR-Dv)}function wS(){return typeof window>"u"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches}function JR({text:a,content:e,speed:i,cursorWidth:r,active:o,waiting:c,completed:u,holdCursor:h=!1,onComplete:m}){const p=Qe.useRef(null),g=Qe.useRef(m),v=Qe.useRef(null),_=Qe.useRef(null),x=Qe.useRef(null),b=Qe.useRef("idle"),[w,y]=Qe.useState("idle");g.current=m;const M=Qe.useCallback(()=>{v.current&&(clearTimeout(v.current),v.current=null)},[]),P=Qe.useCallback(()=>{var D;M(),_.current=null,x.current=null,b.current="complete",y("complete"),(D=g.current)==null||D.call(g)},[M]),z=Qe.useCallback(D=>{M(),_.current=Date.now()+D,v.current=setTimeout(P,D)},[M,P]);Qe.useLayoutEffect(()=>{b.current="idle",y("idle"),x.current=null,_.current=null,M()},[a,i,r,M]),Qe.useLayoutEffect(()=>{var H,$,me;if(c||u||b.current==="complete")return;if(!o){b.current==="cursor-hold"&&v.current&&_.current!=null&&(M(),x.current=Math.max(0,_.current-Date.now()),_.current=null);return}if(b.current==="cursor-hold"&&!v.current){const Se=x.current??Nv();x.current=null,z(Se);return}if(b.current==="animating"||b.current==="cursor-hold")return;if(wS()){(H=g.current)==null||H.call(g);return}const D=p.current;if(!D||!a){($=g.current)==null||$.call(g);return}D.style.width="",D.offsetWidth;const q=Math.max(a.length/i*1e3,120),G=Math.max(a.length,1),Z=D.closest(".typewriter-block"),de=(Z==null?void 0:Z.clientWidth)??((me=D.parentElement)==null?void 0:me.clientWidth)??0;D.style.whiteSpace="nowrap",D.style.width="auto";const oe=D.scrollWidth,Y=de>0?Math.min(oe,de):oe;D.style.width="0",D.style.setProperty("--tw-duration",`${q}ms`),D.style.setProperty("--tw-target-width",`${Y}px`),D.style.setProperty("--tw-steps",String(G)),D.style.setProperty("--tw-cursor-width",`${r}px`),D.offsetWidth,b.current="animating",y("animating");const B=Se=>{if(Se.animationName===KR){if(h){D.style.width=`${Y}px`,b.current="cursor-hold",y("cursor-hold"),z(Nv());return}D.style.width="",P()}};return D.addEventListener("animationend",B),()=>{D.removeEventListener("animationend",B)}},[o,u,P,h,z,i,a,c,M,r]);const C=w==="animating",O=w==="cursor-hold",N=w==="complete",T=["typewriter","typewriter-line",c?"is-waiting":"",C?"is-animating":"",O?"is-cursor-hold":"",u||N?"is-complete":"",!o&&!c&&!u&&!N&&(C||O)?"is-paused":""].filter(Boolean).join(" ");return F.jsx("span",{ref:p,className:T,children:e??a})}function yp({text:a,children:e,className:i,speed:r=ZR,cursorWidth:o=jR,multiline:c="auto",active:u=!0,holdCursor:h=!0,onComplete:m}){const p=Qe.useRef(null),g=Qe.useRef(m),[v,_]=Qe.useState([]),[x,b]=Qe.useState(0),[w,y]=Qe.useState(0),[M,P]=Qe.useState(!1),[z,C]=Qe.useState(!1),O=wS();g.current=m;const N=Qe.useCallback(()=>{const oe=p.current;if(!oe||!a)return _([]),b(0),C(!0),!0;const Y=oe.clientWidth;if(Y<1)return!1;const H=(c==="auto"||c===!0)&&!O,{lines:$,blockHeight:me}=wv(a,Y,oe,H);let Se=me;if(!H){const U=wv(a,Y,oe,!0);Se=Math.max(me,U.blockHeight)}return _($),b(Se),C(!0),!0},[a,c,O]);Qe.useLayoutEffect(()=>{var oe,Y;if(y(0),P(!1),C(!1),_([]),b(0),O){(oe=g.current)==null||oe.call(g),C(!0);return}if(!a){(Y=g.current)==null||Y.call(g),C(!0);return}if(!N()){const B=new ResizeObserver(()=>{N()&&B.disconnect()});return p.current&&B.observe(p.current),()=>B.disconnect()}},[a,c,N,O]);const I=Qe.useCallback(oe=>{var B;const Y=oe>=v.length-1;WR.flushSync(()=>{if(!Y){y(oe+1);return}P(!0)}),Y&&((B=g.current)==null||B.call(g))},[v]),D=["typewriter-block",v.length>1?"typewriter-lines":"typewriter-host",i??"",M?"is-complete":"",z?"":"is-measuring",O?"is-static":""].filter(Boolean).join(" "),q={...!M&&!O&&x>0?{height:x,minHeight:x}:void 0},G=e??a;if(!z)return F.jsx("span",{ref:p,className:D,style:q,children:G});if(O||!a)return F.jsx("span",{ref:p,className:["typewriter","is-static",i??""].filter(Boolean).join(" "),children:G});if(M)return F.jsx("span",{ref:p,className:["typewriter-block","typewriter-host","is-complete",i??""].filter(Boolean).join(" "),children:G});const Z=v.length>0?v:[a],de=!!e&&Z.length<=1;return F.jsxs("span",{ref:p,className:D,style:q,"aria-label":a,children:[F.jsx("span",{className:"typewriter-ghost","aria-hidden":!0,children:G}),F.jsx("span",{className:"typewriter-overlay","aria-hidden":!0,children:Z.map((oe,Y)=>F.jsx(JR,{text:oe,content:de?e:void 0,speed:r,cursorWidth:o,waiting:Y>w,active:u&&Y===w,completed:Y<w,holdCursor:h&&Y===Z.length-1,onComplete:Y===w?()=>I(Y):void 0},`${Y}-${oe}`))})]})}function $R(){return typeof window<"u"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function DS(a,e){const i=(e==null?void 0:e.amount)??.2,[r,o]=Qe.useState(!1);return Qe.useLayoutEffect(()=>{if(r)return;if($R()){o(!0);return}const c=a.current;if(!c)return;const u=new IntersectionObserver(h=>{for(const m of h)if(m.isIntersecting&&m.intersectionRatio>=Math.min(i,1)){o(!0),u.disconnect();return}},{root:null,threshold:[0,i,Math.min(i+.15,1),1],rootMargin:"0px"});return u.observe(c),()=>u.disconnect()},[i,r,a]),r}function e3(a){return String(a).padStart(2,"0")}function fu(){return typeof window<"u"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}const t3=1600,n3=1500,Lv=5e3,i3=7e3;function a3(){return Lv+Math.random()*(i3-Lv)}function s3({text:a,active:e}){const[i,r]=Qe.useState(!1),[o,c]=Qe.useState(0),u=Qe.useRef(null),h=`> ${a}`,m=Qe.useCallback(()=>{u.current&&(clearTimeout(u.current),u.current=null)},[]);Qe.useLayoutEffect(()=>{if(m(),!e){r(!1),c(0);return}if(fu()){r(!0);return}const g=window.setTimeout(()=>r(!0),n3);return()=>{window.clearTimeout(g),m()}},[e,m]);const p=Qe.useCallback(()=>{fu()||(m(),u.current=setTimeout(()=>{u.current=null,c(g=>g+1)},a3()))},[m]);return F.jsx("p",{className:"flow-step__example",children:i?F.jsx(yp,{text:h,className:"flow-step__example-type",speed:42,multiline:"auto",active:!0,holdCursor:!0,onComplete:p},o):F.jsx("span",{className:"flow-step__example-type","aria-hidden":!0,children:h})})}function r3(){const[a,e]=Qe.useState(()=>new Set),[i,r]=Qe.useState(!1),o=Qe.useRef(new Map),c=Qe.useRef(null),u=DS(c,{amount:.35}),h=hs.steps.every(v=>a.has(`step-${v.n}`));Qe.useLayoutEffect(()=>{if(fu()){e(new Set(hs.steps.map(_=>`step-${_.n}`))),r(!0);return}const v=new IntersectionObserver(_=>{e(x=>{const b=new Set(x);for(const w of _){const y=w.target.dataset.flowKey;y&&w.isIntersecting&&b.add(y)}return b})},{root:null,threshold:[0,.01,.08,.15,.25],rootMargin:"-42% 0px -42% 0px"});for(const _ of o.current.values())v.observe(_);return()=>{v.disconnect()}},[]),Qe.useLayoutEffect(()=>{if(fu())return;if(!h){r(!1);return}const v=window.setTimeout(()=>{r(!0)},t3);return()=>window.clearTimeout(v)},[h]);const m=Qe.useCallback((v,_)=>{_?o.current.set(v,_):o.current.delete(v)},[]),p=Qe.useCallback(v=>{e(_=>new Set(_).add(v))},[]),g=u&&i;return F.jsx("section",{id:"how",className:"section flow",children:F.jsxs("div",{className:"container",children:[F.jsx("p",{className:"section-kicker",children:hs.kicker}),F.jsx("h2",{className:"section-title flow__title",children:hs.title}),F.jsx("div",{className:"flow__chips",children:hs.chips.map(v=>F.jsx(CS,{label:v.label,status:v.value},v.label))}),F.jsx("div",{className:"flow__steps",role:"list",children:hs.steps.map((v,_)=>{const x=`step-${v.n}`,b=a.has(x);return F.jsxs("article",{ref:w=>m(x,w),"data-flow-key":x,role:"listitem",className:`flow-step${b?" flow-step--expanded":""}`,"aria-expanded":b,children:[F.jsxs("button",{type:"button",className:"flow-step__head",onClick:()=>p(x),"aria-label":b?`${v.title}, expanded`:`${v.title}, tap to expand`,children:[F.jsxs("span",{className:"flow-step__idx",children:["Step ",e3(v.n)]}),F.jsx("h3",{className:"flow-step__title",children:v.title}),F.jsx("span",{className:"flow-step__chevron","aria-hidden":!0,children:b?"−":"+"})]}),F.jsx("div",{className:"flow-step__expand","aria-hidden":!b,children:F.jsx("div",{className:"flow-step__expand-inner",children:F.jsxs("div",{className:`flow-step__split${_===2?" flow-step__split--supervise":""}`,children:[F.jsx("p",{className:"flow-step__meta",children:v.feature}),F.jsxs("div",{className:"flow-step__copy",children:[F.jsx("p",{className:"flow-step__detail",children:v.body}),F.jsx(s3,{text:v.example,active:b}),F.jsx("div",{className:"flow-step__actions",children:F.jsx("a",{href:En.explore,className:"flow-step__open","aria-label":`Explore after ${v.title}`,children:F.jsx("span",{"aria-hidden":!0,className:"flow-step__open-arrow",children:"→"})})})]}),F.jsx("div",{className:`flow-step__sheet${_===2?" flow-step__sheet--log":""}`,"aria-hidden":!b,children:b?_===2?F.jsx(VR,{}):F.jsx(GR,{stepIndex:_,width:280}):null})]})})})]},x)})}),F.jsx("p",{ref:c,className:"flow__outcome",children:g?F.jsx(yp,{text:hs.outcome,className:"flow__outcome-type",speed:42,multiline:"auto",active:!0,holdCursor:!0}):F.jsx("span",{className:"flow__outcome-type","aria-hidden":!0,children:hs.outcome})})]})})}const o3=["M41.9213 3.43614C43.0393 3.43614 43.8716 3.77154 44.4182 4.44235C44.9647 5.138 45.1262 6.1939 44.9026 7.61005L41.884 26.8026C41.7846 27.4982 41.8467 28.0075 42.0703 28.3305C42.2691 28.6784 42.6542 28.8771 43.2256 28.9268L43.8591 28.9641L43.8219 29.2622L36.7784 30.492L36.4803 30.492L40.1324 7.46098C40.3064 6.26843 40.0206 5.67216 39.2753 5.67216C38.9523 5.67216 38.6045 5.75912 38.2318 5.93303C37.8343 6.10694 37.3995 6.44235 36.9275 6.93924L36.7411 6.79017C38.0828 4.55415 39.8095 3.43614 41.9213 3.43614Z","M29.9958 3.43614C31.1138 3.43614 31.9461 3.77154 32.4927 4.44235C33.0393 5.138 33.2007 6.1939 32.9771 7.61005L29.9585 26.8026C29.8591 27.4982 29.9212 28.0075 30.1449 28.3305C30.3436 28.6784 30.7287 28.8771 31.3001 28.9268L31.9337 28.9641L31.8964 29.2622L24.8529 30.492L24.5548 30.492L28.207 7.46098C28.3809 6.26843 28.0952 5.67216 27.3498 5.67216C27.0268 5.67216 26.679 5.75912 26.3063 5.93303C25.9088 6.10694 25.474 6.44235 25.002 6.93924L24.8157 6.79017C26.1573 4.55415 27.884 3.43614 29.9958 3.43614Z","M18.0703 3.43614C19.1883 3.43614 20.0206 3.77154 20.5672 4.44235C21.1138 5.138 21.2753 6.1939 21.0517 7.61005L18.033 26.8026C17.9337 27.4982 17.9958 28.0075 18.2194 28.3305C18.4181 28.6784 18.8032 28.8771 19.3747 28.9268L20.0082 28.9641L19.9709 29.2622L12.9275 30.492L12.6293 30.492L16.2815 7.46098C16.4554 6.26843 16.1697 5.67216 15.4243 5.67216C15.1014 5.67216 14.7535 5.75912 14.3809 5.93303C13.9834 6.10694 13.5486 6.44235 13.0765 6.93924L12.8902 6.79017C14.2318 4.55415 15.9585 3.43614 18.0703 3.43614Z","M45.5631 10.8482C46.0378 11.9189 46.0912 12.9315 45.7231 13.8861C45.3095 14.8231 44.3453 15.4956 42.8305 15.9035L16.576 22.853C15.2325 23.2226 14.7771 24.0651 15.2096 25.3806L15.7698 26.7714L13.8491 27.2839L9.924 22.1284L9.25377 20.6168L40.8242 12.2711C41.6674 12.048 42.2133 11.7494 42.4619 11.3754C42.6651 10.9838 42.669 10.5676 42.4735 10.1267C42.3199 9.78031 42.1016 9.5003 41.8185 9.2867C41.4899 9.05556 41.0511 8.87329 40.5021 8.7399L41.5734 7.5866C42.563 7.86379 43.3915 8.28774 44.0591 8.85845C44.7127 9.39767 45.214 10.0609 45.5631 10.8482Z"],l3=58,c3=35;function u3({fill:a="#C8F5A8",width:e=58,height:i=35,padding:r=10,"aria-hidden":o=!0,...c}){const u=[-r,-r,l3+r*2,c3+r*2].join(" ");return F.jsx("svg",{width:e,height:i,viewBox:u,fill:"none",xmlns:"http://www.w3.org/2000/svg","aria-hidden":o,...c,children:o3.map(h=>F.jsx("path",{d:h,fill:a},h.slice(0,24)))})}const f3={sm:{width:46,height:28},md:{width:46,height:28},lg:{width:69,height:42},hero:{width:119,height:72}};function NS({size:a="md",showWordmark:e=!0,className:i="",brandName:r="Morpheum"}){const o=f3[a];return F.jsxs("span",{className:`brand-mark brand-mark--${a} ${i}`.trim(),children:[F.jsx(u3,{className:"brand-mark__icon",width:o.width,height:o.height,padding:0,fill:"var(--terminal-brand)"}),e?F.jsx("span",{className:"brand-mark__word",children:r}):null]})}function d3(){return F.jsx("footer",{className:"site-footer",children:F.jsxs("div",{className:"container site-footer__inner",children:[F.jsxs("div",{className:"site-footer__brand",children:[F.jsx("a",{className:"site-footer__logo",href:"#hero","aria-label":"Morpheum home",children:F.jsx(NS,{size:"sm"})}),F.jsx("p",{className:"site-footer__legal",children:S_.legal})]}),F.jsxs("div",{className:"site-footer__meta",children:[F.jsxs("nav",{className:"site-footer__nav","aria-label":"Footer",children:[Qc.map(a=>F.jsx("a",{href:a.href,children:a.label},a.id)),F.jsx("a",{href:En.docs,children:"Docs"}),F.jsx("a",{href:En.manifesto,children:"Manifesto"}),F.jsx("a",{href:En.discord,children:"Discord"}),F.jsx("a",{href:En.x,children:"X"})]}),F.jsx("div",{className:"site-footer__labels","aria-label":"Protocol",children:S_.labels.map(a=>F.jsx("span",{className:"site-footer__label",children:a},a))})]})]})})}const Uv="!@#$%^&*()_+{}[]|;:,.<>?/0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ",h3=50,LS=3500,p3=4e3,m3=LS+p3;function g3(){return typeof window>"u"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Ov(a){return/[A-Za-z0-9]/.test(a)}function _3(){return Uv[Math.floor(Math.random()*Uv.length)]??"?"}function v3(a){return Math.random()<.5?_3():a}function S3(a,e){const i=[];for(let m=0;m<a.length;m++)Ov(a[m]??"")&&i.push(m);const r=i.length,o=r===0?1:Math.min(e/LS,1),c=Math.floor(o*r),u=new Set(i.slice(0,c));let h="";for(let m=0;m<a.length;m++){const p=a[m]??"";!Ov(p)||u.has(m)?h+=p:h+=v3(p)}return h}function Ep(a,e=!0){const[i,r]=Qe.useState(a);return Qe.useEffect(()=>{if(!e||g3()){r(a);return}let o=Date.now();const c=()=>{const h=Date.now();let m=h-o;m>=m3&&(o=h,m=0),r(S3(a,m))};c();const u=setInterval(c,h3);return()=>{clearInterval(u)}},[a,e]),i}function x3(){const[a,e]=ds.headline,i=Ep(ds.eyebrow.label);return F.jsxs("section",{id:"hero",className:"hero","aria-labelledby":"hero-heading",children:[F.jsx("div",{className:"hero__atmosphere","aria-hidden":!0}),F.jsx("div",{className:"hero__grid","aria-hidden":!0}),F.jsx("div",{className:"hero__scanlines","aria-hidden":!0}),F.jsx("div",{className:"hero__grain","aria-hidden":!0}),F.jsx("div",{className:"hero__veil","aria-hidden":!0}),F.jsxs("div",{className:"container hero__content",children:[F.jsxs("a",{className:"hero__eyebrow hero__eyebrow--matrix",href:ds.eyebrow.href,"aria-label":`${ds.eyebrow.label}›`,children:[i,F.jsx("span",{className:"hero__eyebrow-chevron","aria-hidden":!0,children:"›"})]}),F.jsxs("h1",{id:"hero-heading",className:"hero__headline",children:[F.jsx("span",{className:"hero__line hero__line--lead",children:a}),F.jsx("span",{className:"hero__line hero__line--punch",children:e})]}),F.jsxs("div",{className:"hero__ctas",children:[F.jsx(to,{href:ds.primaryCta.href,variant:"primary",children:ds.primaryCta.label}),F.jsx(to,{href:ds.secondaryCta.href,variant:"secondary",children:ds.secondaryCta.label})]})]})]})}function M3(){const a=Ep(wd.text);return F.jsx("div",{className:"manifesto-strip",children:F.jsx("a",{className:"manifesto-strip__link manifesto-strip__link--matrix",href:wd.href,"aria-label":wd.text,children:a})})}function y3(){const a=[...v_,...v_];return F.jsx("div",{className:"marquee","aria-label":"Live status",children:F.jsx("div",{className:"marquee__viewport",children:F.jsx("div",{className:"marquee__track",children:a.map((e,i)=>F.jsx(CS,{label:e.label,status:e.status,live:"live"in e?e.live:!1},`${e.label}-${i}`))})})})}function E3({text:a}){const e=Ep(a);return F.jsx("span",{className:"persona-card__status persona-card__status--matrix","aria-label":a,children:e})}function b3(){return F.jsx("section",{id:"personas",className:"section personas",children:F.jsxs("div",{className:"container",children:[F.jsx("p",{className:"section-kicker",children:Dd.kicker}),F.jsx("h2",{className:"section-title personas__title",children:Dd.title}),F.jsx("div",{className:"personas__grid",children:Dd.items.map(a=>F.jsxs("article",{className:`persona-card persona-card--${a.weight}`,children:[F.jsx("h3",{className:"persona-card__title",children:a.title}),F.jsx("ol",{className:"persona-card__steps",children:a.steps.map(e=>F.jsxs("li",{children:[F.jsxs("span",{className:"persona-card__chevron","aria-hidden":!0,children:[">"," "]}),e]},e))}),F.jsxs("div",{className:"persona-card__cta-row",children:[F.jsx(to,{href:a.cta.href,variant:"ghost",className:"persona-card__cta",children:a.cta.label}),F.jsx(E3,{text:a.status})]})]},a.title))})]})})}function T3(){const[a,e]=Qe.useState(!1),[i,r]=Qe.useState(!1),[o,c]=Qe.useState("");return Qe.useEffect(()=>{const u=()=>e(window.scrollY>24);return u(),window.addEventListener("scroll",u,{passive:!0}),()=>window.removeEventListener("scroll",u)},[]),Qe.useEffect(()=>{const u=Qc.map(m=>m.id),h=new IntersectionObserver(m=>{var g;const p=m.filter(v=>v.isIntersecting).sort((v,_)=>_.intersectionRatio-v.intersectionRatio);(g=p[0])!=null&&g.target.id&&c(p[0].target.id)},{rootMargin:"-30% 0px -55% 0px",threshold:[0,.25,.5]});return u.forEach(m=>{const p=document.getElementById(m);p&&h.observe(p)}),()=>h.disconnect()},[]),Qe.useEffect(()=>(document.body.style.overflow=i?"hidden":"",()=>{document.body.style.overflow=""}),[i]),F.jsxs(F.Fragment,{children:[F.jsx("header",{className:`sticky-header ${a?"sticky-header--solid":""}`,children:F.jsxs("div",{className:"sticky-header__inner",children:[F.jsx("a",{className:"sticky-header__logo",href:"#hero","aria-label":"Morpheum home",children:F.jsx(NS,{size:"sm",brandName:"Morpheum"})}),F.jsx("nav",{className:"sticky-header__nav","aria-label":"Primary",children:Qc.map(u=>F.jsx("a",{href:u.href,className:`sticky-header__link ${o===u.id?"is-active":""}`,children:u.label},u.id))}),F.jsxs("div",{className:"sticky-header__actions",children:[F.jsx("a",{className:"sticky-header__docs",href:En.docs,children:"Docs"}),F.jsx(to,{href:En.app,variant:"primary",className:"sticky-header__launch",children:"Launch Demo"}),F.jsxs("button",{type:"button",className:"sticky-header__menu","aria-expanded":i,"aria-controls":"mobile-nav","aria-label":i?"Close menu":"Open menu",onClick:()=>r(u=>!u),children:[F.jsx("span",{}),F.jsx("span",{}),F.jsx("span",{})]})]})]})}),F.jsx("div",{id:"mobile-nav",className:`mobile-sheet ${i?"is-open":""}`,hidden:!i,children:F.jsxs("nav",{className:"mobile-sheet__nav","aria-label":"Mobile",children:[Qc.map(u=>F.jsx("a",{href:u.href,onClick:()=>r(!1),className:o===u.id?"is-active":"",children:u.label},u.id)),F.jsx("a",{href:En.docs,onClick:()=>r(!1),children:"Docs"})]})})]})}function A3(){const a=Qe.useRef(null),e=DS(a,{amount:.35});return F.jsx("section",{className:"thesis section","aria-label":"Thesis",children:F.jsxs("div",{className:"container thesis__inner",children:[F.jsx("p",{ref:a,className:"thesis__close",children:e?F.jsxs(yp,{text:__.close,className:"thesis__close-type",speed:36,multiline:!1,active:!0,holdCursor:!0,children:["The Agent-native"," ",F.jsx("span",{className:"thesis__close-accent",children:"L1 DEX"})," — ",F.jsx("span",{className:"thesis__close-phrase",children:"faster, safer trades."})]}):F.jsxs("span",{className:"thesis__close-type","aria-hidden":!0,children:["The Agent-native"," ",F.jsx("span",{className:"thesis__close-accent",children:"L1 DEX"})," — ",F.jsx("span",{className:"thesis__close-phrase",children:"faster, safer trades."})]})}),F.jsx("p",{className:"section-kicker",children:"Two Risks in Agentic Economy"}),F.jsx("div",{className:"thesis__risks",children:__.risks.map(i=>F.jsxs("article",{className:"thesis__pair",children:[F.jsxs("div",{className:"thesis__risk",children:[F.jsx("p",{className:"thesis__label",children:"Risk"}),F.jsx("h3",{className:"thesis__risk-title",children:i.risk}),F.jsxs("p",{className:"thesis__failure",children:[F.jsx("span",{"aria-hidden":!0,children:"> "}),i.failure]})]}),F.jsxs("div",{className:"thesis__solve",children:[F.jsx("p",{className:"thesis__label thesis__label--solve",children:"Solution"}),F.jsx("p",{className:"thesis__solve-body",children:i.solve})]})]},i.risk))})]})})}function R3(){return F.jsxs("div",{className:"page",children:[F.jsx("a",{className:"skip-link",href:"#hero",children:"Skip to content"}),F.jsx(M3,{}),F.jsx(T3,{}),F.jsxs("main",{className:"page__main",children:[F.jsx(PR,{}),F.jsx(x3,{}),F.jsx(A3,{}),F.jsx(y3,{}),F.jsx(qM,{}),F.jsx(b3,{}),F.jsx(r3,{}),F.jsx(ZM,{}),F.jsx(WM,{})]}),F.jsx(d3,{})]})}kM.createRoot(document.getElementById("root")).render(F.jsx(Qe.StrictMode,{children:F.jsx(R3,{})}));
