 ...
 */var p_;function KM(){if(p_)return il;p_=1;var a=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(r,o,c){var u=null;if(c!==void 0&&(u=""+c),o.key!==void 0&&(u=""+o.key),"key"in o){c={};for(var d in o)d!=="key"&&(c[d]=o[d])}else c=o;return o=c.ref,{$$typeof:a,type:r,key:u,ref:o!==void 0?o:null,props:c}}return il.Fragment=e,il.jsx=i,il.jsxs=i,il}var m_;function QM(){return m_||(m_=1,Cd.exports=KM()),Cd.exports}var D=QM(),wd={exports:{}},ct={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:za,depthTest:!1,depthWrite:!1})}function IT(a,e,i){const r=new Float32Array($s),o=new ee(0,1,0);return new Fi({name:"SphericalGaussianBlur",defines:{n:$s,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${a}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:o}},vertexShader:Su(),fragmentShader:`
		...
		`,blending:za,depthTest:!1,depthWrite:!1})}function lv(){return new Fi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Su(),fragmentShader:`
		...
		`,blending:za,depthTest:!1,depthWrite:!1})}function cv(){return new Fi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Su(),fragmentShader:`
		...
		`,blending:za,depthTest:!1,depthWrite:!1})}function Su(){return`
...
`)}const GA={[Qv]:"Linear",[Jv]:"Reinhard",[$v]:"Cineon",[ex]:"ACESFilmic",[nx]:"AgX",[ix]:"Neutral",[tx]:"Custom"};function VA(a,e){const i=GA[e];return i===void 0?(st("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+a+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+a+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const tu=new ee;function kA(){Rt.getLuminanceCoefficients(tu);const a=tu.x.toFixed(4),e=tu.y.toFixed(4),i=tu.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${a}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
...
}`,b2=[new ee(1,0,0),new ee(-1,0,0),new ee(0,1,0),new ee(0,-1,0),new ee(0,0,1),new ee(0,0,-1)],T2=[new ee(0,-1,0),new ee(0,-1,0),new ee(0,0,1),new ee(0,0,-1),new ee(0,-1,0),new ee(0,-1,0)],Av=new vn,ul=new ee,gh=new ee;function A2(a,e,i){let r=new vx;const o=new Pt,c=new Pt,u=new pn,d=new HE,m=new GE,p={},g=i.maxTextureSize,_={[Ga]:oi,[oi]:Ga,[oa]:oa},v=new Fi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Pt},radius:{value:4}},vertexShader:y2,fragmentShader:E2}),S=v.clone();S.defines.HORIZONTAL_PASS=1;const E=new Ii;E.setAttribute("position",new da(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const w=new Pi(E,v),y=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=iu;let M=this.type;this.render=function(N,B,T){if(y.enabled===!1||y.autoUpdate===!1&&y.needsUpdate===!1||N.length===0)return;this.type===dy&&(st("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=iu);const L=a.getRenderTarget(),X=a.getActiveCubeFace(),V=a.getActiveMipmapLevel(),j=a.state;j.setBlending(za),j.buffers.depth.getReversed()===!0?j.buffers.color.setClear(0,0,0,0):j.buffers.color.setClear(1,1,1,1),j.buffers.depth.setTest(!0),j.setScissorTest(!1);const ue=M!==this.type;ue&&B.traverse(function(fe){fe.material&&(Array.isArray(fe.material)?fe.material.forEach(q=>q.needsUpdate=!0):fe.material.needsUpdate=!0)});for(let fe=0,q=N.length;fe<q;fe++){const F=N[fe],H=F.shadow;if(H===void 0){st("WebGLShadowMap:",F,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;o.copy(H.mapSize);const $=H.getFrameExtents();o.multiply($),c.copy(H.mapSize),(o.x>g||o.y>g)&&(o.x>g&&(c.x=Math.floor(g/$.x),o.x=c.x*$.x,H.mapSize.x=c.x),o.y>g&&(c.y=Math.floor(g/$.y),o.y=c.y*$.y,H.mapSize.y=c.y));const _e=a.state.buffers.depth.getReversed();if(H.camera._reversedDepth=_e,H.map===null||ue===!0){if(H.map!==null&&(H.map.depthTexture!==null&&(H.map.depthTexture.dispose(),H.map.depthTexture=null),H.map.dispose()),this.type===fl){if(F.isPointLight){st("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}H.map=new fa(o.x,o.y,{format:ar,type:Va,minFilter:Tn,magFilter:Tn,generateMipmaps:!1}),H.map.texture.name=F.name+".shadowMap",H.map.depthTexture=new uo(o.x,o.y,la),H.map.depthTexture.name=F.name+".shadowMapDepth",H.map.depthTexture.format=ka,H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=Bn,H.map.depthTexture.magFilter=Bn}else F.isPointLight?(H.map=new Rx(o.x),H.map.depthTexture=new LE(o.x,ha)):(H.map=new fa(o.x,o.y),H.map.depthTexture=new uo(o.x,o.y,ha)),H.map.depthTexture.name=F.name+".shadowMap",H.map.depthTexture.format=ka,this.type===iu?(H.map.depthTexture.compareFunction=_e?yp:Mp,H.map.depthTexture.minFilter=Tn,H.map.depthTexture.magFilter=Tn):(H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=Bn,H.map.depthTexture.magFilter=Bn);H.camera.updateProjectionMatrix()}const Me=H.map.isWebGLCubeRenderTarget?6:1;for(let O=0;O<Me;O++){if(H.map.isWebGLCubeRenderTarget)a.setRenderTarget(H.map,O),a.clear();else{O===0&&(a.setRenderTarget(H.map),a.clear());const K=H.getViewport(O);u.set(c.x*K.x,c.y*K.y,c.x*K.z,c.y*K.w),j.viewport(u)}if(F.isPointLight){const K=H.camera,ye=H.matrix,Ce=F.distance||K.far;Ce!==K.far&&(K.far=Ce,K.updateProjectionMatrix()),ul.setFromMatrixPosition(F.matrixWorld),K.position.copy(ul),gh.copy(K.position),gh.add(b2[O]),K.up.copy(T2[O]),K.lookAt(gh),K.updateMatrixWorld(),ye.makeTranslation(-ul.x,-ul.y,-ul.z),Av.multiplyMatrices(K.projectionMatrix,K.matrixWorldInverse),H._frustum.setFromProjectionMatrix(Av,K.coordinateSystem,K.reversedDepth)}else H.updateMatrices(F);r=H.getFrustum(),C(B,T,H.camera,F,this.type)}H.isPointLightShadow!==!0&&this.type===fl&&P(H,T),H.needsUpdate=!1}M=this.type,y.needsUpdate=!1,a.setRenderTarget(L,X,V)};function P(N,B){const T=e.update(w);v.defines.VSM_SAMPLES!==N.blurSamples&&(v.defines.VSM_SAMPLES=N.blurSamples,S.defines.VSM_SAMPLES=N.blurSamples,v.needsUpdate=!0,S.needsUpdate=!0),N.mapPass===null&&(N.mapPass=new fa(o.x,o.y,{format:ar,type:Va})),v.uniforms.shadow_pass.value=N.map.depthTexture,v.uniforms.resolution.value=N.mapSize,v.uniforms.radius.value=N.radius,a.setRenderTarget(N.mapPass),a.clear(),a.renderBufferDirect(B,null,T,v,w,null),S.uniforms.shadow_pass.value=N.mapPass.texture,S.uniforms.resolution.value=N.mapSize,S.uniforms.radius.value=N.radius,a.setRenderTarget(N.map),a.clear(),a.renderBufferDirect(B,null,T,S,w,null)}function z(N,B,T,L){let X=null;const V=T.isPointLight===!0?N.customDistanceMaterial:N.customDepthMaterial;if(V!==void 0)X=V;else if(X=T.isPointLight===!0?m:d,a.localClippingEnabled&&B.clipShadows===!0&&Array.isArray(B.clippingPlanes)&&B.clippingPlanes.length!==0||B.displacementMap&&B.displacementScale!==0||B.alphaMap&&B.alphaTest>0||B.map&&B.alphaTest>0||B.alphaToCoverage===!0){const j=X.uuid,ue=B.uuid;let fe=p[j];fe===void 0&&(fe={},p[j]=fe);let q=fe[ue];q===void 0&&(q=X.clone(),fe[ue]=q,B.addEventListener("dispose",I)),X=q}if(X.visible=B.visible,X.wireframe=B.wireframe,L===fl?X.side=B.shadowSide!==null?B.shadowSide:B.side:X.side=B.shadowSide!==null?B.shadowSide:_[B.side],X.alphaMap=B.alphaMap,X.alphaTest=B.alphaToCoverage===!0?.5:B.alphaTest,X.map=B.map,X.clipShadows=B.clipShadows,X.clippingPlanes=B.clippingPlanes,X.clipIntersection=B.clipIntersection,X.displacementMap=B.displacementMap,X.displacementScale=B.displacementScale,X.displacementBias=B.displacementBias,X.wireframeLinewidth=B.wireframeLinewidth,X.linewidth=B.linewidth,T.isPointLight===!0&&X.isMeshDistanceMaterial===!0){const j=a.properties.get(X);j.light=T}return X}function C(N,B,T,L,X){if(N.visible===!1)return;if(N.layers.test(B.layers)&&(N.isMesh||N.isLine||N.isPoints)&&(N.castShadow||N.receiveShadow&&X===fl)&&(!N.frustumCulled||r.intersectsObject(N))){N.modelViewMatrix.multiplyMatrices(T.matrixWorldInverse,N.matrixWorld);const ue=e.update(N),fe=N.material;if(Array.isArray(fe)){const q=ue.groups;for(let F=0,H=q.length;F<H;F++){const $=q[F],_e=fe[$.materialIndex];if(_e&&_e.visible){const Me=z(N,_e,L,X);N.onBeforeShadow(a,N,B,T,ue,Me,$),a.renderBufferDirect(T,null,ue,Me,N,$),N.onAfterShadow(a,N,B,T,ue,Me,$)}}}else if(fe.visible){const q=z(N,fe,L,X);N.onBeforeShadow(a,N,B,T,ue,q,null),a.renderBufferDirect(T,null,ue,q,N,null),N.onAfterShadow(a,N,B,T,ue,q,null)}}const j=N.children;for(let ue=0,fe=j.length;ue<fe;ue++)C(j[ue],B,T,L,X)}function I(N){N.target.removeEventListener("dispose",I);for(const T in p){const L=p[T],X=N.target.uuid;X in L&&(L[X].dispose(),delete L[X])}}}function R2(a,e){function i(){let k=!1;const Ae=new pn;let ce=null;const Re=new pn(0,0,0,0);return{setMask:function(we){ce!==we&&!k&&(a.colorMask(we,we,we,we),ce=we)},setLocked:function(we){k=we},setClear:function(we,xe,je,Ve,Ft){Ft===!0&&(we*=Ve,xe*=Ve,je*=Ve),Ae.set(we,xe,je,Ve),Re.equals(Ae)===!1&&(a.clearColor(we,xe,je,Ve),Re.copy(Ae))},reset:function(){k=!1,ce=null,Re.set(-1,0,0,0)}}}function r(){let k=!1,Ae=!1,ce=null,Re=null,we=null;return{setReversed:function(xe){if(Ae!==xe){const je=e.get("EXT_clip_control");xe?je.clipControlEXT(je.LOWER_LEFT_EXT,je.ZERO_TO_ONE_EXT):je.clipControlEXT(je.LOWER_LEFT_EXT,je.NEGATIVE_ONE_TO_ONE_EXT),Ae=xe;const Ve=we;we=null,this.setClear(Ve)}},getReversed:function(){return Ae},setTest:function(xe){xe?Te(a.DEPTH_TEST):We(a.DEPTH_TEST)},setMask:function(xe){ce!==xe&&!k&&(a.depthMask(xe),ce=xe)},setFunc:function(xe){if(Ae&&(xe=Wy[xe]),Re!==xe){switch(xe){case bh:a.depthFunc(a.NEVER);break;case Th:a.depthFunc(a.ALWAYS);break;case Ah:a.depthFunc(a.LESS);break;case lo:a.depthFunc(a.LEQUAL);break;case Rh:a.depthFunc(a.EQUAL);break;case Ch:a.depthFunc(a.GEQUAL);break;case wh:a.depthFunc(a.GREATER);break;case Dh:a.depthFunc(a.NOTEQUAL);break;default:a.depthFunc(a.LEQUAL)}Re=xe}},setLocked:function(xe){k=xe},setClear:function(xe){we!==xe&&(we=xe,Ae&&(xe=1-xe),a.clearDepth(xe))},reset:function(){k=!1,ce=null,Re=null,we=null,Ae=!1}}}function o(){let k=!1,Ae=null,ce=null,Re=null,we=null,xe=null,je=null,Ve=null,Ft=null;return{setTest:function(Ct){k||(Ct?Te(a.STENCIL_TEST):We(a.STENCIL_TEST))},setMask:function(Ct){Ae!==Ct&&!k&&(a.stencilMask(Ct),Ae=Ct)},setFunc:function(Ct,zn,Hn){(ce!==Ct||Re!==zn||we!==Hn)&&(a.stencilFunc(Ct,zn,Hn),ce=Ct,Re=zn,we=Hn)},setOp:function(Ct,zn,Hn){(xe!==Ct||je!==zn||Ve!==Hn)&&(a.stencilOp(Ct,zn,Hn),xe=Ct,je=zn,Ve=Hn)},setLocked:function(Ct){k=Ct},setClear:function(Ct){Ft!==Ct&&(a.clearStencil(Ct),Ft=Ct)},reset:function(){k=!1,Ae=null,ce=null,Re=null,we=null,xe=null,je=null,Ve=null,Ft=null}}}const c=new i,u=new r,d=new o,m=new WeakMap,p=new WeakMap;let g={},_={},v={},S=new WeakMap,E=[],w=null,y=!1,M=null,P=null,z=null,C=null,I=null,N=null,B=null,T=new wt(0,0,0),L=0,X=!1,V=null,j=null,ue=null,fe=null,q=null;const F=a.getParameter(a.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let H=!1,$=0;const _e=a.getParameter(a.VERSION);_e.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(_e)[1]),H=$>=1):_e.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(_e)[1]),H=$>=2);let Me=null,O={};const K=a.getParameter(a.SCISSOR_BOX),ye=a.getParameter(a.VIEWPORT),Ce=new pn().fromArray(K),ze=new pn().fromArray(ye);function se(k,Ae,ce,Re){const we=new Uint8Array(4),xe=a.createTexture();a.bindTexture(k,xe),a.texParameteri(k,a.TEXTURE_MIN_FILTER,a.NEAREST),a.texParameteri(k,a.TEXTURE_MAG_FILTER,a.NEAREST);for(let je=0;je<ce;je++)k===a.TEXTURE_3D||k===a.TEXTURE_2D_ARRAY?a.texImage3D(Ae,0,a.RGBA,1,1,Re,0,a.RGBA,a.UNSIGNED_BYTE,we):a.texImage2D(Ae+je,0,a.RGBA,1,1,0,a.RGBA,a.UNSIGNED_BYTE,we);return xe}const be={};be[a.TEXTURE_2D]=se(a.TEXTURE_2D,a.TEXTURE_2D,1),be[a.TEXTURE_CUBE_MAP]=se(a.TEXTURE_CUBE_MAP,a.TEXTURE_CUBE_MAP_POSITIVE_X,6),be[a.TEXTURE_2D_ARRAY]=se(a.TEXTURE_2D_ARRAY,a.TEXTURE_2D_ARRAY,1,1),be[a.TEXTURE_3D]=se(a.TEXTURE_3D,a.TEXTURE_3D,1,1),c.setClear(0,0,0,1),u.setClear(1),d.setClear(0),Te(a.DEPTH_TEST),u.setFunc(lo),Yt(!1),zt(R_),Te(a.CULL_FACE),_t(za);function Te(k){g[k]!==!0&&(a.enable(k),g[k]=!0)}function We(k){g[k]!==!1&&(a.disable(k),g[k]=!1)}function it(k,Ae){return v[k]!==Ae?(a.bindFramebuffer(k,Ae),v[k]=Ae,k===a.DRAW_FRAMEBUFFER&&(v[a.FRAMEBUFFER]=Ae),k===a.FRAMEBUFFER&&(v[a.DRAW_FRAMEBUFFER]=Ae),!0):!1}function et(k,Ae){let ce=E,Re=!1;if(k){ce=S.get(Ae),ce===void 0&&(ce=[],S.set(Ae,ce));const we=k.textures;if(ce.length!==we.length||ce[0]!==a.COLOR_ATTACHMENT0){for(let xe=0,je=we.length;xe<je;xe++)ce[xe]=a.COLOR_ATTACHMENT0+xe;ce.length=we.length,Re=!0}}else ce[0]!==a.BACK&&(ce[0]=a.BACK,Re=!0);Re&&a.drawBuffers(ce)}function qt(k){return w!==k?(a.useProgram(k),w=k,!0):!1}const ot={[Js]:a.FUNC_ADD,[py]:a.FUNC_SUBTRACT,[my]:a.FUNC_REVERSE_SUBTRACT};ot[gy]=a.MIN,ot[_y]=a.MAX;const gt={[vy]:a.ZERO,[xy]:a.ONE,[Sy]:a.SRC_COLOR,[yh]:a.SRC_ALPHA,[Ay]:a.SRC_ALPHA_SATURATE,[by]:a.DST_COLOR,[yy]:a.DST_ALPHA,[My]:a.ONE_MINUS_SRC_COLOR,[Eh]:a.ONE_MINUS_SRC_ALPHA,[Ty]:a.ONE_MINUS_DST_COLOR,[Ey]:a.ONE_MINUS_DST_ALPHA,[Ry]:a.CONSTANT_COLOR,[Cy]:a.ONE_MINUS_CONSTANT_COLOR,[wy]:a.CONSTANT_ALPHA,[Dy]:a.ONE_MINUS_CONSTANT_ALPHA};function _t(k,Ae,ce,Re,we,xe,je,Ve,Ft,Ct){if(k===za){y===!0&&(We(a.BLEND),y=!1);return}if(y===!1&&(Te(a.BLEND),y=!0),k!==hy){if(k!==M||Ct!==X){if((P!==Js||I!==Js)&&(a.blendEquation(a.FUNC_ADD),P=Js,I=Js),Ct)switch(k){case io:a.blendFuncSeparate(a.ONE,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA);break;case Mh:a.blendFunc(a.ONE,a.ONE);break;case C_:a.blendFuncSeparate(a.ZERO,a.ONE_MINUS_SRC_COLOR,a.ZERO,a.ONE);break;case w_:a.blendFuncSeparate(a.DST_COLOR,a.ONE_MINUS_SRC_ALPHA,a.ZERO,a.ONE);break;default:Lt("WebGLState: Invalid blending: ",k);break}else switch(k){case io:a.blendFuncSeparate(a.SRC_ALPHA,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA);break;case Mh:a.blendFuncSeparate(a.SRC_ALPHA,a.ONE,a.ONE,a.ONE);break;case C_:Lt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case w_:Lt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Lt("WebGLState: Invalid blending: ",k);break}z=null,C=null,N=null,B=null,T.set(0,0,0),L=0,M=k,X=Ct}return}we=we||Ae,xe=xe||ce,je=je||Re,(Ae!==P||we!==I)&&(a.blendEquationSeparate(ot[Ae],ot[we]),P=Ae,I=we),(ce!==z||Re!==C||xe!==N||je!==B)&&(a.blendFuncSeparate(gt[ce],gt[Re],gt[xe],gt[je]),z=ce,C=Re,N=xe,B=je),(Ve.equals(T)===!1||Ft!==L)&&(a.blendColor(Ve.r,Ve.g,Ve.b,Ft),T.copy(Ve),L=Ft),M=k,X=!1}function rt(k,Ae){k.side===oa?We(a.CULL_FACE):Te(a.CULL_FACE);let ce=k.side===oi;Ae&&(ce=!ce),Yt(ce),k.blending===io&&k.transparent===!1?_t(za):_t(k.blending,k.blendEquation,k.blendSrc,k.blendDst,k.blendEquationAlpha,k.blendSrcAlpha,k.blendDstAlpha,k.blendColor,k.blendAlpha,k.premultipliedAlpha),u.setFunc(k.depthFunc),u.setTest(k.depthTest),u.setMask(k.depthWrite),c.setMask(k.colorWrite);const Re=k.stencilWrite;d.setTest(Re),Re&&(d.setMask(k.stencilWriteMask),d.setFunc(k.stencilFunc,k.stencilRef,k.stencilFuncMask),d.setOp(k.stencilFail,k.stencilZFail,k.stencilZPass)),an(k.polygonOffset,k.polygonOffsetFactor,k.polygonOffsetUnits),k.alphaToCoverage===!0?Te(a.SAMPLE_ALPHA_TO_COVERAGE):We(a.SAMPLE_ALPHA_TO_COVERAGE)}function Yt(k){V!==k&&(k?a.frontFace(a.CW):a.frontFace(a.CCW),V=k)}function zt(k){k!==uy?(Te(a.CULL_FACE),k!==j&&(k===R_?a.cullFace(a.BACK):k===fy?a.cullFace(a.FRONT):a.cullFace(a.FRONT_AND_BACK))):We(a.CULL_FACE),j=k}function Ht(k){k!==ue&&(H&&a.lineWidth(k),ue=k)}function an(k,Ae,ce){k?(Te(a.POLYGON_OFFSET_FILL),(fe!==Ae||q!==ce)&&(fe=Ae,q=ce,u.getReversed()&&(Ae=-Ae),a.polygonOffset(Ae,ce))):We(a.POLYGON_OFFSET_FILL)}function It(k){k?Te(a.SCISSOR_TEST):We(a.SCISSOR_TEST)}function jt(k){k===void 0&&(k=a.TEXTURE0+F-1),Me!==k&&(a.activeTexture(k),Me=k)}function Z(k,Ae,ce){ce===void 0&&(Me===null?ce=a.TEXTURE0+F-1:ce=Me);let Re=O[ce];Re===void 0&&(Re={type:void 0,texture:void 0},O[ce]=Re),(Re.type!==k||Re.texture!==Ae)&&(Me!==ce&&(a.activeTexture(ce),Me=ce),a.bindTexture(k,Ae||be[k]),Re.type=k,Re.texture=Ae)}function Dt(){const k=O[Me];k!==void 0&&k.type!==void 0&&(a.bindTexture(k.type,null),k.type=void 0,k.texture=void 0)}function xt(){try{a.compressedTexImage2D(...arguments)}catch(k){Lt("WebGLState:",k)}}function U(){try{a.compressedTexImage3D(...arguments)}catch(k){Lt("WebGLState:",k)}}function b(){try{a.texSubImage2D(...arguments)}catch(k){Lt("WebGLState:",k)}}function J(){try{a.texSubImage3D(...arguments)}catch(k){Lt("WebGLState:",k)}}function oe(){try{a.compressedTexSubImage2D(...arguments)}catch(k){Lt("WebGLState:",k)}}function pe(){try{a.compressedTexSubImage3D(...arguments)}catch(k){Lt("WebGLState:",k)}}function Ne(){try{a.texStorage2D(...arguments)}catch(k){Lt("WebGLState:",k)}}function Pe(){try{a.texStorage3D(...arguments)}catch(k){Lt("WebGLState:",k)}}function he(){try{a.texImage2D(...arguments)}catch(k){Lt("WebGLState:",k)}}function me(){try{a.texImage3D(...arguments)}catch(k){Lt("WebGLState:",k)}}function De(k){return _[k]!==void 0?_[k]:a.getParameter(k)}function Ge(k,Ae){_[k]!==Ae&&(a.pixelStorei(k,Ae),_[k]=Ae)}function Be(k){Ce.equals(k)===!1&&(a.scissor(k.x,k.y,k.z,k.w),Ce.copy(k))}function ge(k){ze.equals(k)===!1&&(a.viewport(k.x,k.y,k.z,k.w),ze.copy(k))}function Le(k,Ae){let ce=p.get(Ae);ce===void 0&&(ce=new WeakMap,p.set(Ae,ce));let Re=ce.get(k);Re===void 0&&(Re=a.getUniformBlockIndex(Ae,k.name),ce.set(k,Re))}function Oe(k,Ae){const Re=p.get(Ae).get(k);m.get(Ae)!==Re&&(a.uniformBlockBinding(Ae,Re,k.__bindingPointIndex),m.set(Ae,Re))}function qe(){a.disable(a.BLEND),a.disable(a.CULL_FACE),a.disable(a.DEPTH_TEST),a.disable(a.POLYGON_OFFSET_FILL),a.disable(a.SCISSOR_TEST),a.disable(a.STENCIL_TEST),a.disable(a.SAMPLE_ALPHA_TO_COVERAGE),a.blendEquation(a.FUNC_ADD),a.blendFunc(a.ONE,a.ZERO),a.blendFuncSeparate(a.ONE,a.ZERO,a.ONE,a.ZERO),a.blendColor(0,0,0,0),a.colorMask(!0,!0,!0,!0),a.clearColor(0,0,0,0),a.depthMask(!0),a.depthFunc(a.LESS),u.setReversed(!1),a.clearDepth(1),a.stencilMask(4294967295),a.stencilFunc(a.ALWAYS,0,4294967295),a.stencilOp(a.KEEP,a.KEEP,a.KEEP),a.clearStencil(0),a.cullFace(a.BACK),a.frontFace(a.CCW),a.polygonOffset(0,0),a.activeTexture(a.TEXTURE0),a.bindFramebuffer(a.FRAMEBUFFER,null),a.bindFramebuffer(a.DRAW_FRAMEBUFFER,null),a.bindFramebuffer(a.READ_FRAMEBUFFER,null),a.useProgram(null),a.lineWidth(1),a.scissor(0,0,a.canvas.width,a.canvas.height),a.viewport(0,0,a.canvas.width,a.canvas.height),a.pixelStorei(a.PACK_ALIGNMENT,4),a.pixelStorei(a.UNPACK_ALIGNMENT,4),a.pixelStorei(a.UNPACK_FLIP_Y_WEBGL,!1),a.pixelStorei(a.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),a.pixelStorei(a.UNPACK_COLORSPACE_CONVERSION_WEBGL,a.BROWSER_DEFAULT_WEBGL),a.pixelStorei(a.PACK_ROW_LENGTH,0),a.pixelStorei(a.PACK_SKIP_PIXELS,0),a.pixelStorei(a.PACK_SKIP_ROWS,0),a.pixelStorei(a.UNPACK_ROW_LENGTH,0),a.pixelStorei(a.UNPACK_IMAGE_HEIGHT,0),a.pixelStorei(a.UNPACK_SKIP_PIXELS,0),a.pixelStorei(a.UNPACK_SKIP_ROWS,0),a.pixelStorei(a.UNPACK_SKIP_IMAGES,0),g={},_={},Me=null,O={},v={},S=new WeakMap,E=[],w=null,y=!1,M=null,P=null,z=null,C=null,I=null,N=null,B=null,T=new wt(0,0,0),L=0,X=!1,V=null,j=null,ue=null,fe=null,q=null,Ce.set(0,0,a.canvas.width,a.canvas.height),ze.set(0,0,a.canvas.width,a.canvas.height),c.reset(),u.reset(),d.reset()}return{buffers:{color:c,depth:u,stencil:d},enable:Te,disable:We,bindFramebuffer:it,drawBuffers:et,useProgram:qt,setBlending:_t,setMaterial:rt,setFlipSided:Yt,setCullFace:zt,setLineWidth:Ht,setPolygonOffset:an,setScissorTest:It,activeTexture:jt,bindTexture:Z,unbindTexture:Dt,compressedTexImage2D:xt,compressedTexImage3D:U,texImage2D:he,texImage3D:me,pixelStorei:Ge,getParameter:De,updateUBOMapping:Le,uniformBlockBinding:Oe,texStorage2D:Ne,texStorage3D:Pe,texSubImage2D:b,texSubImage3D:J,compressedTexSubImage2D:oe,compressedTexSubImage3D:pe,scissor:Be,viewport:ge,reset:qe}}function C2(a,e,i,r,o,c,u){const d=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new Pt,g=new WeakMap,_=new Set;let v;const S=new WeakMap;let E=!1;try{E=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function w(U,b){return E?new OffscreenCanvas(U,b):mu("canvas")}function y(U,b,J){let oe=1;const pe=xt(U);if((pe.width>J||pe.height>J)&&(oe=J/Math.max(pe.width,pe.height)),oe<1)if(typeof HTMLImageElement<"u"&&U instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&U instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&U instanceof ImageBitmap||typeof VideoFrame<"u"&&U instanceof VideoFrame){const Ne=Math.floor(oe*pe.width),Pe=Math.floor(oe*pe.height);v===void 0&&(v=w(Ne,Pe));const he=b?w(Ne,Pe):v;return he.width=Ne,he.height=Pe,he.getContext("2d").drawImage(U,0,0,Ne,Pe),st("WebGLRenderer: Texture has been resized from ("+pe.width+"x"+pe.height+") to ("+Ne+"x"+Pe+")."),he}else return"data"in U&&st("WebGLRenderer: Image in DataTexture is too big ("+pe.width+"x"+pe.height+")."),U;return U}function M(U){return U.generateMipmaps}function P(U){a.generateMipmap(U)}function z(U){return U.isWebGLCubeRenderTarget?a.TEXTURE_CUBE_MAP:U.isWebGL3DRenderTarget?a.TEXTURE_3D:U.isWebGLArrayRenderTarget||U.isCompressedArrayTexture?a.TEXTURE_2D_ARRAY:a.TEXTURE_2D}function C(U,b,J,oe,pe,Ne=!1){if(U!==null){if(a[U]!==void 0)return a[U];st("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+U+"'")}let Pe;oe&&(Pe=e.get("EXT_texture_norm16"),Pe||st("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let he=b;if(b===a.RED&&(J===a.FLOAT&&(he=a.R32F),J===a.HALF_FLOAT&&(he=a.R16F),J===a.UNSIGNED_BYTE&&(he=a.R8),J===a.UNSIGNED_SHORT&&Pe&&(he=Pe.R16_EXT),J===a.SHORT&&Pe&&(he=Pe.R16_SNORM_EXT)),b===a.RED_INTEGER&&(J===a.UNSIGNED_BYTE&&(he=a.R8UI),J===a.UNSIGNED_SHORT&&(he=a.R16UI),J===a.UNSIGNED_INT&&(he=a.R32UI),J===a.BYTE&&(he=a.R8I),J===a.SHORT&&(he=a.R16I),J===a.INT&&(he=a.R32I)),b===a.RG&&(J===a.FLOAT&&(he=a.RG32F),J===a.HALF_FLOAT&&(he=a.RG16F),J===a.UNSIGNED_BYTE&&(he=a.RG8),J===a.UNSIGNED_SHORT&&Pe&&(he=Pe.RG16_EXT),J===a.SHORT&&Pe&&(he=Pe.RG16_SNORM_EXT)),b===a.RG_INTEGER&&(J===a.UNSIGNED_BYTE&&(he=a.RG8UI),J===a.UNSIGNED_SHORT&&(he=a.RG16UI),J===a.UNSIGNED_INT&&(he=a.RG32UI),J===a.BYTE&&(he=a.RG8I),J===a.SHORT&&(he=a.RG16I),J===a.INT&&(he=a.RG32I)),b===a.RGB_INTEGER&&(J===a.UNSIGNED_BYTE&&(he=a.RGB8UI),J===a.UNSIGNED_SHORT&&(he=a.RGB16UI),J===a.UNSIGNED_INT&&(he=a.RGB32UI),J===a.BYTE&&(he=a.RGB8I),J===a.SHORT&&(he=a.RGB16I),J===a.INT&&(he=a.RGB32I)),b===a.RGBA_INTEGER&&(J===a.UNSIGNED_BYTE&&(he=a.RGBA8UI),J===a.UNSIGNED_SHORT&&(he=a.RGBA16UI),J===a.UNSIGNED_INT&&(he=a.RGBA32UI),J===a.BYTE&&(he=a.RGBA8I),J===a.SHORT&&(he=a.RGBA16I),J===a.INT&&(he=a.RGBA32I)),b===a.RGB&&(J===a.UNSIGNED_SHORT&&Pe&&(he=Pe.RGB16_EXT),J===a.SHORT&&Pe&&(he=Pe.RGB16_SNORM_EXT),J===a.UNSIGNED_INT_5_9_9_9_REV&&(he=a.RGB9_E5),J===a.UNSIGNED_INT_10F_11F_11F_REV&&(he=a.R11F_G11F_B10F)),b===a.RGBA){const me=Ne?hu:Rt.getTransfer(pe);J===a.FLOAT&&(he=a.RGBA32F),J===a.HALF_FLOAT&&(he=a.RGBA16F),J===a.UNSIGNED_BYTE&&(he=me===Wt?a.SRGB8_ALPHA8:a.RGBA8),J===a.UNSIGNED_SHORT&&Pe&&(he=Pe.RGBA16_EXT),J===a.SHORT&&Pe&&(he=Pe.RGBA16_SNORM_EXT),J===a.UNSIGNED_SHORT_4_4_4_4&&(he=a.RGBA4),J===a.UNSIGNED_SHORT_5_5_5_1&&(he=a.RGB5_A1)}return(he===a.R16F||he===a.R32F||he===a.RG16F||he===a.RG32F||he===a.RGBA16F||he===a.RGBA32F)&&e.get("EXT_color_buffer_float"),he}function I(U,b){let J;return U?b===null||b===ha||b===Sl?J=a.DEPTH24_STENCIL8:b===la?J=a.DEPTH32F_STENCIL8:b===xl&&(J=a.DEPTH24_STENCIL8,st("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===ha||b===Sl?J=a.DEPTH_COMPONENT24:b===la?J=a.DEPTH_COMPONENT32F:b===xl&&(J=a.DEPTH_COMPONENT16),J}function N(U,b){return M(U)===!0||U.isFramebufferTexture&&U.minFilter!==Bn&&U.minFilter!==Tn?Math.log2(Math.max(b.width,b.height))+1:U.mipmaps!==void 0&&U.mipmaps.length>0?U.mipmaps.length:U.isCompressedTexture&&Array.isArray(U.image)?b.mipmaps.length:1}function B(U){const b=U.target;b.removeEventListener("dispose",B),L(b),b.isVideoTexture&&g.delete(b),b.isHTMLTexture&&_.delete(b)}function T(U){const b=U.target;b.removeEventListener("dispose",T),V(b)}function L(U){const b=r.get(U);if(b.__webglInit===void 0)return;const J=U.source,oe=S.get(J);if(oe){const pe=oe[b.__cacheKey];pe.usedTimes--,pe.usedTimes===0&&X(U),Object.keys(oe).length===0&&S.delete(J)}r.remove(U)}function X(U){const b=r.get(U);a.deleteTexture(b.__webglTexture);const J=U.source,oe=S.get(J);delete oe[b.__cacheKey],u.memory.textures--}function V(U){const b=r.get(U);if(U.depthTexture&&(U.depthTexture.dispose(),r.remove(U.depthTexture)),U.isWebGLCubeRenderTarget)for(let oe=0;oe<6;oe++){if(Array.isArray(b.__webglFramebuffer[oe]))for(let pe=0;pe<b.__webglFramebuffer[oe].length;pe++)a.deleteFramebuffer(b.__webglFramebuffer[oe][pe]);else a.deleteFramebuffer(b.__webglFramebuffer[oe]);b.__webglDepthbuffer&&a.deleteRenderbuffer(b.__webglDepthbuffer[oe])}else{if(Array.isArray(b.__webglFramebuffer))for(let oe=0;oe<b.__webglFramebuffer.length;oe++)a.deleteFramebuffer(b.__webglFramebuffer[oe]);else a.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&a.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&a.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let oe=0;oe<b.__webglColorRenderbuffer.length;oe++)b.__webglColorRenderbuffer[oe]&&a.deleteRenderbuffer(b.__webglColorRenderbuffer[oe]);b.__webglDepthRenderbuffer&&a.deleteRenderbuffer(b.__webglDepthRenderbuffer)}const J=U.textures;for(let oe=0,pe=J.length;oe<pe;oe++){const Ne=r.get(J[oe]);Ne.__webglTexture&&(a.deleteTexture(Ne.__webglTexture),u.memory.textures--),r.remove(J[oe])}r.remove(U)}let j=0;function ue(){j=0}function fe(){return j}function q(U){j=U}function F(){const U=j;return U>=o.maxTextures&&st("WebGLTextures: Trying to use "+U+" texture units while this GPU supports only "+o.maxTextures),j+=1,U}function H(U){const b=[];return b.push(U.wrapS),b.push(U.wrapT),b.push(U.wrapR||0),b.push(U.magFilter),b.push(U.minFilter),b.push(U.anisotropy),b.push(U.internalFormat),b.push(U.format),b.push(U.type),b.push(U.generateMipmaps),b.push(U.premultiplyAlpha),b.push(U.flipY),b.push(U.unpackAlignment),b.push(U.colorSpace),b.join()}function $(U,b){const J=r.get(U);if(U.isVideoTexture&&Z(U),U.isRenderTargetTexture===!1&&U.isExternalTexture!==!0&&U.version>0&&J.__version!==U.version){const oe=U.image;if(oe===null)st("WebGLRenderer: Texture marked for update but no image data found.");else if(oe.complete===!1)st("WebGLRenderer: Texture marked for update but image is incomplete");else{We(J,U,b);return}}else U.isExternalTexture&&(J.__webglTexture=U.sourceTexture?U.sourceTexture:null);i.bindTexture(a.TEXTURE_2D,J.__webglTexture,a.TEXTURE0+b)}function _e(U,b){const J=r.get(U);if(U.isRenderTargetTexture===!1&&U.version>0&&J.__version!==U.version){We(J,U,b);return}else U.isExternalTexture&&(J.__webglTexture=U.sourceTexture?U.sourceTexture:null);i.bindTexture(a.TEXTURE_2D_ARRAY,J.__webglTexture,a.TEXTURE0+b)}function Me(U,b){const J=r.get(U);if(U.isRenderTargetTexture===!1&&U.version>0&&J.__version!==U.version){We(J,U,b);return}i.bindTexture(a.TEXTURE_3D,J.__webglTexture,a.TEXTURE0+b)}function O(U,b){const J=r.get(U);if(U.isCubeDepthTexture!==!0&&U.version>0&&J.__version!==U.version){it(J,U,b);return}i.bindTexture(a.TEXTURE_CUBE_MAP,J.__webglTexture,a.TEXTURE0+b)}const K={[Nh]:a.REPEAT,[Ki]:a.CLAMP_TO_EDGE,[Lh]:a.MIRRORED_REPEAT},ye={[Bn]:a.NEAREST,[Uy]:a.NEAREST_MIPMAP_NEAREST,[Oc]:a.NEAREST_MIPMAP_LINEAR,[Tn]:a.LINEAR,[zd]:a.LINEAR_MIPMAP_NEAREST,[Ts]:a.LINEAR_MIPMAP_LINEAR},Ce={[Iy]:a.NEVER,[Gy]:a.ALWAYS,[Fy]:a.LESS,[Mp]:a.LEQUAL,[By]:a.EQUAL,[yp]:a.GEQUAL,[zy]:a.GREATER,[Hy]:a.NOTEQUAL};function ze(U,b){if(b.type===la&&e.has("OES_texture_float_linear")===!1&&(b.magFilter===Tn||b.magFilter===zd||b.magFilter===Oc||b.magFilter===Ts||b.minFilter===Tn||b.minFilter===zd||b.minFilter===Oc||b.minFilter===Ts)&&st("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),a.texParameteri(U,a.TEXTURE_WRAP_S,K[b.wrapS]),a.texParameteri(U,a.TEXTURE_WRAP_T,K[b.wrapT]),(U===a.TEXTURE_3D||U===a.TEXTURE_2D_ARRAY)&&a.texParameteri(U,a.TEXTURE_WRAP_R,K[b.wrapR]),a.texParameteri(U,a.TEXTURE_MAG_FILTER,ye[b.magFilter]),a.texParameteri(U,a.TEXTURE_MIN_FILTER,ye[b.minFilter]),b.compareFunction&&(a.texParameteri(U,a.TEXTURE_COMPARE_MODE,a.COMPARE_REF_TO_TEXTURE),a.texParameteri(U,a.TEXTURE_COMPARE_FUNC,Ce[b.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===Bn||b.minFilter!==Oc&&b.minFilter!==Ts||b.type===la&&e.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||r.get(b).__currentAnisotropy){const J=e.get("EXT_texture_filter_anisotropic");a.texParameterf(U,J.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,o.getMaxAnisotropy())),r.get(b).__currentAnisotropy=b.anisotropy}}}function se(U,b){let J=!1;U.__webglInit===void 0&&(U.__webglInit=!0,b.addEventListener("dispose",B));const oe=b.source;let pe=S.get(oe);pe===void 0&&(pe={},S.set(oe,pe));const Ne=H(b);if(Ne!==U.__cacheKey){pe[Ne]===void 0&&(pe[Ne]={texture:a.createTexture(),usedTimes:0},u.memory.textures++,J=!0),pe[Ne].usedTimes++;const Pe=pe[U.__cacheKey];Pe!==void 0&&(pe[U.__cacheKey].usedTimes--,Pe.usedTimes===0&&X(b)),U.__cacheKey=Ne,U.__webglTexture=pe[Ne].texture}return J}function be(U,b,J){return Math.floor(Math.floor(U/J)/b)}function Te(U,b,J,oe){const Ne=U.updateRanges;if(Ne.length===0)i.texSubImage2D(a.TEXTURE_2D,0,0,0,b.width,b.height,J,oe,b.data);else{Ne.sort((Ge,Be)=>Ge.start-Be.start);let Pe=0;for(let Ge=1;Ge<Ne.length;Ge++){const Be=Ne[Pe],ge=Ne[Ge],Le=Be.start+Be.count,Oe=be(ge.start,b.width,4),qe=be(Be.start,b.width,4);ge.start<=Le+1&&Oe===qe&&be(ge.start+ge.count-1,b.width,4)===Oe?Be.count=Math.max(Be.count,ge.start+ge.count-Be.start):(++Pe,Ne[Pe]=ge)}Ne.length=Pe+1;const he=i.getParameter(a.UNPACK_ROW_LENGTH),me=i.getParameter(a.UNPACK_SKIP_PIXELS),De=i.getParameter(a.UNPACK_SKIP_ROWS);i.pixelStorei(a.UNPACK_ROW_LENGTH,b.width);for(let Ge=0,Be=Ne.length;Ge<Be;Ge++){const ge=Ne[Ge],Le=Math.floor(ge.start/4),Oe=Math.ceil(ge.count/4),qe=Le%b.width,k=Math.floor(Le/b.width),Ae=Oe,ce=1;i.pixelStorei(a.UNPACK_SKIP_PIXELS,qe),i.pixelStorei(a.UNPACK_SKIP_ROWS,k),i.texSubImage2D(a.TEXTURE_2D,0,qe,k,Ae,ce,J,oe,b.data)}U.clearUpdateRanges(),i.pixelStorei(a.UNPACK_ROW_LENGTH,he),i.pixelStorei(a.UNPACK_SKIP_PIXELS,me),i.pixelStorei(a.UNPACK_SKIP_ROWS,De)}}function We(U,b,J){let oe=a.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(oe=a.TEXTURE_2D_ARRAY),b.isData3DTexture&&(oe=a.TEXTURE_3D);const pe=se(U,b),Ne=b.source;i.bindTexture(oe,U.__webglTexture,a.TEXTURE0+J);const Pe=r.get(Ne);if(Ne.version!==Pe.__version||pe===!0){if(i.activeTexture(a.TEXTURE0+J),(typeof ImageBitmap<"u"&&b.image instanceof ImageBitmap)===!1){const ce=Rt.getPrimaries(Rt.workingColorSpace),Re=b.colorSpace===bs?null:Rt.getPrimaries(b.colorSpace),we=b.colorSpace===bs||ce===Re?a.NONE:a.BROWSER_DEFAULT_WEBGL;i.pixelStorei(a.UNPACK_FLIP_Y_WEBGL,b.flipY),i.pixelStorei(a.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),i.pixelStorei(a.UNPACK_COLORSPACE_CONVERSION_WEBGL,we)}i.pixelStorei(a.UNPACK_ALIGNMENT,b.unpackAlignment);let me=y(b.image,!1,o.maxTextureSize);me=Dt(b,me);const De=c.convert(b.format,b.colorSpace),Ge=c.convert(b.type);let Be=C(b.internalFormat,De,Ge,b.normalized,b.colorSpace,b.isVideoTexture);ze(oe,b);let ge;const Le=b.mipmaps,Oe=b.isVideoTexture!==!0,qe=Pe.__version===void 0||pe===!0,k=Ne.dataReady,Ae=N(b,me);if(b.isDepthTexture)Be=I(b.format===tr,b.type),qe&&(Oe?i.texStorage2D(a.TEXTURE_2D,1,Be,me.width,me.height):i.texImage2D(a.TEXTURE_2D,0,Be,me.width,me.height,0,De,Ge,null));else if(b.isDataTexture)if(Le.length>0){Oe&&qe&&i.texStorage2D(a.TEXTURE_2D,Ae,Be,Le[0].width,Le[0].height);for(let ce=0,Re=Le.length;ce<Re;ce++)ge=Le[ce],Oe?k&&i.texSubImage2D(a.TEXTURE_2D,ce,0,0,ge.width,ge.height,De,Ge,ge.data):i.texImage2D(a.TEXTURE_2D,ce,Be,ge.width,ge.height,0,De,Ge,ge.data);b.generateMipmaps=!1}else Oe?(qe&&i.texStorage2D(a.TEXTURE_2D,Ae,Be,me.width,me.height),k&&Te(b,me,De,Ge)):i.texImage2D(a.TEXTURE_2D,0,Be,me.width,me.height,0,De,Ge,me.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){Oe&&qe&&i.texStorage3D(a.TEXTURE_2D_ARRAY,Ae,Be,Le[0].width,Le[0].height,me.depth);for(let ce=0,Re=Le.length;ce<Re;ce++)if(ge=Le[ce],b.format!==Qi)if(De!==null)if(Oe){if(k)if(b.layerUpdates.size>0){const we=iv(ge.width,ge.height,b.format,b.type);for(const xe of b.layerUpdates){const je=ge.data.subarray(xe*we/ge.data.BYTES_PER_ELEMENT,(xe+1)*we/ge.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(a.TEXTURE_2D_ARRAY,ce,0,0,xe,ge.width,ge.height,1,De,je)}b.clearLayerUpdates()}else i.compressedTexSubImage3D(a.TEXTURE_2D_ARRAY,ce,0,0,0,ge.width,ge.height,me.depth,De,ge.data)}else i.compressedTexImage3D(a.TEXTURE_2D_ARRAY,ce,Be,ge.width,ge.height,me.depth,0,ge.data,0,0);else st("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Oe?k&&i.texSubImage3D(a.TEXTURE_2D_ARRAY,ce,0,0,0,ge.width,ge.height,me.depth,De,Ge,ge.data):i.texImage3D(a.TEXTURE_2D_ARRAY,ce,Be,ge.width,ge.height,me.depth,0,De,Ge,ge.data)}else{Oe&&qe&&i.texStorage2D(a.TEXTURE_2D,Ae,Be,Le[0].width,Le[0].height);for(let ce=0,Re=Le.length;ce<Re;ce++)ge=Le[ce],b.format!==Qi?De!==null?Oe?k&&i.compressedTexSubImage2D(a.TEXTURE_2D,ce,0,0,ge.width,ge.height,De,ge.data):i.compressedTexImage2D(a.TEXTURE_2D,ce,Be,ge.width,ge.height,0,ge.data):st("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Oe?k&&i.texSubImage2D(a.TEXTURE_2D,ce,0,0,ge.width,ge.height,De,Ge,ge.data):i.texImage2D(a.TEXTURE_2D,ce,Be,ge.width,ge.height,0,De,Ge,ge.data)}else if(b.isDataArrayTexture)if(Oe){if(qe&&i.texStorage3D(a.TEXTURE_2D_ARRAY,Ae,Be,me.width,me.height,me.depth),k)if(b.layerUpdates.size>0){const ce=iv(me.width,me.height,b.format,b.type);for(const Re of b.layerUpdates){const we=me.data.subarray(Re*ce/me.data.BYTES_PER_ELEMENT,(Re+1)*ce/me.data.BYTES_PER_ELEMENT);i.texSubImage3D(a.TEXTURE_2D_ARRAY,0,0,0,Re,me.width,me.height,1,De,Ge,we)}b.clearLayerUpdates()}else i.texSubImage3D(a.TEXTURE_2D_ARRAY,0,0,0,0,me.width,me.height,me.depth,De,Ge,me.data)}else i.texImage3D(a.TEXTURE_2D_ARRAY,0,Be,me.width,me.height,me.depth,0,De,Ge,me.data);else if(b.isData3DTexture)Oe?(qe&&i.texStorage3D(a.TEXTURE_3D,Ae,Be,me.width,me.height,me.depth),k&&i.texSubImage3D(a.TEXTURE_3D,0,0,0,0,me.width,me.height,me.depth,De,Ge,me.data)):i.texImage3D(a.TEXTURE_3D,0,Be,me.width,me.height,me.depth,0,De,Ge,me.data);else if(b.isFramebufferTexture){if(qe)if(Oe)i.texStorage2D(a.TEXTURE_2D,Ae,Be,me.width,me.height);else{let ce=me.width,Re=me.height;for(let we=0;we<Ae;we++)i.texImage2D(a.TEXTURE_2D,we,Be,ce,Re,0,De,Ge,null),ce>>=1,Re>>=1}}else if(b.isHTMLTexture){if("texElementImage2D"in a){const ce=a.canvas;if(ce.hasAttribute("layoutsubtree")||ce.setAttribute("layoutsubtree","true"),me.parentNode!==ce){ce.appendChild(me),_.add(b),ce.onpaint=Re=>{const we=Re.changedElements;for(const xe of _)we.includes(xe.image)&&(xe.needsUpdate=!0)},ce.requestPaint();return}if(a.texElementImage2D.length===3)a.texElementImage2D(a.TEXTURE_2D,a.RGBA8,me);else{const we=a.RGBA,xe=a.RGBA,je=a.UNSIGNED_BYTE;a.texElementImage2D(a.TEXTURE_2D,0,we,xe,je,me)}a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MIN_FILTER,a.LINEAR),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_S,a.CLAMP_TO_EDGE),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_T,a.CLAMP_TO_EDGE)}}else if(Le.length>0){if(Oe&&qe){const ce=xt(Le[0]);i.texStorage2D(a.TEXTURE_2D,Ae,Be,ce.width,ce.height)}for(let ce=0,Re=Le.length;ce<Re;ce++)ge=Le[ce],Oe?k&&i.texSubImage2D(a.TEXTURE_2D,ce,0,0,De,Ge,ge):i.texImage2D(a.TEXTURE_2D,ce,Be,De,Ge,ge);b.generateMipmaps=!1}else if(Oe){if(qe){const ce=xt(me);i.texStorage2D(a.TEXTURE_2D,Ae,Be,ce.width,ce.height)}k&&i.texSubImage2D(a.TEXTURE_2D,0,0,0,De,Ge,me)}else i.texImage2D(a.TEXTURE_2D,0,Be,De,Ge,me);M(b)&&P(oe),Pe.__version=Ne.version,b.onUpdate&&b.onUpdate(b)}U.__version=b.version}function it(U,b,J){if(b.image.length!==6)return;const oe=se(U,b),pe=b.source;i.bindTexture(a.TEXTURE_CUBE_MAP,U.__webglTexture,a.TEXTURE0+J);const Ne=r.get(pe);if(pe.version!==Ne.__version||oe===!0){i.activeTexture(a.TEXTURE0+J);const Pe=Rt.getPrimaries(Rt.workingColorSpace),he=b.colorSpace===bs?null:Rt.getPrimaries(b.colorSpace),me=b.colorSpace===bs||Pe===he?a.NONE:a.BROWSER_DEFAULT_WEBGL;i.pixelStorei(a.UNPACK_FLIP_Y_WEBGL,b.flipY),i.pixelStorei(a.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),i.pixelStorei(a.UNPACK_ALIGNMENT,b.unpackAlignment),i.pixelStorei(a.UNPACK_COLORSPACE_CONVERSION_WEBGL,me);const De=b.isCompressedTexture||b.image[0].isCompressedTexture,Ge=b.image[0]&&b.image[0].isDataTexture,Be=[];for(let xe=0;xe<6;xe++)!De&&!Ge?Be[xe]=y(b.image[xe],!0,o.maxCubemapSize):Be[xe]=Ge?b.image[xe].image:b.image[xe],Be[xe]=Dt(b,Be[xe]);const ge=Be[0],Le=c.convert(b.format,b.colorSpace),Oe=c.convert(b.type),qe=C(b.internalFormat,Le,Oe,b.normalized,b.colorSpace),k=b.isVideoTexture!==!0,Ae=Ne.__version===void 0||oe===!0,ce=pe.dataReady;let Re=N(b,ge);ze(a.TEXTURE_CUBE_MAP,b);let we;if(De){k&&Ae&&i.texStorage2D(a.TEXTURE_CUBE_MAP,Re,qe,ge.width,ge.height);for(let xe=0;xe<6;xe++){we=Be[xe].mipmaps;for(let je=0;je<we.length;je++){const Ve=we[je];b.format!==Qi?Le!==null?k?ce&&i.compressedTexSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+xe,je,0,0,Ve.width,Ve.height,Le,Ve.data):i.compressedTexImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+xe,je,qe,Ve.width,Ve.height,0,Ve.data):st("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):k?ce&&i.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+xe,je,0,0,Ve.width,Ve.height,Le,Oe,Ve.data):i.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+xe,je,qe,Ve.width,Ve.height,0,Le,Oe,Ve.data)}}}else{if(we=b.mipmaps,k&&Ae){we.length>0&&Re++;const xe=xt(Be[0]);i.texStorage2D(a.TEXTURE_CUBE_MAP,Re,qe,xe.width,xe.height)}for(let xe=0;xe<6;xe++)if(Ge){k?ce&&i.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,0,0,Be[xe].width,Be[xe].height,Le,Oe,Be[xe].data):i.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,qe,Be[xe].width,Be[xe].height,0,Le,Oe,Be[xe].data);for(let je=0;je<we.length;je++){const Ft=we[je].image[xe].image;k?ce&&i.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+xe,je+1,0,0,Ft.width,Ft.height,Le,Oe,Ft.data):i.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+xe,je+1,qe,Ft.width,Ft.height,0,Le,Oe,Ft.data)}}else{k?ce&&i.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,0,0,Le,Oe,Be[xe]):i.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,qe,Le,Oe,Be[xe]);for(let je=0;je<we.length;je++){const Ve=we[je];k?ce&&i.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+xe,je+1,0,0,Le,Oe,Ve.image[xe]):i.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+xe,je+1,qe,Le,Oe,Ve.image[xe])}}}M(b)&&P(a.TEXTURE_CUBE_MAP),Ne.__version=pe.version,b.onUpdate&&b.onUpdate(b)}U.__version=b.version}function et(U,b,J,oe,pe,Ne){const Pe=c.convert(J.format,J.colorSpace),he=c.convert(J.type),me=C(J.internalFormat,Pe,he,J.normalized,J.colorSpace),De=r.get(b),Ge=r.get(J);if(Ge.__renderTarget=b,!De.__hasExternalTextures){const Be=Math.max(1,b.width>>Ne),ge=Math.max(1,b.height>>Ne);pe===a.TEXTURE_3D||pe===a.TEXTURE_2D_ARRAY?i.texImage3D(pe,Ne,me,Be,ge,b.depth,0,Pe,he,null):i.texImage2D(pe,Ne,me,Be,ge,0,Pe,he,null)}i.bindFramebuffer(a.FRAMEBUFFER,U),jt(b)?d.framebufferTexture2DMultisampleEXT(a.FRAMEBUFFER,oe,pe,Ge.__webglTexture,0,It(b)):(pe===a.TEXTURE_2D||pe>=a.TEXTURE_CUBE_MAP_POSITIVE_X&&pe<=a.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&a.framebufferTexture2D(a.FRAMEBUFFER,oe,pe,Ge.__webglTexture,Ne),i.bindFramebuffer(a.FRAMEBUFFER,null)}function qt(U,b,J){if(a.bindRenderbuffer(a.RENDERBUFFER,U),b.depthBuffer){const oe=b.depthTexture,pe=oe&&oe.isDepthTexture?oe.type:null,Ne=I(b.stencilBuffer,pe),Pe=b.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT;jt(b)?d.renderbufferStorageMultisampleEXT(a.RENDERBUFFER,It(b),Ne,b.width,b.height):J?a.renderbufferStorageMultisample(a.RENDERBUFFER,It(b),Ne,b.width,b.height):a.renderbufferStorage(a.RENDERBUFFER,Ne,b.width,b.height),a.framebufferRenderbuffer(a.FRAMEBUFFER,Pe,a.RENDERBUFFER,U)}else{const oe=b.textures;for(let pe=0;pe<oe.length;pe++){const Ne=oe[pe],Pe=c.convert(Ne.format,Ne.colorSpace),he=c.convert(Ne.type),me=C(Ne.internalFormat,Pe,he,Ne.normalized,Ne.colorSpace);jt(b)?d.renderbufferStorageMultisampleEXT(a.RENDERBUFFER,It(b),me,b.width,b.height):J?a.renderbufferStorageMultisample(a.RENDERBUFFER,It(b),me,b.width,b.height):a.renderbufferStorage(a.RENDERBUFFER,me,b.width,b.height)}}a.bindRenderbuffer(a.RENDERBUFFER,null)}function ot(U,b,J){const oe=b.isWebGLCubeRenderTarget===!0;if(i.bindFramebuffer(a.FRAMEBUFFER,U),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const pe=r.get(b.depthTexture);if(pe.__renderTarget=b,(!pe.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),oe){if(pe.__webglInit===void 0&&(pe.__webglInit=!0,b.depthTexture.addEventListener("dispose",B)),pe.__webglTexture===void 0){pe.__webglTexture=a.createTexture(),i.bindTexture(a.TEXTURE_CUBE_MAP,pe.__webglTexture),ze(a.TEXTURE_CUBE_MAP,b.depthTexture);const De=c.convert(b.depthTexture.format),Ge=c.convert(b.depthTexture.type);let Be;b.depthTexture.format===ka?Be=a.DEPTH_COMPONENT24:b.depthTexture.format===tr&&(Be=a.DEPTH24_STENCIL8);for(let ge=0;ge<6;ge++)a.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,Be,b.width,b.height,0,De,Ge,null)}}else $(b.depthTexture,0);const Ne=pe.__webglTexture,Pe=It(b),he=oe?a.TEXTURE_CUBE_MAP_POSITIVE_X+J:a.TEXTURE_2D,me=b.depthTexture.format===tr?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT;if(b.depthTexture.format===ka)jt(b)?d.framebufferTexture2DMultisampleEXT(a.FRAMEBUFFER,me,he,Ne,0,Pe):a.framebufferTexture2D(a.FRAMEBUFFER,me,he,Ne,0);else if(b.depthTexture.format===tr)jt(b)?d.framebufferTexture2DMultisampleEXT(a.FRAMEBUFFER,me,he,Ne,0,Pe):a.framebufferTexture2D(a.FRAMEBUFFER,me,he,Ne,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function gt(U){const b=r.get(U),J=U.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==U.depthTexture){const oe=U.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),oe){const pe=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,oe.removeEventListener("dispose",pe)};oe.addEventListener("dispose",pe),b.__depthDisposeCallback=pe}b.__boundDepthTexture=oe}if(U.depthTexture&&!b.__autoAllocateDepthBuffer)if(J)for(let oe=0;oe<6;oe++)ot(b.__webglFramebuffer[oe],U,oe);else{const oe=U.texture.mipmaps;oe&&oe.length>0?ot(b.__webglFramebuffer[0],U,0):ot(b.__webglFramebuffer,U,0)}else if(J){b.__webglDepthbuffer=[];for(let oe=0;oe<6;oe++)if(i.bindFramebuffer(a.FRAMEBUFFER,b.__webglFramebuffer[oe]),b.__webglDepthbuffer[oe]===void 0)b.__webglDepthbuffer[oe]=a.createRenderbuffer(),qt(b.__webglDepthbuffer[oe],U,!1);else{const pe=U.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,Ne=b.__webglDepthbuffer[oe];a.bindRenderbuffer(a.RENDERBUFFER,Ne),a.framebufferRenderbuffer(a.FRAMEBUFFER,pe,a.RENDERBUFFER,Ne)}}else{const oe=U.texture.mipmaps;if(oe&&oe.length>0?i.bindFramebuffer(a.FRAMEBUFFER,b.__webglFramebuffer[0]):i.bindFramebuffer(a.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=a.createRenderbuffer(),qt(b.__webglDepthbuffer,U,!1);else{const pe=U.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,Ne=b.__webglDepthbuffer;a.bindRenderbuffer(a.RENDERBUFFER,Ne),a.framebufferRenderbuffer(a.FRAMEBUFFER,pe,a.RENDERBUFFER,Ne)}}i.bindFramebuffer(a.FRAMEBUFFER,null)}function _t(U,b,J){const oe=r.get(U);b!==void 0&&et(oe.__webglFramebuffer,U,U.texture,a.COLOR_ATTACHMENT0,a.TEXTURE_2D,0),J!==void 0&&gt(U)}function rt(U){const b=U.texture,J=r.get(U),oe=r.get(b);U.addEventListener("dispose",T);const pe=U.textures,Ne=U.isWebGLCubeRenderTarget===!0,Pe=pe.length>1;if(Pe||(oe.__webglTexture===void 0&&(oe.__webglTexture=a.createTexture()),oe.__version=b.version,u.memory.textures++),Ne){J.__webglFramebuffer=[];for(let he=0;he<6;he++)if(b.mipmaps&&b.mipmaps.length>0){J.__webglFramebuffer[he]=[];for(let me=0;me<b.mipmaps.length;me++)J.__webglFramebuffer[he][me]=a.createFramebuffer()}else J.__webglFramebuffer[he]=a.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){J.__webglFramebuffer=[];for(let he=0;he<b.mipmaps.length;he++)J.__webglFramebuffer[he]=a.createFramebuffer()}else J.__webglFramebuffer=a.createFramebuffer();if(Pe)for(let he=0,me=pe.length;he<me;he++){const De=r.get(pe[he]);De.__webglTexture===void 0&&(De.__webglTexture=a.createTexture(),u.memory.textures++)}if(U.samples>0&&jt(U)===!1){J.__webglMultisampledFramebuffer=a.createFramebuffer(),J.__webglColorRenderbuffer=[],i.bindFramebuffer(a.FRAMEBUFFER,J.__webglMultisampledFramebuffer);for(let he=0;he<pe.length;he++){const me=pe[he];J.__webglColorRenderbuffer[he]=a.createRenderbuffer(),a.bindRenderbuffer(a.RENDERBUFFER,J.__webglColorRenderbuffer[he]);const De=c.convert(me.format,me.colorSpace),Ge=c.convert(me.type),Be=C(me.internalFormat,De,Ge,me.normalized,me.colorSpace,U.isXRRenderTarget===!0),ge=It(U);a.renderbufferStorageMultisample(a.RENDERBUFFER,ge,Be,U.width,U.height),a.framebufferRenderbuffer(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0+he,a.RENDERBUFFER,J.__webglColorRenderbuffer[he])}a.bindRenderbuffer(a.RENDERBUFFER,null),U.depthBuffer&&(J.__webglDepthRenderbuffer=a.createRenderbuffer(),qt(J.__webglDepthRenderbuffer,U,!0)),i.bindFramebuffer(a.FRAMEBUFFER,null)}}if(Ne){i.bindTexture(a.TEXTURE_CUBE_MAP,oe.__webglTexture),ze(a.TEXTURE_CUBE_MAP,b);for(let he=0;he<6;he++)if(b.mipmaps&&b.mipmaps.length>0)for(let me=0;me<b.mipmaps.length;me++)et(J.__webglFramebuffer[he][me],U,b,a.COLOR_ATTACHMENT0,a.TEXTURE_CUBE_MAP_POSITIVE_X+he,me);else et(J.__webglFramebuffer[he],U,b,a.COLOR_ATTACHMENT0,a.TEXTURE_CUBE_MAP_POSITIVE_X+he,0);M(b)&&P(a.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Pe){for(let he=0,me=pe.length;he<me;he++){const De=pe[he],Ge=r.get(De);let Be=a.TEXTURE_2D;(U.isWebGL3DRenderTarget||U.isWebGLArrayRenderTarget)&&(Be=U.isWebGL3DRenderTarget?a.TEXTURE_3D:a.TEXTURE_2D_ARRAY),i.bindTexture(Be,Ge.__webglTexture),ze(Be,De),et(J.__webglFramebuffer,U,De,a.COLOR_ATTACHMENT0+he,Be,0),M(De)&&P(Be)}i.unbindTexture()}else{let he=a.TEXTURE_2D;if((U.isWebGL3DRenderTarget||U.isWebGLArrayRenderTarget)&&(he=U.isWebGL3DRenderTarget?a.TEXTURE_3D:a.TEXTURE_2D_ARRAY),i.bindTexture(he,oe.__webglTexture),ze(he,b),b.mipmaps&&b.mipmaps.length>0)for(let me=0;me<b.mipmaps.length;me++)et(J.__webglFramebuffer[me],U,b,a.COLOR_ATTACHMENT0,he,me);else et(J.__webglFramebuffer,U,b,a.COLOR_ATTACHMENT0,he,0);M(b)&&P(he),i.unbindTexture()}U.depthBuffer&&gt(U)}function Yt(U){const b=U.textures;for(let J=0,oe=b.length;J<oe;J++){const pe=b[J];if(M(pe)){const Ne=z(U),Pe=r.get(pe).__webglTexture;i.bindTexture(Ne,Pe),P(Ne),i.unbindTexture()}}}const zt=[],Ht=[];function an(U){if(U.samples>0){if(jt(U)===!1){const b=U.textures,J=U.width,oe=U.height;let pe=a.COLOR_BUFFER_BIT;const Ne=U.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,Pe=r.get(U),he=b.length>1;if(he)for(let De=0;De<b.length;De++)i.bindFramebuffer(a.FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),a.framebufferRenderbuffer(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0+De,a.RENDERBUFFER,null),i.bindFramebuffer(a.FRAMEBUFFER,Pe.__webglFramebuffer),a.framebufferTexture2D(a.DRAW_FRAMEBUFFER,a.COLOR_ATTACHMENT0+De,a.TEXTURE_2D,null,0);i.bindFramebuffer(a.READ_FRAMEBUFFER,Pe.__webglMultisampledFramebuffer);const me=U.texture.mipmaps;me&&me.length>0?i.bindFramebuffer(a.DRAW_FRAMEBUFFER,Pe.__webglFramebuffer[0]):i.bindFramebuffer(a.DRAW_FRAMEBUFFER,Pe.__webglFramebuffer);for(let De=0;De<b.length;De++){if(U.resolveDepthBuffer&&(U.depthBuffer&&(pe|=a.DEPTH_BUFFER_BIT),U.stencilBuffer&&U.resolveStencilBuffer&&(pe|=a.STENCIL_BUFFER_BIT)),he){a.framebufferRenderbuffer(a.READ_FRAMEBUFFER,a.COLOR_ATTACHMENT0,a.RENDERBUFFER,Pe.__webglColorRenderbuffer[De]);const Ge=r.get(b[De]).__webglTexture;a.framebufferTexture2D(a.DRAW_FRAMEBUFFER,a.COLOR_ATTACHMENT0,a.TEXTURE_2D,Ge,0)}a.blitFramebuffer(0,0,J,oe,0,0,J,oe,pe,a.NEAREST),m===!0&&(zt.length=0,Ht.length=0,zt.push(a.COLOR_ATTACHMENT0+De),U.depthBuffer&&U.resolveDepthBuffer===!1&&(zt.push(Ne),Ht.push(Ne),a.invalidateFramebuffer(a.DRAW_FRAMEBUFFER,Ht)),a.invalidateFramebuffer(a.READ_FRAMEBUFFER,zt))}if(i.bindFramebuffer(a.READ_FRAMEBUFFER,null),i.bindFramebuffer(a.DRAW_FRAMEBUFFER,null),he)for(let De=0;De<b.length;De++){i.bindFramebuffer(a.FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),a.framebufferRenderbuffer(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0+De,a.RENDERBUFFER,Pe.__webglColorRenderbuffer[De]);const Ge=r.get(b[De]).__webglTexture;i.bindFramebuffer(a.FRAMEBUFFER,Pe.__webglFramebuffer),a.framebufferTexture2D(a.DRAW_FRAMEBUFFER,a.COLOR_ATTACHMENT0+De,a.TEXTURE_2D,Ge,0)}i.bindFramebuffer(a.DRAW_FRAMEBUFFER,Pe.__webglMultisampledFramebuffer)}else if(U.depthBuffer&&U.resolveDepthBuffer===!1&&m){const b=U.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT;a.invalidateFramebuffer(a.DRAW_FRAMEBUFFER,[b])}}}function It(U){return Math.min(o.maxSamples,U.samples)}function jt(U){const b=r.get(U);return U.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function Z(U){const b=u.render.frame;g.get(U)!==b&&(g.set(U,b),U.update())}function Dt(U,b){const J=U.colorSpace,oe=U.format,pe=U.type;return U.isCompressedTexture===!0||U.isVideoTexture===!0||J!==du&&J!==bs&&(Rt.getTransfer(J)===Wt?(oe!==Qi||pe!==Ui)&&st("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Lt("WebGLTextures: Unsupported texture color space:",J)),b}function xt(U){return typeof HTMLImageElement<"u"&&U instanceof HTMLImageElement?(p.width=U.naturalWidth||U.width,p.height=U.naturalHeight||U.height):typeof VideoFrame<"u"&&U instanceof VideoFrame?(p.width=U.displayWidth,p.height=U.displayHeight):(p.width=U.width,p.height=U.height),p}this.allocateTextureUnit=F,this.resetTextureUnits=ue,this.getTextureUnits=fe,this.setTextureUnits=q,this.setTexture2D=$,this.setTexture2DArray=_e,this.setTexture3D=Me,this.setTextureCube=O,this.rebindTextures=_t,this.setupRenderTarget=rt,this.updateRenderTargetMipmap=Yt,this.updateMultisampleRenderTarget=an,this.setupDepthRenderbuffer=gt,this.setupFrameBufferTexture=et,this.useMultisampledRTT=jt,this.isReversedDepthBuffer=function(){return i.buffers.depth.getReversed()}}function w2(a,e){function i(r,o=bs){let c;const u=Rt.getTransfer(o);if(r===Ui)return a.UNSIGNED_BYTE;if(r===gp)return a.UNSIGNED_SHORT_4_4_4_4;if(r===_p)return a.UNSIGNED_SHORT_5_5_5_1;if(r===ox)return a.UNSIGNED_INT_5_9_9_9_REV;if(r===lx)return a.UNSIGNED_INT_10F_11F_11F_REV;if(r===sx)return a.BYTE;if(r===rx)return a.SHORT;if(r===xl)return a.UNSIGNED_SHORT;if(r===mp)return a.INT;if(r===ha)return a.UNSIGNED_INT;if(r===la)return a.FLOAT;if(r===Va)return a.HALF_FLOAT;if(r===cx)return a.ALPHA;if(r===ux)return a.RGB;if(r===Qi)return a.RGBA;if(r===ka)return a.DEPTH_COMPONENT;if(r===tr)return a.DEPTH_STENCIL;if(r===fx)return a.RED;if(r===vp)return a.RED_INTEGER;if(r===ar)return a.RG;if(r===xp)return a.RG_INTEGER;if(r===Sp)return a.RGBA_INTEGER;if(r===au||r===su||r===ru||r===ou)if(u===Wt)if(c=e.get("WEBGL_compressed_texture_s3tc_srgb"),c!==null){if(r===au)return c.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===su)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===ru)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===ou)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(c=e.get("WEBGL_compressed_texture_s3tc"),c!==null){if(r===au)return c.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===su)return c.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===ru)return c.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===ou)return c.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===Uh||r===Oh||r===Ph||r===Ih)if(c=e.get("WEBGL_compressed_texture_pvrtc"),c!==null){if(r===Uh)return c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===Oh)return c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===Ph)return c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===Ih)return c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===Fh||r===Bh||r===zh||r===Hh||r===Gh||r===uu||r===Vh)if(c=e.get("WEBGL_compressed_texture_etc"),c!==null){if(r===Fh||r===Bh)return u===Wt?c.COMPRESSED_SRGB8_ETC2:c.COMPRESSED_RGB8_ETC2;if(r===zh)return u===Wt?c.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:c.COMPRESSED_RGBA8_ETC2_EAC;if(r===Hh)return c.COMPRESSED_R11_EAC;if(r===Gh)return c.COMPRESSED_SIGNED_R11_EAC;if(r===uu)return c.COMPRESSED_RG11_EAC;if(r===Vh)return c.COMPRESSED_SIGNED_RG11_EAC}else return null;if(r===kh||r===Xh||r===Wh||r===qh||r===Yh||r===jh||r===Zh||r===Kh||r===Qh||r===Jh||r===$h||r===ep||r===tp||r===np)if(c=e.get("WEBGL_compressed_texture_astc"),c!==null){if(r===kh)return u===Wt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:c.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===Xh)return u===Wt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:c.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===Wh)return u===Wt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:c.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===qh)return u===Wt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:c.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===Yh)return u===Wt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:c.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===jh)return u===Wt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:c.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===Zh)return u===Wt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:c.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===Kh)return u===Wt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:c.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===Qh)return u===Wt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:c.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===Jh)return u===Wt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:c.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===$h)return u===Wt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:c.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===ep)return u===Wt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:c.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===tp)return u===Wt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:c.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===np)return u===Wt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:c.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===ip||r===ap||r===sp)if(c=e.get("EXT_texture_compression_bptc"),c!==null){if(r===ip)return u===Wt?c.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:c.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===ap)return c.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===sp)return c.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===rp||r===op||r===fu||r===lp)if(c=e.get("EXT_texture_compression_rgtc"),c!==null){if(r===rp)return c.COMPRESSED_RED_RGTC1_EXT;if(r===op)return c.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===fu)return c.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===lp)return c.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Sl?a.UNSIGNED_INT_24_8:a[r]!==void 0?a[r]:null}return{convert:i}}const D2=`
void main() {
...
}`;class L2{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,i){if(this.texture===null){const r=new Mx(e.texture);(e.depthNear!==i.depthNear||e.depthFar!==i.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const i=e.cameras[0].viewport,r=new Fi({vertexShader:D2,fragmentShader:N2,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new Pi(new nr(20,20),r)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class U2 extends rr{constructor(e,i){super();const r=this;let o=null,c=1,u=null,d="local-floor",m=1,p=null,g=null,_=null,v=null,S=null,E=null;const w=typeof XRWebGLBinding<"u",y=new L2,M={},P=i.getContextAttributes();let z=null,C=null;const I=[],N=[],B=new Pt;let T=null;const L=new Li;L.viewport=new pn;const X=new Li;X.viewport=new pn;const V=[L,X],j=new kE;let ue=null,fe=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(se){let be=I[se];return be===void 0&&(be=new Wd,I[se]=be),be.getTargetRaySpace()},this.getControllerGrip=function(se){let be=I[se];return be===void 0&&(be=new Wd,I[se]=be),be.getGripSpace()},this.getHand=function(se){let be=I[se];return be===void 0&&(be=new Wd,I[se]=be),be.getHandSpace()};function q(se){const be=N.indexOf(se.inputSource);if(be===-1)return;const Te=I[be];Te!==void 0&&(Te.update(se.inputSource,se.frame,p||u),Te.dispatchEvent({type:se.type,data:se.inputSource}))}function F(){o.removeEventListener("select",q),o.removeEventListener("selectstart",q),o.removeEventListener("selectend",q),o.removeEventListener("squeeze",q),o.removeEventListener("squeezestart",q),o.removeEventListener("squeezeend",q),o.removeEventListener("end",F),o.removeEventListener("inputsourceschange",H);for(let se=0;se<I.length;se++){const be=N[se];be!==null&&(N[se]=null,I[se].disconnect(be))}ue=null,fe=null,y.reset();for(const se in M)delete M[se];e.setRenderTarget(z),S=null,v=null,_=null,o=null,C=null,ze.stop(),r.isPresenting=!1,e.setPixelRatio(T),e.setSize(B.width,B.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(se){c=se,r.isPresenting===!0&&st("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(se){d=se,r.isPresenting===!0&&st("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||u},this.setReferenceSpace=function(se){p=se},this.getBaseLayer=function(){return v!==null?v:S},this.getBinding=function(){return _===null&&w&&(_=new XRWebGLBinding(o,i)),_},this.getFrame=function(){return E},this.getSession=function(){return o},this.setSession=async function(se){if(o=se,o!==null){if(z=e.getRenderTarget(),o.addEventListener("select",q),o.addEventListener("selectstart",q),o.addEventListener("selectend",q),o.addEventListener("squeeze",q),o.addEventListener("squeezestart",q),o.addEventListener("squeezeend",q),o.addEventListener("end",F),o.addEventListener("inputsourceschange",H),P.xrCompatible!==!0&&await i.makeXRCompatible(),T=e.getPixelRatio(),e.getSize(B),w&&"createProjectionLayer"in XRWebGLBinding.prototype){let Te=null,We=null,it=null;P.depth&&(it=P.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,Te=P.stencil?tr:ka,We=P.stencil?Sl:ha);const et={colorFormat:i.RGBA8,depthFormat:it,scaleFactor:c};_=this.getBinding(),v=_.createProjectionLayer(et),o.updateRenderState({layers:[v]}),e.setPixelRatio(1),e.setSize(v.textureWidth,v.textureHeight,!1),C=new fa(v.textureWidth,v.textureHeight,{format:Qi,type:Ui,depthTexture:new uo(v.textureWidth,v.textureHeight,We,void 0,void 0,void 0,void 0,void 0,void 0,Te),stencilBuffer:P.stencil,colorSpace:e.outputColorSpace,samples:P.antialias?4:0,resolveDepthBuffer:v.ignoreDepthValues===!1,resolveStencilBuffer:v.ignoreDepthValues===!1})}else{const Te={antialias:P.antialias,alpha:!0,depth:P.depth,stencil:P.stencil,framebufferScaleFactor:c};S=new XRWebGLLayer(o,i,Te),o.updateRenderState({baseLayer:S}),e.setPixelRatio(1),e.setSize(S.framebufferWidth,S.framebufferHeight,!1),C=new fa(S.framebufferWidth,S.framebufferHeight,{format:Qi,type:Ui,colorSpace:e.outputColorSpace,stencilBuffer:P.stencil,resolveDepthBuffer:S.ignoreDepthValues===!1,resolveStencilBuffer:S.ignoreDepthValues===!1})}C.isXRRenderTarget=!0,this.setFoveation(m),p=null,u=await o.requestReferenceSpace(d),ze.setContext(o),ze.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(o!==null)return o.environmentBlendMode},this.getDepthTexture=function(){return y.getDepthTexture()};function H(se){for(let be=0;be<se.removed.length;be++){const Te=se.removed[be],We=N.indexOf(Te);We>=0&&(N[We]=null,I[We].disconnect(Te))}for(let be=0;be<se.added.length;be++){const Te=se.added[be];let We=N.indexOf(Te);if(We===-1){for(let et=0;et<I.length;et++)if(et>=N.length){N.push(Te),We=et;break}else if(N[et]===null){N[et]=Te,We=et;break}if(We===-1)break}const it=I[We];it&&it.connect(Te)}}const $=new ee,_e=new ee;function Me(se,be,Te){$.setFromMatrixPosition(be.matrixWorld),_e.setFromMatrixPosition(Te.matrixWorld);const We=$.distanceTo(_e),it=be.projectionMatrix.elements,et=Te.projectionMatrix.elements,qt=it[14]/(it[10]-1),ot=it[14]/(it[10]+1),gt=(it[9]+1)/it[5],_t=(it[9]-1)/it[5],rt=(it[8]-1)/it[0],Yt=(et[8]+1)/et[0],zt=qt*rt,Ht=qt*Yt,an=We/(-rt+Yt),It=an*-rt;if(be.matrixWorld.decompose(se.position,se.quaternion,se.scale),se.translateX(It),se.translateZ(an),se.matrixWorld.compose(se.position,se.quaternion,se.scale),se.matrixWorldInverse.copy(se.matrixWorld).invert(),it[10]===-1)se.projectionMatrix.copy(be.projectionMatrix),se.projectionMatrixInverse.copy(be.projectionMatrixInverse);else{const jt=qt+an,Z=ot+an,Dt=zt-It,xt=Ht+(We-It),U=gt*ot/Z*jt,b=_t*ot/Z*jt;se.projectionMatrix.makePerspective(Dt,xt,U,b,jt,Z),se.projectionMatrixInverse.copy(se.projectionMatrix).invert()}}function O(se,be){be===null?se.matrixWorld.copy(se.matrix):se.matrixWorld.multiplyMatrices(be.matrixWorld,se.matrix),se.matrixWorldInverse.copy(se.matrixWorld).invert()}this.updateCamera=function(se){if(o===null)return;let be=se.near,Te=se.far;y.texture!==null&&(y.depthNear>0&&(be=y.depthNear),y.depthFar>0&&(Te=y.depthFar)),j.near=X.near=L.near=be,j.far=X.far=L.far=Te,(ue!==j.near||fe!==j.far)&&(o.updateRenderState({depthNear:j.near,depthFar:j.far}),ue=j.near,fe=j.far),j.layers.mask=se.layers.mask|6,L.layers.mask=j.layers.mask&-5,X.layers.mask=j.layers.mask&-3;const We=se.parent,it=j.cameras;O(j,We);for(let et=0;et<it.length;et++)O(it[et],We);it.length===2?Me(j,L,X):j.projectionMatrix.copy(L.projectionMatrix),K(se,j,We)};function K(se,be,Te){Te===null?se.matrix.copy(be.matrixWorld):(se.matrix.copy(Te.matrixWorld),se.matrix.invert(),se.matrix.multiply(be.matrixWorld)),se.matrix.decompose(se.position,se.quaternion,se.scale),se.updateMatrixWorld(!0),se.projectionMatrix.copy(be.projectionMatrix),se.projectionMatrixInverse.copy(be.projectionMatrixInverse),se.isPerspectiveCamera&&(se.fov=Ml*2*Math.atan(1/se.projectionMatrix.elements[5]),se.zoom=1)}this.getCamera=function(){return j},this.getFoveation=function(){if(!(v===null&&S===null))return m},this.setFoveation=function(se){m=se,v!==null&&(v.fixedFoveation=se),S!==null&&S.fixedFoveation!==void 0&&(S.fixedFoveation=se)},this.hasDepthSensing=function(){return y.texture!==null},this.getDepthSensingMesh=function(){return y.getMesh(j)},this.getCameraTexture=function(se){return M[se]};let ye=null;function Ce(se,be){if(g=be.getViewerPose(p||u),E=be,g!==null){const Te=g.views;S!==null&&(e.setRenderTargetFramebuffer(C,S.framebuffer),e.setRenderTarget(C));let We=!1;Te.length!==j.cameras.length&&(j.cameras.length=0,We=!0);for(let ot=0;ot<Te.length;ot++){const gt=Te[ot];let _t=null;if(S!==null)_t=S.getViewport(gt);else{const Yt=_.getViewSubImage(v,gt);_t=Yt.viewport,ot===0&&(e.setRenderTargetTextures(C,Yt.colorTexture,Yt.depthStencilTexture),e.setRenderTarget(C))}let rt=V[ot];rt===void 0&&(rt=new Li,rt.layers.enable(ot),rt.viewport=new pn,V[ot]=rt),rt.matrix.fromArray(gt.transform.matrix),rt.matrix.decompose(rt.position,rt.quaternion,rt.scale),rt.projectionMatrix.fromArray(gt.projectionMatrix),rt.projectionMatrixInverse.copy(rt.projectionMatrix).invert(),rt.viewport.set(_t.x,_t.y,_t.width,_t.height),ot===0&&(j.matrix.copy(rt.matrix),j.matrix.decompose(j.position,j.quaternion,j.scale)),We===!0&&j.cameras.push(rt)}const it=o.enabledFeatures;if(it&&it.includes("depth-sensing")&&o.depthUsage=="gpu-optimized"&&w){_=r.getBinding();const ot=_.getDepthInformation(Te[0]);ot&&ot.isValid&&ot.texture&&y.init(ot,o.renderState)}if(it&&it.includes("camera-access")&&w){e.state.unbindTexture(),_=r.getBinding();for(let ot=0;ot<Te.length;ot++){const gt=Te[ot].camera;if(gt){let _t=M[gt];_t||(_t=new Mx,M[gt]=_t);const rt=_.getCameraImage(gt);_t.sourceTexture=rt}}}}for(let Te=0;Te<I.length;Te++){const We=N[Te],it=I[Te];We!==null&&it!==void 0&&it.update(We,be,p||u)}ye&&ye(se,be),be.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:be}),E=null}const ze=new Tx;ze.setAnimationLoop(Ce),this.setAnimationLoop=function(se){ye=se},this.dispose=function(){}}}const O2=new vn,Lx=new ut;Lx.set(-1,0,0,0,1,0,0,0,1);function P2(a,e){function i(y,M){y.matrixAutoUpdate===!0&&y.updateMatrix(),M.value.copy(y.matrix)}function r(y,M){M.color.getRGB(y.fogColor.value,yx(a)),M.isFog?(y.fogNear.value=M.near,y.fogFar.value=M.far):M.isFogExp2&&(y.fogDensity.value=M.density)}function o(y,M,P,z,C){M.isNodeMaterial?M.uniformsNeedUpdate=!1:M.isMeshBasicMaterial?c(y,M):M.isMeshLambertMaterial?(c(y,M),M.envMap&&(y.envMapIntensity.value=M.envMapIntensity)):M.isMeshToonMaterial?(c(y,M),_(y,M)):M.isMeshPhongMaterial?(c(y,M),g(y,M),M.envMap&&(y.envMapIntensity.value=M.envMapIntensity)):M.isMeshStandardMaterial?(c(y,M),v(y,M),M.isMeshPhysicalMaterial&&S(y,M,C)):M.isMeshMatcapMaterial?(c(y,M),E(y,M)):M.isMeshDepthMaterial?c(y,M):M.isMeshDistanceMaterial?(c(y,M),w(y,M)):M.isMeshNormalMaterial?c(y,M):M.isLineBasicMaterial?(u(y,M),M.isLineDashedMaterial&&d(y,M)):M.isPointsMaterial?m(y,M,P,z):M.isSpriteMaterial?p(y,M):M.isShadowMaterial?(y.color.value.copy(M.color),y.opacity.value=M.opacity):M.isShaderMaterial&&(M.uniformsNeedUpdate=!1)}function c(y,M){y.opacity.value=M.opacity,M.color&&y.diffuse.value.copy(M.color),M.emissive&&y.emissive.value.copy(M.emissive).multiplyScalar(M.emissiveIntensity),M.map&&(y.map.value=M.map,i(M.map,y.mapTransform)),M.alphaMap&&(y.alphaMap.value=M.alphaMap,i(M.alphaMap,y.alphaMapTransform)),M.bumpMap&&(y.bumpMap.value=M.bumpMap,i(M.bumpMap,y.bumpMapTransform),y.bumpScale.value=M.bumpScale,M.side===oi&&(y.bumpScale.value*=-1)),M.normalMap&&(y.normalMap.value=M.normalMap,i(M.normalMap,y.normalMapTransform),y.normalScale.value.copy(M.normalScale),M.side===oi&&y.normalScale.value.negate()),M.displacementMap&&(y.displacementMap.value=M.displacementMap,i(M.displacementMap,y.displacementMapTransform),y.displacementScale.value=M.displacementScale,y.displacementBias.value=M.displacementBias),M.emissiveMap&&(y.emissiveMap.value=M.emissiveMap,i(M.emissiveMap,y.emissiveMapTransform)),M.specularMap&&(y.specularMap.value=M.specularMap,i(M.specularMap,y.specularMapTransform)),M.alphaTest>0&&(y.alphaTest.value=M.alphaTest);const P=e.get(M),z=P.envMap,C=P.envMapRotation;z&&(y.envMap.value=z,y.envMapRotation.value.setFromMatrix4(O2.makeRotationFromEuler(C)).transpose(),z.isCubeTexture&&z.isRenderTargetTexture===!1&&y.envMapRotation.value.premultiply(Lx),y.reflectivity.value=M.reflectivity,y.ior.value=M.ior,y.refractionRatio.value=M.refractionRatio),M.lightMap&&(y.lightMap.value=M.lightMap,y.lightMapIntensity.value=M.lightMapIntensity,i(M.lightMap,y.lightMapTransform)),M.aoMap&&(y.aoMap.value=M.aoMap,y.aoMapIntensity.value=M.aoMapIntensity,i(M.aoMap,y.aoMapTransform))}function u(y,M){y.diffuse.value.copy(M.color),y.opacity.value=M.opacity,M.map&&(y.map.value=M.map,i(M.map,y.mapTransform))}function d(y,M){y.dashSize.value=M.dashSize,y.totalSize.value=M.dashSize+M.gapSize,y.scale.value=M.scale}function m(y,M,P,z){y.diffuse.value.copy(M.color),y.opacity.value=M.opacity,y.size.value=M.size*P,y.scale.value=z*.5,M.map&&(y.map.value=M.map,i(M.map,y.uvTransform)),M.alphaMap&&(y.alphaMap.value=M.alphaMap,i(M.alphaMap,y.alphaMapTransform)),M.alphaTest>0&&(y.alphaTest.value=M.alphaTest)}function p(y,M){y.diffuse.value.copy(M.color),y.opacity.value=M.opacity,y.rotation.value=M.rotation,M.map&&(y.map.value=M.map,i(M.map,y.mapTransform)),M.alphaMap&&(y.alphaMap.value=M.alphaMap,i(M.alphaMap,y.alphaMapTransform)),M.alphaTest>0&&(y.alphaTest.value=M.alphaTest)}function g(y,M){y.specular.value.copy(M.specular),y.shininess.value=Math.max(M.shininess,1e-4)}function _(y,M){M.gradientMap&&(y.gradientMap.value=M.gradientMap)}function v(y,M){y.metalness.value=M.metalness,M.metalnessMap&&(y.metalnessMap.value=M.metalnessMap,i(M.metalnessMap,y.metalnessMapTransform)),y.roughness.value=M.roughness,M.roughnessMap&&(y.roughnessMap.value=M.roughnessMap,i(M.roughnessMap,y.roughnessMapTransform)),M.envMap&&(y.envMapIntensity.value=M.envMapIntensity)}function S(y,M,P){y.ior.value=M.ior,M.sheen>0&&(y.sheenColor.value.copy(M.sheenColor).multiplyScalar(M.sheen),y.sheenRoughness.value=M.sheenRoughness,M.sheenColorMap&&(y.sheenColorMap.value=M.sheenColorMap,i(M.sheenColorMap,y.sheenColorMapTransform)),M.sheenRoughnessMap&&(y.sheenRoughnessMap.value=M.sheenRoughnessMap,i(M.sheenRoughnessMap,y.sheenRoughnessMapTransform))),M.clearcoat>0&&(y.clearcoat.value=M.clearcoat,y.clearcoatRoughness.value=M.clearcoatRoughness,M.clearcoatMap&&(y.clearcoatMap.value=M.clearcoatMap,i(M.clearcoatMap,y.clearcoatMapTransform)),M.clearcoatRoughnessMap&&(y.clearcoatRoughnessMap.value=M.clearcoatRoughnessMap,i(M.clearcoatRoughnessMap,y.clearcoatRoughnessMapTransform)),M.clearcoatNormalMap&&(y.clearcoatNormalMap.value=M.clearcoatNormalMap,i(M.clearcoatNormalMap,y.clearcoatNormalMapTransform),y.clearcoatNormalScale.value.copy(M.clearcoatNormalScale),M.side===oi&&y.clearcoatNormalScale.value.negate())),M.dispersion>0&&(y.dispersion.value=M.dispersion),M.iridescence>0&&(y.iridescence.value=M.iridescence,y.iridescenceIOR.value=M.iridescenceIOR,y.iridescenceThicknessMinimum.value=M.iridescenceThicknessRange[0],y.iridescenceThicknessMaximum.value=M.iridescenceThicknessRange[1],M.iridescenceMap&&(y.iridescenceMap.value=M.iridescenceMap,i(M.iridescenceMap,y.iridescenceMapTransform)),M.iridescenceThicknessMap&&(y.iridescenceThicknessMap.value=M.iridescenceThicknessMap,i(M.iridescenceThicknessMap,y.iridescenceThicknessMapTransform))),M.transmission>0&&(y.transmission.value=M.transmission,y.transmissionSamplerMap.value=P.texture,y.transmissionSamplerSize.value.set(P.width,P.height),M.transmissionMap&&(y.transmissionMap.value=M.transmissionMap,i(M.transmissionMap,y.transmissionMapTransform)),y.thickness.value=M.thickness,M.thicknessMap&&(y.thicknessMap.value=M.thicknessMap,i(M.thicknessMap,y.thicknessMapTransform)),y.attenuationDistance.value=M.attenuationDistance,y.attenuationColor.value.copy(M.attenuationColor)),M.anisotropy>0&&(y.anisotropyVector.value.set(M.anisotropy*Math.cos(M.anisotropyRotation),M.anisotropy*Math.sin(M.anisotropyRotation)),M.anisotropyMap&&(y.anisotropyMap.value=M.anisotropyMap,i(M.anisotropyMap,y.anisotropyMapTransform))),y.specularIntensity.value=M.specularIntensity,y.specularColor.value.copy(M.specularColor),M.specularColorMap&&(y.specularColorMap.value=M.specularColorMap,i(M.specularColorMap,y.specularColorMapTransform)),M.specularIntensityMap&&(y.specularIntensityMap.value=M.specularIntensityMap,i(M.specularIntensityMap,y.specularIntensityMapTransform))}function E(y,M){M.matcap&&(y.matcap.value=M.matcap)}function w(y,M){const P=e.get(M).light;y.referencePosition.value.setFromMatrixPosition(P.matrixWorld),y.nearDistance.value=P.shadow.camera.near,y.farDistance.value=P.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:o}}function I2(a,e,i,r){let o={},c={},u=[];const d=a.getParameter(a.MAX_UNIFORM_BUFFER_BINDINGS);function m(C,I){const N=I.program;r.uniformBlockBinding(C,N)}function p(C,I){let N=o[C.id];N===void 0&&(y(C),N=g(C),o[C.id]=N,C.addEventListener("dispose",P));const B=I.program;r.updateUBOMapping(C,B);const T=e.render.frame;c[C.id]!==T&&(v(C),c[C.id]=T)}function g(C){const I=_();C.__bindingPointIndex=I;const N=a.createBuffer(),B=C.__size,T=C.usage;return a.bindBuffer(a.UNIFORM_BUFFER,N),a.bufferData(a.UNIFORM_BUFFER,B,T),a.bindBuffer(a.UNIFORM_BUFFER,null),a.bindBufferBase(a.UNIFORM_BUFFER,I,N),N}function _(){for(let C=0;C<d;C++)if(u.indexOf(C)===-1)return u.push(C),C;return Lt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function v(C){const I=o[C.id],N=C.uniforms,B=C.__cache;a.bindBuffer(a.UNIFORM_BUFFER,I);for(let T=0,L=N.length;T<L;T++){const X=N[T];if(Array.isArray(X))for(let V=0,j=X.length;V<j;V++)S(X[V],T,V,B);else S(X,T,0,B)}a.bindBuffer(a.UNIFORM_BUFFER,null)}function S(C,I,N,B){if(w(C,I,N,B)===!0){const T=C.__offset,L=C.value;if(Array.isArray(L)){let X=0;for(let V=0;V<L.length;V++){const j=L[V],ue=M(j);E(j,C.__data,X),typeof j!="number"&&typeof j!="boolean"&&!j.isMatrix3&&!ArrayBuffer.isView(j)&&(X+=ue.storage/Float32Array.BYTES_PER_ELEMENT)}}else E(L,C.__data,0);a.bufferSubData(a.UNIFORM_BUFFER,T,C.__data)}}function E(C,I,N){typeof C=="number"||typeof C=="boolean"?I[0]=C:C.isMatrix3?(I[0]=C.elements[0],I[1]=C.elements[1],I[2]=C.elements[2],I[3]=0,I[4]=C.elements[3],I[5]=C.elements[4],I[6]=C.elements[5],I[7]=0,I[8]=C.elements[6],I[9]=C.elements[7],I[10]=C.elements[8],I[11]=0):ArrayBuffer.isView(C)?I.set(new C.constructor(C.buffer,C.byteOffset,I.length)):C.toArray(I,N)}function w(C,I,N,B){const T=C.value,L=I+"_"+N;if(B[L]===void 0)return typeof T=="number"||typeof T=="boolean"?B[L]=T:ArrayBuffer.isView(T)?B[L]=T.slice():B[L]=T.clone(),!0;{const X=B[L];if(typeof T=="number"||typeof T=="boolean"){if(X!==T)return B[L]=T,!0}else{if(ArrayBuffer.isView(T))return!0;if(X.equals(T)===!1)return X.copy(T),!0}}return!1}function y(C){const I=C.uniforms;let N=0;const B=16;for(let L=0,X=I.length;L<X;L++){const V=Array.isArray(I[L])?I[L]:[I[L]];for(let j=0,ue=V.length;j<ue;j++){const fe=V[j],q=Array.isArray(fe.value)?fe.value:[fe.value];for(let F=0,H=q.length;F<H;F++){const $=q[F],_e=M($),Me=N%B,O=Me%_e.boundary,K=Me+O;N+=O,K!==0&&B-K<_e.storage&&(N+=B-K),fe.__data=new Float32Array(_e.storage/Float32Array.BYTES_PER_ELEMENT),fe.__offset=N,N+=_e.storage}}}const T=N%B;return T>0&&(N+=B-T),C.__size=N,C.__cache={},this}function M(C){const I={boundary:0,storage:0};return typeof C=="number"||typeof C=="boolean"?(I.boundary=4,I.storage=4):C.isVector2?(I.boundary=8,I.storage=8):C.isVector3||C.isColor?(I.boundary=16,I.storage=12):C.isVector4?(I.boundary=16,I.storage=16):C.isMatrix3?(I.boundary=48,I.storage=48):C.isMatrix4?(I.boundary=64,I.storage=64):C.isTexture?st("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(C)?(I.boundary=16,I.storage=C.byteLength):st("WebGLRenderer: Unsupported uniform value type.",C),I}function P(C){const I=C.target;I.removeEventListener("dispose",P);const N=u.indexOf(I.__bindingPointIndex);u.splice(N,1),a.deleteBuffer(o[I.id]),delete o[I.id],delete c[I.id]}function z(){for(const C in o)a.deleteBuffer(o[C]);u=[],o={},c={}}return{bind:m,update:p,dispose:z}}const F2=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let sa=null;function B2(){return sa===null&&(sa=new CE(F2,16,16,ar,Va),sa.name="DFG_LUT",sa.minFilter=Tn,sa.magFilter=Tn,sa.wrapS=Ki,sa.wrapT=Ki,sa.generateMipmaps=!1,sa.needsUpdate=!0),sa}class z2{constructor(e={}){const{canvas:i=ky(),context:r=null,depth:o=!0,stencil:c=!1,alpha:u=!1,antialias:d=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:p=!1,powerPreference:g="default",failIfMajorPerformanceCaveat:_=!1,reversedDepthBuffer:v=!1,outputBufferType:S=Ui}=e;this.isWebGLRenderer=!0;let E;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");E=r.getContextAttributes().alpha}else E=u;const w=S,y=new Set([Sp,xp,vp]),M=new Set([Ui,ha,xl,Sl,gp,_p]),P=new Uint32Array(4),z=new Int32Array(4),C=new ee;let I=null,N=null;const B=[],T=[];let L=null;this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=ua,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const X=this;let V=!1,j=null,ue=null,fe=null,q=null;this._outputColorSpace=Jn;let F=0,H=0,$=null,_e=-1,Me=null;const O=new pn,K=new pn;let ye=null;const Ce=new wt(0);let ze=0,se=i.width,be=i.height,Te=1,We=null,it=null;const et=new pn(0,0,se,be),qt=new pn(0,0,se,be);let ot=!1;const gt=new vx;let _t=!1,rt=!1;const Yt=new vn,zt=new ee,Ht=new pn,an={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let It=!1;function jt(){return $===null?Te:1}let Z=r;function Dt(A,Y){return i.getContext(A,Y)}try{const A={alpha:!0,depth:o,stencil:c,antialias:d,premultipliedAlpha:m,preserveDrawingBuffer:p,powerPreference:g,failIfMajorPerformanceCaveat:_};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${pp}`),i.addEventListener("webglcontextlost",Ft,!1),i.addEventListener("webglcontextrestored",Ct,!1),i.addEventListener("webglcontextcreationerror",zn,!1),Z===null){const Y="webgl2";if(Z=Dt(Y,A),Z===null)throw Dt(Y)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(A){throw Lt("WebGLRenderer: "+A.message),A}let xt,U,b,J,oe,pe,Ne,Pe,he,me,De,Ge,Be,ge,Le,Oe,qe,k,Ae,ce,Re,we,xe;function je(){xt=new BT(Z),xt.init(),Re=new w2(Z,xt),U=new DT(Z,xt,e,Re),b=new R2(Z,xt),U.reversedDepthBuffer&&v&&b.buffers.depth.setReversed(!0),ue=Z.createFramebuffer(),fe=Z.createFramebuffer(),q=Z.createFramebuffer(),J=new GT(Z),oe=new h2,pe=new C2(Z,xt,b,oe,U,Re,J),Ne=new FT(X),Pe=new WE(Z),we=new CT(Z,Pe),he=new zT(Z,Pe,J,we),me=new kT(Z,he,Pe,we,J),k=new VT(Z,U,pe),Le=new NT(oe),De=new d2(X,Ne,xt,U,we,Le),Ge=new P2(X,oe),Be=new m2,ge=new M2(xt),qe=new RT(X,Ne,b,me,E,m),Oe=new A2(X,me,U),xe=new I2(Z,J,U,b),Ae=new wT(Z,xt,J),ce=new HT(Z,xt,J),J.programs=De.programs,X.capabilities=U,X.extensions=xt,X.properties=oe,X.renderLists=Be,X.shadowMap=Oe,X.state=b,X.info=J}je(),w!==Ui&&(L=new WT(w,i.width,i.height,d,o,c));const Ve=new U2(X,Z);this.xr=Ve,this.getContext=function(){return Z},this.getContextAttributes=function(){return Z.getContextAttributes()},this.forceContextLoss=function(){const A=xt.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=xt.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return Te},this.setPixelRatio=function(A){A!==void 0&&(Te=A,this.setSize(se,be,!1))},this.getSize=function(A){return A.set(se,be)},this.setSize=function(A,Y,re=!0){if(Ve.isPresenting){st("WebGLRenderer: Can't change size while VR device is presenting.");return}se=A,be=Y,i.width=Math.floor(A*Te),i.height=Math.floor(Y*Te),re===!0&&(i.style.width=A+"px",i.style.height=Y+"px"),L!==null&&L.setSize(i.width,i.height),this.setViewport(0,0,A,Y)},this.getDrawingBufferSize=function(A){return A.set(se*Te,be*Te).floor()},this.setDrawingBufferSize=function(A,Y,re){se=A,be=Y,Te=re,i.width=Math.floor(A*re),i.height=Math.floor(Y*re),this.setViewport(0,0,A,Y)},this.setEffects=function(A){if(w===Ui){Lt("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(A){for(let Y=0;Y<A.length;Y++)if(A[Y].isOutputPass===!0){st("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}L.setEffects(A||[])},this.getCurrentViewport=function(A){return A.copy(O)},this.getViewport=function(A){return A.copy(et)},this.setViewport=function(A,Y,re,ne){A.isVector4?et.set(A.x,A.y,A.z,A.w):et.set(A,Y,re,ne),b.viewport(O.copy(et).multiplyScalar(Te).round())},this.getScissor=function(A){return A.copy(qt)},this.setScissor=function(A,Y,re,ne){A.isVector4?qt.set(A.x,A.y,A.z,A.w):qt.set(A,Y,re,ne),b.scissor(K.copy(qt).multiplyScalar(Te).round())},this.getScissorTest=function(){return ot},this.setScissorTest=function(A){b.setScissorTest(ot=A)},this.setOpaqueSort=function(A){We=A},this.setTransparentSort=function(A){it=A},this.getClearColor=function(A){return A.copy(qe.getClearColor())},this.setClearColor=function(){qe.setClearColor(...arguments)},this.getClearAlpha=function(){return qe.getClearAlpha()},this.setClearAlpha=function(){qe.setClearAlpha(...arguments)},this.clear=function(A=!0,Y=!0,re=!0){let ne=0;if(A){let te=!1;if($!==null){const Ie=$.texture.format;te=y.has(Ie)}if(te){const Ie=$.texture.type,Xe=M.has(Ie),Fe=qe.getClearColor(),Ze=qe.getClearAlpha(),Ye=Fe.r,Ue=Fe.g,tt=Fe.b;Xe?(P[0]=Ye,P[1]=Ue,P[2]=tt,P[3]=Ze,Z.clearBufferuiv(Z.COLOR,0,P)):(z[0]=Ye,z[1]=Ue,z[2]=tt,z[3]=Ze,Z.clearBufferiv(Z.COLOR,0,z))}else ne|=Z.COLOR_BUFFER_BIT}Y&&(ne|=Z.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),re&&(ne|=Z.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),ne!==0&&Z.clear(ne)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(A){A.setRenderer(this),j=A},this.dispose=function(){i.removeEventListener("webglcontextlost",Ft,!1),i.removeEventListener("webglcontextrestored",Ct,!1),i.removeEventListener("webglcontextcreationerror",zn,!1),qe.dispose(),Be.dispose(),ge.dispose(),oe.dispose(),Ne.dispose(),me.dispose(),we.dispose(),xe.dispose(),De.dispose(),Ve.dispose(),Ve.removeEventListener("sessionstart",cn),Ve.removeEventListener("sessionend",An),Yn.stop()};function Ft(A){A.preventDefault(),P_("WebGLRenderer: Context Lost."),V=!0}function Ct(){P_("WebGLRenderer: Context Restored."),V=!1;const A=J.autoReset,Y=Oe.enabled,re=Oe.autoUpdate,ne=Oe.needsUpdate,te=Oe.type;je(),J.autoReset=A,Oe.enabled=Y,Oe.autoUpdate=re,Oe.needsUpdate=ne,Oe.type=te}function zn(A){Lt("WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function Hn(A){const Y=A.target;Y.removeEventListener("dispose",Hn),Xa(Y)}function Xa(A){Rs(A),oe.remove(A)}function Rs(A){const Y=oe.get(A).programs;Y!==void 0&&(Y.forEach(function(re){De.releaseProgram(re)}),A.isShaderMaterial&&De.releaseShaderCache(A))}this.renderBufferDirect=function(A,Y,re,ne,te,Ie){Y===null&&(Y=an);const Xe=te.isMesh&&te.matrixWorld.determinantAffine()<0,Fe=Hi(A,Y,re,ne,te);b.setMaterial(ne,Xe);let Ze=re.index,Ye=1;if(ne.wireframe===!0){if(Ze=he.getWireframeAttribute(re),Ze===void 0)return;Ye=2}const Ue=re.drawRange,tt=re.attributes.position;let Qe=Ue.start*Ye,lt=(Ue.start+Ue.count)*Ye;Ie!==null&&(Qe=Math.max(Qe,Ie.start*Ye),lt=Math.min(lt,(Ie.start+Ie.count)*Ye)),Ze!==null?(Qe=Math.max(Qe,0),lt=Math.min(lt,Ze.count)):tt!=null&&(Qe=Math.max(Qe,0),lt=Math.min(lt,tt.count));const Nt=lt-Qe;if(Nt<0||Nt===1/0)return;we.setup(te,ne,Fe,re,Ze);let ht,yt=Ae;if(Ze!==null&&(ht=Pe.get(Ze),yt=ce,yt.setIndex(ht)),te.isMesh)ne.wireframe===!0?(b.setLineWidth(ne.wireframeLinewidth*jt()),yt.setMode(Z.LINES)):yt.setMode(Z.TRIANGLES);else if(te.isLine){let Et=ne.linewidth;Et===void 0&&(Et=1),b.setLineWidth(Et*jt()),te.isLineSegments?yt.setMode(Z.LINES):te.isLineLoop?yt.setMode(Z.LINE_LOOP):yt.setMode(Z.LINE_STRIP)}else te.isPoints?yt.setMode(Z.POINTS):te.isSprite&&yt.setMode(Z.TRIANGLES);if(te.isBatchedMesh)if(xt.get("WEBGL_multi_draw"))yt.renderMultiDraw(te._multiDrawStarts,te._multiDrawCounts,te._multiDrawCount);else{const Et=te._multiDrawStarts,He=te._multiDrawCounts,rn=te._multiDrawCount,pt=Ze?Pe.get(Ze).bytesPerElement:1,Rn=oe.get(ne).currentProgram.getUniforms();for(let li=0;li<rn;li++)Rn.setValue(Z,"_gl_DrawID",li),yt.render(Et[li]/pt,He[li])}else if(te.isInstancedMesh)yt.renderInstances(Qe,Nt,te.count);else if(re.isInstancedBufferGeometry){const Et=re._maxInstanceCount!==void 0?re._maxInstanceCount:1/0,He=Math.min(re.instanceCount,Et);yt.renderInstances(Qe,Nt,He)}else yt.render(Qe,Nt)};function Si(A,Y,re){A.transparent===!0&&A.side===oa&&A.forceSinglePass===!1?(A.side=oi,A.needsUpdate=!0,ei(A,Y,re),A.side=Ga,A.needsUpdate=!0,ei(A,Y,re),A.side=oa):ei(A,Y,re)}this.compile=function(A,Y,re=null){re===null&&(re=A),N=ge.get(re),N.init(Y),T.push(N),re.traverseVisible(function(te){te.isLight&&te.layers.test(Y.layers)&&(N.pushLight(te),te.castShadow&&N.pushShadow(te))}),A!==re&&A.traverseVisible(function(te){te.isLight&&te.layers.test(Y.layers)&&(N.pushLight(te),te.castShadow&&N.pushShadow(te))}),N.setupLights();const ne=new Set;return A.traverse(function(te){if(!(te.isMesh||te.isPoints||te.isLine||te.isSprite))return;const Ie=te.material;if(Ie)if(Array.isArray(Ie))for(let Xe=0;Xe<Ie.length;Xe++){const Fe=Ie[Xe];Si(Fe,re,te),ne.add(Fe)}else Si(Ie,re,te),ne.add(Ie)}),N=T.pop(),ne},this.compileAsync=function(A,Y,re=null){const ne=this.compile(A,Y,re);return new Promise(te=>{function Ie(){if(ne.forEach(function(Xe){oe.get(Xe).currentProgram.isReady()&&ne.delete(Xe)}),ne.size===0){te(A);return}setTimeout(Ie,10)}xt.get("KHR_parallel_shader_compile")!==null?Ie():setTimeout(Ie,10)})};let qn=null;function Mi(A){qn&&qn(A)}function cn(){Yn.stop()}function An(){Yn.start()}const Yn=new Tx;Yn.setAnimationLoop(Mi),typeof self<"u"&&Yn.setContext(self),this.setAnimationLoop=function(A){qn=A,Ve.setAnimationLoop(A),A===null?Yn.stop():Yn.start()},Ve.addEventListener("sessionstart",cn),Ve.addEventListener("sessionend",An),this.render=function(A,Y){if(Y!==void 0&&Y.isCamera!==!0){Lt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(V===!0)return;j!==null&&j.renderStart(A,Y);const re=Ve.enabled===!0&&Ve.isPresenting===!0,ne=L!==null&&($===null||re)&&L.begin(X,$);if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),Y.parent===null&&Y.matrixWorldAutoUpdate===!0&&Y.updateMatrixWorld(),Ve.enabled===!0&&Ve.isPresenting===!0&&(L===null||L.isCompositing()===!1)&&(Ve.cameraAutoUpdate===!0&&Ve.updateCamera(Y),Y=Ve.getCamera()),A.isScene===!0&&A.onBeforeRender(X,A,Y,$),N=ge.get(A,T.length),N.init(Y),N.state.textureUnits=pe.getTextureUnits(),T.push(N),Yt.multiplyMatrices(Y.projectionMatrix,Y.matrixWorldInverse),gt.setFromProjectionMatrix(Yt,ca,Y.reversedDepth),rt=this.localClippingEnabled,_t=Le.init(this.clippingPlanes,rt),I=Be.get(A,B.length),I.init(),B.push(I),Ve.enabled===!0&&Ve.isPresenting===!0){const Xe=X.xr.getDepthSensingMesh();Xe!==null&&$n(Xe,Y,-1/0,X.sortObjects)}$n(A,Y,0,X.sortObjects),I.finish(),X.sortObjects===!0&&I.sort(We,it,Y.reversedDepth),It=Ve.enabled===!1||Ve.isPresenting===!1||Ve.hasDepthSensing()===!1,It&&qe.addToRenderList(I,A),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),_t===!0&&Le.beginShadows();const te=N.state.shadowsArray;if(Oe.render(te,A,Y),_t===!0&&Le.endShadows(),(ne&&L.hasRenderPass())===!1){const Xe=I.opaque,Fe=I.transmissive;if(N.setupLights(),Y.isArrayCamera){const Ze=Y.cameras;if(Fe.length>0)for(let Ye=0,Ue=Ze.length;Ye<Ue;Ye++){const tt=Ze[Ye];Wa(Xe,Fe,A,tt)}It&&qe.render(A);for(let Ye=0,Ue=Ze.length;Ye<Ue;Ye++){const tt=Ze[Ye];Cs(I,A,tt,tt.viewport)}}else Fe.length>0&&Wa(Xe,Fe,A,Y),It&&qe.render(A),Cs(I,A,Y)}$!==null&&H===0&&(pe.updateMultisampleRenderTarget($),pe.updateRenderTargetMipmap($)),ne&&L.end(X),A.isScene===!0&&A.onAfterRender(X,A,Y),we.resetDefaultState(),_e=-1,Me=null,T.pop(),T.length>0?(N=T[T.length-1],pe.setTextureUnits(N.state.textureUnits),_t===!0&&Le.setGlobalState(X.clippingPlanes,N.state.camera)):N=null,B.pop(),B.length>0?I=B[B.length-1]:I=null,j!==null&&j.renderEnd()};function $n(A,Y,re,ne){if(A.visible===!1)return;if(A.layers.test(Y.layers)){if(A.isGroup)re=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(Y);else if(A.isLightProbeGrid)N.pushLightProbeGrid(A);else if(A.isLight)N.pushLight(A),A.castShadow&&N.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||gt.intersectsSprite(A)){ne&&Ht.setFromMatrixPosition(A.matrixWorld).applyMatrix4(Yt);const Xe=me.update(A),Fe=A.material;Fe.visible&&I.push(A,Xe,Fe,re,Ht.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||gt.intersectsObject(A))){const Xe=me.update(A),Fe=A.material;if(ne&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),Ht.copy(A.boundingSphere.center)):(Xe.boundingSphere===null&&Xe.computeBoundingSphere(),Ht.copy(Xe.boundingSphere.center)),Ht.applyMatrix4(A.matrixWorld).applyMatrix4(Yt)),Array.isArray(Fe)){const Ze=Xe.groups;for(let Ye=0,Ue=Ze.length;Ye<Ue;Ye++){const tt=Ze[Ye],Qe=Fe[tt.materialIndex];Qe&&Qe.visible&&I.push(A,Xe,Qe,re,Ht.z,tt)}}else Fe.visible&&I.push(A,Xe,Fe,re,Ht.z,null)}}const Ie=A.children;for(let Xe=0,Fe=Ie.length;Xe<Fe;Xe++)$n(Ie[Xe],Y,re,ne)}function Cs(A,Y,re,ne){const{opaque:te,transmissive:Ie,transparent:Xe}=A;N.setupLightsView(re),_t===!0&&Le.setGlobalState(X.clippingPlanes,re),ne&&b.viewport(O.copy(ne)),te.length>0&&pa(te,Y,re),Ie.length>0&&pa(Ie,Y,re),Xe.length>0&&pa(Xe,Y,re),b.buffers.depth.setTest(!0),b.buffers.depth.setMask(!0),b.buffers.color.setMask(!0),b.setPolygonOffset(!1)}function Wa(A,Y,re,ne){if((re.isScene===!0?re.overrideMaterial:null)!==null)return;if(N.state.transmissionRenderTarget[ne.id]===void 0){const Qe=xt.has("EXT_color_buffer_half_float")||xt.has("EXT_color_buffer_float");N.state.transmissionRenderTarget[ne.id]=new fa(1,1,{generateMipmaps:!0,type:Qe?Va:Ui,minFilter:Ts,samples:Math.max(4,U.samples),stencilBuffer:c,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Rt.workingColorSpace})}const Ie=N.state.transmissionRenderTarget[ne.id],Xe=ne.viewport||O;Ie.setSize(Xe.z*X.transmissionResolutionScale,Xe.w*X.transmissionResolutionScale);const Fe=X.getRenderTarget(),Ze=X.getActiveCubeFace(),Ye=X.getActiveMipmapLevel();X.setRenderTarget(Ie),X.getClearColor(Ce),ze=X.getClearAlpha(),ze<1&&X.setClearColor(16777215,.5),X.clear(),It&&qe.render(re);const Ue=X.toneMapping;X.toneMapping=ua;const tt=ne.viewport;if(ne.viewport!==void 0&&(ne.viewport=void 0),N.setupLightsView(ne),_t===!0&&Le.setGlobalState(X.clippingPlanes,ne),pa(A,re,ne),pe.updateMultisampleRenderTarget(Ie),pe.updateRenderTargetMipmap(Ie),xt.has("WEBGL_multisampled_render_to_texture")===!1){let Qe=!1;for(let lt=0,Nt=Y.length;lt<Nt;lt++){const ht=Y[lt],{object:yt,geometry:Et,material:He,group:rn}=ht;if(He.side===oa&&yt.layers.test(ne.layers)){const pt=He.side;He.side=oi,He.needsUpdate=!0,Bi(yt,re,ne,Et,He,rn),He.side=pt,He.needsUpdate=!0,Qe=!0}}Qe===!0&&(pe.updateMultisampleRenderTarget(Ie),pe.updateRenderTargetMipmap(Ie))}X.setRenderTarget(Fe,Ze,Ye),X.setClearColor(Ce,ze),tt!==void 0&&(ne.viewport=tt),X.toneMapping=Ue}function pa(A,Y,re){const ne=Y.isScene===!0?Y.overrideMaterial:null;for(let te=0,Ie=A.length;te<Ie;te++){const Xe=A[te],{object:Fe,geometry:Ze,group:Ye}=Xe;let Ue=Xe.material;Ue.allowOverride===!0&&ne!==null&&(Ue=ne),Fe.layers.test(re.layers)&&Bi(Fe,Y,re,Ze,Ue,Ye)}}function Bi(A,Y,re,ne,te,Ie){A.onBeforeRender(X,Y,re,ne,te,Ie),A.modelViewMatrix.multiplyMatrices(re.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),te.onBeforeRender(X,Y,re,ne,A,Ie),te.transparent===!0&&te.side===oa&&te.forceSinglePass===!1?(te.side=oi,te.needsUpdate=!0,X.renderBufferDirect(re,Y,ne,te,A,Ie),te.side=Ga,te.needsUpdate=!0,X.renderBufferDirect(re,Y,ne,te,A,Ie),te.side=oa):X.renderBufferDirect(re,Y,ne,te,A,Ie),A.onAfterRender(X,Y,re,ne,te,Ie)}function ei(A,Y,re){Y.isScene!==!0&&(Y=an);const ne=oe.get(A),te=N.state.lights,Ie=N.state.shadowsArray,Xe=te.state.version,Fe=De.getParameters(A,te.state,Ie,Y,re,N.state.lightProbeGridArray),Ze=De.getProgramCacheKey(Fe);let Ye=ne.programs;ne.environment=A.isMeshStandardMaterial||A.isMeshLambertMaterial||A.isMeshPhongMaterial?Y.environment:null,ne.fog=Y.fog;const Ue=A.isMeshStandardMaterial||A.isMeshLambertMaterial&&!A.envMap||A.isMeshPhongMaterial&&!A.envMap;ne.envMap=Ne.get(A.envMap||ne.environment,Ue),ne.envMapRotation=ne.environment!==null&&A.envMap===null?Y.environmentRotation:A.envMapRotation,Ye===void 0&&(A.addEventListener("dispose",Hn),Ye=new Map,ne.programs=Ye);let tt=Ye.get(Ze);if(tt!==void 0){if(ne.currentProgram===tt&&ne.lightsStateVersion===Xe)return zi(A,Fe),tt}else Fe.uniforms=De.getUniforms(A),j!==null&&A.isNodeMaterial&&j.build(A,re,Fe),A.onBeforeCompile(Fe,X),tt=De.acquireProgram(Fe,Ze),Ye.set(Ze,tt),ne.uniforms=Fe.uniforms;const Qe=ne.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(Qe.clippingPlanes=Le.uniform),zi(A,Fe),ne.needsLights=or(A),ne.lightsStateVersion=Xe,ne.needsLights&&(Qe.ambientLightColor.value=te.state.ambient,Qe.lightProbe.value=te.state.probe,Qe.directionalLights.value=te.state.directional,Qe.directionalLightShadows.value=te.state.directionalShadow,Qe.spotLights.value=te.state.spot,Qe.spotLightShadows.value=te.state.spotShadow,Qe.rectAreaLights.value=te.state.rectArea,Qe.ltc_1.value=te.state.rectAreaLTC1,Qe.ltc_2.value=te.state.rectAreaLTC2,Qe.pointLights.value=te.state.point,Qe.pointLightShadows.value=te.state.pointShadow,Qe.hemisphereLights.value=te.state.hemi,Qe.directionalShadowMatrix.value=te.state.directionalShadowMatrix,Qe.spotLightMatrix.value=te.state.spotLightMatrix,Qe.spotLightMap.value=te.state.spotLightMap,Qe.pointShadowMatrix.value=te.state.pointShadowMatrix),ne.lightProbeGrid=N.state.lightProbeGridArray.length>0,ne.currentProgram=tt,ne.uniformsList=null,tt}function yi(A){if(A.uniformsList===null){const Y=A.currentProgram.getUniforms();A.uniformsList=lu.seqWithValue(Y.seq,A.uniforms)}return A.uniformsList}function zi(A,Y){const re=oe.get(A);re.outputColorSpace=Y.outputColorSpace,re.batching=Y.batching,re.batchingColor=Y.batchingColor,re.instancing=Y.instancing,re.instancingColor=Y.instancingColor,re.instancingMorph=Y.instancingMorph,re.skinning=Y.skinning,re.morphTargets=Y.morphTargets,re.morphNormals=Y.morphNormals,re.morphColors=Y.morphColors,re.morphTargetsCount=Y.morphTargetsCount,re.numClippingPlanes=Y.numClippingPlanes,re.numIntersection=Y.numClipIntersection,re.vertexAlphas=Y.vertexAlphas,re.vertexTangents=Y.vertexTangents,re.toneMapping=Y.toneMapping}function Ji(A,Y){if(A.length===0)return null;if(A.length===1)return A[0].texture!==null?A[0]:null;C.setFromMatrixPosition(Y.matrixWorld);for(let re=0,ne=A.length;re<ne;re++){const te=A[re];if(te.texture!==null&&te.boundingBox.containsPoint(C))return te}return null}function Hi(A,Y,re,ne,te){Y.isScene!==!0&&(Y=an),pe.resetTextureUnits();const Ie=Y.fog,Xe=ne.isMeshStandardMaterial||ne.isMeshLambertMaterial||ne.isMeshPhongMaterial?Y.environment:null,Fe=$===null?X.outputColorSpace:$.isXRRenderTarget===!0?$.texture.colorSpace:Rt.workingColorSpace,Ze=ne.isMeshStandardMaterial||ne.isMeshLambertMaterial&&!ne.envMap||ne.isMeshPhongMaterial&&!ne.envMap,Ye=Ne.get(ne.envMap||Xe,Ze),Ue=ne.vertexColors===!0&&!!re.attributes.color&&re.attributes.color.itemSize===4,tt=!!re.attributes.tangent&&(!!ne.normalMap||ne.anisotropy>0),Qe=!!re.morphAttributes.position,lt=!!re.morphAttributes.normal,Nt=!!re.morphAttributes.color;let ht=ua;ne.toneMapped&&($===null||$.isXRRenderTarget===!0)&&(ht=X.toneMapping);const yt=re.morphAttributes.position||re.morphAttributes.normal||re.morphAttributes.color,Et=yt!==void 0?yt.length:0,He=oe.get(ne),rn=N.state.lights;if(_t===!0&&(rt===!0||A!==Me)){const Gt=A===Me&&ne.id===_e;Le.setState(ne,A,Gt)}let pt=!1;ne.version===He.__version?(He.needsLights&&He.lightsStateVersion!==rn.state.version||He.outputColorSpace!==Fe||te.isBatchedMesh&&He.batching===!1||!te.isBatchedMesh&&He.batching===!0||te.isBatchedMesh&&He.batchingColor===!0&&te.colorTexture===null||te.isBatchedMesh&&He.batchingColor===!1&&te.colorTexture!==null||te.isInstancedMesh&&He.instancing===!1||!te.isInstancedMesh&&He.instancing===!0||te.isSkinnedMesh&&He.skinning===!1||!te.isSkinnedMesh&&He.skinning===!0||te.isInstancedMesh&&He.instancingColor===!0&&te.instanceColor===null||te.isInstancedMesh&&He.instancingColor===!1&&te.instanceColor!==null||te.isInstancedMesh&&He.instancingMorph===!0&&te.morphTexture===null||te.isInstancedMesh&&He.instancingMorph===!1&&te.morphTexture!==null||He.envMap!==Ye||ne.fog===!0&&He.fog!==Ie||He.numClippingPlanes!==void 0&&(He.numClippingPlanes!==Le.numPlanes||He.numIntersection!==Le.numIntersection)||He.vertexAlphas!==Ue||He.vertexTangents!==tt||He.morphTargets!==Qe||He.morphNormals!==lt||He.morphColors!==Nt||He.toneMapping!==ht||He.morphTargetsCount!==Et||!!He.lightProbeGrid!=N.state.lightProbeGridArray.length>0)&&(pt=!0):(pt=!0,He.__version=ne.version);let Rn=He.currentProgram;pt===!0&&(Rn=ei(ne,Y,te),j&&ne.isNodeMaterial&&j.onUpdateProgram(ne,Rn,He));let li=!1,Gi=!1,ci=!1;const Vt=Rn.getUniforms(),on=He.uniforms;if(b.useProgram(Rn.program)&&(li=!0,Gi=!0,ci=!0),ne.id!==_e&&(_e=ne.id,Gi=!0),He.needsLights){const Gt=Ji(N.state.lightProbeGridArray,te);He.lightProbeGrid!==Gt&&(He.lightProbeGrid=Gt,Gi=!0)}if(li||Me!==A){b.buffers.depth.getReversed()&&A.reversedDepth!==!0&&(A._reversedDepth=!0,A.updateProjectionMatrix()),Vt.setValue(Z,"projectionMatrix",A.projectionMatrix),Vt.setValue(Z,"viewMatrix",A.matrixWorldInverse);const $i=Vt.map.cameraPosition;$i!==void 0&&$i.setValue(Z,zt.setFromMatrixPosition(A.matrixWorld)),U.logarithmicDepthBuffer&&Vt.setValue(Z,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(ne.isMeshPhongMaterial||ne.isMeshToonMaterial||ne.isMeshLambertMaterial||ne.isMeshBasicMaterial||ne.isMeshStandardMaterial||ne.isShaderMaterial)&&Vt.setValue(Z,"isOrthographic",A.isOrthographicCamera===!0),Me!==A&&(Me=A,Gi=!0,ci=!0)}if(He.needsLights&&(rn.state.directionalShadowMap.length>0&&Vt.setValue(Z,"directionalShadowMap",rn.state.directionalShadowMap,pe),rn.state.spotShadowMap.length>0&&Vt.setValue(Z,"spotShadowMap",rn.state.spotShadowMap,pe),rn.state.pointShadowMap.length>0&&Vt.setValue(Z,"pointShadowMap",rn.state.pointShadowMap,pe)),te.isSkinnedMesh){Vt.setOptional(Z,te,"bindMatrix"),Vt.setOptional(Z,te,"bindMatrixInverse");const Gt=te.skeleton;Gt&&(Gt.boneTexture===null&&Gt.computeBoneTexture(),Vt.setValue(Z,"boneTexture",Gt.boneTexture,pe))}te.isBatchedMesh&&(Vt.setOptional(Z,te,"batchingTexture"),Vt.setValue(Z,"batchingTexture",te._matricesTexture,pe),Vt.setOptional(Z,te,"batchingIdTexture"),Vt.setValue(Z,"batchingIdTexture",te._indirectTexture,pe),Vt.setOptional(Z,te,"batchingColorTexture"),te._colorsTexture!==null&&Vt.setValue(Z,"batchingColorTexture",te._colorsTexture,pe));const Vi=re.morphAttributes;if((Vi.position!==void 0||Vi.normal!==void 0||Vi.color!==void 0)&&k.update(te,re,Rn),(Gi||He.receiveShadow!==te.receiveShadow)&&(He.receiveShadow=te.receiveShadow,Vt.setValue(Z,"receiveShadow",te.receiveShadow)),(ne.isMeshStandardMaterial||ne.isMeshLambertMaterial||ne.isMeshPhongMaterial)&&ne.envMap===null&&Y.environment!==null&&(on.envMapIntensity.value=Y.environmentIntensity),on.dfgLUT!==void 0&&(on.dfgLUT.value=B2()),Gi){if(Vt.setValue(Z,"toneMappingExposure",X.toneMappingExposure),He.needsLights&&sn(on,ci),Ie&&ne.fog===!0&&Ge.refreshFogUniforms(on,Ie),Ge.refreshMaterialUniforms(on,ne,Te,be,N.state.transmissionRenderTarget[A.id]),He.needsLights&&He.lightProbeGrid){const Gt=He.lightProbeGrid;on.probesSH.value=Gt.texture,on.probesMin.value.copy(Gt.boundingBox.min),on.probesMax.value.copy(Gt.boundingBox.max),on.probesResolution.value.copy(Gt.resolution)}lu.upload(Z,yi(He),on,pe)}if(ne.isShaderMaterial&&ne.uniformsNeedUpdate===!0&&(lu.upload(Z,yi(He),on,pe),ne.uniformsNeedUpdate=!1),ne.isSpriteMaterial&&Vt.setValue(Z,"center",te.center),Vt.setValue(Z,"modelViewMatrix",te.modelViewMatrix),Vt.setValue(Z,"normalMatrix",te.normalMatrix),Vt.setValue(Z,"modelMatrix",te.matrixWorld),ne.uniformsGroups!==void 0){const Gt=ne.uniformsGroups;for(let $i=0,qa=Gt.length;$i<qa;$i++){const ws=Gt[$i];xe.update(ws,Rn),xe.bind(ws,Rn)}}return Rn}function sn(A,Y){A.ambientLightColor.needsUpdate=Y,A.lightProbe.needsUpdate=Y,A.directionalLights.needsUpdate=Y,A.directionalLightShadows.needsUpdate=Y,A.pointLights.needsUpdate=Y,A.pointLightShadows.needsUpdate=Y,A.spotLights.needsUpdate=Y,A.spotLightShadows.needsUpdate=Y,A.rectAreaLights.needsUpdate=Y,A.hemisphereLights.needsUpdate=Y}function or(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return F},this.getActiveMipmapLevel=function(){return H},this.getRenderTarget=function(){return $},this.setRenderTargetTextures=function(A,Y,re){const ne=oe.get(A);ne.__autoAllocateDepthBuffer=A.resolveDepthBuffer===!1,ne.__autoAllocateDepthBuffer===!1&&(ne.__useRenderToTexture=!1),oe.get(A.texture).__webglTexture=Y,oe.get(A.depthTexture).__webglTexture=ne.__autoAllocateDepthBuffer?void 0:re,ne.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(A,Y){const re=oe.get(A);re.__webglFramebuffer=Y,re.__useDefaultFramebuffer=Y===void 0},this.setRenderTarget=function(A,Y=0,re=0){$=A,F=Y,H=re;let ne=null,te=!1,Ie=!1;if(A){const Fe=oe.get(A);if(Fe.__useDefaultFramebuffer!==void 0){b.bindFramebuffer(Z.FRAMEBUFFER,Fe.__webglFramebuffer),O.copy(A.viewport),K.copy(A.scissor),ye=A.scissorTest,b.viewport(O),b.scissor(K),b.setScissorTest(ye),_e=-1;return}else if(Fe.__webglFramebuffer===void 0)pe.setupRenderTarget(A);else if(Fe.__hasExternalTextures)pe.rebindTextures(A,oe.get(A.texture).__webglTexture,oe.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const Ue=A.depthTexture;if(Fe.__boundDepthTexture!==Ue){if(Ue!==null&&oe.has(Ue)&&(A.width!==Ue.image.width||A.height!==Ue.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");pe.setupDepthRenderbuffer(A)}}const Ze=A.texture;(Ze.isData3DTexture||Ze.isDataArrayTexture||Ze.isCompressedArrayTexture)&&(Ie=!0);const Ye=oe.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray(Ye[Y])?ne=Ye[Y][re]:ne=Ye[Y],te=!0):A.samples>0&&pe.useMultisampledRTT(A)===!1?ne=oe.get(A).__webglMultisampledFramebuffer:Array.isArray(Ye)?ne=Ye[re]:ne=Ye,O.copy(A.viewport),K.copy(A.scissor),ye=A.scissorTest}else O.copy(et).multiplyScalar(Te).floor(),K.copy(qt).multiplyScalar(Te).floor(),ye=ot;if(re!==0&&(ne=ue),b.bindFramebuffer(Z.FRAMEBUFFER,ne)&&b.drawBuffers(A,ne),b.viewport(O),b.scissor(K),b.setScissorTest(ye),te){const Fe=oe.get(A.texture);Z.framebufferTexture2D(Z.FRAMEBUFFER,Z.COLOR_ATTACHMENT0,Z.TEXTURE_CUBE_MAP_POSITIVE_X+Y,Fe.__webglTexture,re)}else if(Ie){const Fe=Y;for(let Ze=0;Ze<A.textures.length;Ze++){const Ye=oe.get(A.textures[Ze]);Z.framebufferTextureLayer(Z.FRAMEBUFFER,Z.COLOR_ATTACHMENT0+Ze,Ye.__webglTexture,re,Fe)}}else if(A!==null&&re!==0){const Fe=oe.get(A.texture);Z.framebufferTexture2D(Z.FRAMEBUFFER,Z.COLOR_ATTACHMENT0,Z.TEXTURE_2D,Fe.__webglTexture,re)}_e=-1},this.readRenderTargetPixels=function(A,Y,re,ne,te,Ie,Xe,Fe=0){if(!(A&&A.isWebGLRenderTarget)){Lt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ze=oe.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Xe!==void 0&&(Ze=Ze[Xe]),Ze){b.bindFramebuffer(Z.FRAMEBUFFER,Ze);try{const Ye=A.textures[Fe],Ue=Ye.format,tt=Ye.type;if(A.textures.length>1&&Z.readBuffer(Z.COLOR_ATTACHMENT0+Fe),!U.textureFormatReadable(Ue)){Lt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!U.textureTypeReadable(tt)){Lt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}Y>=0&&Y<=A.width-ne&&re>=0&&re<=A.height-te&&Z.readPixels(Y,re,ne,te,Re.convert(Ue),Re.convert(tt),Ie)}finally{const Ye=$!==null?oe.get($).__webglFramebuffer:null;b.bindFramebuffer(Z.FRAMEBUFFER,Ye)}}},this.readRenderTargetPixelsAsync=async function(A,Y,re,ne,te,Ie,Xe,Fe=0){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ze=oe.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Xe!==void 0&&(Ze=Ze[Xe]),Ze)if(Y>=0&&Y<=A.width-ne&&re>=0&&re<=A.height-te){b.bindFramebuffer(Z.FRAMEBUFFER,Ze);const Ye=A.textures[Fe],Ue=Ye.format,tt=Ye.type;if(A.textures.length>1&&Z.readBuffer(Z.COLOR_ATTACHMENT0+Fe),!U.textureFormatReadable(Ue))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!U.textureTypeReadable(tt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Qe=Z.createBuffer();Z.bindBuffer(Z.PIXEL_PACK_BUFFER,Qe),Z.bufferData(Z.PIXEL_PACK_BUFFER,Ie.byteLength,Z.STREAM_READ),Z.readPixels(Y,re,ne,te,Re.convert(Ue),Re.convert(tt),0);const lt=$!==null?oe.get($).__webglFramebuffer:null;b.bindFramebuffer(Z.FRAMEBUFFER,lt);const Nt=Z.fenceSync(Z.SYNC_GPU_COMMANDS_COMPLETE,0);return Z.flush(),await Xy(Z,Nt,4),Z.bindBuffer(Z.PIXEL_PACK_BUFFER,Qe),Z.getBufferSubData(Z.PIXEL_PACK_BUFFER,0,Ie),Z.deleteBuffer(Qe),Z.deleteSync(Nt),Ie}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(A,Y=null,re=0){const ne=Math.pow(2,-re),te=Math.floor(A.image.width*ne),Ie=Math.floor(A.image.height*ne),Xe=Y!==null?Y.x:0,Fe=Y!==null?Y.y:0;pe.setTexture2D(A,0),Z.copyTexSubImage2D(Z.TEXTURE_2D,re,0,0,Xe,Fe,te,Ie),b.unbindTexture()},this.copyTextureToTexture=function(A,Y,re=null,ne=null,te=0,Ie=0){let Xe,Fe,Ze,Ye,Ue,tt,Qe,lt,Nt;const ht=A.isCompressedTexture?A.mipmaps[Ie]:A.image;if(re!==null)Xe=re.max.x-re.min.x,Fe=re.max.y-re.min.y,Ze=re.isBox3?re.max.z-re.min.z:1,Ye=re.min.x,Ue=re.min.y,tt=re.isBox3?re.min.z:0;else{const on=Math.pow(2,-te);Xe=Math.floor(ht.width*on),Fe=Math.floor(ht.height*on),A.isDataArrayTexture?Ze=ht.depth:A.isData3DTexture?Ze=Math.floor(ht.depth*on):Ze=1,Ye=0,Ue=0,tt=0}ne!==null?(Qe=ne.x,lt=ne.y,Nt=ne.z):(Qe=0,lt=0,Nt=0);const yt=Re.convert(Y.format),Et=Re.convert(Y.type);let He;Y.isData3DTexture?(pe.setTexture3D(Y,0),He=Z.TEXTURE_3D):Y.isDataArrayTexture||Y.isCompressedArrayTexture?(pe.setTexture2DArray(Y,0),He=Z.TEXTURE_2D_ARRAY):(pe.setTexture2D(Y,0),He=Z.TEXTURE_2D),b.activeTexture(Z.TEXTURE0),b.pixelStorei(Z.UNPACK_FLIP_Y_WEBGL,Y.flipY),b.pixelStorei(Z.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Y.premultiplyAlpha),b.pixelStorei(Z.UNPACK_ALIGNMENT,Y.unpackAlignment);const rn=b.getParameter(Z.UNPACK_ROW_LENGTH),pt=b.getParameter(Z.UNPACK_IMAGE_HEIGHT),Rn=b.getParameter(Z.UNPACK_SKIP_PIXELS),li=b.getParameter(Z.UNPACK_SKIP_ROWS),Gi=b.getParameter(Z.UNPACK_SKIP_IMAGES);b.pixelStorei(Z.UNPACK_ROW_LENGTH,ht.width),b.pixelStorei(Z.UNPACK_IMAGE_HEIGHT,ht.height),b.pixelStorei(Z.UNPACK_SKIP_PIXELS,Ye),b.pixelStorei(Z.UNPACK_SKIP_ROWS,Ue),b.pixelStorei(Z.UNPACK_SKIP_IMAGES,tt);const ci=A.isDataArrayTexture||A.isData3DTexture,Vt=Y.isDataArrayTexture||Y.isData3DTexture;if(A.isDepthTexture){const on=oe.get(A),Vi=oe.get(Y),Gt=oe.get(on.__renderTarget),$i=oe.get(Vi.__renderTarget);b.bindFramebuffer(Z.READ_FRAMEBUFFER,Gt.__webglFramebuffer),b.bindFramebuffer(Z.DRAW_FRAMEBUFFER,$i.__webglFramebuffer);for(let qa=0;qa<Ze;qa++)ci&&(Z.framebufferTextureLayer(Z.READ_FRAMEBUFFER,Z.COLOR_ATTACHMENT0,oe.get(A).__webglTexture,te,tt+qa),Z.framebufferTextureLayer(Z.DRAW_FRAMEBUFFER,Z.COLOR_ATTACHMENT0,oe.get(Y).__webglTexture,Ie,Nt+qa)),Z.blitFramebuffer(Ye,Ue,Xe,Fe,Qe,lt,Xe,Fe,Z.DEPTH_BUFFER_BIT,Z.NEAREST);b.bindFramebuffer(Z.READ_FRAMEBUFFER,null),b.bindFramebuffer(Z.DRAW_FRAMEBUFFER,null)}else if(te!==0||A.isRenderTargetTexture||oe.has(A)){const on=oe.get(A),Vi=oe.get(Y);b.bindFramebuffer(Z.READ_FRAMEBUFFER,fe),b.bindFramebuffer(Z.DRAW_FRAMEBUFFER,q);for(let Gt=0;Gt<Ze;Gt++)ci?Z.framebufferTextureLayer(Z.READ_FRAMEBUFFER,Z.COLOR_ATTACHMENT0,on.__webglTexture,te,tt+Gt):Z.framebufferTexture2D(Z.READ_FRAMEBUFFER,Z.COLOR_ATTACHMENT0,Z.TEXTURE_2D,on.__webglTexture,te),Vt?Z.framebufferTextureLayer(Z.DRAW_FRAMEBUFFER,Z.COLOR_ATTACHMENT0,Vi.__webglTexture,Ie,Nt+Gt):Z.framebufferTexture2D(Z.DRAW_FRAMEBUFFER,Z.COLOR_ATTACHMENT0,Z.TEXTURE_2D,Vi.__webglTexture,Ie),te!==0?Z.blitFramebuffer(Ye,Ue,Xe,Fe,Qe,lt,Xe,Fe,Z.COLOR_BUFFER_BIT,Z.NEAREST):Vt?Z.copyTexSubImage3D(He,Ie,Qe,lt,Nt+Gt,Ye,Ue,Xe,Fe):Z.copyTexSubImage2D(He,Ie,Qe,lt,Ye,Ue,Xe,Fe);b.bindFramebuffer(Z.READ_FRAMEBUFFER,null),b.bindFramebuffer(Z.DRAW_FRAMEBUFFER,null)}else Vt?A.isDataTexture||A.isData3DTexture?Z.texSubImage3D(He,Ie,Qe,lt,Nt,Xe,Fe,Ze,yt,Et,ht.data):Y.isCompressedArrayTexture?Z.compressedTexSubImage3D(He,Ie,Qe,lt,Nt,Xe,Fe,Ze,yt,ht.data):Z.texSubImage3D(He,Ie,Qe,lt,Nt,Xe,Fe,Ze,yt,Et,ht):A.isDataTexture?Z.texSubImage2D(Z.TEXTURE_2D,Ie,Qe,lt,Xe,Fe,yt,Et,ht.data):A.isCompressedTexture?Z.compressedTexSubImage2D(Z.TEXTURE_2D,Ie,Qe,lt,ht.width,ht.height,yt,ht.data):Z.texSubImage2D(Z.TEXTURE_2D,Ie,Qe,lt,Xe,Fe,yt,Et,ht);b.pixelStorei(Z.UNPACK_ROW_LENGTH,rn),b.pixelStorei(Z.UNPACK_IMAGE_HEIGHT,pt),b.pixelStorei(Z.UNPACK_SKIP_PIXELS,Rn),b.pixelStorei(Z.UNPACK_SKIP_ROWS,li),b.pixelStorei(Z.UNPACK_SKIP_IMAGES,Gi),Ie===0&&Y.generateMipmaps&&Z.generateMipmap(He),b.unbindTexture()},this.initRenderTarget=function(A){oe.get(A).__webglFramebuffer===void 0&&pe.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?pe.setTextureCube(A,0):A.isData3DTexture?pe.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?pe.setTexture2DArray(A,0):pe.setTexture2D(A,0),b.unbindTexture()},this.resetState=function(){F=0,H=0,$=null,b.reset(),we.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ca}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const i=this.getContext();i.drawingBufferColorSpace=Rt._getDrawingBufferColorSpace(e),i.unpackColorSpace=Rt._getUnpackColorSpace()}}const H2="/assets/Reckk-RegularItalic-DLM8ilig.ttf",G2="/assets/Reckk-MediumItalic-D_uyfX4p.otf",V2="/assets/CXLMediumItalic-DYSp-DoC.otf",k2=4,X2=5,Ba={fleet:"MAEX",name:"SharpeShark",version:"v1",role:"Executor",didShort:"0xf8a2…6035"};function Ux(a){return["discover","copy","supervise","isolate"][a]??"discover"}function W2(a){return Ux(a)}function q2(a,e,i){const r=e.split(/\s+/),o=[];let c="";for(const u of r){const d=c?`${c} ${u}`:u;a.measureText(d).width<=i?c=d:(c&&o.push(c),c=u)}return c&&o.push(c),o}function Y2(a,e){const r=e<520?300:400,o=Math.round(r*a),c=Math.round(o*X2/k2);return{W:o,H:c}}function Ox(a,e,i,r,o,c){const u=Math.min(c,r/2,o/2);a.beginPath(),a.moveTo(e+u,i),a.arcTo(e+r,i,e+r,i+o,u),a.arcTo(e+r,i+o,e,i+o,u),a.arcTo(e,i+o,e,i,u),a.arcTo(e,i,e+r,i,u),a.closePath()}function nn(a,e,i,r,o,c,u){Ox(a,e,i,r,o,c),a.fillStyle=u,a.fill()}function mn(a,e,i,r,o,c,u,d){Ox(a,e,i,r,o,c),a.strokeStyle=u,a.lineWidth=d,a.stroke()}function yu(a,e,i,r,o,c){nn(a,e,i,r,o,c,"#0c0e12"),mn(a,e,i,r,o,c,"rgba(255,255,255,0.12)",Math.max(1,c*.12))}function Eu(a,e,i,r,o,c,u){const d=11*u;a.fillStyle="#c8f5a8",a.font=`700 ${d}px "DM Mono", ui-monospace, monospace`,a.textAlign="left",a.fillText(c,e+o,i+o+d);const m=22*u,p=e+r-o-m,g=i+o-2*u;return mn(a,p,g,m,m,4*u,"rgba(255,255,255,0.14)",1),a.strokeStyle="rgba(255,255,255,0.55)",a.lineWidth=Math.max(1,1.25*u),a.beginPath(),a.moveTo(p+6*u,g+6*u),a.lineTo(p+m-6*u,g+m-6*u),a.moveTo(p+m-6*u,g+6*u),a.lineTo(p+6*u,g+m-6*u),a.stroke(),i+o+d+10*u}function Px(a,e,i,r,o,c,u,d){const m=28*d,p=(r-o*2)/2,g=10*d;a.font=`700 ${g}px "DM Mono", ui-monospace, monospace`;for(let _=0;_<2;_++){const v=e+o+_*p,S=_===u;a.fillStyle=S?"rgba(255,255,255,0.92)":"rgba(255,255,255,0.38)",a.textAlign="center",a.fillText(c[_],v+p/2,i+14*d),S&&(a.fillStyle="#c8f5a8",a.fillRect(v+4*d,i+m-2*d,p-8*d,2*d))}return a.textAlign="left",a.strokeStyle="rgba(255,255,255,0.08)",a.lineWidth=1,a.beginPath(),a.moveTo(e+o,i+m),a.lineTo(e+r-o,i+m),a.stroke(),i+m+10*d}function j2(a,e,i,r,o,c,u,d,m){const p=10*m,g=22*m;a.fillStyle="rgba(255,255,255,0.92)",a.font=`700 ${p}px "DM Mono", ui-monospace, monospace`,a.textAlign="left",a.fillText(c,e+o,i+14*m);const _=`${String(u).padStart(2,"0")} / ${String(d).padStart(2,"0")}`;a.fillStyle="rgba(255,255,255,0.38)",a.font=`700 ${8*m}px "DM Mono", ui-monospace, monospace`,a.textAlign="right",a.fillText(_,e+r-o,i+14*m),a.textAlign="left",a.strokeStyle="rgba(255,255,255,0.08)",a.lineWidth=1,a.beginPath(),a.moveTo(e+o,i+g),a.lineTo(e+r-o,i+g),a.stroke(),a.fillStyle="#c8f5a8";const v=Math.min(72*m,r*.28);return a.fillRect(e+o,i+g-2*m,v,2*m),i+g+10*m}function Z2(a,e,i,r,o,c,u){const d=9*u;a.fillStyle="rgba(255,255,255,0.38)",a.font=`700 ${d}px "DM Mono", ui-monospace, monospace`,a.textAlign="left",a.fillText(o,e,i+d);const m=i+d+6*u,p=34*u;nn(a,e,m,r,p,6*u,"rgba(255,255,255,0.04)"),mn(a,e,m,r,p,6*u,"rgba(255,255,255,0.12)",1),a.fillStyle=c.startsWith("Select")||c==="0x..."?"rgba(255,255,255,0.35)":"rgba(255,255,255,0.88)",a.font=`500 ${11*u}px "Spline Sans", "DM Sans", ui-sans-serif, sans-serif`,a.fillText(c,e+10*u,m+p*.62),a.strokeStyle="rgba(255,255,255,0.4)",a.lineWidth=Math.max(1,1.2*u);const g=e+r-14*u,_=m+p/2;return a.beginPath(),a.moveTo(g-4*u,_-2*u),a.lineTo(g,_+3*u),a.lineTo(g+4*u,_-2*u),a.stroke(),d+6*u+p}function K2(a,e,i,r,o){const c=9*o;a.fillStyle="rgba(255,255,255,0.38)",a.font=`700 ${c}px "DM Mono", ui-monospace, monospace`,a.textAlign="left",a.fillText("AMOUNT",e,i+c),a.textAlign="right",a.fillStyle="rgba(255,255,255,0.45)",a.fillText("AVAILABLE 5,000.00",e+r,i+c),a.textAlign="left";const u=i+c+6*o,d=44*o;nn(a,e,u,r,d,8*o,"#050508"),mn(a,e,u,r,d,8*o,"rgba(255,255,255,0.1)",1),a.fillStyle="rgba(255,255,255,0.92)",a.font=`700 ${22*o}px "DM Mono", ui-monospace, monospace`,a.fillText("0.00",e+12*o,u+d*.68);const m=u+d+10*o;return a.strokeStyle="rgba(255,255,255,0.12)",a.lineWidth=Math.max(2,2*o),a.beginPath(),a.moveTo(e,m),a.lineTo(e+r,m),a.stroke(),nn(a,e,m-5*o,14*o,10*o,5*o,"rgba(255,255,255,0.85)"),a.fillStyle="rgba(255,255,255,0.35)",a.font=`500 ${8*o}px "DM Mono", ui-monospace, monospace`,a.fillText("0.01",e,m+14*o),a.textAlign="right",a.fillText("5,000.00",e+r,m+14*o),a.textAlign="left",c+6*o+d+10*o+16*o}function Q2(a,e,i,r,o,c){a.strokeStyle="rgba(255,255,255,0.08)",a.lineWidth=1,a.beginPath(),a.moveTo(e,i),a.lineTo(e+r,i),a.stroke();const u=i+10*o,d=36*o,m=72*o;mn(a,e,u,m,d,6*o,"rgba(255,255,255,0.14)",1),a.fillStyle="rgba(255,255,255,0.55)",a.font=`700 ${9*o}px "DM Mono", ui-monospace, monospace`,a.textAlign="center",a.fillText("CANCEL",e+m/2,u+d*.62);const p=e+m+8*o,g=r-m-8*o;return nn(a,p,u,g,d,6*o,"rgba(255,255,255,0.06)"),mn(a,p,u,g,d,6*o,"rgba(255,255,255,0.1)",1),a.fillStyle="#c8f5a8",a.fillRect(p,u+4*o,3*o,d-8*o),a.fillStyle="rgba(255,255,255,0.55)",a.font=`700 ${8.5*o}px "DM Mono", ui-monospace, monospace`,a.fillText(c,p+g/2+2*o,u+d*.62),a.textAlign="left",10*o+d}function Cp(a,e,i,r,o){const c=44*o;nn(a,e,i,r,c,8*o,"rgba(200,245,168,0.08)"),mn(a,e,i,r,c,8*o,"rgba(200,245,168,0.22)",1);const u=28*o;return nn(a,e+8*o,i+(c-u)/2,u,u,4*o,"rgba(200,245,168,0.14)"),a.fillStyle="#c8f5a8",a.font=`700 ${10*o}px "DM Mono", ui-monospace, monospace`,a.textAlign="center",a.fillText("SS",e+8*o+u/2,i+c*.58),a.textAlign="left",a.fillStyle="rgba(255,255,255,0.92)",a.font=`700 ${11*o}px "Spline Sans", "DM Sans", ui-sans-serif, sans-serif`,a.fillText(Ba.name,e+8*o+u+8*o,i+16*o),a.fillStyle="rgba(255,255,255,0.42)",a.font=`500 ${9*o}px "DM Mono", ui-monospace, monospace`,a.fillText(`${Ba.role} · ${Ba.didShort}`,e+8*o+u+8*o,i+32*o),c}function J2(a,e,i,r,o){const c=Math.min(r*190/316,r*.58),u=12*o,d=8*o,m=a.createLinearGradient(e,i+c,e+r,i);m.addColorStop(0,"#050508"),m.addColorStop(1,"rgba(200,245,168,0.14)"),nn(a,e,i,r,c,d,m),mn(a,e,i,r,c,d,"rgba(255,255,255,0.14)",Math.max(1,1.25*o)),mn(a,e+2.5*o,i+2.5*o,r-5*o,c-5*o,d-1.5*o,"rgba(200,245,168,0.35)",Math.max(1,o)),a.fillStyle="rgba(255,255,255,0.92)",a.font=`700 ${11*o}px "Spline Sans", "DM Sans", ui-sans-serif, sans-serif`,a.fillText(Ba.fleet,e+u,i+u+10*o),a.fillStyle="#c8f5a8",a.beginPath(),a.arc(e+r-u-7*o,i+u+5*o,6*o,0,Math.PI*2),a.fill(),a.fillStyle="#0a0a0c",a.font=`700 ${8*o}px "DM Mono", ui-monospace, monospace`,a.textAlign="center",a.fillText("✓",e+r-u-7*o,i+u+8*o),a.textAlign="left";const p=i+c-u-2*o;a.fillStyle="rgba(255,255,255,0.92)",a.font=`700 ${10*o}px "Spline Sans", "DM Sans", ui-sans-serif, sans-serif`,a.fillText(Ba.name.toUpperCase(),e+u,p-24*o),a.fillStyle="rgba(255,255,255,0.45)",a.font=`500 ${9*o}px "Spline Sans", "DM Sans", ui-sans-serif, sans-serif`,a.fillText(`${Ba.role} · ${Ba.version}`,e+u,p-10*o),a.fillStyle="#c8f5a8",a.font=`700 ${10*o}px "DM Mono", ui-monospace, monospace`,a.fillText(Ba.didShort,e+u,p);const g=28*o;return nn(a,e+r-u-g,i+c-u-g,g,g,4*o,"rgba(200,245,168,0.14)"),mn(a,e+r-u-g,i+c-u-g,g,g,4*o,"rgba(200,245,168,0.28)",1),a.fillStyle="#c8f5a8",a.font=`700 ${11*o}px "DM Mono", ui-monospace, monospace`,a.textAlign="center",a.fillText("SS",e+r-u-g/2,i+c-u-g*.35),a.textAlign="left",c}function $2(a,e,i,r,o){const c=Math.min(r*190/316,r*.58),u=10*o,d=8*o,m=a.createLinearGradient(e,i,e+r,i+c);m.addColorStop(0,"#0a0c10"),m.addColorStop(.55,"#12161c"),m.addColorStop(1,"rgba(200,245,168,0.18)"),nn(a,e,i,r,c,d,m),mn(a,e,i,r,c,d,"rgba(255,255,255,0.14)",Math.max(1,1.25*o)),a.fillStyle="rgba(255,255,255,0.92)",a.font=`700 ${10*o}px "Spline Sans", "DM Sans", ui-sans-serif, sans-serif`,a.fillText("Morpheum.",e+u,i+u+10*o),a.strokeStyle="rgba(255,255,255,0.45)",a.lineWidth=Math.max(1,o);for(let p=0;p<3;p++){const g=5*o+p*3.5*o,_=4*o+p*2.5*o;a.beginPath(),a.ellipse(e+r-u-4*o,i+u+8*o,g,_,-.4,-.2,1.2),a.stroke()}return a.fillStyle="rgba(255,255,255,0.88)",a.font=`700 ${9*o}px "DM Mono", ui-monospace, monospace`,a.fillText("5678  ····  ····  7890",e+u,i+c*.52),a.fillStyle="rgba(255,255,255,0.92)",a.font=`700 ${8*o}px "Spline Sans", "DM Sans", ui-sans-serif, sans-serif`,a.fillText(Ba.name.toUpperCase(),e+u,i+c-u-2*o),a.textAlign="right",a.fillStyle="rgba(255,255,255,0.55)",a.font=`700 ${8*o}px "DM Mono", ui-monospace, monospace`,a.fillText("12/28",e+r-u,i+c-u-2*o),a.textAlign="left",c}function eR(a,e,i,r,o,c=25){const u=9*o;a.fillStyle="rgba(255,255,255,0.38)",a.font=`700 ${u}px "DM Mono", ui-monospace, monospace`,a.textAlign="left",a.fillText("MIRROR SIZE",e,i+u),a.textAlign="right",a.fillStyle="#c8f5a8",a.fillText(`${c}%`,e+r,i+u),a.textAlign="left";const d=i+u+12*o,m=Math.max(4,5*o);nn(a,e,d,r,m,m/2,"rgba(255,255,255,0.1)");const p=Math.max(m,r*c/100);nn(a,e,d,p,m,m/2,"rgba(200,245,168,0.75)");const g=7*o;return a.fillStyle="#f4f6f0",a.beginPath(),a.arc(e+p,d+m/2,g,0,Math.PI*2),a.fill(),a.strokeStyle="rgba(200,245,168,0.55)",a.lineWidth=Math.max(1,o),a.stroke(),a.fillStyle="rgba(255,255,255,0.35)",a.font=`500 ${7.5*o}px "DM Mono", ui-monospace, monospace`,a.fillText("5%",e,d+m+14*o),a.textAlign="right",a.fillText("100%",e+r,d+m+14*o),a.textAlign="left",u+12*o+m+16*o}function tR(a,e,i,r,o){const c=9*o;a.fillStyle="rgba(255,255,255,0.38)",a.font=`700 ${c}px "DM Mono", ui-monospace, monospace`,a.fillText("AGENTIC PROTECTION",e,i+c);const u=5*o,d=(r-u*2)/3,m=52*o,p=i+c+8*o;return[{label:"Manual",tone:"rgba(255,255,255,0.12)",active:!1},{label:"Guarded",tone:"rgba(234,179,8,0.55)",active:!0},{label:"High",tone:"rgba(255,71,87,0.35)",active:!1}].forEach((_,v)=>{const S=e+v*(d+u);nn(a,S,p,d,m,6*o,"rgba(255,255,255,0.04)"),mn(a,S,p,d,m,6*o,_.active?_.tone:"rgba(255,255,255,0.1)",_.active?Math.max(1.5,1.5*o):1),_.active&&(a.fillStyle="rgba(234,179,8,0.12)",a.fillRect(S+1,p+1,3*o,m-2)),a.fillStyle=_.active?"rgba(255,255,255,0.92)":"rgba(255,255,255,0.55)",a.font=`700 ${9*o}px "Spline Sans", "DM Sans", ui-sans-serif, sans-serif`,a.textAlign="center",a.fillText(_.label,S+d/2,p+18*o),a.fillStyle="rgba(255,255,255,0.38)",a.font=`400 ${7*o}px "Spline Sans", "DM Sans", ui-sans-serif, sans-serif`;const E=_.label==="Guarded"?"safe default":_.label==="Manual"?"signals":"silent";a.fillText(E,S+d/2,p+34*o)}),a.textAlign="left",c+8*o+m}function nR(a,e,i,r,o,c="SLIDE TO START COPY"){const u=40*o;nn(a,e,i,r,u,8*o,"rgba(255,255,255,0.05)"),mn(a,e,i,r,u,8*o,"rgba(255,255,255,0.12)",1);const d=.22,m=4*o,p=u-m*2,g=r-m*2-p;return nn(a,e+m,i+m,p+g*d,p,p/2,"rgba(200,245,168,0.18)"),nn(a,e+m,i+m,p,p,p/2,"rgba(200,245,168,0.85)"),a.fillStyle="#0a0a0c",a.font=`700 ${12*o}px "DM Mono", ui-monospace, monospace`,a.textAlign="center",a.fillText("›",e+m+p/2,i+u*.62),a.fillStyle="rgba(255,255,255,0.5)",a.font=`700 ${8*o}px "DM Mono", ui-monospace, monospace`,a.fillText(c,e+r/2+p*.15,i+u*.62),a.textAlign="left",u}const pl=2,ro={sharpe:"2.41",roi:"+38.2%",riskScore:"72",reputation:"84",receipts:[{action:"Close BTC long",pnl:"+103.09"},{action:"Open ETH long",pnl:null},{action:"Close SOL short",pnl:"+41.20"}]};function Rv(a,e,i,r,o,c){const u=6*c,d=o.length,m=(r-u*(d-1))/d,p=36*c;return o.forEach(([g,_],v)=>{const S=e+v*(m+u);nn(a,S,i,m,p,6*c,"rgba(255,255,255,0.04)"),mn(a,S,i,m,p,6*c,"rgba(255,255,255,0.1)",1),a.fillStyle="rgba(255,255,255,0.4)",a.font=`700 ${7*c}px "DM Mono", ui-monospace, monospace`,a.textAlign="center",a.fillText(g,S+m/2,i+12*c),a.fillStyle="#c8f5a8",a.font=`700 ${11*c}px "DM Mono", ui-monospace, monospace`,a.fillText(_,S+m/2,i+26*c)}),a.textAlign="left",p}function iR(a,e,i,r,o){const c=[{label:"Verified",brand:!0},{label:"Receipt"},{label:"Risk",value:ro.riskScore},{label:"Rep",value:ro.reputation}],u=4*o,d=22*o,m=5*o;let p=e;a.font=`700 ${6.5*o}px "DM Mono", ui-monospace, monospace`;for(const g of c){const _=a.measureText(g.label.toUpperCase()).width,v=g.value?a.measureText(g.value).width+3*o:0,S=m*2+6*o+_+v;if(p+S>e+r)break;const E=g.brand?"rgba(200,245,168,0.12)":"rgba(255,255,255,0.04)",w=g.brand?"rgba(200,245,168,0.35)":"rgba(255,255,255,0.12)";nn(a,p,i,S,d,4*o,E),mn(a,p,i,S,d,4*o,w,1);const y=2*o;a.beginPath(),a.arc(p+m+y,i+d/2,y,0,Math.PI*2),a.fillStyle=g.brand?"#c8f5a8":"rgba(255,255,255,0.35)",a.fill();let M=p+m+y*2+4*o;a.fillStyle=g.brand?"#c8f5a8":"rgba(255,255,255,0.55)",a.textAlign="left",a.fillText(g.label.toUpperCase(),M,i+d*.68),M+=_+3*o,g.value&&(a.fillStyle="rgba(255,255,255,0.92)",a.fillText(g.value,M,i+d*.68)),p+=S+u}return a.textAlign="left",d}function aR(a,e,i,r,o){const c=ro.receipts,u=22*o,d=14*o+c.length*u;return nn(a,e,i,r,d,6*o,"rgba(255,255,255,0.03)"),mn(a,e,i,r,d,6*o,"rgba(255,255,255,0.08)",1),a.fillStyle="rgba(255,255,255,0.4)",a.font=`700 ${6.5*o}px "DM Mono", ui-monospace, monospace`,a.textAlign="left",a.fillText("RECEIPTS",e+8*o,i+10*o),c.forEach((m,p)=>{const g=i+14*o+p*u;a.fillStyle="rgba(255,255,255,0.72)",a.font=`500 ${8*o}px "DM Mono", ui-monospace, monospace`,a.textAlign="left",a.fillText(m.action,e+8*o,g+u*.62),a.textAlign="right",m.pnl?(a.fillStyle="#c8f5a8",a.font=`700 ${8*o}px "DM Mono", ui-monospace, monospace`,a.fillText(m.pnl,e+r-8*o,g+u*.62)):(a.fillStyle="rgba(255,255,255,0.35)",a.fillText("—",e+r-8*o,g+u*.62))}),a.textAlign="left",d}function sR(a,e,i,r,o){const c=Math.min(r*150/316,r*.48),u=12*o,d=8*o,m=a.createLinearGradient(e,i+c,e+r,i);m.addColorStop(0,"#050508"),m.addColorStop(1,"rgba(200,245,168,0.14)"),nn(a,e,i,r,c,d,m),mn(a,e,i,r,c,d,"rgba(255,255,255,0.14)",Math.max(1,1.25*o)),mn(a,e+2.5*o,i+2.5*o,r-5*o,c-5*o,d-1.5*o,"rgba(200,245,168,0.35)",Math.max(1,o)),a.fillStyle="rgba(255,255,255,0.92)",a.font=`700 ${11*o}px "Spline Sans", "DM Sans", ui-sans-serif, sans-serif`,a.fillText("MAEX",e+u,i+u+10*o);const p=40*o,g=16*o,_=e+r-u-p,v=i+u-1*o;return nn(a,_,v,p,g,8*o,"rgba(200,245,168,0.14)"),mn(a,_,v,p,g,8*o,"rgba(200,245,168,0.28)",1),a.fillStyle="#c8f5a8",a.font=`700 ${8*o}px "DM Mono", ui-monospace, monospace`,a.textAlign="center",a.fillText("LIVE",_+p/2,v+11*o),a.textAlign="left",a.fillStyle="rgba(255,255,255,0.92)",a.font=`700 ${14*o}px "Spline Sans", "DM Sans", ui-sans-serif, sans-serif`,a.fillText("MAEX Core",e+u,i+u+36*o),a.fillStyle="rgba(255,255,255,0.45)",a.font=`500 ${9*o}px "Spline Sans", "DM Sans", ui-sans-serif, sans-serif`,a.fillText("Curated agent basket · 4 agents",e+u,i+u+52*o),a.fillStyle="#c8f5a8",a.font=`700 ${18*o}px "DM Mono", ui-monospace, monospace`,a.fillText("+12.8%",e+u,i+c-u-4*o),a.fillStyle="rgba(255,255,255,0.4)",a.font=`700 ${8*o}px "DM Mono", ui-monospace, monospace`,a.textAlign="right",a.fillText("30D RETURN",e+r-u,i+c-u-8*o),a.textAlign="left",c}function rR(a,e,i,r,o){const c=[["SharpeShark","42%","+38%"],["SortinoSloth","33%","+21%"],["FundingFox","25%","−4%"]],u=26*o,d=c.length*u;return nn(a,e,i,r,d,6*o,"rgba(255,255,255,0.03)"),mn(a,e,i,r,d,6*o,"rgba(255,255,255,0.08)",1),c.forEach(([m,p,g],_)=>{const v=i+_*u;_>0&&(a.strokeStyle="rgba(255,255,255,0.06)",a.lineWidth=1,a.beginPath(),a.moveTo(e+8*o,v),a.lineTo(e+r-8*o,v),a.stroke()),a.fillStyle="rgba(255,255,255,0.85)",a.font=`600 ${9*o}px "Spline Sans", "DM Sans", ui-sans-serif, sans-serif`,a.textAlign="left",a.fillText(m,e+10*o,v+u*.62),a.fillStyle="rgba(255,255,255,0.4)",a.font=`700 ${8*o}px "DM Mono", ui-monospace, monospace`,a.textAlign="center",a.fillText(p,e+r*.58,v+u*.62);const S=!g.startsWith("−")&&!g.startsWith("-");a.fillStyle=S?"#c8f5a8":"rgba(255,120,120,0.85)",a.textAlign="right",a.fillText(g,e+r-10*o,v+u*.62)}),a.textAlign="left",d}function oR(a,e,i,r,o,c=0){const u=r/300,d=12*u,m=10*u,p=(c%pl+pl)%pl,g=[{header:"AGENT PROOF",segment:"AGENTS"},{header:"INDEX PROOF",segment:"INDICES"}][p];yu(a,e,i,r,o,m);let _=Eu(a,e,i,r,d,g.header,u);_=j2(a,e,_,r,d,g.segment,p+1,pl,u);const v=i+o-d;if(p===0){_+=Cp(a,e+d,_,r-d*2,u)+8*u,_+22*u<=v&&(_+=iR(a,e+d,_,r-d*2,u)+8*u);const E=[["SHARPE",ro.sharpe],["ROI",ro.roi],["RISK",ro.riskScore]];_+36*u<=v&&(_+=Rv(a,e+d,_,r-d*2,E,u)+8*u),_+70*u<=v&&aR(a,e+d,_,r-d*2,u);return}_+=sR(a,e+d,_,r-d*2,u)+8*u,_+78*u<=v&&(_+=rR(a,e+d,_,r-d*2,u)+8*u);const S=[["RETURN","+12.8%"],["RISK","58"],["AGENTS","4"]];_+36*u<=v&&Rv(a,e+d,_,r-d*2,S,u)}function lR(a,e,i,r,o,c=0){const u=r/300,d=12*u,m=10*u;yu(a,e,i,r,o,m);let p=Eu(a,e,i,r,d,"COPY TRADE",u);p=Px(a,e,p,r,d,["MIRROR","BUCKET"],0,u);const g=40*u,_=i+o-d-g,v=_-10*u;if(c%2===0){const E=6*u,w=r-d*2;let y=(w-E)/2,M=Math.min(y*190/316,y*.58);const P=Math.max(64*u,v-p-28*u);M>P&&(y=y*(P/M),M=P);const z=u*(y/((w-E)/2)),C=e+d+(w-(y*2+E))/2;$2(a,C,p,y,z),J2(a,C+y+E,p,y,z),p+=M+10*u;const I=[["SPREAD","0.02%"],["FUNDING","8h"],["SIZE","25%"]],N=5*u,B=(r-d*2-N*2)/3,T=32*u;p+T<=v&&(I.forEach(([L,X],V)=>{const j=e+d+V*(B+N);nn(a,j,p,B,T,6*u,"rgba(255,255,255,0.04)"),mn(a,j,p,B,T,6*u,"rgba(255,255,255,0.1)",1),a.fillStyle="rgba(255,255,255,0.4)",a.font=`700 ${6.5*u}px "DM Mono", ui-monospace, monospace`,a.textAlign="center",a.fillText(L,j+B/2,p+11*u),a.fillStyle="#c8f5a8",a.font=`700 ${10*u}px "DM Mono", ui-monospace, monospace`,a.fillText(X,j+B/2,p+24*u)}),a.textAlign="left")}else p+=Cp(a,e+d,p,r-d*2,u)+10*u,p+36*u<v&&(p+=eR(a,e+d,p,r-d*2,u,25)+10*u),p+50*u<v&&tR(a,e+d,p,r-d*2,u);nR(a,e+d,_,r-d*2,u)}const cR=2,uR=[{agent:"SharpeShark",timeLabel:"07-08, 15:42",status:"want-to",statusLabel:"Want to",action:"Open ETH long · 1.2 ETH",showActions:!0},{agent:"NightOwl",timeLabel:"07-08, 15:31",status:"rejected",statusLabel:"Rejected",action:"Open BTC short · 0.04 BTC"},{agent:"SharpeShark",timeLabel:"07-08, 15:25",status:"short",statusLabel:"Close Long",action:"BTCUSDT · 0.04 BTC",pnl:{text:"+103.09",tone:"long"}},{agent:"FluxRunner",timeLabel:"07-08, 14:10",status:"long",statusLabel:"Open Long",action:"ETHUSDT · 0.8 ETH"},{agent:"NightOwl",timeLabel:"07-07, 09:42",status:"short",statusLabel:"Open Short",action:"SOLUSDT · 12 SOL"}];function fR(a){switch(a){case"want-to":return{fg:"rgba(200,245,168,0.95)",bg:"rgba(184,245,168,0.12)"};case"rejected":return{fg:"#ff4757",bg:"rgba(255,71,87,0.12)"};case"long":return{fg:"#00ff88",bg:"rgba(0,255,136,0.12)"};case"short":return{fg:"#ff4757",bg:"rgba(255,71,87,0.12)"}}}function dR(a,e,i,r,o){const c=r/300,u=12*c,d=10*c;yu(a,e,i,r,o,d);let m=Eu(a,e,i,r,u,"ACTIVITY LOG",c);const p=i+o-u,g=58*c,_=10*c,v=6*c,S=e+u+g+v+_+v,E=e+r-u-S,w=e+u+g+v+_/2,y=uR,M=4*c;y.forEach((P,z)=>{if(m>=p-8*c)return;const C=z===0,I=z===y.length-1,N=fR(P.status),B=8*c,T=6*c,L=7*c,X=8*c,V=P.showActions?22*c:0,j=P.showActions?5*c:0,fe=Math.max(B+2*c+T,L+4*c+X)+j+V+M;if(m+Math.min(fe,28*c)>p)return;a.textAlign="right",a.fillStyle="rgba(255,255,255,0.88)",a.font=`500 ${B}px "DM Mono", ui-monospace, monospace`,a.fillText(P.agent,e+u+g,m+B),a.fillStyle="rgba(255,255,255,0.38)",a.font=`500 ${T}px "DM Mono", ui-monospace, monospace`,a.fillText(P.timeLabel,e+u+g,m+B+2*c+T),a.textAlign="left",I||(a.strokeStyle="rgba(255,255,255,0.14)",a.lineWidth=Math.max(1,c),a.beginPath(),a.moveTo(w,m+6*c),a.lineTo(w,m+fe),a.stroke());const q=2.4*c;a.beginPath(),a.arc(w,m+5*c,q,0,Math.PI*2),a.fillStyle=C?"#c8f5a8":"rgba(255,255,255,0.32)",a.fill(),C&&(a.beginPath(),a.arc(w,m+5*c,q+2.2*c,0,Math.PI*2),a.fillStyle="rgba(200,245,168,0.16)",a.fill());const F=4*c,H=2*c;a.font=`700 ${L}px "DM Mono", ui-monospace, monospace`;const $=P.statusLabel.toUpperCase(),_e=a.measureText($).width+F*2,Me=L+H*2;nn(a,S,m,_e,Me,3*c,N.bg),a.fillStyle=N.fg,a.fillText($,S+F,m+L+H*.35),a.fillStyle="rgba(255,255,255,0.55)",a.font=`400 ${X}px "DM Mono", ui-monospace, monospace`;const O=m+Me+3*c+X;let K=P.action;if(P.pnl){const ye=`${P.action} · `;a.fillText(ye,S,O);const Ce=a.measureText(ye).width;a.fillStyle=P.pnl.tone==="long"?"#00ff88":"#ff4757",a.font=`700 ${X}px "DM Mono", ui-monospace, monospace`,a.fillText(P.pnl.text,S+Ce,O)}else{for(;K.length>8&&a.measureText(K).width>E;)K=`${K.slice(0,-2)}…`;a.fillText(K,S,O)}if(P.showActions&&m+Me+3*c+X+j+V<=p){const ye=m+Me+3*c+X+j,Ce=(E-5*c)/2;mn(a,S,ye,Ce,V,3*c,"rgba(255,255,255,0.18)",1),a.fillStyle="rgba(255,255,255,0.72)",a.font=`700 ${7*c}px "DM Mono", ui-monospace, monospace`,a.textAlign="center",a.fillText("REJECT",S+Ce/2,ye+V*.68),nn(a,S+Ce+5*c,ye,Ce,V,3*c,"rgba(184,245,168,0.88)"),a.fillStyle="rgba(8,14,10,0.92)",a.fillText("APPROVE",S+Ce+5*c+Ce/2,ye+V*.68),a.textAlign="left"}m+=fe})}function hR(a,e,i,r,o){const c=r/300,u=12*c,d=10*c;yu(a,e,i,r,o,d);let m=Eu(a,e,i,r,u,"FUND BUCKET",c);m=Px(a,e,m,r,u,["FUND BUCKET","CREATE BUCKET"],0,c),m+=Cp(a,e+u,m,r-u*2,c)+8*c,m+=Z2(a,e+u,m,r-u*2,"FROM","Select source bucket",c)+8*c;const p=10*c+36*c;i+o-u-p-m-8*c>70*c&&(m+=K2(a,e+u,m,r-u*2,c)+6*c),Q2(a,e+u,i+o-u-p,r-u*2,c,"COMPLETE REQUIRED FIELDS")}function Ix(a,e,i,r,o,c,u=0){switch(e){case"discover":oR(a,i,r,o,c,u);break;case"copy":lR(a,i,r,o,c,u);break;case"supervise":dR(a,i,r,o,c);break;case"isolate":hR(a,i,r,o,c);break}}function pR(a,e,i,r,o=0){a.clearRect(0,0,i,r),Ix(a,e,0,0,i,r,o)}function mR(a,e,i,r,o){const{W:c,H:u}=Y2(i,r),d=document.createElement("canvas");d.width=c,d.height=u;const m=d.getContext("2d"),p=m.createLinearGradient(0,0,0,u);p.addColorStop(0,"#080a0e"),p.addColorStop(.55,"#05070d"),p.addColorStop(1,"#030406"),m.fillStyle=p,m.fillRect(0,0,c,u);const g=Math.round(22*i),_=Math.round(.05*u),v=Math.round(.045*u),S=c-g*2;let E=_;const w=Math.min(34*i,c*.095);m.fillStyle="rgba(255,255,255,0.94)",m.font=`normal 400 ${w}px ${o}`,m.textBaseline="alphabetic",m.fillText(a.verb,g,E+w*.85),E+=Math.round(.09*u);const y=Math.min(13*i,c*.036);m.fillStyle="rgba(255,255,255,0.55)",m.font=`400 ${y}px "Spline Sans", "DM Sans", ui-sans-serif, sans-serif`;const M=q2(m,a.description,S);m.fillText(M[0]??a.description,g,E+y),E+=Math.round(.07*u),E+=Math.round(.03*u);const P=g,z=E,C=S,I=Math.max(80*i,u-E-v);Ix(m,W2(e),P,z,C,I);const N=new Sx(d);return N.colorSpace=Jn,N.minFilter=Ts,N.generateMipmaps=!0,N}const Cv="!@#$%^&*()_+{}[]|;:,.<>?/0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ",gR=50,cu=500,_h=100,wv=168;function _R(){return typeof window>"u"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches}function vR(){return Cv[Math.floor(Math.random()*Cv.length)]??"?"}function Dv(a){return Array.from(a).map(e=>{const i=Math.random()*(cu-_h),r=_h+Math.random()*(cu-i-_h),o=Math.min(cu,i+r);return{original:e,start:i,end:o}})}function xR(a){return Math.min(1,Math.max(0,a))}function SR({text:a,className:e,scrollerRef:i}){const r=Ke.useRef(null),o=Ke.useRef(Dv(a)),c=_R();return Ke.useEffect(()=>{o.current=Dv(a)},[a]),Ke.useEffect(()=>{if(c)return;const u=r.current;if(!u)return;let d=0,m=!0,p=-1;const g=()=>{const v=i.current;if(!v)return;const S=Math.max(0,-v.getBoundingClientRect().top),E=Math.min(cu,Math.max(0,S-gR));if(E===p&&p>=0)return;p=E;const w=o.current,y=u.querySelectorAll(".scroll-dissolve__glyph");let M=w.length>0;for(let P=0;P<w.length;P++){const z=w[P],C=y[P];if(!C)continue;const I=Math.max(.001,z.end-z.start),N=xR((E-z.start)/I);if(N<1&&(M=!1),N<=0){C.textContent=z.original===" "?" ":z.original,C.style.transform="translateY(0)",C.style.opacity="1",C.style.visibility="visible";continue}if(N>=1){C.textContent=z.original===" "?" ":z.original,C.style.transform=`translateY(${-wv}px)`,C.style.opacity="0",C.style.visibility="hidden";continue}C.textContent=vR(),C.style.transform=`translateY(${-N*wv}px)`,C.style.opacity=String(1-N),C.style.visibility="visible"}u.style.visibility=M?"hidden":"visible",u.style.display=M?"none":"block"},_=()=>{m&&(g(),d=requestAnimationFrame(_))};return d=requestAnimationFrame(_),()=>{m=!1,cancelAnimationFrame(d)}},[c,i,a]),c?D.jsx("p",{className:e,"aria-label":a,children:a}):D.jsx("p",{ref:r,className:["scroll-dissolve",e].filter(Boolean).join(" "),"aria-label":a,children:Array.from(a).map((u,d)=>D.jsx("span",{className:"scroll-dissolve__glyph","aria-hidden":!0,children:u===" "?" ":u},`${d}-${u}`))})}const MR="Proof first. Risk contained.",no=Sh.verbs.map((a,e)=>{const i=[{top:"#c8f5a8",mid:"#0a1410",bot:"#1a3d2e"},{top:"#9ee089",mid:"#060e18",bot:"#1e3a52"},{top:"#f0e6a0",mid:"#0c1008",bot:"#2a3820"},{top:"#7fd9a8",mid:"#080810",bot:"#243048"}];return{verb:a.verb,description:a.description,mood:i[e]??i[0]}}),dn=no.length,Fa=2.95,vl=6.9,wp=32,Fx=4,Bx=5,fp=2.05,yR=1,ER=Fa*.55,zx=.28,Hx=.35,bR=zx+Hx,Nv=.85,TR=35,Lv=TR/60*1e3,AR=.1;function Gx(a){return a<520?{mode:"mobile",canvasW:1280,canvasH:320,fontPx:112,planeBaseW:4.55,frustumFill:.9}:a<900?{mode:"tablet",canvasW:1600,canvasH:360,fontPx:132,planeBaseW:5.25,frustumFill:.94}:{mode:"desktop",canvasW:1920,canvasH:420,fontPx:152,planeBaseW:6.1,frustumFill:.96}}const RR=1.35,CR=.72,wR=.62,DR=.2,NR=14,LR=.42,UR=128,OR=12,PR=.004,IR=.0022,Uv=.12,FR=.88,BR=4,zR=22,HR=32,GR=40,VR=`
varying vec2 vUv;
void main() {
  vUv = uv;
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
